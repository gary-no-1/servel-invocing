...
<asp:ImageButton id="BlankPanelWithHeaderIcon" runat="server" ToolTip="&lt;%# GetResourceValue(&quot;Btn:ExpandCollapse&quot;) %&gt;" causesvalidation="False" imageurl="../images/icon_panelcollapse.gif" /></td><td class="dhb"><table cellpadding="0" cellspacing="0" border="0"><tr><td class="dht" valign="middle">All the Masters</td></tr></table>
	...
	</asp:Button></td><td></td><td></td></tr><tr><td colspan="3"><hr></hr></td></tr><tr><td><asp:Button runat="server" id="btnStates" causesvalidation="False" commandname="Redirect" consumers="page" height="50px" text="States" width="205px">		
	...
	</asp:Button></td></tr><tr><td colspan="3"><hr></hr></td></tr><tr><td><asp:Button runat="server" id="btnItemType" causesvalidation="False" commandname="Redirect" consumers="page" height="50px" requiredroles="&lt;PRoles>1;2;4&lt;/PRoles>" text="Item Type" width="205px">		
