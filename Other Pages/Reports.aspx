...
<asp:ImageButton id="BlankPanelWithHeaderIcon" runat="server" ToolTip="&lt;%# GetResourceValue(&quot;Btn:ExpandCollapse&quot;) %&gt;" causesvalidation="False" imageurl="../images/icon_panelcollapse.gif" /></td><td class="dhb"><table cellpadding="0" cellspacing="0" border="0"><tr><td class="dht" valign="middle">All the reports</td></tr></table>
	...
	</asp:Button></td><td><asp:Button runat="server" id="btnGSThsnTaxDetail" bordercolor="#0" borderstyle="NotSet" causesvalidation="False" commandname="Redirect" consumers="page" height="50px" requiredroles="&lt;PRoles>1;2;4&lt;/PRoles>" text="GST HSN Tax Detail" width="205px">		
	</asp:Button></td><td><asp:Button runat="server" id="btnGSThsnTaxReport" bordercolor="#0" borderstyle="NotSet" causesvalidation="False" commandname="Redirect" consumers="page" height="50px" requiredroles="&lt;PRoles>1;2;4&lt;/PRoles>" text="GST HSN Tax  Report (hsn)" width="205px">		
