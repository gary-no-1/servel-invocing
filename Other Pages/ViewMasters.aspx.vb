...
' This file implements the code-behind class for ViewMasters.aspx.
' ViewMasters.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class ViewMasters
        Inherits BaseApplicationPage
' Code-behind class for the ViewMasters page.
...
'          ' NOTE: If the Base function redirects to another page, any code here will not be executed.
'        End Sub
'Public Sub PushButton6_Click(ByVal sender As Object, ByVal args As EventArgs)
'            
'          ' Click handler for PushButton6.
'          ' Customize by adding code before the call or replace the call to the Base function with your own code.
'          PushButton6_Click_Base(sender, args)
'          ' NOTE: If the Base function redirects to another page, any code here will not be executed.
'        End Sub
'Public Sub PushButton5_Click(ByVal sender As Object, ByVal args As EventArgs)
'            
'          ' Click handler for PushButton5.
'          ' Customize by adding code before the call or replace the call to the Base function with your own code.
'          PushButton5_Click_Base(sender, args)
'          ' NOTE: If the Base function redirects to another page, any code here will not be executed.
'        End Sub
'Public Sub PushButton4_Click(ByVal sender As Object, ByVal args As EventArgs)
'            
'          ' Click handler for PushButton4.
'          ' Customize by adding code before the call or replace the call to the Base function with your own code.
'          PushButton4_Click_Base(sender, args)
'          ' NOTE: If the Base function redirects to another page, any code here will not be executed.
'        End Sub
'Public Sub PushButton3_Click(ByVal sender As Object, ByVal args As EventArgs)
'            
'          ' Click handler for PushButton3.
'          ' Customize by adding code before the call or replace the call to the Base function with your own code.
'          PushButton3_Click_Base(sender, args)
'          ' NOTE: If the Base function redirects to another page, any code here will not be executed.
'        End Sub
'Public Sub PushButton2_Click(ByVal sender As Object, ByVal args As EventArgs)
'            
'          ' Click handler for PushButton2.
'          ' Customize by adding code before the call or replace the call to the Base function with your own code.
'          PushButton2_Click_Base(sender, args)
'          ' NOTE: If the Base function redirects to another page, any code here will not be executed.
'        End Sub
...
'          ' NOTE: If the Base function redirects to another page, any code here will not be executed.
'        End Sub
'Public Sub PushButton9_Click(ByVal sender As Object, ByVal args As EventArgs)
'            
'          ' Click handler for PushButton9.
'          ' Customize by adding code before the call or replace the call to the Base function with your own code.
'          PushButton9_Click_Base(sender, args)
'          ' NOTE: If the Base function redirects to another page, any code here will not be executed.
'        End Sub
'Public Sub PushButton8_Click(ByVal sender As Object, ByVal args As EventArgs)
'            
'          ' Click handler for PushButton8.
'          ' Customize by adding code before the call or replace the call to the Base function with your own code.
'          PushButton8_Click_Base(sender, args)
'          ' NOTE: If the Base function redirects to another page, any code here will not be executed.
'        End Sub
'Public Sub PushButton7_Click(ByVal sender As Object, ByVal args As EventArgs)
'            
'          ' Click handler for PushButton7.
'          ' Customize by adding code before the call or replace the call to the Base function with your own code.
'          PushButton7_Click_Base(sender, args)
'          ' NOTE: If the Base function redirects to another page, any code here will not be executed.
'        End Sub
'Public Sub PushButton10_Click(ByVal sender As Object, ByVal args As EventArgs)
'            
'          ' Click handler for PushButton10.
'          ' Customize by adding code before the call or replace the call to the Base function with your own code.
'          PushButton10_Click_Base(sender, args)
'          ' NOTE: If the Base function redirects to another page, any code here will not be executed.
'        End Sub
Public Sub btnItemType_Click(ByVal sender As Object, ByVal args As EventArgs)
            
          ' Click handler for btnItemType.
          ' Customize by adding code before the call or replace the call to the Base function with your own code.
          btnItemType_Click_Base(sender, args)
          ' NOTE: If the Base function redirects to another page, any code here will not be executed.
        End Sub
Public Sub btnItemGroup_Click(ByVal sender As Object, ByVal args As EventArgs)
            
          ' Click handler for btnItemGroup.
          ' Customize by adding code before the call or replace the call to the Base function with your own code.
          btnItemGroup_Click_Base(sender, args)
          ' NOTE: If the Base function redirects to another page, any code here will not be executed.
        End Sub
		Public Sub btnCompany_Click(ByVal sender As Object, ByVal args As EventArgs)
            
          ' Click handler for btnCompany.
          ' Customize by adding code before the call or replace the call to the Base function with your own code.
          btnCompany_Click_Base(sender, args)
          ' NOTE: If the Base function redirects to another page, any code here will not be executed.
        End Sub
                
Public Sub btnCommodity_Click(ByVal sender As Object, ByVal args As EventArgs)
            
          ' Click handler for btnCommodity.
          ' Customize by adding code before the call or replace the call to the Base function with your own code.
          btnCommodity_Click_Base(sender, args)
          ' NOTE: If the Base function redirects to another page, any code here will not be executed.
        End Sub
Public Sub btnUOM_Click(ByVal sender As Object, ByVal args As EventArgs)
            
          ' Click handler for btnUOM.
          ' Customize by adding code before the call or replace the call to the Base function with your own code.
          btnUOM_Click_Base(sender, args)
          ' NOTE: If the Base function redirects to another page, any code here will not be executed.
        End Sub
Public Sub btnTransporter_Click(ByVal sender As Object, ByVal args As EventArgs)
            
          ' Click handler for btnTransporter.
          ' Customize by adding code before the call or replace the call to the Base function with your own code.
          btnTransporter_Click_Base(sender, args)
          ' NOTE: If the Base function redirects to another page, any code here will not be executed.
        End Sub
Public Sub btnTerms_Click(ByVal sender As Object, ByVal args As EventArgs)
            
          ' Click handler for btnTerms.
          ' Customize by adding code before the call or replace the call to the Base function with your own code.
          btnTerms_Click_Base(sender, args)
          ' NOTE: If the Base function redirects to another page, any code here will not be executed.
        End Sub
Public Sub btnTaxTypes_Click(ByVal sender As Object, ByVal args As EventArgs)
            
          ' Click handler for btnTaxTypes.
          ' Customize by adding code before the call or replace the call to the Base function with your own code.
          btnTaxTypes_Click_Base(sender, args)
          ' NOTE: If the Base function redirects to another page, any code here will not be executed.
        End Sub
Public Sub btnTaxGroups_Click(ByVal sender As Object, ByVal args As EventArgs)
            
          ' Click handler for btnTaxGroups.
          ' Customize by adding code before the call or replace the call to the Base function with your own code.
          btnTaxGroups_Click_Base(sender, args)
          ' NOTE: If the Base function redirects to another page, any code here will not be executed.
        End Sub
Public Sub btnTaxes_Click(ByVal sender As Object, ByVal args As EventArgs)
            
          ' Click handler for btnTaxes.
          ' Customize by adding code before the call or replace the call to the Base function with your own code.
          btnTaxes_Click_Base(sender, args)
          ' NOTE: If the Base function redirects to another page, any code here will not be executed.
        End Sub
Public Sub btnSalesPerson_Click(ByVal sender As Object, ByVal args As EventArgs)
            
          ' Click handler for btnSalesPerson.
          ' Customize by adding code before the call or replace the call to the Base function with your own code.
...
#Region "Section 2: Do not modify this section."
        ...
        Public WithEvents btnTaxGroups As System.Web.UI.WebControls.Button
        
        Public WithEvents btnTaxTypes As System.Web.UI.WebControls.Button
        
        Public WithEvents btnTerms As System.Web.UI.WebControls.Button
        
        Public WithEvents btnTransporter As System.Web.UI.WebControls.Button
        
        Public WithEvents btnUOM As System.Web.UI.WebControls.Button
        ...
        Protected Overridable Sub Page_InitializeEventHandlers(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Init
            ...
            AddHandler Me.btnTaxGroups.Click, AddressOf btnTaxGroups_Click
        
            AddHandler Me.btnTaxTypes.Click, AddressOf btnTaxTypes_Click
        
            AddHandler Me.btnTerms.Click, AddressOf btnTerms_Click
        
            AddHandler Me.btnTransporter.Click, AddressOf btnTransporter_Click
        
            AddHandler Me.btnUOM.Click, AddressOf btnUOM_Click
        ...
        Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
			...
			Me.Authorize(Ctype(btnCommodity, Control), "1;2;4")
			...
			Me.Authorize(Ctype(btnTaxGroups, Control), "1;2")
					
			Me.Authorize(Ctype(btnTaxTypes, Control), "1;2")
					
			Me.Authorize(Ctype(btnTerms, Control), "1;2")
					
			Me.Authorize(Ctype(btnTransporter, Control), "1;2;4")
					
			Me.Authorize(Ctype(btnUOM, Control), "1;2;3;4")
    ...
    End Function
      ...
      End Sub
        ...
        Public Sub btnCommodity_Click_Base(ByVal sender As Object, ByVal args As EventArgs)
            ...
            Dim url As String = "../commodity/ShowCommodityTable.aspx"
        ...
        ' event handler for PushButton with Layout
        Public Sub btnCompany_Click_Base(ByVal sender As Object, ByVal args As EventArgs)
            ...
            ' Any code after the Response.Redirect call will not be executed, since the page is
            ' redirected to the URL.
            Dim url As String = "../company/ShowCompanyTable.aspx"
            Dim shouldRedirect As Boolean = True
            Dim TargetKey As String = Nothing
            Dim DFKA As String = Nothing
            Dim id As String = Nothing
        ...
        Public Sub btnItemGroup_Click_Base(ByVal sender As Object, ByVal args As EventArgs)
            ...
            ' Any code after the Response.Redirect call will not be executed, since the page is
            ' redirected to the URL.
            Dim url As String = "../item_groups/ShowItem_groupsTable.aspx"
            Dim shouldRedirect As Boolean = True
            Dim TargetKey As String = Nothing
            Dim DFKA As String = Nothing
            Dim id As String = Nothing
        ...
        ' event handler for PushButton with Layout
        Public Sub btnItemType_Click_Base(ByVal sender As Object, ByVal args As EventArgs)
            ...
            ' Any code after the Response.Redirect call will not be executed, since the page is
            ' redirected to the URL.
            Dim url As String = "../item_types/ShowItem_typesTable.aspx"
            Dim shouldRedirect As Boolean = True
            Dim TargetKey As String = Nothing
            Dim DFKA As String = Nothing
            Dim id As String = Nothing
        ...
        ' event handler for PushButton with Layout
        Public Sub btnSalesPerson_Click_Base(ByVal sender As Object, ByVal args As EventArgs)
            ...
            ' Any code after the Response.Redirect call will not be executed, since the page is
            ' redirected to the URL.
            Dim url As String = "../saleperson/ShowSalepersonTable.aspx"
            Dim shouldRedirect As Boolean = True
            Dim TargetKey As String = Nothing
            Dim DFKA As String = Nothing
            Dim id As String = Nothing
        ...
        Public Sub btnTaxes_Click_Base(ByVal sender As Object, ByVal args As EventArgs)
            ...
            ' Any code after the Response.Redirect call will not be executed, since the page is
            ' redirected to the URL.
            Dim url As String = "../taxes/ShowTaxesTable.aspx"
            Dim shouldRedirect As Boolean = True
            Dim TargetKey As String = Nothing
            Dim DFKA As String = Nothing
            Dim id As String = Nothing
        ...
        ' event handler for PushButton with Layout
        Public Sub btnTaxGroups_Click_Base(ByVal sender As Object, ByVal args As EventArgs)
            ...
            ' Any code after the Response.Redirect call will not be executed, since the page is
            ' redirected to the URL.
            Dim url As String = "../tax_groups/ShowTax_groupsTable.aspx"
            Dim shouldRedirect As Boolean = True
            Dim TargetKey As String = Nothing
            Dim DFKA As String = Nothing
            Dim id As String = Nothing
        ...
        ' event handler for PushButton with Layout
        Public Sub btnTaxTypes_Click_Base(ByVal sender As Object, ByVal args As EventArgs)
            ...
            ' Any code after the Response.Redirect call will not be executed, since the page is
            ' redirected to the URL.
            Dim url As String = "../tax_types/ShowTax_typesTable.aspx"
            Dim shouldRedirect As Boolean = True
            Dim TargetKey As String = Nothing
            Dim DFKA As String = Nothing
            Dim id As String = Nothing
        ...
        ' event handler for PushButton with Layout
        Public Sub btnTransporter_Click_Base(ByVal sender As Object, ByVal args As EventArgs)
            ...
            ' Any code after the Response.Redirect call will not be executed, since the page is
            ' redirected to the URL.
            Dim url As String = "../transporters/ShowTransportersTable.aspx"
            Dim shouldRedirect As Boolean = True
            Dim TargetKey As String = Nothing
            Dim DFKA As String = Nothing
            Dim id As String = Nothing
        ...
        ' event handler for PushButton with Layout
        Public Sub btnUOM_Click_Base(ByVal sender As Object, ByVal args As EventArgs)
            ...
            ' Any code after the Response.Redirect call will not be executed, since the page is
            ' redirected to the URL.
            Dim url As String = "../unitsofmeasure/ShowUnitsofmeasureTable.aspx"
            Dim shouldRedirect As Boolean = True
            Dim TargetKey As String = Nothing
            Dim DFKA As String = Nothing
            Dim id As String = Nothing
