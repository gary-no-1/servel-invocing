...
' ShowHsnTable.aspx page.  The Row or RecordControl classes are the 
...
Namespace ServelInvocing.UI.Controls.ShowHsnTable
...
' Base class for the HsnTableControlRow control on the ShowHsnTable page.
...
Public Class BaseHsnTableControlRow
        ...
        Protected Overridable Sub Control_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
			...
			Me.Page.LoadFocusScripts(Me)
              ...
              AddHandler Me.HsnRowCopyButton.Click, AddressOf HsnRowCopyButton_Click
        ...
        Public Overridable Sub HsnRowCopyButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
            ...
            Dim url As String = "../hsn/AddHsn.aspx?Hsn={PK}"
      ...
      Me.Page.CommitTransaction(sender)
        ...
        Public Overridable Sub HsnRowEditButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
            ...
            ' Any code after the Response.Redirect call will not be executed, since the page is
            ' redirected to the URL.
            Dim url As String = "../hsn/EditHsn.aspx?Hsn={PK}"
            Dim shouldRedirect As Boolean = True
            Dim TargetKey As String = Nothing
            Dim DFKA As String = Nothing
            Dim id As String = Nothing
        ...
        Public Overridable Sub HsnRowViewButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
            ...
            ' Any code after the Response.Redirect call will not be executed, since the page is
            ' redirected to the URL.
            Dim url As String = "../hsn/ShowHsn.aspx?Hsn={PK}"
            Dim shouldRedirect As Boolean = True
            Dim TargetKey As String = Nothing
            Dim DFKA As String = Nothing
            Dim id As String = Nothing
...
#Region "Helper Properties"
        ...
        Public ReadOnly Property HsnRowCopyButton() As System.Web.UI.WebControls.ImageButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "HsnRowCopyButton"), System.Web.UI.WebControls.ImageButton)
            End Get
        End Property
...
' Base class for the HsnTableControl control on the ShowHsnTable page.
...
Public Class BaseHsnTableControl
        ...
        Protected Overridable Sub Control_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            ' Setup the button events.
              ...
              AddHandler Me.HsnCopyButton.Click, AddressOf HsnCopyButton_Click
              ...
              AddHandler Me.HsnExportCSVButton.Click, AddressOf HsnExportCSVButton_Click
              
              AddHandler Me.HsnExportExcelButton.Click, AddressOf HsnExportExcelButton_Click
              
              AddHandler Me.HsnImportButton.Click, AddressOf HsnImportButton_Click
              
              AddHandler Me.HsnNewButton.Click, AddressOf HsnNewButton_Click
              
              AddHandler Me.HsnPDFButton.Click, AddressOf HsnPDFButton_Click
              ...
              AddHandler Me.HsnWordButton.Click, AddressOf HsnWordButton_Click
      ...
      End Sub
        ...
        Public Overridable Sub RegisterPostback()
              ...
              Me.Page.RegisterPostBackTrigger(MiscUtils.FindControlRecursively(Me,"HsnExportCSVButton"))
                        
              Me.Page.RegisterPostBackTrigger(MiscUtils.FindControlRecursively(Me,"HsnExportExcelButton"))
                        
              Me.Page.RegisterPostBackTrigger(MiscUtils.FindControlRecursively(Me,"HsnPDFButton"))
                        
              Me.Page.RegisterPostBackTrigger(MiscUtils.FindControlRecursively(Me,"HsnWordButton"))
      ...
      Me.SaveToSession("HsnSearch_Ajax", Me.HsnSearch.Text)
        ...
        ' event handler for ImageButton
        Public Overridable Sub HsnCopyButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
      ...
      Me.Page.CommitTransaction(sender)
        ...
        ' event handler for ImageButton
        Public Overridable Sub HsnExportCSVButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
          ...
          ' Create the Order By clause based on the user's current sorting preference.
            ...
            Dim columns() as BaseColumn = New BaseColumn() { _
                       HsnTable.hsn, _ 
             HsnTable.gst_description, _ 
             HsnTable.gst_uom, _ 
             Nothing}
            Dim  exportData as ExportDataToCSV = New ExportDataToCSV(HsnTable.Instance, wc, orderBy, columns)
        ...
        ' event handler for ImageButton
        Public Overridable Sub HsnExportExcelButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
            ...
            Dim excelReport As ExportDataToExcel = New ExportDataToExcel(HsnTable.Instance, wc, orderBy)
            ' Add each of the columns in order of export.
            ' To customize the data type, change the second parameter of the new ExcelColumn to be
            ' a format string from Excel's Format Cell menu. For example "dddd, mmmm dd, yyyy h:mm AM/PM;@", "#,##0.00"
             excelReport.AddColumn(New ExcelColumn(HsnTable.hsn, "Default"))
             excelReport.AddColumn(New ExcelColumn(HsnTable.gst_description, "Default"))
             excelReport.AddColumn(New ExcelColumn(HsnTable.gst_uom, "Default"))
        ...
        ' event handler for ImageButton
        Public Overridable Sub HsnImportButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
            ...
            ' Any code after the Response.Redirect call will not be executed, since the page is
            ' redirected to the URL.
            Dim url As String = "../Shared/SelectFileToImport.aspx?TableName=Hsn"
            Try
                ' Enclose all database retrieval/update code within a Transaction boundary
                DbUtils.StartTransaction
        ...
        ' event handler for ImageButton
        Public Overridable Sub HsnNewButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
            ...
            ' Any code after the Response.Redirect call will not be executed, since the page is
            ' redirected to the URL.
            Dim url As String = "../hsn/AddHsn.aspx"
            Dim shouldRedirect As Boolean = True
            Dim TargetKey As String = Nothing
            Dim DFKA As String = Nothing
            Dim id As String = Nothing
        ...
        ' event handler for ImageButton
        Public Overridable Sub HsnPDFButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
            ...
            Try
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowHsnTable.HsnPDFButton.report")
                ' report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "hsn"
                ' If ShowHsnTable.HsnPDFButton.report specifies a valid report template,
                ...
                ' The 5th parameter represents the relative width of the column   			
                 report.AddColumn(HsnTable.hsn.Name, ReportEnum.Align.Left, "${hsn}", ReportEnum.Align.Left, 15)
                 report.AddColumn(HsnTable.gst_description.Name, ReportEnum.Align.Left, "${gst_description}", ReportEnum.Align.Left, 30)
                 report.AddColumn(HsnTable.gst_uom.Name, ReportEnum.Align.Left, "${gst_uom}", ReportEnum.Align.Left, 15)
                ...
                Dim totalRows As Integer = HsnTable.GetRecordCount(whereClause)
                Dim columns As ColumnList = HsnTable.GetColumnList()
                Dim records As HsnRecord() = Nothing
            
                Do 
                    
                    records = HsnTable.GetRecords(whereClause, orderBy, pageNum, rowsPerQuery)
                    If Not (records Is Nothing) AndAlso records.Length > 0 AndAlso whereClause.RunQuery Then 
                        For Each record As HsnRecord In records 
                            ...
                            ' The 4th parameters represent the maximum length of the data value being shown
                                                         report.AddData("${hsn}", record.Format(HsnTable.hsn), ReportEnum.Align.Left, 100)
                             report.AddData("${gst_description}", record.Format(HsnTable.gst_description), ReportEnum.Align.Left, 100)
                             report.AddData("${gst_uom}", record.Format(HsnTable.gst_uom), ReportEnum.Align.Left, 100)
        ...
        ' event handler for ImageButton
        Public Overridable Sub HsnWordButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
            ...
            Try
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowHsnTable.HsnWordButton.word")
                ' report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "hsn"
                ' If ShowHsnTable.HsnWordButton.report specifies a valid report template,
                ' AddColumn method will generate a report template.
                ' Each AddColumn method-call specifies a column
                ' The 1st parameter represents the text of the column header
                ' The 2nd parameter represents the horizontal alignment of the column header
...
#Region "Helper Properties"
        ...
        Public ReadOnly Property HsnCopyButton() As System.Web.UI.WebControls.ImageButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "HsnCopyButton"), System.Web.UI.WebControls.ImageButton)
            End Get
        End Property
        ...
        Public ReadOnly Property HsnExportCSVButton() As System.Web.UI.WebControls.ImageButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "HsnExportCSVButton"), System.Web.UI.WebControls.ImageButton)
            End Get
        End Property
        
        Public ReadOnly Property HsnExportExcelButton() As System.Web.UI.WebControls.ImageButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "HsnExportExcelButton"), System.Web.UI.WebControls.ImageButton)
            End Get
        End Property
        
        Public ReadOnly Property HsnImportButton() As System.Web.UI.WebControls.ImageButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "HsnImportButton"), System.Web.UI.WebControls.ImageButton)
            End Get
        End Property
        ...
        Public ReadOnly Property HsnNewButton() As System.Web.UI.WebControls.ImageButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "HsnNewButton"), System.Web.UI.WebControls.ImageButton)
            End Get
        End Property
        ...
        Public ReadOnly Property HsnPDFButton() As System.Web.UI.WebControls.ImageButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "HsnPDFButton"), System.Web.UI.WebControls.ImageButton)
            End Get
        End Property
        ...
        Public ReadOnly Property HsnWordButton() As System.Web.UI.WebControls.ImageButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "HsnWordButton"), System.Web.UI.WebControls.ImageButton)
            End Get
        End Property
