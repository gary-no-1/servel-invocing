...
' AddHsn.aspx page.  The Row or RecordControl classes are the 
...
Namespace ServelInvocing.UI.Controls.AddHsn
...
' Base class for the HsnRecordControl control on the AddHsn page.
...
Public Class BaseHsnRecordControl
        ...
        Public Overridable Sub LoadData()        
            ...
            Me.DataSource = CType(HsnRecord.Copy(recList(0), False), HsnRecord)
        ...
        Public Overridable Sub GetUIData()
            ...
            For Each col In HsnRecord.TableUtils.TableDefinition.Columns()
        ...
        Public Overridable Function CreateWhereClause() As WhereClause
            ...
            HttpContext.Current.Session("QueryString in AddHsn") = recId
