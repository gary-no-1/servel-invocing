...
' ShowHsn.aspx page.  The Row or RecordControl classes are the 
...
Namespace ServelInvocing.UI.Controls.ShowHsn

#Region "Section 1: Place your customizations here."

    
Public Class HsnRecordControl
        Inherits BaseHsnRecordControl
        ' The BaseHsnRecordControl implements the LoadData, DataBind and other
...
' Base class for the HsnRecordControl control on the ShowHsn page.
' Do not modify this class. Instead override any method in HsnRecordControl.
Public Class BaseHsnRecordControl
        Inherits ServelInvocing.UI.BaseApplicationRecordControl

        '  To customize, override this method in HsnRecordControl.
        ...
        Protected Overridable Sub Control_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
              ...
              AddHandler Me.HsnDialogEditButton.Click, AddressOf HsnDialogEditButton_Click
        ...
        Public Overridable Sub LoadData()        
            ...
            Dim Panel As System.Web.UI.WebControls.Panel = CType(MiscUtils.FindControlRecursively(Me, "HsnRecordControlPanel"), System.Web.UI.WebControls.Panel)
            ...
            Dim recList() As HsnRecord = HsnTable.GetRecords(wc, Nothing, 0, 2)
            ...
            Me.DataSource = HsnTable.GetRecord(recList(0).GetID.ToXmlString(), True)
                  
        End Sub

        ' Populate the UI controls using the DataSource.  To customize, override this method in HsnRecordControl.
        ...
        Public Overridable Function CreateWhereClause() As WhereClause
            ...
            Dim recId As String = Me.Page.Request.QueryString.Item("Hsn")
                
            If recId Is Nothing OrElse recId.Trim = "" Then
                ' Get the error message from the application resource file.
                Throw New Exception(Page.GetResourceValue("Err:UrlParamMissing", "ServelInvocing").Replace("{URL}", "Hsn"))
            End If
            HttpContext.Current.Session("QueryString in ShowHsn") = recId
            ...
            If KeyValue.IsXmlKey(recId) Then
                ...
                wc.iAND(HsnTable.id0, BaseFilter.ComparisonOperator.EqualsTo, pkValue.GetColumnValue(HsnTable.id0).ToString())
        
            Else
                ' The URL parameter contains the actual value, not an XML structure.
                
                wc.iAND(HsnTable.id0, BaseFilter.ComparisonOperator.EqualsTo, recId)
        ...
        Public Overridable Sub HsnDialogEditButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
        ...
        Public Property RecordUniqueId() As String
            Get
                Return CType(Me.ViewState("BaseHsnRecordControl_Rec"), String)
            End Get
            Set(ByVal value As String)
                Me.ViewState("BaseHsnRecordControl_Rec") = value
            End Set
        End Property
...
#Region "Helper Properties"
        ...
        Public ReadOnly Property HsnDialogEditButton() As System.Web.UI.WebControls.ImageButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "HsnDialogEditButton"), System.Web.UI.WebControls.ImageButton)
            End Get
        End Property
