...
' EditHsn.aspx page.  The Row or RecordControl classes are the 
...
Namespace ServelInvocing.UI.Controls.EditHsn
...
' Base class for the HsnRecordControl control on the EditHsn page.
...
Public Class BaseHsnRecordControl
        ...
        Public Overridable Function CreateWhereClause() As WhereClause
            ...
            End If
            HttpContext.Current.Session("QueryString in EditHsn") = recId
