...
' This file implements the code-behind class for ShowHsnTable.aspx.
' ShowHsnTable.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class ShowHsnTable
        Inherits BaseApplicationPage
' Code-behind class for the ShowHsnTable page.
...
#Region "Ajax Functions"
      ...
      <Services.WebMethod()> _
      Public Shared Function GetAutoCompletionList_HsnSearch(ByVal prefixText As String, ByVal count As Integer) As String()
      ' GetHsnSearchCompletionList gets the list of suggestions from the database.
      ' prefixText is the search text typed by the user .
      ' count specifies the number of suggestions to be returned.
      ' Customize by adding code before or after the call to  GetAutoCompletionList_HsnSearch()
      ' or replace the call to GetAutoCompletionList_HsnSearch().
      Return GetAutoCompletionList_HsnSearch_Base(prefixText, count)
      End Function
...
#Region "Section 2: Do not modify this section."
        ...
        Public WithEvents gst_descriptionLabel As System.Web.UI.WebControls.Literal
        Public WithEvents gst_descriptionLabel1 As System.Web.UI.WebControls.LinkButton
        Public WithEvents gst_uomLabel As System.Web.UI.WebControls.Literal
        Public WithEvents gst_uomLabel1 As System.Web.UI.WebControls.LinkButton
        Public WithEvents HsnCopyButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents HsnDeleteButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents HsnEditButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents HsnExportCSVButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents HsnExportExcelButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents HsnImportButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents hsnLabel As System.Web.UI.WebControls.LinkButton
        Public WithEvents HsnNewButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents HsnPagination As Pagination
        Public WithEvents HsnPDFButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents HsnRefreshButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents HsnResetButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents HsnSearch As System.Web.UI.WebControls.TextBox
        Public WithEvents HsnSearchButton As ThemeButton
        Public WithEvents HsnTableControl As ServelInvocing.UI.Controls.ShowHsnTable.HsnTableControl
        Public WithEvents HsnTitle As System.Web.UI.WebControls.Literal
        Public WithEvents HsnToggleAll As System.Web.UI.WebControls.CheckBox
        Public WithEvents HsnWordButton As System.Web.UI.WebControls.ImageButton
    ...
    End Function
      ...
      End Sub
        ...
        Public Shared Function GetAutoCompletionList_HsnSearch_Base(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim control as ServelInvocing.UI.Controls.ShowHsnTable.HsnTableControl 
            control = new ServelInvocing.UI.Controls.ShowHsnTable.HsnTableControl()
            
            Return control.GetAutoCompletionList_HsnSearch(prefixText, count)
