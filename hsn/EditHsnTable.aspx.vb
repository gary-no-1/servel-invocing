...
' This file implements the code-behind class for EditHsnTable.aspx.
' EditHsnTable.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class EditHsnTable
        Inherits BaseApplicationPage
' Code-behind class for the EditHsnTable page.
...
#Region "Section 2: Do not modify this section."
        ...
        Public WithEvents HsnAddButton As System.Web.UI.WebControls.ImageButton
        ...
        Public WithEvents HsnSaveButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents HsnSearch As System.Web.UI.WebControls.TextBox
        Public WithEvents HsnSearchButton As ThemeButton
        Public WithEvents HsnTableControl As ServelInvocing.UI.Controls.EditHsnTable.HsnTableControl
        ...
        Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            Page.Title = GetResourceValue("Title:Edit") + " HSN"
        End Sub
    ...
    End Function
      ...
      End Sub
        ...
        Public Shared Function GetAutoCompletionList_HsnSearch_Base(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim control as ServelInvocing.UI.Controls.EditHsnTable.HsnTableControl 
            control = new ServelInvocing.UI.Controls.EditHsnTable.HsnTableControl()
