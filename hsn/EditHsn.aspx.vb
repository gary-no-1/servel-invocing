...
' This file implements the code-behind class for EditHsn.aspx.
' EditHsn.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class EditHsn
        Inherits BaseApplicationPage
' Code-behind class for the EditHsn page.
...
#Region "Section 2: Do not modify this section."
        ...
        Public WithEvents HsnRecordControl As ServelInvocing.UI.Controls.EditHsn.HsnRecordControl
      ...
      End Sub
        ...
        Public Sub SaveButton_Click_Base(ByVal sender As Object, ByVal args As EventArgs)
            ...
            If Not TargetKey Is Nothing Then
                ...
                If Not Me.HsnRecordControl Is Nothing AndAlso Not Me.HsnRecordControl.DataSource Is Nothing Then
                      
                      id = Me.HsnRecordControl.DataSource.id0.ToString
                      value = Me.HsnRecordControl.DataSource.GetValue(Me.HsnRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(DFKA)).ToString
                      ...
                      If Not Formula Is Nothing Then
                            value = EvaluateFormula(Formula, Me.HsnRecordControl.DataSource)
                      End If
