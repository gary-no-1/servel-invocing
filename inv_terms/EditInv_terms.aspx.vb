...
' This file implements the code-behind class for EditInv_terms.aspx.
' EditInv_terms.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class EditInv_terms
        Inherits BaseApplicationPage
' Code-behind class for the EditInv_terms page.
...
#Region "Section 2: Do not modify this section."
        ...
        Public WithEvents Inv_termsRecordControl As ServelInvocing.UI.Controls.EditInv_terms.Inv_termsRecordControl
        ...
        Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            Page.Title = GetResourceValue("Title:Edit") + " Terms"
        End Sub
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.Inv_termsRecordControl.SaveData()
      ...
      End Sub
        ...
        Me.Inv_termsRecordControl.LoadData()
        ...
        Public Sub SaveButton_Click_Base(ByVal sender As Object, ByVal args As EventArgs)
            ...
            If Not TargetKey Is Nothing Then
                ...
                If Not Me.Inv_termsRecordControl Is Nothing AndAlso Not Me.Inv_termsRecordControl.DataSource Is Nothing Then
                      
                      id = Me.Inv_termsRecordControl.DataSource.id0.ToString
                      value = Me.Inv_termsRecordControl.DataSource.GetValue(Me.Inv_termsRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(DFKA)).ToString
                      ...
                      If Not Formula Is Nothing Then
                            value = EvaluateFormula(Formula, Me.Inv_termsRecordControl.DataSource)
                      End If
