...
' This file implements the code-behind class for ShowInv_termsTable.aspx.
' ShowInv_termsTable.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class ShowInv_termsTable
        Inherits BaseApplicationPage
' Code-behind class for the ShowInv_termsTable page.
...
#Region "Ajax Functions"
      ...
      <Services.WebMethod()> _
      Public Shared Function GetAutoCompletionList_Inv_termsSearch(ByVal prefixText As String, ByVal count As Integer) As String()
      ' GetInv_termsSearchCompletionList gets the list of suggestions from the database.
      ' prefixText is the search text typed by the user .
      ' count specifies the number of suggestions to be returned.
      ' Customize by adding code before or after the call to  GetAutoCompletionList_Inv_termsSearch()
      ' or replace the call to GetAutoCompletionList_Inv_termsSearch().
      Return GetAutoCompletionList_Inv_termsSearch_Base(prefixText, count)
      End Function
...
#Region "Section 2: Do not modify this section."
        ...
        Public WithEvents Inv_termsCopyButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents Inv_termsDeleteButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents Inv_termsEditButton As System.Web.UI.WebControls.ImageButton
        ...
        Public WithEvents Inv_termsImportButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents Inv_termsNewButton As System.Web.UI.WebControls.ImageButton
        ...
        Public WithEvents Inv_termsSearch As System.Web.UI.WebControls.TextBox
        Public WithEvents Inv_termsSearchButton As ThemeButton
        Public WithEvents Inv_termsTableControl As ServelInvocing.UI.Controls.ShowInv_termsTable.Inv_termsTableControl
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.Inv_termsTableControl.SaveData()
      ...
      End Sub
        ...
        Public Shared Function GetAutoCompletionList_Inv_termsSearch_Base(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim control as ServelInvocing.UI.Controls.ShowInv_termsTable.Inv_termsTableControl 
            control = new ServelInvocing.UI.Controls.ShowInv_termsTable.Inv_termsTableControl()
            
            Return control.GetAutoCompletionList_Inv_termsSearch(prefixText, count)
        ...
        Me.Inv_termsTableControl.LoadData()
