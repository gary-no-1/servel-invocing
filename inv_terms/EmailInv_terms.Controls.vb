...
' EmailInv_terms.aspx page.  The Row or RecordControl classes are the 
...
Namespace ServelInvocing.UI.Controls.EmailInv_terms
...
' Base class for the Inv_termsRecordControl control on the EmailInv_terms page.
...
Public Class BaseInv_termsRecordControl
        ...
        Public Overridable Function CreateWhereClause() As WhereClause
            ...
            End If
            HttpContext.Current.Session("QueryString in EmailInv_terms") = recId
