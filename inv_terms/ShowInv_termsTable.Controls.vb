...
' ShowInv_termsTable.aspx page.  The Row or RecordControl classes are the 
...
Namespace ServelInvocing.UI.Controls.ShowInv_termsTable
...
' Base class for the Inv_termsTableControlRow control on the ShowInv_termsTable page.
...
Public Class BaseInv_termsTableControlRow
        ...
        Protected Overridable Sub Control_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
			...
			Me.Page.LoadFocusScripts(Me)
              ...
              Me.Inv_termsRowDeleteButton.Attributes.Add("onClick", "return (confirm('" & (CType(Me.Page,BaseApplicationPage)).GetResourceValue("DeleteRecordConfirm", "ServelInvocing") & "'));")
              ' Register the event handlers.
          
              AddHandler Me.Inv_termsRowCopyButton.Click, AddressOf Inv_termsRowCopyButton_Click
              
              AddHandler Me.Inv_termsRowDeleteButton.Click, AddressOf Inv_termsRowDeleteButton_Click
              
              AddHandler Me.Inv_termsRowEditButton.Click, AddressOf Inv_termsRowEditButton_Click
              
              AddHandler Me.Inv_termsRowViewButton.Click, AddressOf Inv_termsRowViewButton_Click
        ...
        Public Overridable Sub Setid_inv_hdr()
            ...
            If Me.DataSource IsNot Nothing AndAlso Me.DataSource.id_inv_hdrSpecified Then
                ...
                ' The Format method will return the Display Foreign Key As (DFKA) value
                                Dim formattedValue As String = Me.DataSource.Format(Inv_termsTable.id_inv_hdr)
            ...
            Else 
                ...
                Me.id_inv_hdr.Text = Inv_termsTable.id_inv_hdr.Format(Inv_termsTable.id_inv_hdr.DefaultValue)
        ...
        Public Overridable Sub Inv_termsRowCopyButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
        ...
        ' event handler for ImageButton
        Public Overridable Sub Inv_termsRowDeleteButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
      ...
      Me.Page.CommitTransaction(sender)
        ...
        ' event handler for ImageButton
        Public Overridable Sub Inv_termsRowEditButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
            ...
            ' Any code after the Response.Redirect call will not be executed, since the page is
            ' redirected to the URL.
            Dim url As String = "../inv_terms/EditInv_terms.aspx?Inv_terms={PK}"
            Dim shouldRedirect As Boolean = True
            Dim TargetKey As String = Nothing
            Dim DFKA As String = Nothing
            Dim id As String = Nothing
        ...
        ' event handler for ImageButton
        Public Overridable Sub Inv_termsRowViewButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
            ...
            ' Any code after the Response.Redirect call will not be executed, since the page is
            ' redirected to the URL.
            Dim url As String = "../inv_terms/ShowInv_terms.aspx?Inv_terms={PK}"
            Dim shouldRedirect As Boolean = True
            Dim TargetKey As String = Nothing
            Dim DFKA As String = Nothing
            Dim id As String = Nothing
        ...
        Public Overridable Sub id_inv_hdr_Click(ByVal sender As Object, ByVal args As EventArgs)
            ...
            ' Any code after the Response.Redirect call will not be executed, since the page is
            ' redirected to the URL.
            Dim url As String = "../inv_hdr/ShowInv_hdr.aspx?Inv_hdr={Inv_termsTableControlRow:FK:inv_terms_inv_hdr_id_inv_hdr_FK}"
            Dim shouldRedirect As Boolean = True
            Dim TargetKey As String = Nothing
            Dim DFKA As String = Nothing
            Dim id As String = Nothing
...
#Region "Helper Properties"
        ...
        Public ReadOnly Property Inv_termsRowCopyButton() As System.Web.UI.WebControls.ImageButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "Inv_termsRowCopyButton"), System.Web.UI.WebControls.ImageButton)
            End Get
        End Property
        
        Public ReadOnly Property Inv_termsRowDeleteButton() As System.Web.UI.WebControls.ImageButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "Inv_termsRowDeleteButton"), System.Web.UI.WebControls.ImageButton)
            End Get
        End Property
        
        Public ReadOnly Property Inv_termsRowEditButton() As System.Web.UI.WebControls.ImageButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "Inv_termsRowEditButton"), System.Web.UI.WebControls.ImageButton)
            End Get
        End Property
        
        Public ReadOnly Property Inv_termsRowViewButton() As System.Web.UI.WebControls.ImageButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "Inv_termsRowViewButton"), System.Web.UI.WebControls.ImageButton)
            End Get
        End Property
...
' Base class for the Inv_termsTableControl control on the ShowInv_termsTable page.
...
Public Class BaseInv_termsTableControl
        ...
        Protected Overridable Sub Control_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Init
           ...
           ' Setup the filter and search events.
            ...
            If Not Me.Page.IsPostBack Then
                Dim initialVal As String = ""
                If  Me.InSession(Me.Inv_termsSearch) 				
                    initialVal = Me.GetFromSession(Me.Inv_termsSearch)
                
                End If
                If initialVal <> ""				
                        
                        Me.Inv_termsSearch.Text = initialVal
        ...
        Protected Overridable Sub Control_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            SaveControlsToSession_Ajax()
              ...
              ' Show confirmation message on Click
              Me.Inv_termsDeleteButton.Attributes.Add("onClick", "return (confirm('" & (CType(Me.Page,BaseApplicationPage)).GetResourceValue("DeleteConfirm", "ServelInvocing") & "'));")
            ...
            ' Setup the button events.
              ...
              AddHandler Me.Inv_termsCopyButton.Click, AddressOf Inv_termsCopyButton_Click
              
              AddHandler Me.Inv_termsDeleteButton.Click, AddressOf Inv_termsDeleteButton_Click
              
              AddHandler Me.Inv_termsEditButton.Click, AddressOf Inv_termsEditButton_Click
              ...
              AddHandler Me.Inv_termsImportButton.Click, AddressOf Inv_termsImportButton_Click
              
              AddHandler Me.Inv_termsNewButton.Click, AddressOf Inv_termsNewButton_Click
            ...
            AddHandler Me.Inv_termsSearchButton.Button.Click, AddressOf Inv_termsSearchButton_Click
      ...
      End Sub
          ...
          End If
            ...
            Me.Page.PregetDfkaRecords(Inv_termsTable.id_inv_hdr, Me.DataSource)
        ...
        Public Overridable Function CreateWhereClause() As WhereClause
            ...
            If IsValueSelected(Me.id_inv_hdrFilter) Then
                ...
                wc.iAND(Inv_termsTable.id_inv_hdr, BaseFilter.ComparisonOperator.EqualsTo, MiscUtils.GetSelectedValue(Me.id_inv_hdrFilter, Me.GetFromSession(Me.id_inv_hdrFilter)), False, False)
            
                
            End If
                       
            If IsValueSelected(Me.Inv_termsSearch) Then
                ' Strip "..." from begin and ending of the search text, otherwise the search will return 0 values as in database "..." is not stored.
                If Me.Inv_termsSearch.Text.StartsWith("...") Then
                    Me.Inv_termsSearch.Text = Me.Inv_termsSearch.Text.SubString(3,Me.Inv_termsSearch.Text.Length-3)
                End If
                If Me.Inv_termsSearch.Text.EndsWith("...") then
                    Me.Inv_termsSearch.Text = Me.Inv_termsSearch.Text.SubString(0,Me.Inv_termsSearch.Text.Length-3)
                End If
                
                Dim formatedSearchText As String = MiscUtils.GetSelectedValue(Me.Inv_termsSearch, Me.GetFromSession(Me.Inv_termsSearch))
        ...
        ' These clauses are added depending on operator and fields selected in Control's property page, bindings tab.
                    ...
                    search.iOR(Inv_termsTable.narration, BaseFilter.ComparisonOperator.Contains, MiscUtils.GetSelectedValue(Me.Inv_termsSearch, Me.GetFromSession(Me.Inv_termsSearch)), True, False)
            ...
            If IsValueSelected(Me.narrationFilter) Then
                ...
                wc.iAND(Inv_termsTable.narration, BaseFilter.ComparisonOperator.EqualsTo, MiscUtils.GetSelectedValue(Me.narrationFilter, Me.GetFromSession(Me.narrationFilter)), False, False)
        ...
        Public Overridable Function CreateWhereClause(ByVal searchText as String, ByVal fromSearchControl as String, ByVal AutoTypeAheadSearch as String, ByVal AutoTypeAheadWordSeparators as String) As WhereClause
            ...
            If IsValueSelected(id_inv_hdrFilterSelectedValue) Then
                 ...
                 wc.iAND(Inv_termsTable.id_inv_hdr, BaseFilter.ComparisonOperator.EqualsTo, id_inv_hdrFilterSelectedValue, false, False)
             
             End If
                      
            If IsValueSelected(searchText) and fromSearchControl = "Inv_termsSearch" Then
                ...
                If IsValueSelected(formatedSearchText) Then
                    ...
                    If InvariantLCase(AutoTypeAheadSearch).equals("wordsstartingwithsearchstring") Then
                        ...
                        search.iOR(Inv_termsTable.narration, BaseFilter.ComparisonOperator.Starts_With, formatedSearchText, True, False)
                        search.iOR(Inv_termsTable.narration, BaseFilter.ComparisonOperator.Contains, AutoTypeAheadWordSeparators & formatedSearchText, True, False)
                
                    Else
                        
                        search.iOR(Inv_termsTable.narration, BaseFilter.ComparisonOperator.Contains, formatedSearchText, True, False)
                    End If
                    wc.iAND(search)
            ...
            If IsValueSelected(narrationFilterSelectedValue) Then
                 ...
                 wc.iAND(Inv_termsTable.narration, BaseFilter.ComparisonOperator.EqualsTo, narrationFilterSelectedValue, false, False)
        ...
        Public Overridable Function GetAutoCompletionList_Inv_termsSearch(ByVal prefixText As String, ByVal count As Integer) As String()
            Dim resultList As ArrayList = New ArrayList
            Dim wordList As ArrayList = New ArrayList
            Dim iteration As Integer = 0
            
            Dim wc As WhereClause = CreateWhereClause(prefixText,"Inv_termsSearch", "WordsStartingWithSearchString", "[^a-zA-Z0-9]")
            While (resultList.Count < count AndAlso iteration < 5)
                ' Fetch 100 records in each iteration
                Dim recordList () As ServelInvocing.Business.Inv_termsRecord = Inv_termsTable.GetRecords(wc, Nothing, iteration, 100)
                Dim rec As Inv_termsRecord = Nothing
                ...
                For Each rec In recordList 
                    ...
                    resultItem = rec.Format(Inv_termsTable.narration)
                ...
                For Each repItem In rep.Items
                    ...
                    If recControl.Visible AndAlso recControl.IsNewRecord() Then
                        ...
                        If recControl.id_inv_hdr.Text <> "" Then
                            rec.Parse(recControl.id_inv_hdr.Text, Inv_termsTable.id_inv_hdr)
                        End If
                        ...
                        If recControl.sort_order.Text <> "" Then
                            rec.Parse(recControl.sort_order.Text, Inv_termsTable.sort_order)
                        End If
        ...
        Public Overridable Sub SetInv_termsSearch()
        ...
        Protected Overridable Sub PopulatenarrationFilter(ByVal selectedValue As String, ByVal maxItems As Integer)
            ...
            Dim orderBy As OrderBy = New OrderBy(False, True)
            orderBy.Add(Inv_termsTable.narration, OrderByItem.OrderDir.Asc)
            ...
            Dim values() As String = Inv_termsTable.GetValues(Inv_termsTable.narration, wc, orderBy, maxItems)
            ...
            For Each itemValue In values
                ...
                If ( Inv_termsTable.narration.IsColumnValueTypeBoolean()) Then
                    fvalue = itemValue
                Else
                    fvalue = Inv_termsTable.narration.Format(itemValue)
                End If
        ...
        Protected Overrides Sub SaveControlsToSession()
            ...
            Me.SaveToSession(Me.Inv_termsSearch, Me.Inv_termsSearch.Text)
      ...
      Me.SaveToSession("Inv_termsSearch_Ajax", Me.Inv_termsSearch.Text)
      ...
      Me.SaveToSession("narrationFilter_Ajax", Me.narrationFilter.SelectedValue)
        ...
        Protected Overrides Sub ClearControlsFromSession()
            ...
            Me.RemoveFromSession(Me.Inv_termsSearch)
        ...
        Public Overridable Sub id_inv_hdrLabel1_Click(ByVal sender As Object, ByVal args As EventArgs)
            ...
            Dim sd As OrderByItem = Me.CurrentSortOrder.Find(Inv_termsTable.id_inv_hdr)
            If sd Is Nothing Then
                ' First time sort, so add sort order for id_inv_hdr.
                Me.CurrentSortOrder.Reset()
                Me.CurrentSortOrder.Add(Inv_termsTable.id_inv_hdr, OrderByItem.OrderDir.Asc)
            Else
        ...
        Public Overridable Sub sort_orderLabel_Click(ByVal sender As Object, ByVal args As EventArgs)
            ...
            Dim sd As OrderByItem = Me.CurrentSortOrder.Find(Inv_termsTable.sort_order)
            If sd Is Nothing Then
        ...
        ' event handler for ImageButton
        Public Overridable Sub Inv_termsCopyButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
        ...
        ' event handler for ImageButton
        Public Overridable Sub Inv_termsDeleteButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
      ...
      Me.Page.CommitTransaction(sender)
        ...
        ' event handler for ImageButton
        Public Overridable Sub Inv_termsEditButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
        ...
        Public Overridable Sub Inv_termsExportCSVButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
          ...
          ' Create the Order By clause based on the user's current sorting preference.
            ...
            Dim columns() as BaseColumn = New BaseColumn() { _
                       Inv_termsTable.id_inv_hdr, _ 
             Inv_termsTable.narration, _ 
             Inv_termsTable.sort_order, _ 
             Nothing}
        ...
        Public Overridable Sub Inv_termsExportExcelButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
            ...
            ' a format string from Excel's Format Cell menu. For example "dddd, mmmm dd, yyyy h:mm AM/PM;@", "#,##0.00"
             excelReport.AddColumn(New ExcelColumn(Inv_termsTable.id_inv_hdr, "Default"))
             excelReport.AddColumn(New ExcelColumn(Inv_termsTable.narration, "Default"))
             excelReport.AddColumn(New ExcelColumn(Inv_termsTable.sort_order, "0"))
        ...
        ' event handler for ImageButton
        Public Overridable Sub Inv_termsImportButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
            ...
            ' Any code after the Response.Redirect call will not be executed, since the page is
            ' redirected to the URL.
            Dim url As String = "../Shared/SelectFileToImport.aspx?TableName=Inv_terms"
            Try
                ' Enclose all database retrieval/update code within a Transaction boundary
                DbUtils.StartTransaction
        ...
        ' event handler for ImageButton
        Public Overridable Sub Inv_termsNewButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
        ...
        Public Overridable Sub Inv_termsPDFButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
            ...
            Try
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowInv_termsTable.Inv_termsPDFButton.report")
                ' report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "inv_terms"
                ' If ShowInv_termsTable.Inv_termsPDFButton.report specifies a valid report template,
                ...
                ' The 5th parameter represents the relative width of the column   			
                 report.AddColumn(Inv_termsTable.id_inv_hdr.Name, ReportEnum.Align.Left, "${id_inv_hdr}", ReportEnum.Align.Left, 30)
                 report.AddColumn(Inv_termsTable.narration.Name, ReportEnum.Align.Left, "${narration}", ReportEnum.Align.Left, 30)
                 report.AddColumn(Inv_termsTable.sort_order.Name, ReportEnum.Align.Right, "${sort_order}", ReportEnum.Align.Right, 15)
                    ...
                    If Not (records Is Nothing) AndAlso records.Length > 0 AndAlso whereClause.RunQuery Then 
                        For Each record As Inv_termsRecord In records 
                            ...
                            ' The 4th parameters represent the maximum length of the data value being shown
                                                         report.AddData("${id_inv_hdr}", record.Format(Inv_termsTable.id_inv_hdr), ReportEnum.Align.Left)
                             report.AddData("${narration}", record.Format(Inv_termsTable.narration), ReportEnum.Align.Left, 100)
                             report.AddData("${sort_order}", record.Format(Inv_termsTable.sort_order), ReportEnum.Align.Right, 100)
        ...
        Public Overridable Sub Inv_termsWordButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
            ...
            Try
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowInv_termsTable.Inv_termsWordButton.word")
                ' report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "inv_terms"
                ' If ShowInv_termsTable.Inv_termsWordButton.report specifies a valid report template,
                ' AddColumn method will generate a report template.
                ' Each AddColumn method-call specifies a column
                ' The 1st parameter represents the text of the column header
                ' The 2nd parameter represents the horizontal alignment of the column header
        ...
        Public Overridable Sub Inv_termsSearchButton_Click(ByVal sender As Object, ByVal args As EventArgs)
...
#Region "Helper Properties"
        ...
        Public ReadOnly Property Inv_termsCopyButton() As System.Web.UI.WebControls.ImageButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "Inv_termsCopyButton"), System.Web.UI.WebControls.ImageButton)
            End Get
        End Property
        
        Public ReadOnly Property Inv_termsDeleteButton() As System.Web.UI.WebControls.ImageButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "Inv_termsDeleteButton"), System.Web.UI.WebControls.ImageButton)
            End Get
        End Property
        
        Public ReadOnly Property Inv_termsEditButton() As System.Web.UI.WebControls.ImageButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "Inv_termsEditButton"), System.Web.UI.WebControls.ImageButton)
            End Get
        End Property
        ...
        Public ReadOnly Property Inv_termsImportButton() As System.Web.UI.WebControls.ImageButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "Inv_termsImportButton"), System.Web.UI.WebControls.ImageButton)
            End Get
        End Property
        
        Public ReadOnly Property Inv_termsNewButton() As System.Web.UI.WebControls.ImageButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "Inv_termsNewButton"), System.Web.UI.WebControls.ImageButton)
            End Get
        End Property
        ...
        Public ReadOnly Property Inv_termsSearch() As System.Web.UI.WebControls.TextBox
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "Inv_termsSearch"), System.Web.UI.WebControls.TextBox)
            End Get
        End Property
        
        Public ReadOnly Property Inv_termsSearchButton() As ServelInvocing.UI.IThemeButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "Inv_termsSearchButton"), ServelInvocing.UI.IThemeButton)
          End Get
          End Property
