...
' This file implements the code-behind class for ShowInv_terms.aspx.
' ShowInv_terms.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class ShowInv_terms
        Inherits BaseApplicationPage
' Code-behind class for the ShowInv_terms page.
...
#Region "Section 2: Do not modify this section."
        ...
        Public WithEvents Inv_termsDialogEditButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents Inv_termsRecordControl As ServelInvocing.UI.Controls.ShowInv_terms.Inv_termsRecordControl
