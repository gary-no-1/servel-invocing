...
' Inv_termsWebReport.aspx page.  The Row or RecordControl classes are the 
...
Namespace ServelInvocing.UI.Controls.Inv_termsWebReport
...
' Base class for the Inv_termsTableControlRow control on the Inv_termsWebReport page.
...
' Base class for the Inv_termsTableControl control on the Inv_termsWebReport page.
...
#Region "Helper Properties"
        ...
        Public ReadOnly Property narrationLabel1() As System.Web.UI.WebControls.Literal
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "narrationLabel1"), System.Web.UI.WebControls.Literal)
            End Get
        End Property
