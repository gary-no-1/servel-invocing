...
' This file implements the code-behind class for EmailInv_terms.aspx.
' EmailInv_terms.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class EmailInv_terms
        Inherits BaseApplicationPage
' Code-behind class for the EmailInv_terms page.
...
#Region "Section 2: Do not modify this section."
        ...
        Public WithEvents Inv_termsRecordControl As ServelInvocing.UI.Controls.EmailInv_terms.Inv_termsRecordControl
