...
' This file implements the code-behind class for PrintInv_terms.aspx.
' PrintInv_terms.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class PrintInv_terms
        Inherits BaseApplicationPage
' Code-behind class for the PrintInv_terms page.
...
#Region "Section 2: Do not modify this section."
        ...
        Public WithEvents Inv_termsRecordControl As ServelInvocing.UI.Controls.PrintInv_terms.Inv_termsRecordControl
