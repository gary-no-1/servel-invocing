...
' ShowInv_terms.aspx page.  The Row or RecordControl classes are the 
...
Namespace ServelInvocing.UI.Controls.ShowInv_terms
...
' Base class for the Inv_termsRecordControl control on the ShowInv_terms page.
...
Public Class BaseInv_termsRecordControl
        ...
        Protected Overridable Sub Control_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
              ...
              AddHandler Me.Inv_termsDialogEditButton.Click, AddressOf Inv_termsDialogEditButton_Click
        ...
        Public Overridable Function CreateWhereClause() As WhereClause
            ...
            End If
            HttpContext.Current.Session("QueryString in ShowInv_terms") = recId
        ...
        Public Overridable Sub Inv_termsDialogEditButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
        ...
        Public Overridable Sub id_inv_hdr_Click(ByVal sender As Object, ByVal args As EventArgs)
            ...
            ' Any code after the Response.Redirect call will not be executed, since the page is
            ' redirected to the URL.
            Dim url As String = "../inv_hdr/ShowInv_hdr.aspx?Inv_hdr={Inv_termsRecordControl:FK:inv_terms_inv_hdr_id_inv_hdr_FK}"
            Dim shouldRedirect As Boolean = True
            Dim TargetKey As String = Nothing
            Dim DFKA As String = Nothing
            Dim id As String = Nothing
...
#Region "Helper Properties"
        ...
        Public ReadOnly Property Inv_termsDialogEditButton() As System.Web.UI.WebControls.ImageButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "Inv_termsDialogEditButton"), System.Web.UI.WebControls.ImageButton)
            End Get
        End Property
