...
' ShowInv_taxes.aspx page.  The Row or RecordControl classes are the 
...
Namespace ServelInvocing.UI.Controls.ShowInv_taxes
...
' Base class for the Inv_taxesRecordControl control on the ShowInv_taxes page.
...
Public Class BaseInv_taxesRecordControl
        ...
        Protected Overridable Sub Control_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
              ...
              AddHandler Me.Inv_taxesDialogEditButton.Click, AddressOf Inv_taxesDialogEditButton_Click
        ...
        Public Overridable Function CreateWhereClause() As WhereClause
            ...
            End If
            HttpContext.Current.Session("QueryString in ShowInv_taxes") = recId
        ...
        Public Overridable Sub Inv_taxesDialogEditButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
        ...
        Public Overridable Sub id_inv_hdr_Click(ByVal sender As Object, ByVal args As EventArgs)
            ...
            ' Any code after the Response.Redirect call will not be executed, since the page is
            ' redirected to the URL.
            Dim url As String = "../inv_hdr/ShowInv_hdr.aspx?Inv_hdr={Inv_taxesRecordControl:FK:inv_taxes_inv_hdr_id_inv_hdr_FK}"
            Dim shouldRedirect As Boolean = True
            Dim TargetKey As String = Nothing
            Dim DFKA As String = Nothing
            Dim id As String = Nothing
        ...
        Public Overridable Sub id_taxes_Click(ByVal sender As Object, ByVal args As EventArgs)
            ...
            ' Any code after the Response.Redirect call will not be executed, since the page is
            ' redirected to the URL.
            Dim url As String = "../taxes/ShowTaxes.aspx?Taxes={Inv_taxesRecordControl:FK:inv_taxes_taxes_id_taxes_FK}"
            Dim shouldRedirect As Boolean = True
            Dim TargetKey As String = Nothing
            Dim DFKA As String = Nothing
            Dim id As String = Nothing
...
#Region "Helper Properties"
        ...
        Public ReadOnly Property Inv_taxesDialogEditButton() As System.Web.UI.WebControls.ImageButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "Inv_taxesDialogEditButton"), System.Web.UI.WebControls.ImageButton)
            End Get
        End Property
