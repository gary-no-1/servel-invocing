...
' PrintInv_taxes.aspx page.  The Row or RecordControl classes are the 
...
Namespace ServelInvocing.UI.Controls.PrintInv_taxes
...
' Base class for the Inv_taxesRecordControl control on the PrintInv_taxes page.
...
Public Class BaseInv_taxesRecordControl
        ...
        Public Overridable Function CreateWhereClause() As WhereClause
            ...
            End If
            HttpContext.Current.Session("QueryString in PrintInv_taxes") = recId
