...
' This file implements the code-behind class for PrintInv_taxes.aspx.
' PrintInv_taxes.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class PrintInv_taxes
        Inherits BaseApplicationPage
' Code-behind class for the PrintInv_taxes page.
...
#Region "Section 2: Do not modify this section."
        ...
        Public WithEvents id_taxes As System.Web.UI.WebControls.Literal
        Public WithEvents id_taxesLabel As System.Web.UI.WebControls.Literal
        Public WithEvents Inv_taxesRecordControl As ServelInvocing.UI.Controls.PrintInv_taxes.Inv_taxesRecordControl
