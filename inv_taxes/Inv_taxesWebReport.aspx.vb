...
' This file implements the code-behind class for Inv_taxesWebReport.aspx.
' Inv_taxesWebReport.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class Inv_taxesWebReport
        Inherits BaseApplicationPage
' Code-behind class for the Inv_taxesWebReport page.
...
#Region "Section 2: Do not modify this section."
        ...
        Public WithEvents id_taxesLabel1 As System.Web.UI.WebControls.Literal
        Public WithEvents Inv_taxesTableControl As ServelInvocing.UI.Controls.Inv_taxesWebReport.Inv_taxesTableControl
