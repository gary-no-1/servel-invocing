...
' This file implements the code-behind class for ShowInv_taxesTable.aspx.
' ShowInv_taxesTable.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class ShowInv_taxesTable
        Inherits BaseApplicationPage
' Code-behind class for the ShowInv_taxesTable page.
...
#Region "Ajax Functions"
      ...
      <Services.WebMethod()> _
      Public Shared Function GetAutoCompletionList_Inv_taxesSearch(ByVal prefixText As String, ByVal count As Integer) As String()
      ' GetInv_taxesSearchCompletionList gets the list of suggestions from the database.
      ' prefixText is the search text typed by the user .
      ' count specifies the number of suggestions to be returned.
      ' Customize by adding code before or after the call to  GetAutoCompletionList_Inv_taxesSearch()
      ' or replace the call to GetAutoCompletionList_Inv_taxesSearch().
      Return GetAutoCompletionList_Inv_taxesSearch_Base(prefixText, count)
      End Function
...
#Region "Section 2: Do not modify this section."
        ...
        Public WithEvents id_inv_hdrLabel1 As System.Web.UI.WebControls.LinkButton
        ...
        Public WithEvents Inv_taxesCopyButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents Inv_taxesDeleteButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents Inv_taxesEditButton As System.Web.UI.WebControls.ImageButton
        ...
        Public WithEvents Inv_taxesImportButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents Inv_taxesNewButton As System.Web.UI.WebControls.ImageButton
        ...
        Public WithEvents Inv_taxesSearch As System.Web.UI.WebControls.TextBox
        Public WithEvents Inv_taxesSearchButton As ThemeButton
        Public WithEvents Inv_taxesTableControl As ServelInvocing.UI.Controls.ShowInv_taxesTable.Inv_taxesTableControl
        ...
        Public WithEvents tax_codeLabel As System.Web.UI.WebControls.LinkButton
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.Inv_taxesTableControl.SaveData()
      ...
      End Sub
        ...
        Public Shared Function GetAutoCompletionList_Inv_taxesSearch_Base(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim control as ServelInvocing.UI.Controls.ShowInv_taxesTable.Inv_taxesTableControl 
            control = new ServelInvocing.UI.Controls.ShowInv_taxesTable.Inv_taxesTableControl()
            
            Return control.GetAutoCompletionList_Inv_taxesSearch(prefixText, count)
        ...
        Me.Inv_taxesTableControl.LoadData()
