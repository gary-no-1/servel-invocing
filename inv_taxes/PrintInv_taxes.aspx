...
<%@ Page Language="vb" EnableEventValidation="false" AutoEventWireup="false" Codebehind="PrintInv_taxes.aspx.vb" Culture="en-IN" MasterPageFile="~/Master Pages/Print.master" Inherits="ServelInvocing.UI.PrintInv_taxes" %>
<%@ Register Tagprefix="ServelInvocing" Namespace="ServelInvocing.UI.Controls.PrintInv_taxes" Assembly="ServelInvocing" %>
