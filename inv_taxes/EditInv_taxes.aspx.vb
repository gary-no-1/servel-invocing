...
' This file implements the code-behind class for EditInv_taxes.aspx.
' EditInv_taxes.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class EditInv_taxes
        Inherits BaseApplicationPage
' Code-behind class for the EditInv_taxes page.
...
#Region "Section 2: Do not modify this section."
        ...
        Public WithEvents Inv_taxesRecordControl As ServelInvocing.UI.Controls.EditInv_taxes.Inv_taxesRecordControl
        ...
        Public WithEvents tax_lock As System.Web.UI.WebControls.CheckBox
        ...
        Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            Page.Title = GetResourceValue("Title:Edit") + " Taxes"
        End Sub
      ...
      End Sub
        ...
        Public Sub SaveButton_Click_Base(ByVal sender As Object, ByVal args As EventArgs)
            ...
            If Not TargetKey Is Nothing Then
                ...
                If Not Me.Inv_taxesRecordControl Is Nothing AndAlso Not Me.Inv_taxesRecordControl.DataSource Is Nothing Then
                      
                      id = Me.Inv_taxesRecordControl.DataSource.id0.ToString
                      value = Me.Inv_taxesRecordControl.DataSource.GetValue(Me.Inv_taxesRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(DFKA)).ToString
                      ...
                      If Not Formula Is Nothing Then
                            value = EvaluateFormula(Formula, Me.Inv_taxesRecordControl.DataSource)
                      End If
