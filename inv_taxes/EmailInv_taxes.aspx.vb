...
' This file implements the code-behind class for EmailInv_taxes.aspx.
' EmailInv_taxes.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class EmailInv_taxes
        Inherits BaseApplicationPage
' Code-behind class for the EmailInv_taxes page.
...
#Region "Section 2: Do not modify this section."
        ...
        Public WithEvents Inv_taxesRecordControl As ServelInvocing.UI.Controls.EmailInv_taxes.Inv_taxesRecordControl
