...
' EditTax_groups.aspx page.  The Row or RecordControl classes are the 
...
Namespace ServelInvocing.UI.Controls.EditTax_groups
...
' Base class for the Tax_groupsRecordControl control on the EditTax_groups page.
...
Public Class BaseTax_groupsRecordControl
        ...
        Public Overridable Function CreateWhereClause() As WhereClause
            ...
            End If
            HttpContext.Current.Session("QueryString in EditTax_groups") = recId
