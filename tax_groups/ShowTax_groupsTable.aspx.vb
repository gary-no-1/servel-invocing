...
' This file implements the code-behind class for ShowTax_groupsTable.aspx.
' ShowTax_groupsTable.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class ShowTax_groupsTable
        Inherits BaseApplicationPage
' Code-behind class for the ShowTax_groupsTable page.
...
#Region "Ajax Functions"
      ...
      <Services.WebMethod()> _
      Public Shared Function GetAutoCompletionList_Tax_groupsSearch(ByVal prefixText As String, ByVal count As Integer) As String()
      ' GetTax_groupsSearchCompletionList gets the list of suggestions from the database.
      ' prefixText is the search text typed by the user .
      ' count specifies the number of suggestions to be returned.
      ' Customize by adding code before or after the call to  GetAutoCompletionList_Tax_groupsSearch()
      ' or replace the call to GetAutoCompletionList_Tax_groupsSearch().
      Return GetAutoCompletionList_Tax_groupsSearch_Base(prefixText, count)
      End Function
...
#Region "Section 2: Do not modify this section."
        ...
        Public WithEvents id_taxes_5Label As System.Web.UI.WebControls.LinkButton
        Public WithEvents id_taxes_6Label As System.Web.UI.WebControls.LinkButton
        Public WithEvents id_taxes_7Label As System.Web.UI.WebControls.LinkButton
        Public WithEvents id_taxes_8Label As System.Web.UI.WebControls.LinkButton
        Public WithEvents id_taxes_9Label As System.Web.UI.WebControls.LinkButton
        Public WithEvents notesLabel As System.Web.UI.WebControls.LinkButton
        Public WithEvents PageTitle As System.Web.UI.WebControls.Literal
        Public WithEvents tax_group_codeLabel As System.Web.UI.WebControls.LinkButton
        Public WithEvents Tax_groupsCopyButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents Tax_groupsDeleteButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents Tax_groupsEditButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents Tax_groupsExportCSVButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents Tax_groupsExportExcelButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents Tax_groupsImportButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents Tax_groupsNewButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents Tax_groupsPagination As Pagination
        Public WithEvents Tax_groupsPDFButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents Tax_groupsRefreshButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents Tax_groupsResetButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents Tax_groupsSearch As System.Web.UI.WebControls.TextBox
        Public WithEvents Tax_groupsSearchButton As ThemeButton
        Public WithEvents Tax_groupsTableControl As ServelInvocing.UI.Controls.ShowTax_groupsTable.Tax_groupsTableControl
        Public WithEvents Tax_groupsTitle As System.Web.UI.WebControls.Literal
        Public WithEvents Tax_groupsToggleAll As System.Web.UI.WebControls.CheckBox
        Public WithEvents Tax_groupsWordButton As System.Web.UI.WebControls.ImageButton
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.Tax_groupsTableControl.SaveData()
      ...
      End Sub
        ...
        Public Shared Function GetAutoCompletionList_Tax_groupsSearch_Base(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim control as ServelInvocing.UI.Controls.ShowTax_groupsTable.Tax_groupsTableControl 
            control = new ServelInvocing.UI.Controls.ShowTax_groupsTable.Tax_groupsTableControl()
            
            Return control.GetAutoCompletionList_Tax_groupsSearch(prefixText, count)
        ...
        Me.Tax_groupsTableControl.LoadData()
