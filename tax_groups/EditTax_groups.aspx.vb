...
' This file implements the code-behind class for EditTax_groups.aspx.
' EditTax_groups.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class EditTax_groups
        Inherits BaseApplicationPage
' Code-behind class for the EditTax_groups page.
...
#Region "Section 2: Do not modify this section."
        ...
        Public WithEvents id_taxes_ As System.Web.UI.WebControls.DropDownList
        Public WithEvents id_taxes_1 As System.Web.UI.WebControls.DropDownList
        Public WithEvents id_taxes_1AddRecordLink As System.Web.UI.WebControls.ImageButton
        Public WithEvents id_taxes_1Label As System.Web.UI.WebControls.Literal
        Public WithEvents id_taxes_2 As System.Web.UI.WebControls.DropDownList
        Public WithEvents id_taxes_2AddRecordLink As System.Web.UI.WebControls.ImageButton
        Public WithEvents id_taxes_2Label As System.Web.UI.WebControls.Literal
        Public WithEvents id_taxes_3 As System.Web.UI.WebControls.DropDownList
        Public WithEvents id_taxes_3AddRecordLink As System.Web.UI.WebControls.ImageButton
        Public WithEvents id_taxes_3Label As System.Web.UI.WebControls.Literal
        Public WithEvents id_taxes_4 As System.Web.UI.WebControls.DropDownList
        Public WithEvents id_taxes_4AddRecordLink As System.Web.UI.WebControls.ImageButton
        Public WithEvents id_taxes_4Label As System.Web.UI.WebControls.Literal
        Public WithEvents id_taxes_5 As System.Web.UI.WebControls.DropDownList
        Public WithEvents id_taxes_5AddRecordLink As System.Web.UI.WebControls.ImageButton
        Public WithEvents id_taxes_5Label As System.Web.UI.WebControls.Literal
        Public WithEvents id_taxes_6 As System.Web.UI.WebControls.DropDownList
        Public WithEvents id_taxes_6AddRecordLink As System.Web.UI.WebControls.ImageButton
        Public WithEvents id_taxes_6Label As System.Web.UI.WebControls.Literal
        Public WithEvents id_taxes_7 As System.Web.UI.WebControls.DropDownList
        Public WithEvents id_taxes_7AddRecordLink As System.Web.UI.WebControls.ImageButton
        Public WithEvents id_taxes_7Label As System.Web.UI.WebControls.Literal
        Public WithEvents id_taxes_8 As System.Web.UI.WebControls.DropDownList
        Public WithEvents id_taxes_8AddRecordLink As System.Web.UI.WebControls.ImageButton
        Public WithEvents id_taxes_8Label As System.Web.UI.WebControls.Literal
        Public WithEvents id_taxes_9AddRecordLink As System.Web.UI.WebControls.ImageButton
        Public WithEvents id_taxes_9Label As System.Web.UI.WebControls.Literal
        Public WithEvents notesLabel As System.Web.UI.WebControls.Literal
        Public WithEvents PageTitle As System.Web.UI.WebControls.Literal
        Public WithEvents SaveButton As ThemeButton
        Public WithEvents tax_group_codeLabel As System.Web.UI.WebControls.Literal
        Public WithEvents Tax_groupsRecordControl As ServelInvocing.UI.Controls.EditTax_groups.Tax_groupsRecordControl
        ...
        Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            Page.Title = GetResourceValue("Title:Edit") + " Tax Groups"
        End Sub
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.Tax_groupsRecordControl.SaveData()
      ...
      End Sub
        ...
        Me.Tax_groupsRecordControl.LoadData()
        ...
        Public Sub SaveButton_Click_Base(ByVal sender As Object, ByVal args As EventArgs)
            ...
            If Not TargetKey Is Nothing Then
                ...
                If Not Me.Tax_groupsRecordControl Is Nothing AndAlso Not Me.Tax_groupsRecordControl.DataSource Is Nothing Then
                      
                      id = Me.Tax_groupsRecordControl.DataSource.id0.ToString
                      value = Me.Tax_groupsRecordControl.DataSource.GetValue(Me.Tax_groupsRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(DFKA)).ToString
                      ...
                      If Not Formula Is Nothing Then
                            value = EvaluateFormula(Formula, Me.Tax_groupsRecordControl.DataSource)
                      End If
