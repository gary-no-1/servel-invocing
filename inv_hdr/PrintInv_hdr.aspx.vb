...
' This file implements the code-behind class for PrintInv_hdr.aspx.
' PrintInv_hdr.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class PrintInv_hdr
        Inherits BaseApplicationPage
' Code-behind class for the PrintInv_hdr page.
