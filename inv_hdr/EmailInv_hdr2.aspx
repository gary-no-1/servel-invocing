<%@ Register Tagprefix="ServelInvocing" Namespace="ServelInvocing.UI.Controls.EmailInv_hdr2" Assembly="ServelInvocing" %>

<%@ Register Tagprefix="Selectors" Namespace="ServelInvocing" Assembly="ServelInvocing" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<%@ Page Language="vb" EnableEventValidation="false" AutoEventWireup="false" Codebehind="EmailInv_hdr2.aspx.vb" Culture="en-IN" MasterPageFile="~/Master Pages/Email.master" Inherits="ServelInvocing.UI.EmailInv_hdr2" %>
...
</td></tr><tr><td><asp:panel id="Inv_hdrRecordControlCollapsibleRegion" runat="server"><table class="dBody" cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td><asp:panel id="Inv_hdrRecordControlPanel" runat="server"><table cellpadding="0" cellspacing="0" border="0"><tr><td class="fls"><asp:Literal runat="server" id="inv_noLabel" Text="Invoice No:">	</asp:Literal></td><td class="dfv"><asp:Literal runat="server" id="inv_no"></asp:Literal> </td><td class="fls"><asp:Literal runat="server" id="inv_dtLabel" Text="Invoice Date">	</asp:Literal></td><td class="dfv"><asp:Literal runat="server" id="inv_dt"></asp:Literal> </td></tr><tr><td class="fls"><asp:Literal runat="server" id="pro_inv_noLabel" Text="Pro Inv No:">	</asp:Literal></td><td class="dfv"><asp:Literal runat="server" id="pro_inv_no"></asp:Literal> </td><td class="fls"><asp:Literal runat="server" id="pro_inv_dtLabel" Text="Pro Inv Date">	</asp:Literal></td><td class="dfv"><asp:Literal runat="server" id="pro_inv_dt"></asp:Literal> </td></tr><tr><td class="fls"><asp:Literal runat="server" id="sale_ord_noLabel" Text="OA No:">	</asp:Literal></td><td class="dfv"><asp:Literal runat="server" id="sale_ord_no"></asp:Literal> </td><td class="fls"><asp:Literal runat="server" id="sale_ord_dtLabel" Text="OA Date">	</asp:Literal></td><td class="dfv"><asp:Literal runat="server" id="sale_ord_dt"></asp:Literal> </td></tr><tr><td class="fls"><asp:Literal runat="server" id="id_partyLabel" Text="Party">	</asp:Literal></td><td class="dfv"><asp:Literal runat="server" id="id_party"></asp:Literal> </td><td class="fls"><asp:Literal runat="server" id="id_siteLabel" Text="Site">	</asp:Literal></td><td class="dfv"><asp:Literal runat="server" id="id_site"></asp:Literal> </td></tr><tr><td class="fls"><asp:Literal runat="server" id="bill_nameLabel" Text="Bill Name">	</asp:Literal></td><td class="dfv"><asp:Literal runat="server" id="bill_name"></asp:Literal> </td><td class="fls"><asp:Literal runat="server" id="ship_nameLabel" Text="Ship Name">	</asp:Literal></td><td class="dfv"><asp:Literal runat="server" id="ship_name"></asp:Literal> </td></tr><tr><td class="fls"><asp:Literal runat="server" id="tin_noLabel" Text="TIN">	</asp:Literal></td><td class="dfv"><asp:Literal runat="server" id="tin_no"></asp:Literal> </td><td class="fls"><asp:Literal runat="server" id="emailLabel" Text="Email">	</asp:Literal></td><td class="dfv"><asp:Literal runat="server" id="email"></asp:Literal> </td></tr><tr><td class="fls"><asp:Literal runat="server" id="additional_emailLabel" Text="Additional Email">	</asp:Literal></td><td class="dfv"><asp:Literal runat="server" id="additional_email"></asp:Literal> </td><td class="fls"><asp:Literal runat="server" id="contactLabel" Text="Contact">	</asp:Literal></td><td class="dfv"><asp:Literal runat="server" id="contact"></asp:Literal> </td></tr><tr><td class="fls"><asp:Literal runat="server" id="phoneLabel" Text="Phone">	</asp:Literal></td><td class="dfv"><asp:Literal runat="server" id="phone"></asp:Literal> </td><td class="fls"><asp:Literal runat="server" id="po_noLabel" Text="P.O. No:">	</asp:Literal></td><td class="dfv"><asp:Literal runat="server" id="po_no"></asp:Literal> </td></tr><tr><td class="fls"><asp:Literal runat="server" id="po_dtLabel" Text="P.O. Date">	</asp:Literal></td><td class="dfv"><asp:Literal runat="server" id="po_dt"></asp:Literal> </td><td class="fls"><asp:Literal runat="server" id="id_commodityLabel" Text="Commodity">	</asp:Literal></td><td class="dfv"><asp:Literal runat="server" id="id_commodity"></asp:Literal> </td></tr><tr><td class="fls"><asp:Literal runat="server" id="id_tax_groupLabel" Text="Tax Code">	</asp:Literal></td><td class="dfv"><asp:Literal runat="server" id="id_tax_group"></asp:Literal> </td><td class="fls"><asp:Literal runat="server" id="item_totalLabel" Text="Item Total">	</asp:Literal></td><td class="dfv"><asp:Literal runat="server" id="item_total"></asp:Literal> </td></tr><tr><td class="fls"><asp:Literal runat="server" id="grand_totalLabel" Text="Grand Total">	</asp:Literal></td><td class="dfv"><asp:Literal runat="server" id="grand_total"></asp:Literal> </td><td class="fls"><asp:Literal runat="server" id="road_permit_noLabel" Text="Road Permit No:">	</asp:Literal></td><td class="dfv"><asp:Literal runat="server" id="road_permit_no"></asp:Literal> </td></tr><tr><td class="fls"><asp:Literal runat="server" id="packing_detailsLabel" Text="Packing Details">	</asp:Literal></td><td class="dfv"><asp:Literal runat="server" id="packing_details"></asp:Literal> </td><td class="fls"><asp:Literal runat="server" id="weightLabel" Text="Weight">	</asp:Literal></td><td class="dfv"><asp:Literal runat="server" id="weight"></asp:Literal> </td></tr><tr><td class="fls"><asp:Literal runat="server" id="no_of_packagesLabel" Text="No Of Packages">	</asp:Literal></td><td class="dfv"><asp:Literal runat="server" id="no_of_packages"></asp:Literal> </td><td class="fls"><asp:Literal runat="server" id="id_transporterLabel" Text="Transporter">	</asp:Literal></td><td class="dfv"><asp:Literal runat="server" id="id_transporter"></asp:Literal> </td></tr><tr><td class="fls"><asp:Literal runat="server" id="gr_rr_noLabel" Text="GR / RR No:">	</asp:Literal></td><td class="dfv"><asp:Literal runat="server" id="gr_rr_no"></asp:Literal> </td><td class="fls"><asp:Literal runat="server" id="gr_rr_dtLabel" Text="GR / RR Date">	</asp:Literal></td><td class="dfv"><asp:Literal runat="server" id="gr_rr_dt"></asp:Literal> </td></tr><tr><td class="fls"><asp:Literal runat="server" id="freight_to_payLabel" Text="Freight To Pay">	</asp:Literal></td><td class="dfv"><asp:Literal runat="server" id="freight_to_pay"></asp:Literal> </td><td class="fls"><asp:Literal runat="server" id="vehicle_noLabel" Text="Vehicle No:">	</asp:Literal></td><td class="dfv"><asp:Literal runat="server" id="vehicle_no"></asp:Literal> </td></tr><tr><td class="fls"><asp:Literal runat="server" id="bill_addressLabel" Text="Bill Address">	</asp:Literal></td><td class="dfv" colspan="3"><asp:Literal runat="server" id="bill_address"></asp:Literal> </td></tr><tr><td class="fls"><asp:Literal runat="server" id="ship_addressLabel" Text="Ship Address">	</asp:Literal></td><td class="dfv" colspan="3"><asp:Literal runat="server" id="ship_address"></asp:Literal> </td></tr></table></asp:panel>
</td></tr></table>
