...
' ShowInv_hdrTable.aspx page.  The Row or RecordControl classes are the 
...
Namespace ServelInvocing.UI.Controls.ShowInv_hdrTable
...
' Base class for the Inv_hdrTableControlRow control on the ShowInv_hdrTable page.
...
Public Class BaseInv_hdrTableControlRow
        ...
        Protected Overridable Sub Control_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
			...
			Me.Page.LoadFocusScripts(Me)
              ...
              Me.Inv_hdrRowDeleteButton.Attributes.Add("onClick", "return (confirm('" & (CType(Me.Page,BaseApplicationPage)).GetResourceValue("DeleteRecordConfirm", "ServelInvocing") & "'));")
              ' Register the event handlers.
          
              AddHandler Me.Inv_hdrRowDeleteButton.Click, AddressOf Inv_hdrRowDeleteButton_Click
              
              AddHandler Me.Inv_hdrRowEditButton.Click, AddressOf Inv_hdrRowEditButton_Click
              
              AddHandler Me.Inv_hdrRowViewButton.Click, AddressOf Inv_hdrRowViewButton_Click
        ...
        Public Overridable Sub Inv_hdrRowDeleteButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
      ...
      Me.Page.CommitTransaction(sender)
        ...
        ' event handler for ImageButton
        Public Overridable Sub Inv_hdrRowEditButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
        ...
        ' event handler for ImageButton
        Public Overridable Sub Inv_hdrRowViewButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
        ...
        Public Overridable Sub id_party_Click(ByVal sender As Object, ByVal args As EventArgs)
            ...
            ' Any code after the Response.Redirect call will not be executed, since the page is
            ' redirected to the URL.
            Dim url As String = "../party/ShowParty.aspx?Party={Inv_hdrTableControlRow:FK:inv_hdr_party_id_party_FK}"
            Dim shouldRedirect As Boolean = True
            Dim TargetKey As String = Nothing
            Dim DFKA As String = Nothing
            Dim id As String = Nothing
...
#Region "Helper Properties"
        ...
        Public ReadOnly Property Inv_hdrRecordRowSelection() As System.Web.UI.WebControls.CheckBox
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "Inv_hdrRecordRowSelection"), System.Web.UI.WebControls.CheckBox)
            End Get
        End Property
        
        Public ReadOnly Property Inv_hdrRowDeleteButton() As System.Web.UI.WebControls.ImageButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "Inv_hdrRowDeleteButton"), System.Web.UI.WebControls.ImageButton)
            End Get
        End Property
        
        Public ReadOnly Property Inv_hdrRowEditButton() As System.Web.UI.WebControls.ImageButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "Inv_hdrRowEditButton"), System.Web.UI.WebControls.ImageButton)
            End Get
        End Property
        
        Public ReadOnly Property Inv_hdrRowViewButton() As System.Web.UI.WebControls.ImageButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "Inv_hdrRowViewButton"), System.Web.UI.WebControls.ImageButton)
            End Get
        End Property
...
' Base class for the Inv_hdrTableControl control on the ShowInv_hdrTable page.
...
Public Class BaseInv_hdrTableControl
        ...
        Protected Overridable Sub Control_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Init
           ...
           ' Setup the filter and search events.
            ...
            If Not Me.Page.IsPostBack Then
                Dim initialVal As String = ""
                If  Me.InSession(Me.Inv_hdrSearch) 				
                    initialVal = Me.GetFromSession(Me.Inv_hdrSearch)
                
                End If
                If initialVal <> ""				
                        
                        Me.Inv_hdrSearch.Text = initialVal
        ...
        Protected Overridable Sub Control_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            ' Setup the pagination events.
              ...
              AddHandler Me.Inv_hdrPagination.FirstPage.Click, AddressOf Inv_hdrPagination_FirstPage_Click
              
              AddHandler Me.Inv_hdrPagination.LastPage.Click, AddressOf Inv_hdrPagination_LastPage_Click
              
              AddHandler Me.Inv_hdrPagination.NextPage.Click, AddressOf Inv_hdrPagination_NextPage_Click
              
              AddHandler Me.Inv_hdrPagination.PageSizeButton.Click, AddressOf Inv_hdrPagination_PageSizeButton_Click
            
              AddHandler Me.Inv_hdrPagination.PreviousPage.Click, AddressOf Inv_hdrPagination_PreviousPage_Click
            ...
            ' Setup the sorting events.
              ...
              AddHandler Me.inv_noLabel.Click, AddressOf inv_noLabel_Click
            ...
            ' Setup the button events.
              ...
              AddHandler Me.Inv_hdrExportCSVButton.Click, AddressOf Inv_hdrExportCSVButton_Click
              
              AddHandler Me.Inv_hdrExportExcelButton.Click, AddressOf Inv_hdrExportExcelButton_Click
              
              AddHandler Me.Inv_hdrImportButton.Click, AddressOf Inv_hdrImportButton_Click
              
              AddHandler Me.Inv_hdrPDFButton.Click, AddressOf Inv_hdrPDFButton_Click
              
              AddHandler Me.Inv_hdrRefreshButton.Click, AddressOf Inv_hdrRefreshButton_Click
              
              AddHandler Me.Inv_hdrResetButton.Click, AddressOf Inv_hdrResetButton_Click
              
              AddHandler Me.Inv_hdrWordButton.Click, AddressOf Inv_hdrWordButton_Click
              
            AddHandler Me.Inv_hdrSearchButton.Button.Click, AddressOf Inv_hdrSearchButton_Click
        ...
        Public Overridable Sub LoadData()
            ...
            Try	
                ...
                Me.Inv_hdrToggleAll.Checked = False
      ...
      End Sub
        ...
        Public Overridable Sub RegisterPostback()
              ...
              Me.Page.RegisterPostBackTrigger(MiscUtils.FindControlRecursively(Me,"Inv_hdrExportCSVButton"))
                        
              Me.Page.RegisterPostBackTrigger(MiscUtils.FindControlRecursively(Me,"Inv_hdrExportExcelButton"))
                        
              Me.Page.RegisterPostBackTrigger(MiscUtils.FindControlRecursively(Me,"Inv_hdrPDFButton"))
                        
              Me.Page.RegisterPostBackTrigger(MiscUtils.FindControlRecursively(Me,"Inv_hdrWordButton"))
        ...
        Protected Overridable Sub BindPaginationControls()
            ...
            Me.Inv_hdrPagination.FirstPage.Enabled = Not (Me.PageIndex = 0)
            Me.Inv_hdrPagination.LastPage.Enabled = Not (Me.PageIndex = Me.TotalPages - 1)
            If Me.TotalPages = 0 Then
                Me.Inv_hdrPagination.LastPage.Enabled = False
            End If
          
            Me.Inv_hdrPagination.NextPage.Enabled = Not (Me.PageIndex = Me.TotalPages - 1)
            If Me.TotalPages = 0 Then
                Me.Inv_hdrPagination.NextPage.Enabled = False
            End If
          
            Me.Inv_hdrPagination.PreviousPage.Enabled = Not (Me.PageIndex = 0)

            ' Bind the pagination labels.
        
            If Me.TotalPages > 0 Then
                Me.Inv_hdrPagination.CurrentPage.Text = (Me.PageIndex + 1).ToString()
            Else
                Me.Inv_hdrPagination.CurrentPage.Text = "0"
            End If
            Me.Inv_hdrPagination.PageSize.Text = Me.PageSize.ToString()
            Me.Inv_hdrPagination.TotalItems.Text = Me.TotalRecords.ToString()
            Me.Inv_hdrPagination.TotalPages.Text = Me.TotalPages.ToString()
        End Sub
        ...
        Public Overridable Function CreateWhereClause() As WhereClause
            ...
            If IsValueSelected(Me.id_partyFilter) Then
                ...
                wc.iAND(Inv_hdrTable.id_party, BaseFilter.ComparisonOperator.EqualsTo, MiscUtils.GetSelectedValue(Me.id_partyFilter, Me.GetFromSession(Me.id_partyFilter)), False, False)
            
                
            End If
                       
            If IsValueSelected(Me.Inv_hdrSearch) Then
                ' Strip "..." from begin and ending of the search text, otherwise the search will return 0 values as in database "..." is not stored.
                If Me.Inv_hdrSearch.Text.StartsWith("...") Then
                    Me.Inv_hdrSearch.Text = Me.Inv_hdrSearch.Text.SubString(3,Me.Inv_hdrSearch.Text.Length-3)
                End If
                If Me.Inv_hdrSearch.Text.EndsWith("...") then
                    Me.Inv_hdrSearch.Text = Me.Inv_hdrSearch.Text.SubString(0,Me.Inv_hdrSearch.Text.Length-3)
                End If
                
                Dim formatedSearchText As String = MiscUtils.GetSelectedValue(Me.Inv_hdrSearch, Me.GetFromSession(Me.Inv_hdrSearch))
        ...
        ' These clauses are added depending on operator and fields selected in Control's property page, bindings tab.
                    ...
                    search.iOR(Inv_hdrTable.id_tax_group, BaseFilter.ComparisonOperator.Contains, MiscUtils.GetSelectedValue(Me.Inv_hdrSearch, Me.GetFromSession(Me.Inv_hdrSearch)), True, False)
        
                    search.iOR(Inv_hdrTable.pro_inv_no, BaseFilter.ComparisonOperator.Contains, MiscUtils.GetSelectedValue(Me.Inv_hdrSearch, Me.GetFromSession(Me.Inv_hdrSearch)), True, False)
        ...
        Public Overridable Function CreateWhereClause(ByVal searchText as String, ByVal fromSearchControl as String, ByVal AutoTypeAheadSearch as String, ByVal AutoTypeAheadWordSeparators as String) As WhereClause
            ...
            If IsValueSelected(id_partyFilterSelectedValue) Then
                 ...
                 wc.iAND(Inv_hdrTable.id_party, BaseFilter.ComparisonOperator.EqualsTo, id_partyFilterSelectedValue, false, False)
             
             End If
                      
            If IsValueSelected(searchText) and fromSearchControl = "Inv_hdrSearch" Then
                ...
                If IsValueSelected(formatedSearchText) Then
                    ...
                    If InvariantLCase(AutoTypeAheadSearch).equals("wordsstartingwithsearchstring") Then
                        ...
                        search.iOR(Inv_hdrTable.id_tax_group, BaseFilter.ComparisonOperator.Starts_With, formatedSearchText, True, False)
                        search.iOR(Inv_hdrTable.id_tax_group, BaseFilter.ComparisonOperator.Contains, AutoTypeAheadWordSeparators & formatedSearchText, True, False)
                
                        search.iOR(Inv_hdrTable.pro_inv_no, BaseFilter.ComparisonOperator.Starts_With, formatedSearchText, True, False)
                        search.iOR(Inv_hdrTable.pro_inv_no, BaseFilter.ComparisonOperator.Contains, AutoTypeAheadWordSeparators & formatedSearchText, True, False)
                
                    Else
                        
                        search.iOR(Inv_hdrTable.id_tax_group, BaseFilter.ComparisonOperator.Contains, formatedSearchText, True, False)
                        search.iOR(Inv_hdrTable.pro_inv_no, BaseFilter.ComparisonOperator.Contains, formatedSearchText, True, False)
                    End If
                    wc.iAND(search)
        ...
        Public Overridable Function GetAutoCompletionList_Inv_hdrSearch(ByVal prefixText As String, ByVal count As Integer) As String()
            Dim resultList As ArrayList = New ArrayList
            Dim wordList As ArrayList = New ArrayList
            Dim iteration As Integer = 0
            
            Dim wc As WhereClause = CreateWhereClause(prefixText,"Inv_hdrSearch", "WordsStartingWithSearchString", "[^a-zA-Z0-9]")
            While (resultList.Count < count AndAlso iteration < 5)
                ' Fetch 100 records in each iteration
                Dim recordList () As ServelInvocing.Business.Inv_hdrRecord = Inv_hdrTable.GetRecords(wc, Nothing, iteration, 100)
                Dim rec As Inv_hdrRecord = Nothing
                ...
                For Each rec In recordList 
                    ...
                    resultItem = rec.Format(Inv_hdrTable.id_tax_group)
                    ...
                    resultItem = rec.Format(Inv_hdrTable.pro_inv_no)
                    If resultItem IsNot Nothing AndAlso resultItem.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture).Contains(prefixText.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture))  Then
        ...
        Protected Overridable Sub GetPageSize()
            ...
            If Me.Inv_hdrPagination.PageSize.Text.Trim <> "" Then
                Try
                    'Me.PageSize = Integer.Parse(Me.Inv_hdrPagination.PageSize.Text)
                Catch ex As Exception
                End Try
            End If
        End Sub
                ...
                For Each repItem In rep.Items
                    ...
                    If recControl.Visible AndAlso recControl.IsNewRecord() Then
                        ...
                        If recControl.inv_no.Text <> "" Then
                            rec.Parse(recControl.inv_no.Text, Inv_hdrTable.inv_no)
                        End If
        ...
        Public Overridable Sub SetInv_hdrSearch()
        ...
        Protected Overrides Sub SaveControlsToSession()
            ...
            Me.SaveToSession(Me.Inv_hdrSearch, Me.Inv_hdrSearch.Text)
      ...
      Me.SaveToSession("Inv_hdrSearch_Ajax", Me.Inv_hdrSearch.Text)
        ...
        Protected Overrides Sub ClearControlsFromSession()
            ...
            Me.RemoveFromSession(Me.Inv_hdrSearch)
        ...
        ' event handler for ImageButton
        Public Overridable Sub Inv_hdrPagination_FirstPage_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
        ...
        ' event handler for ImageButton
        Public Overridable Sub Inv_hdrPagination_LastPage_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
        ...
        ' event handler for ImageButton
        Public Overridable Sub Inv_hdrPagination_NextPage_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
        ...
        ' event handler for LinkButton
        Public Overridable Sub Inv_hdrPagination_PageSizeButton_Click(ByVal sender As Object, ByVal args As EventArgs)
            ...
            Me.PageIndex = Integer.Parse(Me.Inv_hdrPagination.CurrentPage.Text) - 1
        ...
        ' event handler for ImageButton
        Public Overridable Sub Inv_hdrPagination_PreviousPage_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
        ...
        Public Overridable Sub bill_addressLabel_Click(ByVal sender As Object, ByVal args As EventArgs)
            ...
            Dim sd As OrderByItem = Me.CurrentSortOrder.Find(Inv_hdrTable.bill_address)
            If sd Is Nothing Then
                ' First time sort, so add sort order for bill_address.
                Me.CurrentSortOrder.Reset()
                Me.CurrentSortOrder.Add(Inv_hdrTable.bill_address, OrderByItem.OrderDir.Asc)
            Else
        ...
        Public Overridable Sub grand_totalLabel_Click(ByVal sender As Object, ByVal args As EventArgs)
            ...
            Dim sd As OrderByItem = Me.CurrentSortOrder.Find(Inv_hdrTable.grand_total)
            If sd Is Nothing Then
                ' First time sort, so add sort order for grand_total.
                Me.CurrentSortOrder.Reset()
                Me.CurrentSortOrder.Add(Inv_hdrTable.grand_total, OrderByItem.OrderDir.Asc)
            Else
        ...
        Public Overridable Sub id_partyLabel1_Click(ByVal sender As Object, ByVal args As EventArgs)
            ...
            Dim sd As OrderByItem = Me.CurrentSortOrder.Find(Inv_hdrTable.id_party)
            If sd Is Nothing Then
                ' First time sort, so add sort order for id_party.
                Me.CurrentSortOrder.Reset()
                Me.CurrentSortOrder.Add(Inv_hdrTable.id_party, OrderByItem.OrderDir.Asc)
            Else
        ...
        Public Overridable Sub inv_dtLabel_Click(ByVal sender As Object, ByVal args As EventArgs)
            ...
            Dim sd As OrderByItem = Me.CurrentSortOrder.Find(Inv_hdrTable.inv_dt)
            If sd Is Nothing Then
                ' First time sort, so add sort order for inv_dt.
                Me.CurrentSortOrder.Reset()
                Me.CurrentSortOrder.Add(Inv_hdrTable.inv_dt, OrderByItem.OrderDir.Asc)
            Else
        ...
        Public Overridable Sub inv_noLabel_Click(ByVal sender As Object, ByVal args As EventArgs)
            ' Sorts by inv_no when clicked.
              
            ' Get previous sorting state for inv_no.
            
            Dim sd As OrderByItem = Me.CurrentSortOrder.Find(Inv_hdrTable.inv_no)
            If sd Is Nothing Then
                ' First time sort, so add sort order for inv_no.
                Me.CurrentSortOrder.Reset()
                Me.CurrentSortOrder.Add(Inv_hdrTable.inv_no, OrderByItem.OrderDir.Asc)
            Else
        ...
        Public Overridable Sub item_totalLabel_Click(ByVal sender As Object, ByVal args As EventArgs)
            ...
            Dim sd As OrderByItem = Me.CurrentSortOrder.Find(Inv_hdrTable.item_total)
            If sd Is Nothing Then
                ' First time sort, so add sort order for item_total.
                Me.CurrentSortOrder.Reset()
                Me.CurrentSortOrder.Add(Inv_hdrTable.item_total, OrderByItem.OrderDir.Asc)
            Else
        ...
        Public Overridable Sub po_dtLabel_Click(ByVal sender As Object, ByVal args As EventArgs)
            ...
            Dim sd As OrderByItem = Me.CurrentSortOrder.Find(Inv_hdrTable.po_dt)
            If sd Is Nothing Then
                ' First time sort, so add sort order for po_dt.
                Me.CurrentSortOrder.Reset()
                Me.CurrentSortOrder.Add(Inv_hdrTable.po_dt, OrderByItem.OrderDir.Asc)
            Else
        ...
        Public Overridable Sub po_noLabel_Click(ByVal sender As Object, ByVal args As EventArgs)
            ...
            Dim sd As OrderByItem = Me.CurrentSortOrder.Find(Inv_hdrTable.po_no)
            If sd Is Nothing Then
                ' First time sort, so add sort order for po_no.
                Me.CurrentSortOrder.Reset()
                Me.CurrentSortOrder.Add(Inv_hdrTable.po_no, OrderByItem.OrderDir.Asc)
            Else
        ...
        Public Overridable Sub tin_noLabel_Click(ByVal sender As Object, ByVal args As EventArgs)
            ...
            Dim sd As OrderByItem = Me.CurrentSortOrder.Find(Inv_hdrTable.tin_no)
            If sd Is Nothing Then
                ' First time sort, so add sort order for tin_no.
                Me.CurrentSortOrder.Reset()
                Me.CurrentSortOrder.Add(Inv_hdrTable.tin_no, OrderByItem.OrderDir.Asc)
            Else
        ...
        ' event handler for ImageButton
        Public Overridable Sub Inv_hdrExportCSVButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
          ...
          ' Create the Order By clause based on the user's current sorting preference.
            ...
            Dim columns() as BaseColumn = New BaseColumn() { _
             ...
             Inv_hdrTable.tin_no, _ 
             Inv_hdrTable.po_no, _ 
             Inv_hdrTable.po_dt, _ 
             Inv_hdrTable.item_total, _ 
             Inv_hdrTable.grand_total, _ 
             Nothing}
            Dim  exportData as ExportDataToCSV = New ExportDataToCSV(Inv_hdrTable.Instance, wc, orderBy, columns)
        ...
        ' event handler for ImageButton
        Public Overridable Sub Inv_hdrExportExcelButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
            ...
            Dim excelReport As ExportDataToExcel = New ExportDataToExcel(Inv_hdrTable.Instance, wc, orderBy)
            ' Add each of the columns in order of export.
            ...
            ' a format string from Excel's Format Cell menu. For example "dddd, mmmm dd, yyyy h:mm AM/PM;@", "#,##0.00"
             ...
             excelReport.AddColumn(New ExcelColumn(Inv_hdrTable.bill_address, "Default"))
             excelReport.AddColumn(New ExcelColumn(Inv_hdrTable.tin_no, "Default"))
             excelReport.AddColumn(New ExcelColumn(Inv_hdrTable.po_no, "Default"))
             excelReport.AddColumn(New ExcelColumn(Inv_hdrTable.po_dt, "Short Date"))
             excelReport.AddColumn(New ExcelColumn(Inv_hdrTable.item_total, "Standard"))
             excelReport.AddColumn(New ExcelColumn(Inv_hdrTable.grand_total, "Standard"))
        ...
        ' event handler for ImageButton
        Public Overridable Sub Inv_hdrImportButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
            ...
            ' Any code after the Response.Redirect call will not be executed, since the page is
            ' redirected to the URL.
            Dim url As String = "../Shared/SelectFileToImport.aspx?TableName=Inv_hdr"
            Try
                ' Enclose all database retrieval/update code within a Transaction boundary
                DbUtils.StartTransaction
        ...
        ' event handler for ImageButton
        Public Overridable Sub Inv_hdrPDFButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
            ...
            Try
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowInv_hdrTable.Inv_hdrPDFButton.report")
                ' report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "inv_hdr"
                ' If ShowInv_hdrTable.Inv_hdrPDFButton.report specifies a valid report template,
                ...
                ' The 5th parameter represents the relative width of the column   			
                 ...
                 report.AddColumn(Inv_hdrTable.bill_address.Name, ReportEnum.Align.Left, "${bill_address}", ReportEnum.Align.Left, 30)
                 report.AddColumn(Inv_hdrTable.tin_no.Name, ReportEnum.Align.Left, "${tin_no}", ReportEnum.Align.Left, 20)
                 report.AddColumn(Inv_hdrTable.po_no.Name, ReportEnum.Align.Left, "${po_no}", ReportEnum.Align.Left, 24)
                 report.AddColumn(Inv_hdrTable.po_dt.Name, ReportEnum.Align.Left, "${po_dt}", ReportEnum.Align.Left, 20)
                 report.AddColumn(Inv_hdrTable.item_total.Name, ReportEnum.Align.Right, "${item_total}", ReportEnum.Align.Right, 20)
                 report.AddColumn(Inv_hdrTable.grand_total.Name, ReportEnum.Align.Right, "${grand_total}", ReportEnum.Align.Right, 20)
                ...
                Dim pageNum As Integer = 0 
                Dim totalRows As Integer = Inv_hdrTable.GetRecordCount(whereClause)
                Dim columns As ColumnList = Inv_hdrTable.GetColumnList()
                Dim records As Inv_hdrRecord() = Nothing
            
                Do 
                    
                    records = Inv_hdrTable.GetRecords(whereClause, orderBy, pageNum, rowsPerQuery)
                    If Not (records Is Nothing) AndAlso records.Length > 0 AndAlso whereClause.RunQuery Then 
                        For Each record As Inv_hdrRecord In records 
                            ...
                            ' The 4th parameters represent the maximum length of the data value being shown
                             ...
                             report.AddData("${tin_no}", record.Format(Inv_hdrTable.tin_no), ReportEnum.Align.Left, 100)
                             report.AddData("${po_no}", record.Format(Inv_hdrTable.po_no), ReportEnum.Align.Left, 100)
                             report.AddData("${po_dt}", record.Format(Inv_hdrTable.po_dt), ReportEnum.Align.Left, 100)
                             report.AddData("${item_total}", record.Format(Inv_hdrTable.item_total), ReportEnum.Align.Right, 100)
                             report.AddData("${grand_total}", record.Format(Inv_hdrTable.grand_total), ReportEnum.Align.Right, 100)
        ...
        ' event handler for ImageButton
        Public Overridable Sub Inv_hdrRefreshButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
        
            Try
                
            Dim Inv_hdrTableControlObj as Inv_hdrTableControl = DirectCast(Me.Page.FindControlRecursively("Inv_hdrTableControl"), Inv_hdrTableControl)
            Inv_hdrTableControlObj.ResetData = True
                        
            Inv_hdrTableControlObj.RemoveFromSession(Inv_hdrTableControlObj, "DeletedRecordIds")
            Inv_hdrTableControlObj.DeletedRecordIds = Nothing
        ...
        ' event handler for ImageButton
        Public Overridable Sub Inv_hdrResetButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
        ...
        ' event handler for ImageButton
        Public Overridable Sub Inv_hdrWordButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
            ...
            Try
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowInv_hdrTable.Inv_hdrWordButton.word")
                ' report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "inv_hdr"
                ' If ShowInv_hdrTable.Inv_hdrWordButton.report specifies a valid report template,
                ' AddColumn method will generate a report template.
                ' Each AddColumn method-call specifies a column
                ' The 1st parameter represents the text of the column header
                ' The 2nd parameter represents the horizontal alignment of the column header
        ...
        Public Overridable Sub Inv_hdrSearchButton_Click(ByVal sender As Object, ByVal args As EventArgs)
...
#Region "Helper Properties"
        ...
        Public ReadOnly Property Inv_hdrExportCSVButton() As System.Web.UI.WebControls.ImageButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "Inv_hdrExportCSVButton"), System.Web.UI.WebControls.ImageButton)
            End Get
        End Property
        
        Public ReadOnly Property Inv_hdrExportExcelButton() As System.Web.UI.WebControls.ImageButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "Inv_hdrExportExcelButton"), System.Web.UI.WebControls.ImageButton)
            End Get
        End Property
        
        Public ReadOnly Property Inv_hdrImportButton() As System.Web.UI.WebControls.ImageButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "Inv_hdrImportButton"), System.Web.UI.WebControls.ImageButton)
            End Get
        End Property
        
        Public ReadOnly Property Inv_hdrPagination() As ServelInvocing.UI.IPagination
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "Inv_hdrPagination"), ServelInvocing.UI.IPagination)
          End Get
          End Property
        
        Public ReadOnly Property Inv_hdrPDFButton() As System.Web.UI.WebControls.ImageButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "Inv_hdrPDFButton"), System.Web.UI.WebControls.ImageButton)
            End Get
        End Property
        
        Public ReadOnly Property Inv_hdrRefreshButton() As System.Web.UI.WebControls.ImageButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "Inv_hdrRefreshButton"), System.Web.UI.WebControls.ImageButton)
            End Get
        End Property
        
        Public ReadOnly Property Inv_hdrResetButton() As System.Web.UI.WebControls.ImageButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "Inv_hdrResetButton"), System.Web.UI.WebControls.ImageButton)
            End Get
        End Property
        
        Public ReadOnly Property Inv_hdrSearch() As System.Web.UI.WebControls.TextBox
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "Inv_hdrSearch"), System.Web.UI.WebControls.TextBox)
            End Get
        End Property
        
        Public ReadOnly Property Inv_hdrSearchButton() As ServelInvocing.UI.IThemeButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "Inv_hdrSearchButton"), ServelInvocing.UI.IThemeButton)
          End Get
          End Property
        ...
        Public ReadOnly Property Inv_hdrToggleAll() As System.Web.UI.WebControls.CheckBox
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "Inv_hdrToggleAll"), System.Web.UI.WebControls.CheckBox)
            End Get
        End Property
        
        Public ReadOnly Property Inv_hdrWordButton() As System.Web.UI.WebControls.ImageButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "Inv_hdrWordButton"), System.Web.UI.WebControls.ImageButton)
            End Get
        End Property
        
        Public ReadOnly Property inv_noLabel() As System.Web.UI.WebControls.LinkButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "inv_noLabel"), System.Web.UI.WebControls.LinkButton)
            End Get
        End Property
...
#Region "Helper Functions"
        ...
        Public Overridable Function GetSelectedRecordIndex() As Integer
            Dim counter As Integer = 0
            Dim recControl As Inv_hdrTableControlRow
            For Each recControl In Me.GetRecordControls()
                If recControl.Inv_hdrRecordRowSelection.Checked Then
                    Return counter
                End If
                counter += 1
            Next
        ...
        Public Overridable Function GetSelectedRecordControl() As Inv_hdrTableControlRow
            Dim selectedList() As Inv_hdrTableControlRow = Me.GetSelectedRecordControls()
        ...
        Public Overridable Function GetSelectedRecordControls() As Inv_hdrTableControlRow()
            ...
            For Each recControl In Me.GetRecordControls()
                ...
                End If
            Next
            Return DirectCast(selectedList.ToArray(GetType(Inv_hdrTableControlRow)), Inv_hdrTableControlRow())
        ...
        Public Overridable Sub DeleteSelectedRecords(ByVal deferDeletion As Boolean)
            ...
            For Each recCtl In recList
                If deferDeletion Then
                    ...
                    recCtl.Inv_hdrRecordRowSelection.Checked = False
