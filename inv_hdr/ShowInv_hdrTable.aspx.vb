...
' This file implements the code-behind class for ShowInv_hdrTable.aspx.
' ShowInv_hdrTable.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class ShowInv_hdrTable
        Inherits BaseApplicationPage
' Code-behind class for the ShowInv_hdrTable page.
...
#Region "Ajax Functions"
      ...
      <Services.WebMethod()> _
      Public Shared Function GetAutoCompletionList_Inv_hdrSearch(ByVal prefixText As String, ByVal count As Integer) As String()
      ' GetInv_hdrSearchCompletionList gets the list of suggestions from the database.
      ' prefixText is the search text typed by the user .
      ' count specifies the number of suggestions to be returned.
      ' Customize by adding code before or after the call to  GetAutoCompletionList_Inv_hdrSearch()
      ' or replace the call to GetAutoCompletionList_Inv_hdrSearch().
      Return GetAutoCompletionList_Inv_hdrSearch_Base(prefixText, count)
      End Function
...
#Region "Section 2: Do not modify this section."
        ...
        Public WithEvents Inv_hdrExportCSVButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents Inv_hdrExportExcelButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents Inv_hdrImportButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents Inv_hdrPagination As Pagination
        Public WithEvents Inv_hdrPDFButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents Inv_hdrRefreshButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents Inv_hdrResetButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents Inv_hdrSearch As System.Web.UI.WebControls.TextBox
        Public WithEvents Inv_hdrSearchButton As ThemeButton
        Public WithEvents Inv_hdrTableControl As ServelInvocing.UI.Controls.ShowInv_hdrTable.Inv_hdrTableControl
        Public WithEvents Inv_hdrTitle As System.Web.UI.WebControls.Literal
        Public WithEvents Inv_hdrToggleAll As System.Web.UI.WebControls.CheckBox
        Public WithEvents Inv_hdrWordButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents inv_noLabel As System.Web.UI.WebControls.LinkButton
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.Inv_hdrTableControl.SaveData()
      ...
      End Sub
        ...
        Public Shared Function GetAutoCompletionList_Inv_hdrSearch_Base(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim control as ServelInvocing.UI.Controls.ShowInv_hdrTable.Inv_hdrTableControl 
            control = new ServelInvocing.UI.Controls.ShowInv_hdrTable.Inv_hdrTableControl()
            
            Return control.GetAutoCompletionList_Inv_hdrSearch(prefixText, count)
        ...
        Me.Inv_hdrTableControl.LoadData()
