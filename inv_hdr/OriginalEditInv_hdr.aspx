...
<%@ Page Language="vb" EnableEventValidation="false" AutoEventWireup="false" Codebehind="OriginalEditInv_hdr.aspx.vb" Culture="en-IN" MasterPageFile="../Master Pages/VerticalMenu.master" Inherits="ServelInvocing.UI.OriginalEditInv_hdr" %>
<%@ Register Tagprefix="ServelInvocing" Namespace="ServelInvocing.UI.Controls.OriginalEditInv_hdr" Assembly="ServelInvocing" %>
...
</td></tr><tr><td><asp:panel id="Inv_hdrRecordControlCollapsibleRegion" runat="server"><table class="dBody" cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td><asp:panel id="Inv_hdrRecordControlPanel" runat="server"><table cellpadding="0" cellspacing="0" border="0"><tr><td class="fls"><asp:Literal runat="server" id="inv_noLabel" Text="Invoice No:">	</asp:Literal></td><td class="dfv" style="font-weight:bold;font-size:10pt"><asp:Literal runat="server" id="inv_no"></asp:Literal></td><td class="fls"><asp:Literal runat="server" id="inv_dtLabel" Text="Invoice Date">	</asp:Literal></td><td class="dfv"><asp:Literal runat="server" id="inv_dt"></asp:Literal></td><td class="dfv"></td><td class="dfv"></td></tr><tr><td class="fls"><asp:Literal runat="server" id="po_noLabel" Text="P.O. No:">	</asp:Literal></td><td class="dfv"><asp:Literal runat="server" id="po_no"></asp:Literal> </td><td class="fls"><asp:Literal runat="server" id="po_dtLabel" Text="P.O. Date">	</asp:Literal></td><td class="dfv"><asp:Literal runat="server" id="po_dt"></asp:Literal> </td><td class="dfv"></td><td class="dfv"></td></tr><tr><td class="fls"><asp:Literal runat="server" id="sale_ord_noLabel" Text="OA No:">	</asp:Literal></td><td class="dfv"><asp:Literal runat="server" id="sale_ord_no"></asp:Literal> </td><td class="fls"><asp:Literal runat="server" id="sale_ord_dtLabel" Text="OA Date">	</asp:Literal></td><td class="dfv"><asp:Literal runat="server" id="sale_ord_dt"></asp:Literal> </td><td class="dfv"></td><td class="dfv"></td></tr><tr><td class="fls"><asp:Literal runat="server" id="id_partyLabel" Text="Party">	</asp:Literal></td><td class="dfv" style="white-space:nowrap;"><asp:Literal runat="server" id="id_party"></asp:Literal> 
</td><td class="fls"><asp:Literal runat="server" id="tin_noLabel" Text="TIN">	</asp:Literal></td><td class="dfv"><asp:Literal runat="server" id="tin_no"></asp:Literal></td><td class="dfv"></td><td class="dfv"></td></tr><tr><td class="fls"><asp:Literal runat="server" id="bill_nameLabel" Text="Bill Name">	</asp:Literal></td><td class="dfv"><asp:Literal runat="server" id="bill_name"></asp:Literal></td><td class="fls"><asp:Literal runat="server" id="ship_nameLabel" Text="Ship Name">	</asp:Literal></td><td class="dfv"><asp:Literal runat="server" id="ship_name"></asp:Literal></td><td class="dfv"></td><td class="dfv"></td></tr><tr><td class="fls"><asp:Literal runat="server" id="bill_addressLabel" Text="Bill Address">	</asp:Literal></td><td class="dfv" style="width:225px"><asp:Literal runat="server" id="bill_address"></asp:Literal> </td><td class="fls"><asp:Literal runat="server" id="ship_addressLabel" Text="Ship Address">	</asp:Literal></td><td class="dfv" style="width:225px"><asp:Literal runat="server" id="ship_address"></asp:Literal> </td><td class="dfv" style="width:225px"></td><td class="dfv" style="width:225px"></td></tr><tr><td class="fls" colspan="6"><hr></hr></td></tr><tr><td class="fls"><asp:Literal runat="server" id="id_commodityLabel" Text="Commodity">	</asp:Literal></td><td class="dfv" style="white-space:nowrap;"><asp:LinkButton runat="server" id="id_commodity" causesvalidation="False" commandname="Redirect"></asp:LinkButton></td><td class="fls"><asp:Literal runat="server" id="item_totalLabel" Text="Item Total">	</asp:Literal></td><td class="dfv" style="font-weight:bold"><asp:Literal runat="server" id="item_total"></asp:Literal></td><td class="dfv" style="font-weight:bold"><asp:Literal runat="server" id="inv_issued_dtLabel" Text="Invoice Issued Date &amp; Time">	</asp:Literal></td><td class="dfv" style="font-weight:bold"><table border="0" cellpadding="0" cellspacing="0">
<tr>
<td style="padding-right: 5px; vertical-align:top">
<asp:TextBox runat="server" id="inv_issued_dt" Columns="20" MaxLength="20" cssclass="field_input"></asp:TextBox></td>
<td style="padding-right: 5px; white-space:nowrap;">

</td>
<td>
<Selectors:CalendarExtendarClass runat="server" ID="inv_issued_dtCalendarExtender" TargetControlID="inv_issued_dt" CssClass="MyCalendar" Format="d">
...
</td></tr><tr><td class="fls"></td><td class="dfv" style="white-space:nowrap;"></td><td class="fls"><asp:Literal runat="server" id="grand_totalLabel" Text="Grand Total">	</asp:Literal></td><td class="dfv" style="font-weight:bold"><asp:Literal runat="server" id="grand_total"></asp:Literal></td><td class="dfv" style="font-weight:bold"><asp:Literal runat="server" id="goods_removed_dtLabel" Text="Goods Removed Date &amp; Time">	</asp:Literal></td><td class="dfv" style="font-weight:bold"><table border="0" cellpadding="0" cellspacing="0">
<tr>
<td style="padding-right: 5px; vertical-align:top">
<asp:TextBox runat="server" id="goods_removed_dt" Columns="20" MaxLength="20" cssclass="field_input"></asp:TextBox></td>
<td style="padding-right: 5px; white-space:nowrap;">
...
</td></tr><tr><td class="fls"></td><td class="fls"> 
<asp:textbox id="txtIssDt" runat="server" text="Type text" cssclass="field_input"></asp:textbox> 
<asp:dropdownlist id="IssHrsDdl" runat="server" cssclass="Filter_Input" width="50px" /> 
<asp:dropdownlist id="IssMinDdl" runat="server" cssclass="Filter_Input" width="50px" /></td><td class="fls"></td><td class="fls">
<asp:textbox id="TextBox2" runat="server" cssclass="field_input" text="" width="75px"></asp:textbox>
<asp:numericupdownextender id="NumericUpDown1" width="25" runat="server" targetcontrolid="TextBox2" minimum="0" maximum="60" /></td><td class="fls"></td><td class="fls"></td></tr><tr><td class="fls" colspan="6"><hr></hr></td></tr><tr><td class="fls"><asp:Literal runat="server" id="packing_detailsLabel" Text="Packing Details">	</asp:Literal></td><td class="dfv"><asp:TextBox runat="server" id="packing_details" Columns="30" MaxLength="30" cssclass="field_input"></asp:TextBox>&nbsp;
...
<BaseClasses:TextBoxMaxLengthValidator runat="server" id="gr_rr_dtTextBoxMaxLengthValidator" ControlToValidate="gr_rr_dt" ErrorMessage="&lt;%# GetResourceValue(&quot;Val:ValueTooLong&quot;, &quot;ServelInvocing&quot;).Replace(&quot;{FieldName}&quot;, &quot;GR / RR Date&quot;) %>"></BaseClasses:TextBoxMaxLengthValidator></td>
 ...
 </td><td class="fls"><asp:Literal runat="server" id="freight_to_payLabel" Text="Freight To Pay">	</asp:Literal></td><td class="dfv"><asp:TextBox runat="server" id="freight_to_pay" Columns="10" MaxLength="10" cssclass="field_input"></asp:TextBox>&nbsp;
