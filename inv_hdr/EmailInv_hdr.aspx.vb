...
' This file implements the code-behind class for EmailInv_hdr.aspx.
' EmailInv_hdr.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class EmailInv_hdr
        Inherits BaseApplicationPage
' Code-behind class for the EmailInv_hdr page.
