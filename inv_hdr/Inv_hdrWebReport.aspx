...
</td></tr><tr><td><asp:panel id="Inv_hdrTableControlCollapsibleRegion" runat="server"><table class="dBody" cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="tre"><table cellpadding="0" cellspacing="0" border="0" width="100%" onkeydown="captureUpDownKey(this, event)"><tr class="tch"><th class="thc" scope="col"><asp:Literal runat="server" id="pro_inv_noLabel" Text="Pro Inv Number">	</asp:Literal>
                        </th><th class="thc" scope="col"><asp:Literal runat="server" id="pro_inv_dtLabel" Text="Pro Inv DT">	</asp:Literal>
                        </th><th class="thc" scope="col"><asp:Literal runat="server" id="sale_ord_noLabel" Text="Sale Order No.">	</asp:Literal>
                        </th><th class="thc" scope="col"><asp:Literal runat="server" id="sale_ord_dtLabel" Text="Sale Order Date">	</asp:Literal>
