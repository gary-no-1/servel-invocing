...
' This file implements the code-behind class for GetGoodRemovadDate.aspx.
' GetGoodRemovadDate.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class GetGoodRemovadDate
        Inherits BaseApplicationPage
' Code-behind class for the GetGoodRemovadDate page.
...
#Region "Section 2: Do not modify this section."
        ...
        Public WithEvents Label As System.Web.UI.WebControls.Label
