...
' EmailInv_hdr2.aspx page.  The Row or RecordControl classes are the 
...
Namespace ServelInvocing.UI.Controls.EmailInv_hdr2
...
' Base class for the Inv_itemsTableControlRow control on the EmailInv_hdr2 page.
...
' Base class for the Inv_itemsTableControl control on the EmailInv_hdr2 page.
...
' Base class for the Inv_taxesTableControlRow control on the EmailInv_hdr2 page.
...
' Base class for the Inv_taxesTableControl control on the EmailInv_hdr2 page.
...
' Base class for the Inv_termsTableControlRow control on the EmailInv_hdr2 page.
...
' Base class for the Inv_termsTableControl control on the EmailInv_hdr2 page.
...
' Base class for the Inv_hdrRecordControl control on the EmailInv_hdr2 page.
...
Public Class BaseInv_hdrRecordControl
        ...
        Public Overridable Sub Setid_commodity()
            ...
            ' Set the id_commodity Literal on the webpage with value from the
            ' inv_hdr database record.

            ' Me.DataSource is the inv_hdr record retrieved from the database.
            ' Me.id_commodity is the ASP:Literal on the webpage.
            ...
            ' If the id_commodity is NULL or blank, then use the value specified  
            ' on Properties.
            If Me.id_commodity.Text Is Nothing _
                OrElse Me.id_commodity.Text.Trim() = "" Then
                ' Set the value specified on the Properties.
                Me.id_commodity.Text = "&nbsp;"
            End If
        ...
        Public Overridable Sub Setid_site()
            ...
            ' Set the id_site Literal on the webpage with value from the
            ' inv_hdr database record.

            ' Me.DataSource is the inv_hdr record retrieved from the database.
            ' Me.id_site is the ASP:Literal on the webpage.
            ...
            If Me.DataSource IsNot Nothing AndAlso Me.DataSource.id_siteSpecified Then
                ...
                ' The Format method will return the Display Foreign Key As (DFKA) value
                                Dim formattedValue As String = Me.DataSource.Format(Inv_hdrTable.id_site)
            ...
            Else 
                ...
                Me.id_site.Text = Inv_hdrTable.id_site.Format(Inv_hdrTable.id_site.DefaultValue)
                        		
                End If
                 
            ' If the id_site is NULL or blank, then use the value specified  
            ' on Properties.
            If Me.id_site.Text Is Nothing _
                OrElse Me.id_site.Text.Trim() = "" Then
                ' Set the value specified on the Properties.
                Me.id_site.Text = "&nbsp;"
            End If
        ...
        Public Overridable Function CreateWhereClause() As WhereClause
            ...
            End If
            HttpContext.Current.Session("QueryString in EmailInv_hdr2") = recId
...
#Region "Helper Properties"
        ...
        Public ReadOnly Property id_commodity() As System.Web.UI.WebControls.Literal
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "id_commodity"), System.Web.UI.WebControls.Literal)
            End Get
        End Property
        ...
        Public ReadOnly Property id_site() As System.Web.UI.WebControls.Literal
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "id_site"), System.Web.UI.WebControls.Literal)
            End Get
        End Property
