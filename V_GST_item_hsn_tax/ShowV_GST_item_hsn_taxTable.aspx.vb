...
' This file implements the code-behind class for ShowV_GST_item_hsn_taxTable.aspx.
' ShowV_GST_item_hsn_taxTable.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class ShowV_GST_item_hsn_taxTable
        Inherits BaseApplicationPage
' Code-behind class for the ShowV_GST_item_hsn_taxTable page.
...
#Region "Ajax Functions"
      ...
      <Services.WebMethod()> _
      Public Shared Function GetAutoCompletionList_V_GST_item_hsn_taxSearch(ByVal prefixText As String, ByVal count As Integer) As String()
      ' GetV_GST_item_hsn_taxSearchCompletionList gets the list of suggestions from the database.
      ' prefixText is the search text typed by the user .
      ' count specifies the number of suggestions to be returned.
      ' Customize by adding code before or after the call to  GetAutoCompletionList_V_GST_item_hsn_taxSearch()
      ' or replace the call to GetAutoCompletionList_V_GST_item_hsn_taxSearch().
      Return GetAutoCompletionList_V_GST_item_hsn_taxSearch_Base(prefixText, count)
      End Function
...
#Region "Section 2: Do not modify this section."
        ...
        Public WithEvents month_yearLabel As System.Web.UI.WebControls.LinkButton
        ...
        Public WithEvents V_GST_item_hsn_taxExportCSVButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents V_GST_item_hsn_taxExportExcelButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents V_GST_item_hsn_taxFilterButton As ThemeButton
        Public WithEvents V_GST_item_hsn_taxPagination As Pagination
        Public WithEvents V_GST_item_hsn_taxPDFButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents V_GST_item_hsn_taxRefreshButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents V_GST_item_hsn_taxResetButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents V_GST_item_hsn_taxSearch As System.Web.UI.WebControls.TextBox
        Public WithEvents V_GST_item_hsn_taxSearchButton As ThemeButton
        Public WithEvents V_GST_item_hsn_taxTableControl As ServelInvocing.UI.Controls.ShowV_GST_item_hsn_taxTable.V_GST_item_hsn_taxTableControl
        Public WithEvents V_GST_item_hsn_taxTitle As System.Web.UI.WebControls.Literal
        Public WithEvents V_GST_item_hsn_taxWordButton As System.Web.UI.WebControls.ImageButton
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.V_GST_item_hsn_taxTableControl.SaveData()
      ...
      End Sub
        ...
        Public Shared Function GetAutoCompletionList_V_GST_item_hsn_taxSearch_Base(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim control as ServelInvocing.UI.Controls.ShowV_GST_item_hsn_taxTable.V_GST_item_hsn_taxTableControl 
            control = new ServelInvocing.UI.Controls.ShowV_GST_item_hsn_taxTable.V_GST_item_hsn_taxTableControl()
            
            Return control.GetAutoCompletionList_V_GST_item_hsn_taxSearch(prefixText, count)
        ...
        Me.V_GST_item_hsn_taxTableControl.LoadData()
