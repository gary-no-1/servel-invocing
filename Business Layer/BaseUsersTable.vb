...
''' Provides access to the schema information and record data of a database table or view named users.
''' </summary>
''' <remarks>
...
#End Region
    ...
    Protected Overridable Sub Initialize()
        ...
        Me.TableDefinition.TableClassName = System.Reflection.Assembly.CreateQualifiedName("ServelInvocing.Business", "ServelInvocing.Business.UsersTable")
        def.InitializeTableDefinition(Me.TableDefinition)
        Me.ConnectionName = def.GetConnectionName()
        Me.RecordClassName = System.Reflection.Assembly.CreateQualifiedName("ServelInvocing.Business", "ServelInvocing.Business.UsersRecord")
...
#Region "Shared helper methods"
    ...
    Public Shared Function GetRecords( _
     ...
     ByVal pageSize As Integer) As UsersRecord()
        ...
        Dim recList As ArrayList =  UsersTable.Instance.GetRecordList(whereFilter, orderBy, pageIndex, pageSize)
 
        Return CType(recList.ToArray(GetType(ServelInvocing.Business.UsersRecord)), UsersRecord())
    End Function
    ...
    Public Shared Function GetRecords( _
     ...
     ByVal pageSize As Integer) As UsersRecord()
        ...
        Dim recList As ArrayList = UsersTable.Instance.GetRecordList(where.GetFilter(), orderBy, pageIndex, pageSize)
    ...
    Public Shared Function GetRecordCount(ByVal where As String) As Integer
        ...
        Return CInt(UsersTable.Instance.GetRecordListCount(whereFilter, Nothing))
    End Function

    Public Shared Function GetRecordCount(ByVal where As WhereClause) As Integer
        Return CInt(UsersTable.Instance.GetRecordListCount(where.GetFilter(), Nothing))
    End Function
    ...
    Public Shared Function GetRecord( _
     ...
     ByVal orderBy As OrderBy) As UsersRecord
        ...
        Dim recList As ArrayList = UsersTable.Instance.GetRecordList(whereFilter, orderBy, BaseTable.MIN_PAGE_NUMBER, BaseTable.MIN_BATCH_SIZE)
    ...
    Public Shared Function GetValues( _
        ...
        Return UsersTable.Instance.GetColumnValues(retCol, where.GetFilter(), orderBy, BaseTable.MIN_PAGE_NUMBER, maxItems)
    ...
    Public Shared Function GetSum( _
        ...
        Return UsersTable.Instance.GetColumnStatistics(colSel, where.GetFilter(), orderBy, pageIndex, pageSize)
