...
''' <summary>
''' The generated superclass for the <see cref="Pro_inv_termsRecord"></see> class.
''' </summary>
''' <remarks>
''' This class is not intended to be instantiated directly.  To obtain an instance of this class, 
''' use the methods of the <see cref="Pro_inv_termsTable"></see> class.
''' </remarks>
''' <seealso cref="Pro_inv_termsTable"></seealso>
''' <seealso cref="Pro_inv_termsRecord"></seealso>

<Serializable()> Public Class BasePro_inv_termsRecord
	Inherits PrimaryKeyRecord
	

	Public Shared Shadows ReadOnly TableUtils As Pro_inv_termsTable = Pro_inv_termsTable.Instance
...
#Region "Convenience methods to get/set values of fields"
	...
	''' <summary>
	''' This is a convenience method that provides direct access to the value of the record's Pro_inv_terms_.id field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that provides direct access to the value of the record's Pro_inv_terms_.id_pro_inv_hdr field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that allows direct modification of the value of the record's Pro_inv_terms_.id_pro_inv_hdr field.
	''' </summary>
	...
	End Sub
	''' <summary>
	''' This is a convenience method that provides direct access to the value of the record's Pro_inv_terms_.narration field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that allows direct modification of the value of the record's Pro_inv_terms_.narration field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that provides direct access to the value of the record's Pro_inv_terms_.sort_order field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that allows direct modification of the value of the record's Pro_inv_terms_.sort_order field.
	''' </summary>
	...
	End Sub
	''' <summary>
	''' This is a convenience method that provides direct access to the value of the record's Pro_inv_terms_.print_bold field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that allows direct modification of the value of the record's Pro_inv_terms_.print_bold field.
	''' </summary>
...
#Region "Convenience methods to get field names"
	...
	''' <summary>
	''' This is a convenience property that provides direct access to the value of the record's Pro_inv_terms_.id field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience property that provides direct access to the value of the record's Pro_inv_terms_.id_pro_inv_hdr field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience property that provides direct access to the value of the record's Pro_inv_terms_.narration field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience property that provides direct access to the value of the record's Pro_inv_terms_.sort_order field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience property that provides direct access to the value of the record's Pro_inv_terms_.print_bold field.
	''' </summary>
