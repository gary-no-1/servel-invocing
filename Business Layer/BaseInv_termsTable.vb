...
#Region "Properties for columns"
    ...
    End Property
    ''' <summary>
    ''' This is a convenience property that provides direct access to the table's Inv_terms_.print_bold column object.
    ''' </summary>
    ...
    Public Shared ReadOnly Property print_bold() As BaseClasses.Data.BooleanColumn
        Get
            Return Inv_termsTable.Instance.print_boldColumn
        End Get
    End Property
