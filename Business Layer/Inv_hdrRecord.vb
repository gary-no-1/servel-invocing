...
''' Also provides access to the <see cref="Inv_hdrTable"></see> that each record is associated with.
''' </summary>
''' <remarks>
''' </remarks>
''' <seealso cref="Inv_hdrTable"></seealso>

<Serializable()> Public Class Inv_hdrRecord
	Inherits BaseInv_hdrRecord
	...
	Private Sub Audit_Insert(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) _
	    ...
	    'Dim s As String 
	    's = Trim(Me.id_create_user & vbCrLf & "Inserted by: " & BaseClasses.Utils.SecurityControls.GetCurrentUserName() & " on " & DateTime.Now.ToString() & ".")
