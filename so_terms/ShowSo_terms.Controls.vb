...
' ShowSo_terms.aspx page.  The Row or RecordControl classes are the 
...
Namespace ServelInvocing.UI.Controls.ShowSo_terms

#Region "Section 1: Place your customizations here."

    
Public Class So_termsRecordControl
        Inherits BaseSo_termsRecordControl
        ' The BaseSo_termsRecordControl implements the LoadData, DataBind and other
...
' Base class for the So_termsRecordControl control on the ShowSo_terms page.
' Do not modify this class. Instead override any method in So_termsRecordControl.
Public Class BaseSo_termsRecordControl
        Inherits ServelInvocing.UI.BaseApplicationRecordControl

        '  To customize, override this method in So_termsRecordControl.
        ...
        Protected Overridable Sub Control_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
              ...
              AddHandler Me.So_termsDialogEditButton.Click, AddressOf So_termsDialogEditButton_Click
        ...
        Public Overridable Sub LoadData()        
            ...
            Dim Panel As System.Web.UI.WebControls.Panel = CType(MiscUtils.FindControlRecursively(Me, "So_termsRecordControlPanel"), System.Web.UI.WebControls.Panel)
            ...
            Dim recList() As So_termsRecord = So_termsTable.GetRecords(wc, Nothing, 0, 2)
            ...
            Me.DataSource = So_termsTable.GetRecord(recList(0).GetID.ToXmlString(), True)
                  
        End Sub

        ' Populate the UI controls using the DataSource.  To customize, override this method in So_termsRecordControl.
        ...
        Public Overridable Sub Setid_so_hdr()
            ...
            If Me.DataSource IsNot Nothing AndAlso Me.DataSource.id_so_hdrSpecified Then
                ...
                ' The Format method will return the Display Foreign Key As (DFKA) value
                                Dim formattedValue As String = Me.DataSource.Format(So_termsTable.id_so_hdr)
            ...
            Else 
                ...
                Me.id_so_hdr.Text = So_termsTable.id_so_hdr.Format(So_termsTable.id_so_hdr.DefaultValue)
        ...
        Public Overridable Sub Setsort_order()
            ...
            Else 
                ...
                Me.sort_order.Text = So_termsTable.sort_order.Format(So_termsTable.sort_order.DefaultValue)
        ...
        Public Overridable Function CreateWhereClause() As WhereClause
            ...
            Dim recId As String = Me.Page.Request.QueryString.Item("So_terms")
                
            If recId Is Nothing OrElse recId.Trim = "" Then
                ' Get the error message from the application resource file.
                Throw New Exception(Page.GetResourceValue("Err:UrlParamMissing", "ServelInvocing").Replace("{URL}", "So_terms"))
            End If
            HttpContext.Current.Session("QueryString in ShowSo_terms") = recId
            ...
            If KeyValue.IsXmlKey(recId) Then
                ...
                wc.iAND(So_termsTable.id0, BaseFilter.ComparisonOperator.EqualsTo, pkValue.GetColumnValue(So_termsTable.id0).ToString())
        
            Else
                ' The URL parameter contains the actual value, not an XML structure.
                
                wc.iAND(So_termsTable.id0, BaseFilter.ComparisonOperator.EqualsTo, recId)
        ...
        Public Overridable Sub So_termsDialogEditButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
        ...
        Public Overridable Sub id_so_hdr_Click(ByVal sender As Object, ByVal args As EventArgs)
            ...
            ' Any code after the Response.Redirect call will not be executed, since the page is
            ' redirected to the URL.
            Dim url As String = "../so_hdr/ShowSo_hdr.aspx?So_hdr={So_termsRecordControl:FK:so_terms_so_hdr_id_so_hdr_FK}"
            Dim shouldRedirect As Boolean = True
            Dim TargetKey As String = Nothing
            Dim DFKA As String = Nothing
            Dim id As String = Nothing
        ...
        Public Property RecordUniqueId() As String
            Get
                Return CType(Me.ViewState("BaseSo_termsRecordControl_Rec"), String)
            End Get
            Set(ByVal value As String)
                Me.ViewState("BaseSo_termsRecordControl_Rec") = value
            End Set
        End Property
...
#Region "Helper Properties"
        ...
        Public ReadOnly Property So_termsDialogEditButton() As System.Web.UI.WebControls.ImageButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "So_termsDialogEditButton"), System.Web.UI.WebControls.ImageButton)
            End Get
        End Property
        
        Public ReadOnly Property So_termsTitle() As System.Web.UI.WebControls.Literal
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "So_termsTitle"), System.Web.UI.WebControls.Literal)
            End Get
        End Property
