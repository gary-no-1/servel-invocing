...
' This file implements the code-behind class for ShowUsersTable.aspx.
' ShowUsersTable.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class ShowUsersTable
        Inherits BaseApplicationPage
' Code-behind class for the ShowUsersTable page.
...
#Region "Section 2: Do not modify this section."
        ...
        Public WithEvents mobileLabel As System.Web.UI.WebControls.LinkButton
        ...
        Public WithEvents UsersTableControl As ServelInvocing.UI.Controls.ShowUsersTable.UsersTableControl
    ...
    End Function
      ...
      End Sub
        ...
        Public Shared Function GetAutoCompletionList_UsersSearch_Base(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim control as ServelInvocing.UI.Controls.ShowUsersTable.UsersTableControl 
            control = new ServelInvocing.UI.Controls.ShowUsersTable.UsersTableControl()
