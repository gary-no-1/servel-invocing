<%@ Register Tagprefix="ServelInvocing" Namespace="ServelInvocing.UI.Controls.EditUsers" Assembly="ServelInvocing" %>
...
<%@ Page Language="vb" EnableEventValidation="false" AutoEventWireup="false" Codebehind="EditUsers.aspx.vb" Culture="en-IN" MasterPageFile="../Master Pages/VerticalMenu.master" Inherits="ServelInvocing.UI.EditUsers" %><asp:Content id="PageSection" ContentPlaceHolderID="PageContent" Runat="server">
