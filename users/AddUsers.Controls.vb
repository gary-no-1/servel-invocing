...
' AddUsers.aspx page.  The Row or RecordControl classes are the 
...
Namespace ServelInvocing.UI.Controls.AddUsers
...
' Base class for the UsersRecordControl control on the AddUsers page.
...
Public Class BaseUsersRecordControl
        ...
        Public Overridable Sub GetUIData()
            ...
            For Each col In UsersRecord.TableUtils.TableDefinition.Columns()
        ...
        Public Overridable Function CreateWhereClause() As WhereClause
            ...
            HttpContext.Current.Session("QueryString in AddUsers") = recId
