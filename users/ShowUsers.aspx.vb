...
' This file implements the code-behind class for ShowUsers.aspx.
' ShowUsers.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class ShowUsers
        Inherits BaseApplicationPage
' Code-behind class for the ShowUsers page.
