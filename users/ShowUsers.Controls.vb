...
' ShowUsers.aspx page.  The Row or RecordControl classes are the 
...
Namespace ServelInvocing.UI.Controls.ShowUsers
...
' Base class for the UsersRecordControl control on the ShowUsers page.
...
Public Class BaseUsersRecordControl
        ...
        Public Overridable Function CreateWhereClause() As WhereClause
            ...
            End If
            HttpContext.Current.Session("QueryString in ShowUsers") = recId
