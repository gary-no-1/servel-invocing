...
' EditUsersTable.aspx page.  The Row or RecordControl classes are the 
...
Namespace ServelInvocing.UI.Controls.EditUsersTable
...
' Base class for the UsersTableControlRow control on the EditUsersTable page.
...
Public Class BaseUsersTableControlRow
        ...
        Public Overridable Sub SetRoleId()
            ...
            If Me.PreviousUIData.ContainsKey(Me.RoleId.ID) Then
                If Me.PreviousUIData(Me.RoleId.ID) Is Nothing
                    Me.PopulateRoleIdDropDownList(Nothing, 100)
                Else
                    Me.PopulateRoleIdDropDownList(Me.PreviousUIData(Me.RoleId.ID).ToString(), 100)
                End If
                Return
            End If
...
' Base class for the UsersTableControl control on the EditUsersTable page.
...
Public Class BaseUsersTableControl
        ...
        Protected Overridable Sub Control_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            Me.UsersSaveButton.Attributes.Add("onclick", "SubmitHRefOnce(this, """ & Me.Page.GetResourceValue("Txt:SaveRecord", "ServelInvocing") & """);")
            ...
            If Not Me.ResetData Then
                ...
                For Each repItem In rep.Items
                    ...
                    If recControl.Visible AndAlso recControl.IsNewRecord() Then
                        ...
                        End If
                        If MiscUtils.IsValueSelected(recControl.RoleId) Then
