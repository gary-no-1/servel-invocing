...
</td></tr><tr><td><asp:panel id="UsersRecordControlCollapsibleRegion" runat="server"><table class="dBody" cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td><asp:panel id="UsersRecordControlPanel" runat="server"><table cellpadding="0" cellspacing="0" border="0"><tr><td class="fls"><asp:Literal runat="server" id="UserNameLabel" Text="User Name">	</asp:Literal></td><td class="dfv"><asp:Literal runat="server" id="UserName1"></asp:Literal> </td><td class="fls"><asp:Literal runat="server" id="FullNameLabel" Text="Full Name">	</asp:Literal></td><td class="dfv"><asp:Literal runat="server" id="FullName"></asp:Literal> </td></tr><tr><td class="fls"><asp:Literal runat="server" id="emailLabel" Text="Email">	</asp:Literal></td><td class="dfv"><asp:Literal runat="server" id="email"></asp:Literal> </td><td class="fls"><asp:Literal runat="server" id="RoleIdLabel" Text="Role">	</asp:Literal></td><td class="dfv"><asp:LinkButton runat="server" id="RoleId" causesvalidation="False" commandname="Redirect"></asp:LinkButton> </td></tr><tr><td class="fls"><asp:Literal runat="server" id="passwordLabel" Text="Password">	</asp:Literal></td><td class="dfv"><asp:Literal runat="server" id="password"></asp:Literal> </td><td class="fls"></td><td class="dfv"></td></tr></table></asp:panel>
</td></tr></table>
