...
</td></tr><tr><td><asp:panel id="CompanyRecordControlCollapsibleRegion" runat="server"><table class="dBody" cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td><asp:panel id="CompanyRecordControlPanel" runat="server"><table cellpadding="0" cellspacing="0" border="0"><tr><td class="fls"><asp:Literal runat="server" id="nameLabel" Text="Name">	</asp:Literal></td><td class="dfv"><asp:Literal runat="server" id="name"></asp:Literal> </td><td class="fls"></td><td class="dfv"></td></tr><tr><td class="fls"><asp:Literal runat="server" id="addressLabel" Text="Address">	</asp:Literal></td><td class="dfv" colspan="3"><asp:Literal runat="server" id="address"></asp:Literal> </td></tr><tr><td class="fls"><asp:Literal runat="server" id="cityLabel" Text="City">	</asp:Literal></td><td class="dfv"><asp:Literal runat="server" id="city"></asp:Literal></td><td class="fls"></td><td class="dfv"></td></tr><tr><td class="fls"><asp:Literal runat="server" id="stateLabel" Text="State">	</asp:Literal></td><td class="dfv"><asp:Literal runat="server" id="state"></asp:Literal></td><td class="fls"></td><td class="dfv"></td></tr><tr><td class="fls"><asp:Literal runat="server" id="pincodeLabel" Text="Pin Code">	</asp:Literal></td><td class="dfv"><asp:Literal runat="server" id="pincode"></asp:Literal> </td><td class="fls"></td><td class="dfv"></td></tr><tr><td class="fls"><asp:Literal runat="server" id="phoneLabel" Text="Phone">	</asp:Literal></td><td class="dfv"><asp:Literal runat="server" id="phone"></asp:Literal> </td><td class="fls"><asp:Literal runat="server" id="emailLabel" Text="Email">	</asp:Literal></td><td class="dfv"><asp:Literal runat="server" id="email"></asp:Literal> </td></tr><tr><td class="fls"><asp:Literal runat="server" id="pan_noLabel" Text="PAN">	</asp:Literal></td><td class="dfv"><asp:Literal runat="server" id="pan_no"></asp:Literal> </td><td class="fls"><asp:Literal runat="server" id="tin_noLabel" Text="TiIN">	</asp:Literal></td><td class="dfv"><asp:Literal runat="server" id="tin_no"></asp:Literal> </td></tr><tr><td class="fls"><asp:Literal runat="server" id="srv_tax_noLabel" Text="Service Tax No:">	</asp:Literal></td><td class="dfv"><asp:Literal runat="server" id="srv_tax_no"></asp:Literal></td><td class="fls"><asp:Literal runat="server" id="tan_noLabel" Text="TAN">	</asp:Literal></td><td class="dfv"><asp:Literal runat="server" id="tan_no"></asp:Literal></td></tr><tr><td class="fls"><asp:Literal runat="server" id="rangeLabel" Text="Range">	</asp:Literal></td><td class="dfv"><asp:Literal runat="server" id="range"></asp:Literal></td><td class="fls"><asp:Literal runat="server" id="divisionLabel" Text="Division">	</asp:Literal></td><td class="dfv"><asp:Literal runat="server" id="division"></asp:Literal></td></tr><tr><td class="fls"><asp:Literal runat="server" id="ecc_noLabel" Text="ECC No:">	</asp:Literal></td><td class="dfv"><asp:Literal runat="server" id="ecc_no"></asp:Literal></td><td class="fls"><asp:Literal runat="server" id="cer_noLabel" Text="CER No:">	</asp:Literal></td><td class="dfv"><asp:Literal runat="server" id="cer_no"></asp:Literal></td></tr><tr><td class="fls" colspan="4"><hr></hr></td></tr><tr><td class="fls"><asp:Literal runat="server" id="fin_year_startLabel" Text="Finiancial Year Start">	</asp:Literal></td><td class="fls" style="text-align:left;"><asp:Literal runat="server" id="fin_year_start"></asp:Literal></td><td class="fls"><asp:Literal runat="server" id="fin_year_endLabel" Text="Financial Year End">	</asp:Literal></td><td class="fls" style="text-align:left;"><asp:Literal runat="server" id="fin_year_end"></asp:Literal></td></tr><tr><td class="fls"><asp:Literal runat="server" id="inv_pfxLabel" Text="Invoice Prefix">	</asp:Literal></td><td class="fls" style="text-align:left;"><asp:Literal runat="server" id="inv_pfx"></asp:Literal></td><td class="fls"><asp:Literal runat="server" id="inv_sfxLabel" Text="Invoice Suffix">	</asp:Literal></td><td class="fls" style="text-align:left;"><asp:Literal runat="server" id="inv_sfx"></asp:Literal></td></tr><tr><td class="fls"><asp:Literal runat="server" id="next_inv_noLabel" Text="Next Invoice No:">	</asp:Literal></td><td class="fls" style="text-align:left;"><asp:Literal runat="server" id="next_inv_no"></asp:Literal></td><td class="fls"><asp:Literal runat="server" id="pad_inv_noLabel" Text="Invoice Number Length">	</asp:Literal></td><td class="fls" style="text-align:left;"><asp:Literal runat="server" id="pad_inv_no"></asp:Literal></td></tr></table></asp:panel>
</td></tr></table>
