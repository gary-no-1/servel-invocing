...
' This file implements the code-behind class for ShowCompanyTable.aspx.
' ShowCompanyTable.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class ShowCompanyTable
        Inherits BaseApplicationPage
' Code-behind class for the ShowCompanyTable page.
...
'      <Services.WebMethod()> _
'      Public Shared Function GetAutoCompletionList_CompanySearch(ByVal prefixText As String, ByVal count As Integer) As String()
'      ' GetCompanySearchCompletionList gets the list of suggestions from the database.
'      ' prefixText is the search text typed by the user .
'      ' count specifies the number of suggestions to be returned.
'      ' Customize by adding code before or after the call to  GetAutoCompletionList_CompanySearch()
'      ' or replace the call to GetAutoCompletionList_CompanySearch().
'      Return GetAutoCompletionList_CompanySearch_Base(prefixText, count)
'      End Function
...
#Region "Section 2: Do not modify this section."
        ...
        Public WithEvents CompanyResetButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents CompanyTableControl As ServelInvocing.UI.Controls.ShowCompanyTable.CompanyTableControl
        Public WithEvents CompanyTitle As System.Web.UI.WebControls.Literal
        Public WithEvents CompanyToggleAll As System.Web.UI.WebControls.CheckBox
        Public WithEvents CompanyWordButton As System.Web.UI.WebControls.ImageButton
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.CompanyTableControl.SaveData()
      ...
      End Sub
        ...
        Me.CompanyTableControl.LoadData()
