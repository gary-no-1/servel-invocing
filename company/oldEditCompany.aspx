...
<%@ Page Language="vb" EnableEventValidation="false" AutoEventWireup="false" Codebehind="oldEditCompany.aspx.vb" Culture="en-IN" MasterPageFile="../Master Pages/VerticalMenu.master" Inherits="ServelInvocing.UI.oldEditCompany" %>
<%@ Register Tagprefix="ServelInvocing" Namespace="ServelInvocing.UI.Controls.oldEditCompany" Assembly="ServelInvocing" %>
...
<BaseClasses:TextBoxMaxLengthValidator runat="server" id="fin_year_startTextBoxMaxLengthValidator" ControlToValidate="fin_year_start" ErrorMessage="&lt;%# GetResourceValue(&quot;Val:ValueTooLong&quot;, &quot;ServelInvocing&quot;).Replace(&quot;{FieldName}&quot;, &quot;Fin Year Start&quot;) %>"></BaseClasses:TextBoxMaxLengthValidator></td>
</tr>
</table>
</td><td class="fls"><asp:Literal runat="server" id="fin_year_endLabel" Text="Fin Year End">	</asp:Literal></td><td class="dfv"><table border="0" cellpadding="0" cellspacing="0">
<tr>
<td style="padding-right: 5px; vertical-align:top">
...
<BaseClasses:TextBoxMaxLengthValidator runat="server" id="fin_year_endTextBoxMaxLengthValidator" ControlToValidate="fin_year_end" ErrorMessage="&lt;%# GetResourceValue(&quot;Val:ValueTooLong&quot;, &quot;ServelInvocing&quot;).Replace(&quot;{FieldName}&quot;, &quot;Fin Year End&quot;) %>"></BaseClasses:TextBoxMaxLengthValidator></td>
</tr>
</table>
...
<BaseClasses:TextBoxMaxLengthValidator runat="server" id="inv_declarationTextBoxMaxLengthValidator" ControlToValidate="inv_declaration" ErrorMessage="&lt;%# GetResourceValue(&quot;Val:ValueTooLong&quot;, &quot;ServelInvocing&quot;).Replace(&quot;{FieldName}&quot;, &quot;Invoice Declaration&quot;) %>"></BaseClasses:TextBoxMaxLengthValidator></td></tr></table></asp:panel>
</td></tr></table>
