...
<BaseClasses:TextBoxMaxLengthValidator runat="server" id="tin_no1TextBoxMaxLengthValidator" ControlToValidate="tin_no1" ErrorMessage="&lt;%# GetResourceValue(&quot;Val:ValueTooLong&quot;, &quot;ServelInvocing&quot;).Replace(&quot;{FieldName}&quot;, &quot;TIN&quot;) %>"></BaseClasses:TextBoxMaxLengthValidator> </td></tr><tr><td class="fls"><asp:Literal runat="server" id="srv_tax_noLabel" Text="Service Tax No:">	</asp:Literal></td><td class="dfv"><asp:TextBox runat="server" id="srv_tax_no" Columns="30" MaxLength="30" cssclass="field_input"></asp:TextBox>&nbsp;
