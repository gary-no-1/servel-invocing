...
' This file implements the code-behind class for EditCommodity.aspx.
' EditCommodity.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class EditCommodity
        Inherits BaseApplicationPage
' Code-behind class for the EditCommodity page.
...
#Region "Section 2: Do not modify this section."
        ...
        Public WithEvents CommodityRecordControl As ServelInvocing.UI.Controls.EditCommodity.CommodityRecordControl
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.CommodityRecordControl.SaveData()
      ...
      End Sub
        ...
        Me.CommodityRecordControl.LoadData()
        ...
        Public Sub SaveButton_Click_Base(ByVal sender As Object, ByVal args As EventArgs)
            ...
            If Not TargetKey Is Nothing Then
                ...
                If Not Me.CommodityRecordControl Is Nothing AndAlso Not Me.CommodityRecordControl.DataSource Is Nothing Then
                      
                      id = Me.CommodityRecordControl.DataSource.id0.ToString
                      value = Me.CommodityRecordControl.DataSource.GetValue(Me.CommodityRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(DFKA)).ToString
                      ...
                      If Not Formula Is Nothing Then
                            value = EvaluateFormula(Formula, Me.CommodityRecordControl.DataSource)
                      End If
