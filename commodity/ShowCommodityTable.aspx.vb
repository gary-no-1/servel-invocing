...
' This file implements the code-behind class for ShowCommodityTable.aspx.
' ShowCommodityTable.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class ShowCommodityTable
        Inherits BaseApplicationPage
' Code-behind class for the ShowCommodityTable page.
...
#Region "Ajax Functions"
      ...
      <Services.WebMethod()> _
      Public Shared Function GetAutoCompletionList_CommoditySearch(ByVal prefixText As String, ByVal count As Integer) As String()
      ' GetCommoditySearchCompletionList gets the list of suggestions from the database.
      ' prefixText is the search text typed by the user .
      ' count specifies the number of suggestions to be returned.
      ' Customize by adding code before or after the call to  GetAutoCompletionList_CommoditySearch()
      ' or replace the call to GetAutoCompletionList_CommoditySearch().
      Return GetAutoCompletionList_CommoditySearch_Base(prefixText, count)
      End Function
...
#Region "Section 2: Do not modify this section."
        ...
        Public WithEvents CommodityCopyButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents CommodityDeleteButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents CommodityEditButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents CommodityExportCSVButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents CommodityExportExcelButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents CommodityImportButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents commodityLabel As System.Web.UI.WebControls.Literal
        Public WithEvents commodityLabel1 As System.Web.UI.WebControls.LinkButton
        Public WithEvents CommodityNewButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents CommodityPagination As Pagination
        Public WithEvents CommodityPDFButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents CommodityRefreshButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents CommodityResetButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents CommoditySearch As System.Web.UI.WebControls.TextBox
        Public WithEvents CommoditySearchButton As ThemeButton
        Public WithEvents CommodityTableControl As ServelInvocing.UI.Controls.ShowCommodityTable.CommodityTableControl
        Public WithEvents CommodityTitle As System.Web.UI.WebControls.Literal
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.CommodityTableControl.SaveData()
      ...
      End Sub
        ...
        Public Shared Function GetAutoCompletionList_CommoditySearch_Base(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim control as ServelInvocing.UI.Controls.ShowCommodityTable.CommodityTableControl 
            control = new ServelInvocing.UI.Controls.ShowCommodityTable.CommodityTableControl()
            
            Return control.GetAutoCompletionList_CommoditySearch(prefixText, count)
        ...
        Me.CommodityTableControl.LoadData()
