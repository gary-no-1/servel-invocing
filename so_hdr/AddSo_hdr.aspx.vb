...
' This file implements the code-behind class for AddSo_hdr.aspx.
' AddSo_hdr.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class AddSo_hdr
        Inherits BaseApplicationPage
' Code-behind class for the AddSo_hdr page.
...
#Region "Section 2: Do not modify this section."
        ...
        Public WithEvents So_hdrRecordControl As ServelInvocing.UI.Controls.AddSo_hdr.So_hdrRecordControl
        ...
        Public WithEvents So_itemsTableControl As ServelInvocing.UI.Controls.AddSo_hdr.So_itemsTableControl
        ...
        Public WithEvents So_taxesTableControl As ServelInvocing.UI.Controls.AddSo_hdr.So_taxesTableControl
        ...
        Public WithEvents So_termsTableControl As ServelInvocing.UI.Controls.AddSo_hdr.So_termsTableControl
        ...
        Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            Page.Title = GetResourceValue("Title:Add") + " So hdr"
        End Sub
