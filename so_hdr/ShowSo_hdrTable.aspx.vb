...
' This file implements the code-behind class for ShowSo_hdrTable.aspx.
' ShowSo_hdrTable.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class ShowSo_hdrTable
        Inherits BaseApplicationPage
' Code-behind class for the ShowSo_hdrTable page.
...
#Region "Ajax Functions"
      ...
      <Services.WebMethod()> _
      Public Shared Function GetAutoCompletionList_So_hdrSearch(ByVal prefixText As String, ByVal count As Integer) As String()
      ' GetSo_hdrSearchCompletionList gets the list of suggestions from the database.
      ' prefixText is the search text typed by the user .
      ' count specifies the number of suggestions to be returned.
      ' Customize by adding code before or after the call to  GetAutoCompletionList_So_hdrSearch()
      ' or replace the call to GetAutoCompletionList_So_hdrSearch().
      Return GetAutoCompletionList_So_hdrSearch_Base(prefixText, count)
      End Function
...
#Region "Section 2: Do not modify this section."
        ...
        Public WithEvents id_commodityLabel As System.Web.UI.WebControls.LinkButton
        ...
        Public WithEvents id_tax_groupLabel As System.Web.UI.WebControls.LinkButton
        ...
        Public WithEvents So_hdrCopyButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents So_hdrDeleteButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents So_hdrEditButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents So_hdrExportCSVButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents So_hdrExportExcelButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents So_hdrImportButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents So_hdrNewButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents So_hdrPagination As Pagination
        Public WithEvents So_hdrPDFButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents So_hdrRefreshButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents So_hdrResetButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents So_hdrSearch As System.Web.UI.WebControls.TextBox
        Public WithEvents So_hdrSearchButton As ThemeButton
        Public WithEvents So_hdrTableControl As ServelInvocing.UI.Controls.ShowSo_hdrTable.So_hdrTableControl
        Public WithEvents So_hdrTitle As System.Web.UI.WebControls.Literal
        Public WithEvents So_hdrToggleAll As System.Web.UI.WebControls.CheckBox
        Public WithEvents So_hdrWordButton As System.Web.UI.WebControls.ImageButton
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.So_hdrTableControl.SaveData()
      ...
      End Sub
        ...
        Public Shared Function GetAutoCompletionList_So_hdrSearch_Base(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim control as ServelInvocing.UI.Controls.ShowSo_hdrTable.So_hdrTableControl 
            control = new ServelInvocing.UI.Controls.ShowSo_hdrTable.So_hdrTableControl()
            
            Return control.GetAutoCompletionList_So_hdrSearch(prefixText, count)
        ...
        Me.So_hdrTableControl.LoadData()
