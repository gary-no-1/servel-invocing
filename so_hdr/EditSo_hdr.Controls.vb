...
' EditSo_hdr.aspx page.  The Row or RecordControl classes are the 
...
Namespace ServelInvocing.UI.Controls.EditSo_hdr
...
' Base class for the So_itemsTableControlRow control on the EditSo_hdr page.
...
' Base class for the So_itemsTableControl control on the EditSo_hdr page.
...
' Base class for the So_taxesTableControlRow control on the EditSo_hdr page.
...
' Base class for the So_taxesTableControl control on the EditSo_hdr page.
...
' Base class for the So_termsTableControlRow control on the EditSo_hdr page.
...
' Base class for the So_termsTableControl control on the EditSo_hdr page.
...
' Base class for the So_hdrRecordControl control on the EditSo_hdr page.
...
Public Class BaseSo_hdrRecordControl
        ...
        Protected Overridable Sub Control_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
              ...
              Me.id_commodityAddRecordLink.PostBackUrl = "../commodity/AddCommodity.aspx" & "?Target=" & Me.id_commodity.ClientID & "&DFKA=commodity"
              Me.id_commodityAddRecordLink.Attributes.Item("onClick") = "window.open('" & Me.id_commodityAddRecordLink.PostBackUrl & "','_blank', 'width=900, height=700, resizable, scrollbars, modal=yes'); return false;"
              
              Me.id_create_userAddRecordLink.PostBackUrl = "../users/AddUsers.aspx" & "?Target=" & Me.id_create_user.ClientID & "&DFKA=name"
              Me.id_create_userAddRecordLink.Attributes.Item("onClick") = "window.open('" & Me.id_create_userAddRecordLink.PostBackUrl & "','_blank', 'width=900, height=700, resizable, scrollbars, modal=yes'); return false;"
              ...
              Me.id_siteAddRecordLink.PostBackUrl = "../sites/AddSites.aspx" & "?Target=" & Me.id_site.ClientID & "&DFKA=name"
              Me.id_siteAddRecordLink.Attributes.Item("onClick") = "window.open('" & Me.id_siteAddRecordLink.PostBackUrl & "','_blank', 'width=900, height=700, resizable, scrollbars, modal=yes'); return false;"
              ...
              Me.id_update_userAddRecordLink.PostBackUrl = "../users/AddUsers.aspx" & "?Target=" & Me.id_update_user.ClientID & "&DFKA=name"
              Me.id_update_userAddRecordLink.Attributes.Item("onClick") = "window.open('" & Me.id_update_userAddRecordLink.PostBackUrl & "','_blank', 'width=900, height=700, resizable, scrollbars, modal=yes'); return false;"
              
              AddHandler Me.id_commodity.SelectedIndexChanged, AddressOf id_commodity_SelectedIndexChanged
            
              AddHandler Me.id_create_user.SelectedIndexChanged, AddressOf id_create_user_SelectedIndexChanged
              ...
              AddHandler Me.id_update_user.SelectedIndexChanged, AddressOf id_update_user_SelectedIndexChanged
            
              AddHandler Me.additional_email.TextChanged, AddressOf additional_email_TextChanged
              ...
              AddHandler Me.created_on.TextChanged, AddressOf created_on_TextChanged
              ...
              AddHandler Me.inv_cr8_dt.TextChanged, AddressOf inv_cr8_dt_TextChanged
            
              AddHandler Me.inv_created.TextChanged, AddressOf inv_created_TextChanged
            
              AddHandler Me.item_total.TextChanged, AddressOf item_total_TextChanged
            
              AddHandler Me.last_updated.TextChanged, AddressOf last_updated_TextChanged
        ...
        Public Overridable Sub Setadditional_email()
            ...
            ' Set the additional_email TextBox on the webpage with value from the
            ' so_hdr database record.

            ' Me.DataSource is the so_hdr record retrieved from the database.
            ' Me.additional_email is the ASP:TextBox on the webpage.
        ...
        Public Overridable Sub Setcreated_on()
            ...
            ' Set the created_on TextBox on the webpage with value from the
            ' so_hdr database record.

            ' Me.DataSource is the so_hdr record retrieved from the database.
            ' Me.created_on is the ASP:TextBox on the webpage.
        ...
        Public Overridable Sub Setid_create_user()
            ...
            ' Set the id_create_user DropDownList on the webpage with value from the
            ' so_hdr database record.
            
            ' Me.DataSource is the so_hdr record retrieved from the database.
            ' Me.id_create_user is the ASP:DropDownList on the webpage.
            ...
            If Me.DataSource IsNot Nothing AndAlso Me.DataSource.id_create_userSpecified Then
                ...
                ' The Format method will return the Display Foreign Key As (DFKA) value
                Me.Populateid_create_userDropDownList(Me.DataSource.id_create_user.ToString(), 100)
            ...
            Else
                ...
                ' Default Value could also be NULL.
                If Me.DataSource IsNot Nothing AndAlso Me.DataSource.IsCreated Then
                    Me.Populateid_create_userDropDownList(Nothing, 100)
                Else
                    Me.Populateid_create_userDropDownList(So_hdrTable.id_create_user.DefaultValue, 100)
                End If
        ...
        Public Overridable Sub Setid_update_user()
            ...
            ' Set the id_update_user DropDownList on the webpage with value from the
            ' so_hdr database record.
            
            ' Me.DataSource is the so_hdr record retrieved from the database.
            ' Me.id_update_user is the ASP:DropDownList on the webpage.
            ...
            If Me.DataSource IsNot Nothing AndAlso Me.DataSource.id_update_userSpecified Then
                ...
                ' The Format method will return the Display Foreign Key As (DFKA) value
                Me.Populateid_update_userDropDownList(Me.DataSource.id_update_user.ToString(), 100)
            ...
            Else
                ...
                ' Default Value could also be NULL.
                If Me.DataSource IsNot Nothing AndAlso Me.DataSource.IsCreated Then
                    Me.Populateid_update_userDropDownList(Nothing, 100)
                Else
                    Me.Populateid_update_userDropDownList(So_hdrTable.id_update_user.DefaultValue, 100)
                End If
        ...
        Public Overridable Sub Setinv_cr8_dt()
            ...
            ' Set the inv_cr8_dt TextBox on the webpage with value from the
            ' so_hdr database record.

            ' Me.DataSource is the so_hdr record retrieved from the database.
            ' Me.inv_cr8_dt is the ASP:TextBox on the webpage.
        ...
        Public Overridable Sub Setinv_created()
            ...
            ' Set the inv_created TextBox on the webpage with value from the
            ' so_hdr database record.

            ' Me.DataSource is the so_hdr record retrieved from the database.
            ' Me.inv_created is the ASP:TextBox on the webpage.
        ...
        Public Overridable Sub Setlast_updated()
            ...
            ' Set the last_updated TextBox on the webpage with value from the
            ' so_hdr database record.

            ' Me.DataSource is the so_hdr record retrieved from the database.
            ' Me.last_updated is the ASP:TextBox on the webpage.
        ...
        Public Overridable Sub Getadditional_email()
            ...
            ' Retrieve the value entered by the user on the additional_email ASP:TextBox, and
            ' save it into the additional_email field in DataSource so_hdr record.
            
            ' Custom validation should be performed in Validate, not here.
            
            'Save the value to data source
            Me.DataSource.Parse(Me.additional_email.Text, So_hdrTable.additional_email)			
        ...
        Public Overridable Sub Getcreated_on()
            ...
            ' Retrieve the value entered by the user on the created_on ASP:TextBox, and
            ' save it into the created_on field in DataSource so_hdr record.
            ...
            'Save the value to data source
            Me.DataSource.Parse(Me.created_on.Text, So_hdrTable.created_on)			
        ...
        Public Overridable Sub Getgrand_total()
            ...
            ' Retrieve the value entered by the user on the grand_total ASP:TextBox, and
            ' save it into the grand_total field in DataSource so_hdr record.
            
            ' Custom validation should be performed in Validate, not here.
            
            'Save the value to data source
            Me.DataSource.Parse(Me.grand_total.Text, So_hdrTable.grand_total)			
        ...
        Public Overridable Sub Getid_create_user()
            ...
            ' Retrieve the value entered by the user on the id_create_user ASP:DropDownList, and
            ' save it into the id_create_user field in DataSource so_hdr record.
                        
            ' Custom validation should be performed in Validate, not here.
            
            Me.DataSource.Parse(GetValueSelectedPageRequest(Me.id_create_user), So_hdrTable.id_create_user)				
        ...
        Public Overridable Sub Getid_update_user()
            ...
            ' Retrieve the value entered by the user on the id_update_user ASP:DropDownList, and
            ' save it into the id_update_user field in DataSource so_hdr record.
                        
            ' Custom validation should be performed in Validate, not here.
            
            Me.DataSource.Parse(GetValueSelectedPageRequest(Me.id_update_user), So_hdrTable.id_update_user)				
            
        End Sub
                
        Public Overridable Sub Getinv_cr8_dt()
            
            ' Retrieve the value entered by the user on the inv_cr8_dt ASP:TextBox, and
            ' save it into the inv_cr8_dt field in DataSource so_hdr record.
            ' Parse will also validate the date to ensure it is of the proper format
            ' and a valid date.  The format is verified based on the current culture 
            ' settings including the order of month, day and year and the separator character.
            ' Parse throws an exception if the date is invalid.
            ...
            'Save the value to data source
            Me.DataSource.Parse(Me.inv_cr8_dt.Text, So_hdrTable.inv_cr8_dt)			
        ...
        Public Overridable Sub Getinv_created()
            ...
            ' Retrieve the value entered by the user on the inv_created ASP:TextBox, and
            ' save it into the inv_created field in DataSource so_hdr record.
            
            ' Custom validation should be performed in Validate, not here.
            
            'Save the value to data source
            Me.DataSource.Parse(Me.inv_created.Text, So_hdrTable.inv_created)			
        ...
        Public Overridable Sub Getitem_total()
            ...
            ' Retrieve the value entered by the user on the item_total ASP:TextBox, and
            ' save it into the item_total field in DataSource so_hdr record.
            
            ' Custom validation should be performed in Validate, not here.
            
            'Save the value to data source
            Me.DataSource.Parse(Me.item_total.Text, So_hdrTable.item_total)			
        ...
        Public Overridable Sub Getlast_updated()
            ...
            ' Retrieve the value entered by the user on the last_updated ASP:TextBox, and
            ' save it into the last_updated field in DataSource so_hdr record.
            ' Parse will also validate the date to ensure it is of the proper format
            ' and a valid date.  The format is verified based on the current culture 
            ' settings including the order of month, day and year and the separator character.
            ' Parse throws an exception if the date is invalid.
            ...
            'Save the value to data source
            Me.DataSource.Parse(Me.last_updated.Text, So_hdrTable.last_updated)			
        ...
        Public Overridable Function CreateWhereClause() As WhereClause
            ...
            End If
            HttpContext.Current.Session("QueryString in EditSo_hdr") = recId
        ...
        Public Overridable Function CreateWhereClause_id_create_userDropDownList() As WhereClause
            ' By default, we simply return a new WhereClause.
            ' Add additional where clauses to restrict the items shown in the dropdown list.
        ...
        Public Overridable Function CreateWhereClause_id_update_userDropDownList() As WhereClause
            ' By default, we simply return a new WhereClause.
            ' Add additional where clauses to restrict the items shown in the dropdown list.
        ...
        ' Fill the id_create_user list.
        Protected Overridable Sub Populateid_create_userDropDownList( _
                ByVal selectedValue As String, _
                ByVal maxItems As Integer)
            		  					                
            Me.id_create_user.Items.Clear()
            ...
            Me.id_create_user.Items.Add(New ListItem(Me.Page.ExpandResourceValue("{Txt:PleaseSelect}"), "--PLEASE_SELECT--"))							
                            		  			
            ' 2. Set up the WHERE and the ORDER BY clause by calling the CreateWhereClause_id_create_userDropDownList function.
            ' It is better to customize the where clause there.
            
            Dim wc As WhereClause = CreateWhereClause_id_create_userDropDownList()
            ' Create the ORDER BY clause to sort based on the displayed value.			
                ...
                Do
                    ...
                    For each itemValue As UsersRecord In itemValues
                        ...
                        If itemValue.id0Specified Then
                            ...
                            If fvalue Is Nothing OrElse fvalue.Trim() = "" Then fvalue = cvalue
                            Dim newItem As New ListItem(fvalue, cvalue)
                            If counter < maxItems AndAlso Not Me.id_create_user.Items.Contains(newItem) Then Me.id_create_user.Items.Add(newItem)
                            counter += 1
                        End If
                    Next
                    pageNum += 1
            ...
            If Not selectedValue Is Nothing AndAlso _
                selectedValue.Trim <> "" AndAlso _
                Not SetSelectedValue(Me.id_create_user, selectedValue) AndAlso _
                Not SetSelectedDisplayText(Me.id_create_user, selectedValue)Then
                ...
                Try
                    ...
                    If rc IsNot Nothing AndAlso rc.Length = 1 Then
                        ...
                        Dim fvalue As String = So_hdrTable.id_create_user.Format(selectedValue)																			
                            
                        If fvalue Is Nothing OrElse fvalue.Trim() = "" Then fvalue = selectedValue
                        Dim item As ListItem = New ListItem(fvalue, selectedValue)
                        item.Selected = True
                        Me.id_create_user.Items.Add(item)
                    End If
                Catch
                End Try
        ...
        ' Fill the id_update_user list.
        Protected Overridable Sub Populateid_update_userDropDownList( _
                ByVal selectedValue As String, _
                ByVal maxItems As Integer)
            		  					                
            Me.id_update_user.Items.Clear()
            ...
            Me.id_update_user.Items.Add(New ListItem(Me.Page.ExpandResourceValue("{Txt:PleaseSelect}"), "--PLEASE_SELECT--"))							
                            		  			
            ' 2. Set up the WHERE and the ORDER BY clause by calling the CreateWhereClause_id_update_userDropDownList function.
            ' It is better to customize the where clause there.
            
            Dim wc As WhereClause = CreateWhereClause_id_update_userDropDownList()
            ' Create the ORDER BY clause to sort based on the displayed value.			
                ...
                Do
                    ...
                    For each itemValue As UsersRecord In itemValues
                        ...
                        If itemValue.id0Specified Then
                            ...
                            If fvalue Is Nothing OrElse fvalue.Trim() = "" Then fvalue = cvalue
                            Dim newItem As New ListItem(fvalue, cvalue)
                            If counter < maxItems AndAlso Not Me.id_update_user.Items.Contains(newItem) Then Me.id_update_user.Items.Add(newItem)
                            counter += 1
                        End If
                    Next
                    pageNum += 1
            ...
            If Not selectedValue Is Nothing AndAlso _
                selectedValue.Trim <> "" AndAlso _
                Not SetSelectedValue(Me.id_update_user, selectedValue) AndAlso _
                Not SetSelectedDisplayText(Me.id_update_user, selectedValue)Then
                ...
                Try
                    ...
                    If rc IsNot Nothing AndAlso rc.Length = 1 Then
                        ...
                        Dim fvalue As String = So_hdrTable.id_update_user.Format(selectedValue)																			
                            
                        If fvalue Is Nothing OrElse fvalue.Trim() = "" Then fvalue = selectedValue
                        Dim item As ListItem = New ListItem(fvalue, selectedValue)
                        item.Selected = True
                        Me.id_update_user.Items.Add(item)
                    End If
                Catch
                End Try
        ...
        Protected Overridable Sub id_create_user_SelectedIndexChanged(ByVal sender As Object, ByVal args As EventArgs)
            ' If a large list selector or a Quick Add link is used, the dropdown list
            ' will contain an item that was not in the original (smaller) list.  During postbacks,
            ' this new item will not be in the list - since the list is based on the original values
            ' read from the database. This function adds the value back if necessary.
            ...
            ' When this function is fire for Make or Model, we don't want the following code executed.
            ' Therefore, we check this situation using Items.Count > 1			
            If Me.id_create_user.Items.Count > 1 Then
                Dim selectedValue As String = MiscUtils.GetValueSelectedPageRequest(Me.id_create_user)
        ...
        Protected Overridable Sub id_update_user_SelectedIndexChanged(ByVal sender As Object, ByVal args As EventArgs)
            ' If a large list selector or a Quick Add link is used, the dropdown list
            ' will contain an item that was not in the original (smaller) list.  During postbacks,
            ' this new item will not be in the list - since the list is based on the original values
            ' read from the database. This function adds the value back if necessary.
            ...
            ' When this function is fire for Make or Model, we don't want the following code executed.
            ' Therefore, we check this situation using Items.Count > 1			
            If Me.id_update_user.Items.Count > 1 Then
                Dim selectedValue As String = MiscUtils.GetValueSelectedPageRequest(Me.id_update_user)
        ...
        Protected Overridable Sub additional_email_TextChanged(ByVal sender As Object, ByVal args As EventArgs)                
        ...
        Protected Overridable Sub created_on_TextChanged(ByVal sender As Object, ByVal args As EventArgs)                
        ...
        Protected Overridable Sub inv_cr8_dt_TextChanged(ByVal sender As Object, ByVal args As EventArgs)                
                    				
        End Sub
            
        Protected Overridable Sub inv_created_TextChanged(ByVal sender As Object, ByVal args As EventArgs)                
        ...
        Protected Overridable Sub last_updated_TextChanged(ByVal sender As Object, ByVal args As EventArgs)                
...
#Region "Helper Properties"
        ...
        Public ReadOnly Property additional_email() As System.Web.UI.WebControls.TextBox
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "additional_email"), System.Web.UI.WebControls.TextBox)
            End Get
        End Property
        ...
        Public ReadOnly Property created_on() As System.Web.UI.WebControls.TextBox
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "created_on"), System.Web.UI.WebControls.TextBox)
            End Get
        End Property
        ...
        Public ReadOnly Property id_commodityAddRecordLink() As System.Web.UI.WebControls.ImageButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "id_commodityAddRecordLink"), System.Web.UI.WebControls.ImageButton)
            End Get
        End Property
        ...
        Public ReadOnly Property id_create_user() As System.Web.UI.WebControls.DropDownList
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "id_create_user"), System.Web.UI.WebControls.DropDownList)
            End Get
        End Property
            
        Public ReadOnly Property id_create_userAddRecordLink() As System.Web.UI.WebControls.ImageButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "id_create_userAddRecordLink"), System.Web.UI.WebControls.ImageButton)
            End Get
        End Property
        ...
        Public ReadOnly Property id_siteAddRecordLink() As System.Web.UI.WebControls.ImageButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "id_siteAddRecordLink"), System.Web.UI.WebControls.ImageButton)
            End Get
        End Property
        ...
        Public ReadOnly Property id_update_user() As System.Web.UI.WebControls.DropDownList
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "id_update_user"), System.Web.UI.WebControls.DropDownList)
            End Get
        End Property
            
        Public ReadOnly Property id_update_userAddRecordLink() As System.Web.UI.WebControls.ImageButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "id_update_userAddRecordLink"), System.Web.UI.WebControls.ImageButton)
            End Get
        End Property
        ...
        Public ReadOnly Property inv_cr8_dt() As System.Web.UI.WebControls.TextBox
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "inv_cr8_dt"), System.Web.UI.WebControls.TextBox)
            End Get
        End Property
        ...
        Public ReadOnly Property inv_created() As System.Web.UI.WebControls.TextBox
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "inv_created"), System.Web.UI.WebControls.TextBox)
            End Get
        End Property
        ...
        Public ReadOnly Property last_updated() As System.Web.UI.WebControls.TextBox
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "last_updated"), System.Web.UI.WebControls.TextBox)
            End Get
        End Property
