...
' ShowSo_hdrTable.aspx page.  The Row or RecordControl classes are the 
...
Namespace ServelInvocing.UI.Controls.ShowSo_hdrTable

#Region "Section 1: Place your customizations here."

    
Public Class So_hdrTableControlRow
        Inherits BaseSo_hdrTableControlRow
        ' The BaseSo_hdrTableControlRow implements code for a ROW within the
        ' the So_hdrTableControl table.  The BaseSo_hdrTableControlRow implements the DataBind and SaveData methods.
        ' The loading of data is actually performed by the LoadData method in the base class of So_hdrTableControl.
...
Public Class So_hdrTableControl
        Inherits BaseSo_hdrTableControl

    ' The BaseSo_hdrTableControl class implements the LoadData, DataBind, CreateWhereClause
    ' and other methods to load and display the data in a table control.

    ' This is the ideal place to add your code customizations. You can override the LoadData and CreateWhereClause,
    ' The So_hdrTableControlRow class offers another place where you can customize
...
' Base class for the So_hdrTableControlRow control on the ShowSo_hdrTable page.
' Do not modify this class. Instead override any method in So_hdrTableControlRow.
Public Class BaseSo_hdrTableControlRow
        Inherits ServelInvocing.UI.BaseApplicationRecordControl

        '  To customize, override this method in So_hdrTableControlRow.
        ...
        Protected Overridable Sub Control_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
			...
			Me.Page.LoadFocusScripts(Me)
              ...
              Me.So_hdrRowDeleteButton.Attributes.Add("onClick", "return (confirm('" & (CType(Me.Page,BaseApplicationPage)).GetResourceValue("DeleteRecordConfirm", "ServelInvocing") & "'));")
              ' Register the event handlers.
          
              AddHandler Me.So_hdrRowCopyButton.Click, AddressOf So_hdrRowCopyButton_Click
              
              AddHandler Me.So_hdrRowDeleteButton.Click, AddressOf So_hdrRowDeleteButton_Click
              
              AddHandler Me.So_hdrRowEditButton.Click, AddressOf So_hdrRowEditButton_Click
              
              AddHandler Me.So_hdrRowViewButton.Click, AddressOf So_hdrRowViewButton_Click
        ...
        Public Overridable Sub LoadData()        
            ...
            ' LoadData method of the BaseSo_hdrTableControl when the data for the entire
            ' table is loaded.
        ...
        ' Populate the UI controls using the DataSource.  To customize, override this method in So_hdrTableControlRow.
        ...
        Public Overridable Sub SaveData()
            ...
            If Me.DataSource.IsAnyValueChanged Then
                ...
                DirectCast(GetParentControlObject(Me, "So_hdrTableControl"), So_hdrTableControl).DataChanged = True
                DirectCast(GetParentControlObject(Me, "So_hdrTableControl"), So_hdrTableControl).ResetData = True
            End If
        ...
        Public Overridable Sub So_hdrRowCopyButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
            ...
            Dim url As String = "../so_hdr/AddSo_hdr.aspx?So_hdr={PK}"
        ...
        ' event handler for ImageButton
        Public Overridable Sub So_hdrRowDeleteButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
      ...
      Me.Page.CommitTransaction(sender)
        ...
        ' event handler for ImageButton
        Public Overridable Sub So_hdrRowEditButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
        ...
        ' event handler for ImageButton
        Public Overridable Sub So_hdrRowViewButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
            ...
            ' Any code after the Response.Redirect call will not be executed, since the page is
            ' redirected to the URL.
            Dim url As String = "../so_hdr/ShowSo_hdr.aspx?So_hdr={PK}"
            Dim shouldRedirect As Boolean = True
            Dim TargetKey As String = Nothing
            Dim DFKA As String = Nothing
            Dim id As String = Nothing
        ...
        Public Overridable Sub id_commodity_Click(ByVal sender As Object, ByVal args As EventArgs)
            ...
            ' Any code after the Response.Redirect call will not be executed, since the page is
            ' redirected to the URL.
            Dim url As String = "../commodity/ShowCommodity.aspx?Commodity={So_hdrTableControlRow:FK:so_hdr_commodity_id_commodity_FK}"
            Dim shouldRedirect As Boolean = True
            Dim TargetKey As String = Nothing
            Dim DFKA As String = Nothing
            Dim id As String = Nothing
        ...
        Public Overridable Sub id_party_Click(ByVal sender As Object, ByVal args As EventArgs)
            ...
            ' Any code after the Response.Redirect call will not be executed, since the page is
            ' redirected to the URL.
            Dim url As String = "../party/ShowParty.aspx?Party={So_hdrTableControlRow:FK:so_hdr_party_id_party_FK}"
            Dim shouldRedirect As Boolean = True
            Dim TargetKey As String = Nothing
            Dim DFKA As String = Nothing
            Dim id As String = Nothing
        ...
        Public Overridable Sub id_tax_group_Click(ByVal sender As Object, ByVal args As EventArgs)
            ...
            ' Any code after the Response.Redirect call will not be executed, since the page is
            ' redirected to the URL.
            Dim url As String = "../tax_groups/ShowTax_groups.aspx?Tax_groups={So_hdrTableControlRow:FK:so_hdr_tax_groups_id_tax_group_FK}"
            Dim shouldRedirect As Boolean = True
            Dim TargetKey As String = Nothing
            Dim DFKA As String = Nothing
            Dim id As String = Nothing
        ...
        Public Property RecordUniqueId() As String
            Get
                Return CType(Me.ViewState("BaseSo_hdrTableControlRow_Rec"), String)
            End Get
            Set(ByVal value As String)
                Me.ViewState("BaseSo_hdrTableControlRow_Rec") = value
            End Set
        End Property
...
#Region "Helper Properties"
        ...
        Public ReadOnly Property So_hdrRecordRowSelection() As System.Web.UI.WebControls.CheckBox
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "So_hdrRecordRowSelection"), System.Web.UI.WebControls.CheckBox)
            End Get
        End Property
        
        Public ReadOnly Property So_hdrRowCopyButton() As System.Web.UI.WebControls.ImageButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "So_hdrRowCopyButton"), System.Web.UI.WebControls.ImageButton)
            End Get
        End Property
        
        Public ReadOnly Property So_hdrRowDeleteButton() As System.Web.UI.WebControls.ImageButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "So_hdrRowDeleteButton"), System.Web.UI.WebControls.ImageButton)
            End Get
        End Property
        
        Public ReadOnly Property So_hdrRowEditButton() As System.Web.UI.WebControls.ImageButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "So_hdrRowEditButton"), System.Web.UI.WebControls.ImageButton)
            End Get
        End Property
        
        Public ReadOnly Property So_hdrRowViewButton() As System.Web.UI.WebControls.ImageButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "So_hdrRowViewButton"), System.Web.UI.WebControls.ImageButton)
            End Get
        End Property
...
' Base class for the So_hdrTableControl control on the ShowSo_hdrTable page.
' Do not modify this class. Instead override any method in So_hdrTableControl.
Public Class BaseSo_hdrTableControl
        ...
        Protected Overridable Sub Control_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Init
           ...
           ' Setup the filter and search events.
            ...
            If Not Me.Page.IsPostBack Then
                Dim initialVal As String = ""
                If  Me.InSession(Me.So_hdrSearch) 				
                    initialVal = Me.GetFromSession(Me.So_hdrSearch)
                
                End If
                If initialVal <> ""				
                        
                        Me.So_hdrSearch.Text = initialVal
        ...
        Protected Overridable Sub Control_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            SaveControlsToSession_Ajax()
              ...
              ' Show confirmation message on Click
              Me.So_hdrDeleteButton.Attributes.Add("onClick", "return (confirm('" & (CType(Me.Page,BaseApplicationPage)).GetResourceValue("DeleteConfirm", "ServelInvocing") & "'));")
            ' Setup the pagination events.
            
              AddHandler Me.So_hdrPagination.FirstPage.Click, AddressOf So_hdrPagination_FirstPage_Click
              
              AddHandler Me.So_hdrPagination.LastPage.Click, AddressOf So_hdrPagination_LastPage_Click
              
              AddHandler Me.So_hdrPagination.NextPage.Click, AddressOf So_hdrPagination_NextPage_Click
              
              AddHandler Me.So_hdrPagination.PageSizeButton.Click, AddressOf So_hdrPagination_PageSizeButton_Click
            
              AddHandler Me.So_hdrPagination.PreviousPage.Click, AddressOf So_hdrPagination_PreviousPage_Click
            ...
            ' Setup the sorting events.
              ...
              AddHandler Me.id_commodityLabel.Click, AddressOf id_commodityLabel_Click
            
              AddHandler Me.id_partyLabel1.Click, AddressOf id_partyLabel1_Click
            
              AddHandler Me.id_tax_groupLabel.Click, AddressOf id_tax_groupLabel_Click
            ...
            ' Setup the button events.
              ...
              AddHandler Me.So_hdrCopyButton.Click, AddressOf So_hdrCopyButton_Click
              
              AddHandler Me.So_hdrDeleteButton.Click, AddressOf So_hdrDeleteButton_Click
              
              AddHandler Me.So_hdrEditButton.Click, AddressOf So_hdrEditButton_Click
              
              AddHandler Me.So_hdrExportCSVButton.Click, AddressOf So_hdrExportCSVButton_Click
              
              AddHandler Me.So_hdrExportExcelButton.Click, AddressOf So_hdrExportExcelButton_Click
              
              AddHandler Me.So_hdrImportButton.Click, AddressOf So_hdrImportButton_Click
              
              AddHandler Me.So_hdrNewButton.Click, AddressOf So_hdrNewButton_Click
              
              AddHandler Me.So_hdrPDFButton.Click, AddressOf So_hdrPDFButton_Click
              
              AddHandler Me.So_hdrRefreshButton.Click, AddressOf So_hdrRefreshButton_Click
              
              AddHandler Me.So_hdrResetButton.Click, AddressOf So_hdrResetButton_Click
              
              AddHandler Me.So_hdrWordButton.Click, AddressOf So_hdrWordButton_Click
              
            AddHandler Me.So_hdrSearchButton.Button.Click, AddressOf So_hdrSearchButton_Click
        ...
        Public Overridable Sub LoadData()
            ...
            Try	
                ...
                If wc IsNot Nothing AndAlso Not wc.RunQuery Then
                    ...
                    Me.DataSource = DirectCast(alist.ToArray(GetType(So_hdrRecord)), So_hdrRecord())
                ...
                Me.TotalRecords = So_hdrTable.GetRecordCount(wc)
                ...
                ' Make sure to preserve the previously entered data on new rows.
                    ...
                    For Each rc As So_hdrTableControlRow In Me.GetRecordControls()
                        ...
                        End If
                    Next
                    Me.DataSource = DirectCast(postdata.ToArray(GetType(So_hdrRecord)), So_hdrRecord())
                
                Else  ' Get the records from the database	
                    Me.DataSource = So_hdrTable.GetRecords(wc, orderBy, Me.PageIndex, Me.PageSize) 
                End If
                ...
                Me.So_hdrToggleAll.Checked = False
        ...
        Public Overrides Sub DataBind()
          ...
          Me.PreFetchForeignKeyValues()
            ...
            Dim rep As System.Web.UI.WebControls.Repeater = CType(Me.FindControl("So_hdrTableControlRepeater"), System.Web.UI.WebControls.Repeater)
            ...
            For Each repItem As System.Web.UI.WebControls.RepeaterItem In rep.Items
                ...
                Dim recControl As So_hdrTableControlRow = DirectCast(repItem.FindControl("So_hdrTableControlRow"), So_hdrTableControlRow) 
      ...
      End Sub
          ...
          End If
            ...
            Me.Page.PregetDfkaRecords(So_hdrTable.id_commodity, Me.DataSource)
          
            Me.Page.PregetDfkaRecords(So_hdrTable.id_party, Me.DataSource)
          
            Me.Page.PregetDfkaRecords(So_hdrTable.id_tax_group, Me.DataSource)
        ...
        Public Overridable Sub RegisterPostback()
              ...
              Me.Page.RegisterPostBackTrigger(MiscUtils.FindControlRecursively(Me,"So_hdrExportCSVButton"))
                        
              Me.Page.RegisterPostBackTrigger(MiscUtils.FindControlRecursively(Me,"So_hdrExportExcelButton"))
                        
              Me.Page.RegisterPostBackTrigger(MiscUtils.FindControlRecursively(Me,"So_hdrPDFButton"))
                        
              Me.Page.RegisterPostBackTrigger(MiscUtils.FindControlRecursively(Me,"So_hdrWordButton"))
        ...
        Protected Overridable Sub BindPaginationControls()
            ...
            ' Bind the buttons for So_hdrTableControl pagination.
        
            Me.So_hdrPagination.FirstPage.Enabled = Not (Me.PageIndex = 0)
            Me.So_hdrPagination.LastPage.Enabled = Not (Me.PageIndex = Me.TotalPages - 1)
            If Me.TotalPages = 0 Then
                Me.So_hdrPagination.LastPage.Enabled = False
            End If
          
            Me.So_hdrPagination.NextPage.Enabled = Not (Me.PageIndex = Me.TotalPages - 1)
            If Me.TotalPages = 0 Then
                Me.So_hdrPagination.NextPage.Enabled = False
            End If
          
            Me.So_hdrPagination.PreviousPage.Enabled = Not (Me.PageIndex = 0)

            ' Bind the pagination labels.
        
            If Me.TotalPages > 0 Then
                Me.So_hdrPagination.CurrentPage.Text = (Me.PageIndex + 1).ToString()
            Else
                Me.So_hdrPagination.CurrentPage.Text = "0"
            End If
            Me.So_hdrPagination.PageSize.Text = Me.PageSize.ToString()
            Me.So_hdrPagination.TotalItems.Text = Me.TotalRecords.ToString()
            Me.So_hdrPagination.TotalPages.Text = Me.TotalPages.ToString()
        End Sub
        ...
        Public Overridable Sub SaveData()
            ...
            Dim recCtl As So_hdrTableControlRow
        ...
        Public Overridable Function CreateWhereClause() As WhereClause
            ...
            If IsValueSelected(Me.id_partyFilter) Then
                ...
                wc.iAND(So_hdrTable.id_party, BaseFilter.ComparisonOperator.EqualsTo, MiscUtils.GetSelectedValue(Me.id_partyFilter, Me.GetFromSession(Me.id_partyFilter)), False, False)
            
                
            End If
                       
            If IsValueSelected(Me.So_hdrSearch) Then
                ' Strip "..." from begin and ending of the search text, otherwise the search will return 0 values as in database "..." is not stored.
                If Me.So_hdrSearch.Text.StartsWith("...") Then
                    Me.So_hdrSearch.Text = Me.So_hdrSearch.Text.SubString(3,Me.So_hdrSearch.Text.Length-3)
                End If
                If Me.So_hdrSearch.Text.EndsWith("...") then
                    Me.So_hdrSearch.Text = Me.So_hdrSearch.Text.SubString(0,Me.So_hdrSearch.Text.Length-3)
                End If
                
                Dim formatedSearchText As String = MiscUtils.GetSelectedValue(Me.So_hdrSearch, Me.GetFromSession(Me.So_hdrSearch))
        ...
        ' These clauses are added depending on operator and fields selected in Control's property page, bindings tab.
                    ...
                    search.iOR(So_hdrTable.id_commodity, BaseFilter.ComparisonOperator.Contains, MiscUtils.GetSelectedValue(Me.So_hdrSearch, Me.GetFromSession(Me.So_hdrSearch)), True, False)
        
                    search.iOR(So_hdrTable.id_tax_group, BaseFilter.ComparisonOperator.Contains, MiscUtils.GetSelectedValue(Me.So_hdrSearch, Me.GetFromSession(Me.So_hdrSearch)), True, False)
        
                    search.iOR(So_hdrTable.id_create_user, BaseFilter.ComparisonOperator.Contains, MiscUtils.GetSelectedValue(Me.So_hdrSearch, Me.GetFromSession(Me.So_hdrSearch)), True, False)
        
                    search.iOR(So_hdrTable.id_update_user, BaseFilter.ComparisonOperator.Contains, MiscUtils.GetSelectedValue(Me.So_hdrSearch, Me.GetFromSession(Me.So_hdrSearch)), True, False)
        ...
        Public Overridable Function CreateWhereClause(ByVal searchText as String, ByVal fromSearchControl as String, ByVal AutoTypeAheadSearch as String, ByVal AutoTypeAheadWordSeparators as String) As WhereClause
            ...
            If IsValueSelected(id_partyFilterSelectedValue) Then
                 ...
                 wc.iAND(So_hdrTable.id_party, BaseFilter.ComparisonOperator.EqualsTo, id_partyFilterSelectedValue, false, False)
             
             End If
                      
            If IsValueSelected(searchText) and fromSearchControl = "So_hdrSearch" Then
                ...
                If IsValueSelected(formatedSearchText) Then
                    ...
                    If InvariantLCase(AutoTypeAheadSearch).equals("wordsstartingwithsearchstring") Then
                        ...
                        search.iOR(So_hdrTable.id_commodity, BaseFilter.ComparisonOperator.Starts_With, formatedSearchText, True, False)
                        search.iOR(So_hdrTable.id_commodity, BaseFilter.ComparisonOperator.Contains, AutoTypeAheadWordSeparators & formatedSearchText, True, False)
                
                        search.iOR(So_hdrTable.id_tax_group, BaseFilter.ComparisonOperator.Starts_With, formatedSearchText, True, False)
                        search.iOR(So_hdrTable.id_tax_group, BaseFilter.ComparisonOperator.Contains, AutoTypeAheadWordSeparators & formatedSearchText, True, False)
                
                        search.iOR(So_hdrTable.id_create_user, BaseFilter.ComparisonOperator.Starts_With, formatedSearchText, True, False)
                        search.iOR(So_hdrTable.id_create_user, BaseFilter.ComparisonOperator.Contains, AutoTypeAheadWordSeparators & formatedSearchText, True, False)
                
                        search.iOR(So_hdrTable.id_update_user, BaseFilter.ComparisonOperator.Starts_With, formatedSearchText, True, False)
                        search.iOR(So_hdrTable.id_update_user, BaseFilter.ComparisonOperator.Contains, AutoTypeAheadWordSeparators & formatedSearchText, True, False)
                
                    Else
                        
                        search.iOR(So_hdrTable.id_commodity, BaseFilter.ComparisonOperator.Contains, formatedSearchText, True, False)
                        search.iOR(So_hdrTable.id_tax_group, BaseFilter.ComparisonOperator.Contains, formatedSearchText, True, False)
                        search.iOR(So_hdrTable.id_create_user, BaseFilter.ComparisonOperator.Contains, formatedSearchText, True, False)
                        search.iOR(So_hdrTable.id_update_user, BaseFilter.ComparisonOperator.Contains, formatedSearchText, True, False)
                    End If
                    wc.iAND(search)
        ...
        Public Overridable Function GetAutoCompletionList_So_hdrSearch(ByVal prefixText As String, ByVal count As Integer) As String()
            Dim resultList As ArrayList = New ArrayList
            Dim wordList As ArrayList = New ArrayList
            Dim iteration As Integer = 0
            
            Dim wc As WhereClause = CreateWhereClause(prefixText,"So_hdrSearch", "WordsStartingWithSearchString", "[^a-zA-Z0-9]")
            While (resultList.Count < count AndAlso iteration < 5)
                ' Fetch 100 records in each iteration
                Dim recordList () As ServelInvocing.Business.So_hdrRecord = So_hdrTable.GetRecords(wc, Nothing, iteration, 100)
                Dim rec As So_hdrRecord = Nothing
                ...
                For Each rec In recordList 
                    ...
                    resultItem = rec.Format(So_hdrTable.id_commodity)
                    ...
                    resultItem = rec.Format(So_hdrTable.id_tax_group)
                    If resultItem IsNot Nothing AndAlso resultItem.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture).Contains(prefixText.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture))  Then
                    ...
                    resultItem = rec.Format(So_hdrTable.id_create_user)
                    If resultItem IsNot Nothing AndAlso resultItem.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture).Contains(prefixText.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture))  Then
                    ...
                    resultItem = rec.Format(So_hdrTable.id_update_user)
                    If resultItem IsNot Nothing AndAlso resultItem.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture).Contains(prefixText.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture))  Then
        ...
        Protected Overridable Sub GetPageSize()
            ...
            If Me.So_hdrPagination.PageSize.Text.Trim <> "" Then
                Try
                    'Me.PageSize = Integer.Parse(Me.So_hdrPagination.PageSize.Text)
                Catch ex As Exception
                End Try
            End If
        End Sub
        ...
        Protected Overridable Sub AddNewRecords()
            ...
            If Not Me.ResetData Then
                ...
                For Each repItem In rep.Items
                    ...
                    If recControl.Visible AndAlso recControl.IsNewRecord() Then
                        ...
                        Dim rec As So_hdrRecord = New So_hdrRecord()
        
                        If recControl.bill_address.Text <> "" Then
                            rec.Parse(recControl.bill_address.Text, So_hdrTable.bill_address)
                        End If
                        If recControl.ecc_no.Text <> "" Then
                            rec.Parse(recControl.ecc_no.Text, So_hdrTable.ecc_no)
                        End If
                        If recControl.grand_total.Text <> "" Then
                            rec.Parse(recControl.grand_total.Text, So_hdrTable.grand_total)
                        End If
                        If recControl.id_commodity.Text <> "" Then
                            rec.Parse(recControl.id_commodity.Text, So_hdrTable.id_commodity)
                        End If
                        If recControl.id_party.Text <> "" Then
                            rec.Parse(recControl.id_party.Text, So_hdrTable.id_party)
                        End If
                        If recControl.id_tax_group.Text <> "" Then
                            rec.Parse(recControl.id_tax_group.Text, So_hdrTable.id_tax_group)
                        End If
                        If recControl.item_total.Text <> "" Then
                            rec.Parse(recControl.item_total.Text, So_hdrTable.item_total)
                        End If
                        If recControl.po_dt.Text <> "" Then
                            rec.Parse(recControl.po_dt.Text, So_hdrTable.po_dt)
                        End If
                        If recControl.po_no.Text <> "" Then
                            rec.Parse(recControl.po_no.Text, So_hdrTable.po_no)
                        End If
                        If recControl.sale_ord_dt.Text <> "" Then
                            rec.Parse(recControl.sale_ord_dt.Text, So_hdrTable.sale_ord_dt)
                        End If
                        If recControl.sale_ord_no.Text <> "" Then
                            rec.Parse(recControl.sale_ord_no.Text, So_hdrTable.sale_ord_no)
                        End If
                        If recControl.ship_address.Text <> "" Then
                            rec.Parse(recControl.ship_address.Text, So_hdrTable.ship_address)
                        End If
                        If recControl.tin_no.Text <> "" Then
                            rec.Parse(recControl.tin_no.Text, So_hdrTable.tin_no)
                        End If
            ...
            For index = 1 To Me.AddNewRecord
                ...
                newRecordList.Insert(0, New So_hdrRecord())
            ...
            If newRecordList.Count > 0 Then
                ...
                Me.DataSource = DirectCast(finalList.ToArray(GetType(So_hdrRecord)), So_hdrRecord())
        ...
        Public Sub AddToDeletedRecordIds(ByVal rec As So_hdrTableControlRow)
        ...
        Protected Overridable Function InDeletedRecordIds(ByVal rec As So_hdrTableControlRow) As Boolean
        ...
        Public Overridable Sub SetSo_hdrSearch()
        ...
        Protected Overrides Sub SaveControlsToSession()
            ...
            Me.SaveToSession(Me.So_hdrSearch, Me.So_hdrSearch.Text)
      ...
      Me.SaveToSession("So_hdrSearch_Ajax", Me.So_hdrSearch.Text)
        ...
        Protected Overrides Sub ClearControlsFromSession()
            ...
            Me.RemoveFromSession(Me.So_hdrSearch)
        ...
        Protected Overrides Sub LoadViewState(ByVal savedState As Object)
            ...
            Dim orderByStr As String = CType(ViewState("So_hdrTableControl_OrderBy"), String)
        ...
        Protected Overrides Function SaveViewState() As Object
            ...
            If Me.CurrentSortOrder IsNot Nothing Then
                Me.ViewState("So_hdrTableControl_OrderBy") = Me.CurrentSortOrder.ToXmlString()
            End If
        ...
        ' event handler for ImageButton
        Public Overridable Sub So_hdrPagination_FirstPage_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
        ...
        ' event handler for ImageButton
        Public Overridable Sub So_hdrPagination_LastPage_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
        ...
        ' event handler for ImageButton
        Public Overridable Sub So_hdrPagination_NextPage_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
        ...
        ' event handler for LinkButton
        Public Overridable Sub So_hdrPagination_PageSizeButton_Click(ByVal sender As Object, ByVal args As EventArgs)
            ...
            Me.PageIndex = Integer.Parse(Me.So_hdrPagination.CurrentPage.Text) - 1
        ...
        ' event handler for ImageButton
        Public Overridable Sub So_hdrPagination_PreviousPage_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
        ...
        Public Overridable Sub bill_addressLabel_Click(ByVal sender As Object, ByVal args As EventArgs)
            ...
            Dim sd As OrderByItem = Me.CurrentSortOrder.Find(So_hdrTable.bill_address)
            If sd Is Nothing Then
                ' First time sort, so add sort order for bill_address.
                Me.CurrentSortOrder.Reset()
                Me.CurrentSortOrder.Add(So_hdrTable.bill_address, OrderByItem.OrderDir.Asc)
            Else
        ...
        Public Overridable Sub ecc_noLabel_Click(ByVal sender As Object, ByVal args As EventArgs)
            ...
            Dim sd As OrderByItem = Me.CurrentSortOrder.Find(So_hdrTable.ecc_no)
            If sd Is Nothing Then
                ' First time sort, so add sort order for ecc_no.
                Me.CurrentSortOrder.Reset()
                Me.CurrentSortOrder.Add(So_hdrTable.ecc_no, OrderByItem.OrderDir.Asc)
            Else
        ...
        Public Overridable Sub grand_totalLabel_Click(ByVal sender As Object, ByVal args As EventArgs)
            ...
            Dim sd As OrderByItem = Me.CurrentSortOrder.Find(So_hdrTable.grand_total)
            If sd Is Nothing Then
                ' First time sort, so add sort order for grand_total.
                Me.CurrentSortOrder.Reset()
                Me.CurrentSortOrder.Add(So_hdrTable.grand_total, OrderByItem.OrderDir.Asc)
            Else
        ...
        Public Overridable Sub id_commodityLabel_Click(ByVal sender As Object, ByVal args As EventArgs)
            ' Sorts by id_commodity when clicked.
              
            ' Get previous sorting state for id_commodity.
            
            Dim sd As OrderByItem = Me.CurrentSortOrder.Find(So_hdrTable.id_commodity)
            If sd Is Nothing Then
                ' First time sort, so add sort order for id_commodity.
                Me.CurrentSortOrder.Reset()
                Me.CurrentSortOrder.Add(So_hdrTable.id_commodity, OrderByItem.OrderDir.Asc)
            Else
                ' Previously sorted by id_commodity, so just reverse.
                sd.Reverse()
            End If
        ...
        Public Overridable Sub id_partyLabel1_Click(ByVal sender As Object, ByVal args As EventArgs)
            ...
            Dim sd As OrderByItem = Me.CurrentSortOrder.Find(So_hdrTable.id_party)
            If sd Is Nothing Then
                ' First time sort, so add sort order for id_party.
                Me.CurrentSortOrder.Reset()
                Me.CurrentSortOrder.Add(So_hdrTable.id_party, OrderByItem.OrderDir.Asc)
            Else
        ...
        Public Overridable Sub id_tax_groupLabel_Click(ByVal sender As Object, ByVal args As EventArgs)
            ' Sorts by id_tax_group when clicked.
              
            ' Get previous sorting state for id_tax_group.
            
            Dim sd As OrderByItem = Me.CurrentSortOrder.Find(So_hdrTable.id_tax_group)
            If sd Is Nothing Then
                ' First time sort, so add sort order for id_tax_group.
                Me.CurrentSortOrder.Reset()
                Me.CurrentSortOrder.Add(So_hdrTable.id_tax_group, OrderByItem.OrderDir.Asc)
            Else
        ...
        Public Overridable Sub item_totalLabel_Click(ByVal sender As Object, ByVal args As EventArgs)
            ...
            Dim sd As OrderByItem = Me.CurrentSortOrder.Find(So_hdrTable.item_total)
            If sd Is Nothing Then
                ' First time sort, so add sort order for item_total.
                Me.CurrentSortOrder.Reset()
                Me.CurrentSortOrder.Add(So_hdrTable.item_total, OrderByItem.OrderDir.Asc)
            Else
        ...
        Public Overridable Sub po_dtLabel_Click(ByVal sender As Object, ByVal args As EventArgs)
            ...
            Dim sd As OrderByItem = Me.CurrentSortOrder.Find(So_hdrTable.po_dt)
            If sd Is Nothing Then
                ' First time sort, so add sort order for po_dt.
                Me.CurrentSortOrder.Reset()
                Me.CurrentSortOrder.Add(So_hdrTable.po_dt, OrderByItem.OrderDir.Asc)
            Else
        ...
        Public Overridable Sub po_noLabel_Click(ByVal sender As Object, ByVal args As EventArgs)
            ...
            Dim sd As OrderByItem = Me.CurrentSortOrder.Find(So_hdrTable.po_no)
            If sd Is Nothing Then
                ' First time sort, so add sort order for po_no.
                Me.CurrentSortOrder.Reset()
                Me.CurrentSortOrder.Add(So_hdrTable.po_no, OrderByItem.OrderDir.Asc)
            Else
        ...
        Public Overridable Sub sale_ord_dtLabel_Click(ByVal sender As Object, ByVal args As EventArgs)
            ...
            Dim sd As OrderByItem = Me.CurrentSortOrder.Find(So_hdrTable.sale_ord_dt)
            If sd Is Nothing Then
                ' First time sort, so add sort order for sale_ord_dt.
                Me.CurrentSortOrder.Reset()
                Me.CurrentSortOrder.Add(So_hdrTable.sale_ord_dt, OrderByItem.OrderDir.Asc)
            Else
        ...
        Public Overridable Sub sale_ord_noLabel_Click(ByVal sender As Object, ByVal args As EventArgs)
            ...
            Dim sd As OrderByItem = Me.CurrentSortOrder.Find(So_hdrTable.sale_ord_no)
            If sd Is Nothing Then
                ' First time sort, so add sort order for sale_ord_no.
                Me.CurrentSortOrder.Reset()
                Me.CurrentSortOrder.Add(So_hdrTable.sale_ord_no, OrderByItem.OrderDir.Asc)
            Else
        ...
        Public Overridable Sub ship_addressLabel_Click(ByVal sender As Object, ByVal args As EventArgs)
            ...
            Dim sd As OrderByItem = Me.CurrentSortOrder.Find(So_hdrTable.ship_address)
            If sd Is Nothing Then
                ' First time sort, so add sort order for ship_address.
                Me.CurrentSortOrder.Reset()
                Me.CurrentSortOrder.Add(So_hdrTable.ship_address, OrderByItem.OrderDir.Asc)
            Else
        ...
        Public Overridable Sub tin_noLabel_Click(ByVal sender As Object, ByVal args As EventArgs)
            ...
            Dim sd As OrderByItem = Me.CurrentSortOrder.Find(So_hdrTable.tin_no)
            If sd Is Nothing Then
                ' First time sort, so add sort order for tin_no.
                Me.CurrentSortOrder.Reset()
                Me.CurrentSortOrder.Add(So_hdrTable.tin_no, OrderByItem.OrderDir.Asc)
            Else
        ...
        ' event handler for ImageButton
        Public Overridable Sub So_hdrCopyButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
        ...
        ' event handler for ImageButton
        Public Overridable Sub So_hdrDeleteButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
      ...
      Me.Page.CommitTransaction(sender)
        ...
        ' event handler for ImageButton
        Public Overridable Sub So_hdrEditButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
        ...
        ' event handler for ImageButton
        Public Overridable Sub So_hdrExportCSVButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
          ...
          ' Create the Order By clause based on the user's current sorting preference.
            ...
            Dim columns() as BaseColumn = New BaseColumn() { _
                       So_hdrTable.sale_ord_no, _ 
             So_hdrTable.sale_ord_dt, _ 
             So_hdrTable.id_party, _ 
             So_hdrTable.bill_address, _ 
             So_hdrTable.ship_address, _ 
             So_hdrTable.tin_no, _ 
             So_hdrTable.po_no, _ 
             So_hdrTable.po_dt, _ 
             So_hdrTable.ecc_no, _ 
             So_hdrTable.id_commodity, _ 
             So_hdrTable.id_tax_group, _ 
             So_hdrTable.item_total, _ 
             So_hdrTable.grand_total, _ 
             Nothing}
            Dim  exportData as ExportDataToCSV = New ExportDataToCSV(So_hdrTable.Instance, wc, orderBy, columns)
        ...
        ' event handler for ImageButton
        Public Overridable Sub So_hdrExportExcelButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
            ...
            Dim excelReport As ExportDataToExcel = New ExportDataToExcel(So_hdrTable.Instance, wc, orderBy)
            ' Add each of the columns in order of export.
            ' To customize the data type, change the second parameter of the new ExcelColumn to be
            ' a format string from Excel's Format Cell menu. For example "dddd, mmmm dd, yyyy h:mm AM/PM;@", "#,##0.00"
             excelReport.AddColumn(New ExcelColumn(So_hdrTable.sale_ord_no, "Default"))
             excelReport.AddColumn(New ExcelColumn(So_hdrTable.sale_ord_dt, "Short Date"))
             excelReport.AddColumn(New ExcelColumn(So_hdrTable.id_party, "Default"))
             excelReport.AddColumn(New ExcelColumn(So_hdrTable.bill_address, "Default"))
             excelReport.AddColumn(New ExcelColumn(So_hdrTable.ship_address, "Default"))
             excelReport.AddColumn(New ExcelColumn(So_hdrTable.tin_no, "Default"))
             excelReport.AddColumn(New ExcelColumn(So_hdrTable.po_no, "Default"))
             excelReport.AddColumn(New ExcelColumn(So_hdrTable.po_dt, "Short Date"))
             excelReport.AddColumn(New ExcelColumn(So_hdrTable.ecc_no, "Default"))
             excelReport.AddColumn(New ExcelColumn(So_hdrTable.id_commodity, "Default"))
             excelReport.AddColumn(New ExcelColumn(So_hdrTable.id_tax_group, "Default"))
             excelReport.AddColumn(New ExcelColumn(So_hdrTable.item_total, "Standard"))
             excelReport.AddColumn(New ExcelColumn(So_hdrTable.grand_total, "Standard"))
        ...
        ' event handler for ImageButton
        Public Overridable Sub So_hdrImportButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
            ...
            ' Any code after the Response.Redirect call will not be executed, since the page is
            ' redirected to the URL.
            Dim url As String = "../Shared/SelectFileToImport.aspx?TableName=So_hdr"
            Try
                ' Enclose all database retrieval/update code within a Transaction boundary
                DbUtils.StartTransaction
        ...
        ' event handler for ImageButton
        Public Overridable Sub So_hdrNewButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
            ...
            ' Any code after the Response.Redirect call will not be executed, since the page is
            ' redirected to the URL.
            Dim url As String = "../so_hdr/AddSo_hdr.aspx"
            Dim shouldRedirect As Boolean = True
            Dim TargetKey As String = Nothing
            Dim DFKA As String = Nothing
            Dim id As String = Nothing
        ...
        ' event handler for ImageButton
        Public Overridable Sub So_hdrPDFButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
            ...
            Try
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowSo_hdrTable.So_hdrPDFButton.report")
                ' report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "so_hdr"
                ' If ShowSo_hdrTable.So_hdrPDFButton.report specifies a valid report template,
                ...
                ' The 5th parameter represents the relative width of the column   			
                 report.AddColumn(So_hdrTable.sale_ord_no.Name, ReportEnum.Align.Left, "${sale_ord_no}", ReportEnum.Align.Left, 20)
                 report.AddColumn(So_hdrTable.sale_ord_dt.Name, ReportEnum.Align.Left, "${sale_ord_dt}", ReportEnum.Align.Left, 20)
                 report.AddColumn(So_hdrTable.id_party.Name, ReportEnum.Align.Left, "${id_party}", ReportEnum.Align.Left, 30)
                 report.AddColumn(So_hdrTable.bill_address.Name, ReportEnum.Align.Left, "${bill_address}", ReportEnum.Align.Left, 30)
                 report.AddColumn(So_hdrTable.ship_address.Name, ReportEnum.Align.Left, "${ship_address}", ReportEnum.Align.Left, 30)
                 report.AddColumn(So_hdrTable.tin_no.Name, ReportEnum.Align.Left, "${tin_no}", ReportEnum.Align.Left, 20)
                 report.AddColumn(So_hdrTable.po_no.Name, ReportEnum.Align.Left, "${po_no}", ReportEnum.Align.Left, 24)
                 report.AddColumn(So_hdrTable.po_dt.Name, ReportEnum.Align.Left, "${po_dt}", ReportEnum.Align.Left, 20)
                 report.AddColumn(So_hdrTable.ecc_no.Name, ReportEnum.Align.Left, "${ecc_no}", ReportEnum.Align.Left, 20)
                 report.AddColumn(So_hdrTable.id_commodity.Name, ReportEnum.Align.Left, "${id_commodity}", ReportEnum.Align.Left, 30)
                 report.AddColumn(So_hdrTable.id_tax_group.Name, ReportEnum.Align.Left, "${id_tax_group}", ReportEnum.Align.Left, 30)
                 report.AddColumn(So_hdrTable.item_total.Name, ReportEnum.Align.Right, "${item_total}", ReportEnum.Align.Right, 20)
                 report.AddColumn(So_hdrTable.grand_total.Name, ReportEnum.Align.Right, "${grand_total}", ReportEnum.Align.Right, 20)
                ...
                Dim pageNum As Integer = 0 
                Dim totalRows As Integer = So_hdrTable.GetRecordCount(whereClause)
                Dim columns As ColumnList = So_hdrTable.GetColumnList()
                Dim records As So_hdrRecord() = Nothing
            
                Do 
                    
                    records = So_hdrTable.GetRecords(whereClause, orderBy, pageNum, rowsPerQuery)
                    If Not (records Is Nothing) AndAlso records.Length > 0 AndAlso whereClause.RunQuery Then 
                        For Each record As So_hdrRecord In records 
                            ...
                            ' The 4th parameters represent the maximum length of the data value being shown
                                                         report.AddData("${sale_ord_no}", record.Format(So_hdrTable.sale_ord_no), ReportEnum.Align.Left, 100)
                             report.AddData("${sale_ord_dt}", record.Format(So_hdrTable.sale_ord_dt), ReportEnum.Align.Left, 100)
                             report.AddData("${id_party}", record.Format(So_hdrTable.id_party), ReportEnum.Align.Left)
                             report.AddData("${bill_address}", record.Format(So_hdrTable.bill_address), ReportEnum.Align.Left, 100)
                             report.AddData("${ship_address}", record.Format(So_hdrTable.ship_address), ReportEnum.Align.Left, 100)
                             report.AddData("${tin_no}", record.Format(So_hdrTable.tin_no), ReportEnum.Align.Left, 100)
                             report.AddData("${po_no}", record.Format(So_hdrTable.po_no), ReportEnum.Align.Left, 100)
                             report.AddData("${po_dt}", record.Format(So_hdrTable.po_dt), ReportEnum.Align.Left, 100)
                             report.AddData("${ecc_no}", record.Format(So_hdrTable.ecc_no), ReportEnum.Align.Left, 100)
                             report.AddData("${id_commodity}", record.Format(So_hdrTable.id_commodity), ReportEnum.Align.Left)
                             report.AddData("${id_tax_group}", record.Format(So_hdrTable.id_tax_group), ReportEnum.Align.Left)
                             report.AddData("${item_total}", record.Format(So_hdrTable.item_total), ReportEnum.Align.Right, 100)
                             report.AddData("${grand_total}", record.Format(So_hdrTable.grand_total), ReportEnum.Align.Right, 100)
        ...
        ' event handler for ImageButton
        Public Overridable Sub So_hdrRefreshButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
        
            Try
                
            Dim So_hdrTableControlObj as So_hdrTableControl = DirectCast(Me.Page.FindControlRecursively("So_hdrTableControl"), So_hdrTableControl)
            So_hdrTableControlObj.ResetData = True
                        
            So_hdrTableControlObj.RemoveFromSession(So_hdrTableControlObj, "DeletedRecordIds")
            So_hdrTableControlObj.DeletedRecordIds = Nothing
        ...
        ' event handler for ImageButton
        Public Overridable Sub So_hdrResetButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
        ...
        ' event handler for ImageButton
        Public Overridable Sub So_hdrWordButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
            ...
            Try
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowSo_hdrTable.So_hdrWordButton.word")
                ' report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "so_hdr"
                ' If ShowSo_hdrTable.So_hdrWordButton.report specifies a valid report template,
                ' AddColumn method will generate a report template.
                ' Each AddColumn method-call specifies a column
                ' The 1st parameter represents the text of the column header
                ' The 2nd parameter represents the horizontal alignment of the column header
        ...
        Public Overridable Sub So_hdrSearchButton_Click(ByVal sender As Object, ByVal args As EventArgs)
        ...
        Private _DataSource() As So_hdrRecord = Nothing
        Public Property DataSource() As So_hdrRecord ()
            Get
                Return Me._DataSource
            End Get
...
#Region "Helper Properties"
        ...
        Public ReadOnly Property id_commodityLabel() As System.Web.UI.WebControls.LinkButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "id_commodityLabel"), System.Web.UI.WebControls.LinkButton)
            End Get
        End Property
        ...
        Public ReadOnly Property id_tax_groupLabel() As System.Web.UI.WebControls.LinkButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "id_tax_groupLabel"), System.Web.UI.WebControls.LinkButton)
            End Get
        End Property
        ...
        Public ReadOnly Property So_hdrCopyButton() As System.Web.UI.WebControls.ImageButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "So_hdrCopyButton"), System.Web.UI.WebControls.ImageButton)
            End Get
        End Property
        
        Public ReadOnly Property So_hdrDeleteButton() As System.Web.UI.WebControls.ImageButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "So_hdrDeleteButton"), System.Web.UI.WebControls.ImageButton)
            End Get
        End Property
        
        Public ReadOnly Property So_hdrEditButton() As System.Web.UI.WebControls.ImageButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "So_hdrEditButton"), System.Web.UI.WebControls.ImageButton)
            End Get
        End Property
        
        Public ReadOnly Property So_hdrExportCSVButton() As System.Web.UI.WebControls.ImageButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "So_hdrExportCSVButton"), System.Web.UI.WebControls.ImageButton)
            End Get
        End Property
        
        Public ReadOnly Property So_hdrExportExcelButton() As System.Web.UI.WebControls.ImageButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "So_hdrExportExcelButton"), System.Web.UI.WebControls.ImageButton)
            End Get
        End Property
        
        Public ReadOnly Property So_hdrImportButton() As System.Web.UI.WebControls.ImageButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "So_hdrImportButton"), System.Web.UI.WebControls.ImageButton)
            End Get
        End Property
        
        Public ReadOnly Property So_hdrNewButton() As System.Web.UI.WebControls.ImageButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "So_hdrNewButton"), System.Web.UI.WebControls.ImageButton)
            End Get
        End Property
        
        Public ReadOnly Property So_hdrPagination() As ServelInvocing.UI.IPagination
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "So_hdrPagination"), ServelInvocing.UI.IPagination)
          End Get
          End Property
        
        Public ReadOnly Property So_hdrPDFButton() As System.Web.UI.WebControls.ImageButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "So_hdrPDFButton"), System.Web.UI.WebControls.ImageButton)
            End Get
        End Property
        
        Public ReadOnly Property So_hdrRefreshButton() As System.Web.UI.WebControls.ImageButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "So_hdrRefreshButton"), System.Web.UI.WebControls.ImageButton)
            End Get
        End Property
        
        Public ReadOnly Property So_hdrResetButton() As System.Web.UI.WebControls.ImageButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "So_hdrResetButton"), System.Web.UI.WebControls.ImageButton)
            End Get
        End Property
        
        Public ReadOnly Property So_hdrSearch() As System.Web.UI.WebControls.TextBox
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "So_hdrSearch"), System.Web.UI.WebControls.TextBox)
            End Get
        End Property
        
        Public ReadOnly Property So_hdrSearchButton() As ServelInvocing.UI.IThemeButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "So_hdrSearchButton"), ServelInvocing.UI.IThemeButton)
          End Get
          End Property
        ...
        Public ReadOnly Property So_hdrToggleAll() As System.Web.UI.WebControls.CheckBox
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "So_hdrToggleAll"), System.Web.UI.WebControls.CheckBox)
            End Get
        End Property
        
        Public ReadOnly Property So_hdrWordButton() As System.Web.UI.WebControls.ImageButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "So_hdrWordButton"), System.Web.UI.WebControls.ImageButton)
            End Get
        End Property
...
#Region "Helper Functions"
        ...
        Public Overrides Overloads Function EvaluateExpressions(url As String, arg As String, ByVal bEncrypt As Boolean) As String
            ...
            If (needToProcess) Then
                Dim recCtl As So_hdrTableControlRow = Me.GetSelectedRecordControl()
        ...
        Public Overridable Function GetSelectedRecordIndex() As Integer
            Dim counter As Integer = 0
            Dim recControl As So_hdrTableControlRow
            For Each recControl In Me.GetRecordControls()
                If recControl.So_hdrRecordRowSelection.Checked Then
                    Return counter
                End If
                counter += 1
            Next
        ...
        Public Overridable Function GetSelectedRecordControl() As So_hdrTableControlRow
            Dim selectedList() As So_hdrTableControlRow = Me.GetSelectedRecordControls()
        ...
        Public Overridable Function GetSelectedRecordControls() As So_hdrTableControlRow()
            ...
            For Each recControl In Me.GetRecordControls()
                ...
                End If
            Next
            Return DirectCast(selectedList.ToArray(GetType(So_hdrTableControlRow)), So_hdrTableControlRow())
          
        End Function

        Public Overridable Sub DeleteSelectedRecords(ByVal deferDeletion As Boolean)
            Dim recList() As So_hdrTableControlRow = Me.GetSelectedRecordControls()
            ...
            For Each recCtl In recList
                If deferDeletion Then
                    ...
                    recCtl.So_hdrRecordRowSelection.Checked = False
        ...
        Public Function GetRecordControls() As So_hdrTableControlRow()
            ...
            Return DirectCast(recList.ToArray(GetType(So_hdrTableControlRow)), So_hdrTableControlRow())
        End Function
