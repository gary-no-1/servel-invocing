...
' This file implements the code-behind class for EditSo_hdr.aspx.
' EditSo_hdr.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class EditSo_hdr
        Inherits BaseApplicationPage
' Code-behind class for the EditSo_hdr page.
...
#Region "Section 2: Do not modify this section."
        ...
        Public WithEvents id_commodityAddRecordLink As System.Web.UI.WebControls.ImageButton
        Public WithEvents id_commodityLabel As System.Web.UI.WebControls.Literal
        Public WithEvents id_create_user As System.Web.UI.WebControls.DropDownList
        Public WithEvents id_create_userAddRecordLink As System.Web.UI.WebControls.ImageButton
        ...
        Public WithEvents id_siteAddRecordLink As System.Web.UI.WebControls.ImageButton
        ...
        Public WithEvents id_update_user As System.Web.UI.WebControls.DropDownList
        Public WithEvents id_update_userAddRecordLink As System.Web.UI.WebControls.ImageButton
        ...
        Public WithEvents So_hdrRecordControl As ServelInvocing.UI.Controls.EditSo_hdr.So_hdrRecordControl
        Public WithEvents So_hdrTitle As System.Web.UI.WebControls.Literal
        Public WithEvents So_itemsAddButton As System.Web.UI.WebControls.ImageButton
        ...
        Public WithEvents So_itemsTableControl As ServelInvocing.UI.Controls.EditSo_hdr.So_itemsTableControl
        Public WithEvents So_itemsToggleAll As System.Web.UI.WebControls.CheckBox
        Public WithEvents So_taxesAddButton As System.Web.UI.WebControls.ImageButton
        ...
        Public WithEvents So_taxesTableControl As ServelInvocing.UI.Controls.EditSo_hdr.So_taxesTableControl
        Public WithEvents So_taxesToggleAll As System.Web.UI.WebControls.CheckBox
        Public WithEvents So_termsAddButton As System.Web.UI.WebControls.ImageButton
        ...
        Public WithEvents So_termsTableControl As ServelInvocing.UI.Controls.EditSo_hdr.So_termsTableControl
        ...
        Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            Page.Title = GetResourceValue("Title:Edit") + " So hdr"
        End Sub
      ...
      End Sub
        ...
        Public Sub SaveButton_Click_Base(ByVal sender As Object, ByVal args As EventArgs)
            ...
            If Not TargetKey Is Nothing Then
                ...
                If Not Me.So_hdrRecordControl Is Nothing AndAlso Not Me.So_hdrRecordControl.DataSource Is Nothing Then
                      
                      id = Me.So_hdrRecordControl.DataSource.id0.ToString
                      value = Me.So_hdrRecordControl.DataSource.GetValue(Me.So_hdrRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(DFKA)).ToString
                      ...
                      If Not Formula Is Nothing Then
                            value = EvaluateFormula(Formula, Me.So_hdrRecordControl.DataSource)
                      End If
