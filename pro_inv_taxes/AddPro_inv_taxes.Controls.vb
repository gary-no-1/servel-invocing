...
' AddPro_inv_taxes.aspx page.  The Row or RecordControl classes are the 
...
Namespace ServelInvocing.UI.Controls.AddPro_inv_taxes
...
' Base class for the Pro_inv_taxesRecordControl control on the AddPro_inv_taxes page.
...
Public Class BasePro_inv_taxesRecordControl
        ...
        Public Overridable Sub LoadData()        
            ...
            Me.DataSource = CType(Pro_inv_taxesRecord.Copy(recList(0), False), Pro_inv_taxesRecord)
        ...
        Public Overridable Sub GetUIData()
            ...
            For Each col In Pro_inv_taxesRecord.TableUtils.TableDefinition.Columns()
        ...
        Public Overridable Function CreateWhereClause() As WhereClause
            ...
            HttpContext.Current.Session("QueryString in AddPro_inv_taxes") = recId
...
#Region "Helper Functions"
        ...
        Public Overridable Function GetRecord() As Pro_inv_taxesRecord
            ...
            Return New Pro_inv_taxesRecord()
