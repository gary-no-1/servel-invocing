...
' This file implements the code-behind class for ShowPro_inv_taxesTable.aspx.
' ShowPro_inv_taxesTable.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class ShowPro_inv_taxesTable
        Inherits BaseApplicationPage
' Code-behind class for the ShowPro_inv_taxesTable page.
...
#Region "Ajax Functions"
      ...
      <Services.WebMethod()> _
      Public Shared Function GetAutoCompletionList_Pro_inv_taxesSearch(ByVal prefixText As String, ByVal count As Integer) As String()
      ' GetPro_inv_taxesSearchCompletionList gets the list of suggestions from the database.
      ' prefixText is the search text typed by the user .
      ' count specifies the number of suggestions to be returned.
      ' Customize by adding code before or after the call to  GetAutoCompletionList_Pro_inv_taxesSearch()
      ' or replace the call to GetAutoCompletionList_Pro_inv_taxesSearch().
      Return GetAutoCompletionList_Pro_inv_taxesSearch_Base(prefixText, count)
      End Function
...
#Region "Section 2: Do not modify this section."
        ...
        Public WithEvents Pro_inv_taxesSearch As System.Web.UI.WebControls.TextBox
        Public WithEvents Pro_inv_taxesSearchButton As ThemeButton
        Public WithEvents Pro_inv_taxesTableControl As ServelInvocing.UI.Controls.ShowPro_inv_taxesTable.Pro_inv_taxesTableControl
        Public WithEvents Pro_inv_taxesTitle As System.Web.UI.WebControls.Literal
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.Pro_inv_taxesTableControl.SaveData()
      ...
      End Sub
        ...
        Public Shared Function GetAutoCompletionList_Pro_inv_taxesSearch_Base(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim control as ServelInvocing.UI.Controls.ShowPro_inv_taxesTable.Pro_inv_taxesTableControl 
            control = new ServelInvocing.UI.Controls.ShowPro_inv_taxesTable.Pro_inv_taxesTableControl()
            
            Return control.GetAutoCompletionList_Pro_inv_taxesSearch(prefixText, count)
        ...
        Me.Pro_inv_taxesTableControl.LoadData()
