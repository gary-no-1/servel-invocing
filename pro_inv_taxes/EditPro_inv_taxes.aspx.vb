...
' This file implements the code-behind class for EditPro_inv_taxes.aspx.
' EditPro_inv_taxes.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class EditPro_inv_taxes
        Inherits BaseApplicationPage
' Code-behind class for the EditPro_inv_taxes page.
...
#Region "Section 2: Do not modify this section."
        ...
        Public WithEvents id_pro_inv_hdr As System.Web.UI.WebControls.DropDownList
        Public WithEvents id_pro_inv_hdrAddRecordLink As System.Web.UI.WebControls.ImageButton
        Public WithEvents id_pro_inv_hdrLabel As System.Web.UI.WebControls.Literal
        Public WithEvents id_taxes As System.Web.UI.WebControls.DropDownList
        Public WithEvents id_taxesAddRecordLink As System.Web.UI.WebControls.ImageButton
        Public WithEvents id_taxesLabel As System.Web.UI.WebControls.Literal
        Public WithEvents PageTitle As System.Web.UI.WebControls.Literal
        Public WithEvents Pro_inv_taxesRecordControl As ServelInvocing.UI.Controls.EditPro_inv_taxes.Pro_inv_taxesRecordControl
        ...
        Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            Page.Title = GetResourceValue("Title:Edit") + " Pro Inv Taxes"
        End Sub
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.Pro_inv_taxesRecordControl.SaveData()
      ...
      End Sub
        ...
        Me.Pro_inv_taxesRecordControl.LoadData()
        ...
        Public Sub SaveButton_Click_Base(ByVal sender As Object, ByVal args As EventArgs)
            ...
            If Not TargetKey Is Nothing Then
                ...
                If Not Me.Pro_inv_taxesRecordControl Is Nothing AndAlso Not Me.Pro_inv_taxesRecordControl.DataSource Is Nothing Then
                      
                      id = Me.Pro_inv_taxesRecordControl.DataSource.id0.ToString
                      value = Me.Pro_inv_taxesRecordControl.DataSource.GetValue(Me.Pro_inv_taxesRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(DFKA)).ToString
                      ...
                      If Not Formula Is Nothing Then
                            value = EvaluateFormula(Formula, Me.Pro_inv_taxesRecordControl.DataSource)
                      End If
