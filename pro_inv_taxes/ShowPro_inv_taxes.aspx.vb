...
' This file implements the code-behind class for ShowPro_inv_taxes.aspx.
' ShowPro_inv_taxes.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class ShowPro_inv_taxes
        Inherits BaseApplicationPage
' Code-behind class for the ShowPro_inv_taxes page.
...
#Region "Section 2: Do not modify this section."
        ...
        Public WithEvents Pro_inv_taxesDialogEditButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents Pro_inv_taxesRecordControl As ServelInvocing.UI.Controls.ShowPro_inv_taxes.Pro_inv_taxesRecordControl
