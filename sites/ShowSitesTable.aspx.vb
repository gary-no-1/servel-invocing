...
' This file implements the code-behind class for ShowSitesTable.aspx.
' ShowSitesTable.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class ShowSitesTable
        Inherits BaseApplicationPage
' Code-behind class for the ShowSitesTable page.
...
#Region "Ajax Functions"
      ...
      <Services.WebMethod()> _
      Public Shared Function GetAutoCompletionList_SitesSearch(ByVal prefixText As String, ByVal count As Integer) As String()
      ' GetSitesSearchCompletionList gets the list of suggestions from the database.
      ' prefixText is the search text typed by the user .
      ' count specifies the number of suggestions to be returned.
      ' Customize by adding code before or after the call to  GetAutoCompletionList_SitesSearch()
      ' or replace the call to GetAutoCompletionList_SitesSearch().
      Return GetAutoCompletionList_SitesSearch_Base(prefixText, count)
      End Function
...
#Region "Section 2: Do not modify this section."
        ...
        Public WithEvents SitesCopyButton As System.Web.UI.WebControls.ImageButton
        ...
        Public WithEvents SitesExportCSVButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents SitesExportExcelButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents SitesImportButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents SitesNewButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents SitesPagination As Pagination
        Public WithEvents SitesPDFButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents SitesRefreshButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents SitesResetButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents SitesSearch As System.Web.UI.WebControls.TextBox
        Public WithEvents SitesSearchButton As ThemeButton
        Public WithEvents SitesTableControl As ServelInvocing.UI.Controls.ShowSitesTable.SitesTableControl
        Public WithEvents SitesTitle As System.Web.UI.WebControls.Literal
    ...
    End Function
      ...
      End Sub
        ...
        Public Shared Function GetAutoCompletionList_SitesSearch_Base(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim control as ServelInvocing.UI.Controls.ShowSitesTable.SitesTableControl 
            control = new ServelInvocing.UI.Controls.ShowSitesTable.SitesTableControl()
            
            Return control.GetAutoCompletionList_SitesSearch(prefixText, count)
