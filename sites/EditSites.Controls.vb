...
' EditSites.aspx page.  The Row or RecordControl classes are the 
...
Namespace ServelInvocing.UI.Controls.EditSites
...
' Base class for the SitesRecordControl control on the EditSites page.
...
Public Class BaseSitesRecordControl
        ...
        Public Overridable Function CreateWhereClause() As WhereClause
            ...
            End If
            HttpContext.Current.Session("QueryString in EditSites") = recId
