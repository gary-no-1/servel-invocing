...
<tr><td class="ticnb" scope="row"><asp:ImageButton runat="server" id="SitesRowViewButton" causesvalidation="False" commandname="Redirect" cssclass="button_link" imageurl="../Images/icon_view.gif" tooltip="&lt;%# GetResourceValue(&quot;Txt:ViewRecord&quot;, &quot;ServelInvocing&quot;) %>">		
	...
	</asp:ImageButton></td><td class="ticwb"><asp:CheckBox runat="server" id="SitesRecordRowSelection" onclick="moveToThisTableRow(this);">	</asp:CheckBox></td><td class="ttc"><asp:LinkButton runat="server" id="id_party" causesvalidation="False" commandname="Redirect"></asp:LinkButton> </td><td class="ttc"><asp:Literal runat="server" id="name"></asp:Literal> </td><td class="ttc"><asp:Literal runat="server" id="address"></asp:Literal> </td><td class="ttc"><asp:Literal runat="server" id="city"></asp:Literal> </td><td class="ttc"><asp:Literal runat="server" id="contact"></asp:Literal> </td><td class="ttc"><asp:Literal runat="server" id="email"></asp:Literal></td><td class="ttc"><asp:Literal runat="server" id="phone"></asp:Literal> </td><td class="ttc"><asp:Literal runat="server" id="pan_no"></asp:Literal> </td><td class="ttc"><asp:Literal runat="server" id="ecc_no"></asp:Literal> </td><td class="ttc"><asp:Literal runat="server" id="tin_no"></asp:Literal> </td></tr></ServelInvocing:SitesTableControlRow>
</ITEMTEMPLATE>
