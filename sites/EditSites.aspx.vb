...
' This file implements the code-behind class for EditSites.aspx.
' EditSites.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class EditSites
        Inherits BaseApplicationPage
' Code-behind class for the EditSites page.
...
#Region "Section 2: Do not modify this section."
        ...
        Public WithEvents SitesRecordControl As ServelInvocing.UI.Controls.EditSites.SitesRecordControl
        ...
        Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            Page.Title = GetResourceValue("Title:Edit") + " Sites"
        End Sub
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.SitesRecordControl.SaveData()
      ...
      End Sub
        ...
        Me.SitesRecordControl.LoadData()
        ...
        Public Sub SaveButton_Click_Base(ByVal sender As Object, ByVal args As EventArgs)
            ...
            If Not TargetKey Is Nothing Then
                ...
                If Not Me.SitesRecordControl Is Nothing AndAlso Not Me.SitesRecordControl.DataSource Is Nothing Then
                      
                      id = Me.SitesRecordControl.DataSource.id0.ToString
                      value = Me.SitesRecordControl.DataSource.GetValue(Me.SitesRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(DFKA)).ToString
                      ...
                      If Not Formula Is Nothing Then
                            value = EvaluateFormula(Formula, Me.SitesRecordControl.DataSource)
                      End If
