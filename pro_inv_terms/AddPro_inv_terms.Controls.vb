...
' AddPro_inv_terms.aspx page.  The Row or RecordControl classes are the 
...
Namespace ServelInvocing.UI.Controls.AddPro_inv_terms
...
' Base class for the Pro_inv_termsRecordControl control on the AddPro_inv_terms page.
...
Public Class BasePro_inv_termsRecordControl
        ...
        Public Overridable Sub LoadData()        
            ...
            Me.DataSource = CType(Pro_inv_termsRecord.Copy(recList(0), False), Pro_inv_termsRecord)
        ...
        Public Overridable Sub GetUIData()
            ...
            For Each col In Pro_inv_termsRecord.TableUtils.TableDefinition.Columns()
        ...
        Public Overridable Function CreateWhereClause() As WhereClause
            ...
            HttpContext.Current.Session("QueryString in AddPro_inv_terms") = recId
...
#Region "Helper Functions"
        ...
        Public Overridable Function GetRecord() As Pro_inv_termsRecord
            ...
            Return New Pro_inv_termsRecord()
