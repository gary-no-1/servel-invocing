...
' This file implements the code-behind class for EditPro_inv_terms.aspx.
' EditPro_inv_terms.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class EditPro_inv_terms
        Inherits BaseApplicationPage
' Code-behind class for the EditPro_inv_terms page.
...
#Region "Section 2: Do not modify this section."
        ...
        Public WithEvents Pro_inv_termsRecordControl As ServelInvocing.UI.Controls.EditPro_inv_terms.Pro_inv_termsRecordControl
        ...
        Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            Page.Title = GetResourceValue("Title:Edit") + " Pro Inv Terms"
        End Sub
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.Pro_inv_termsRecordControl.SaveData()
      ...
      End Sub
        ...
        Me.Pro_inv_termsRecordControl.LoadData()
        ...
        Public Sub SaveButton_Click_Base(ByVal sender As Object, ByVal args As EventArgs)
            ...
            If Not TargetKey Is Nothing Then
                ...
                If Not Me.Pro_inv_termsRecordControl Is Nothing AndAlso Not Me.Pro_inv_termsRecordControl.DataSource Is Nothing Then
                      
                      id = Me.Pro_inv_termsRecordControl.DataSource.id0.ToString
                      value = Me.Pro_inv_termsRecordControl.DataSource.GetValue(Me.Pro_inv_termsRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(DFKA)).ToString
                      ...
                      If Not Formula Is Nothing Then
                            value = EvaluateFormula(Formula, Me.Pro_inv_termsRecordControl.DataSource)
                      End If
