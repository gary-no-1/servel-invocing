...
' ShowPro_inv_terms.aspx page.  The Row or RecordControl classes are the 
...
Namespace ServelInvocing.UI.Controls.ShowPro_inv_terms

#Region "Section 1: Place your customizations here."

    
Public Class Pro_inv_termsRecordControl
        Inherits BasePro_inv_termsRecordControl
        ' The BasePro_inv_termsRecordControl implements the LoadData, DataBind and other
...
' Base class for the Pro_inv_termsRecordControl control on the ShowPro_inv_terms page.
' Do not modify this class. Instead override any method in Pro_inv_termsRecordControl.
Public Class BasePro_inv_termsRecordControl
        Inherits ServelInvocing.UI.BaseApplicationRecordControl

        '  To customize, override this method in Pro_inv_termsRecordControl.
        ...
        Protected Overridable Sub Control_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
              ...
              AddHandler Me.Pro_inv_termsDialogEditButton.Click, AddressOf Pro_inv_termsDialogEditButton_Click
        ...
        Public Overridable Sub LoadData()        
            ...
            Dim Panel As System.Web.UI.WebControls.Panel = CType(MiscUtils.FindControlRecursively(Me, "Pro_inv_termsRecordControlPanel"), System.Web.UI.WebControls.Panel)
            ...
            Dim recList() As Pro_inv_termsRecord = Pro_inv_termsTable.GetRecords(wc, Nothing, 0, 2)
            ...
            Me.DataSource = Pro_inv_termsTable.GetRecord(recList(0).GetID.ToXmlString(), True)
                  
        End Sub

        ' Populate the UI controls using the DataSource.  To customize, override this method in Pro_inv_termsRecordControl.
        ...
        Public Overridable Function CreateWhereClause() As WhereClause
            ...
            Dim recId As String = Me.Page.Request.QueryString.Item("Pro_inv_terms")
                
            If recId Is Nothing OrElse recId.Trim = "" Then
                ' Get the error message from the application resource file.
                Throw New Exception(Page.GetResourceValue("Err:UrlParamMissing", "ServelInvocing").Replace("{URL}", "Pro_inv_terms"))
            End If
            HttpContext.Current.Session("QueryString in ShowPro_inv_terms") = recId
            ...
            If KeyValue.IsXmlKey(recId) Then
                ...
                wc.iAND(Pro_inv_termsTable.id0, BaseFilter.ComparisonOperator.EqualsTo, pkValue.GetColumnValue(Pro_inv_termsTable.id0).ToString())
        
            Else
                ' The URL parameter contains the actual value, not an XML structure.
                
                wc.iAND(Pro_inv_termsTable.id0, BaseFilter.ComparisonOperator.EqualsTo, recId)
        ...
        Public Overridable Sub Pro_inv_termsDialogEditButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
        ...
        Public Overridable Sub id_pro_inv_hdr_Click(ByVal sender As Object, ByVal args As EventArgs)
            ...
            ' Any code after the Response.Redirect call will not be executed, since the page is
            ' redirected to the URL.
            Dim url As String = "../pro_inv_hdr/ShowPro_inv_hdr.aspx?Pro_inv_hdr={Pro_inv_termsRecordControl:FK:pro_inv_terms_pro_inv_hdr_id_pro_inv_hdr_FK}"
            Dim shouldRedirect As Boolean = True
            Dim TargetKey As String = Nothing
            Dim DFKA As String = Nothing
            Dim id As String = Nothing
        ...
        Public Property RecordUniqueId() As String
            Get
                Return CType(Me.ViewState("BasePro_inv_termsRecordControl_Rec"), String)
            End Get
            Set(ByVal value As String)
                Me.ViewState("BasePro_inv_termsRecordControl_Rec") = value
            End Set
        End Property
...
#Region "Helper Properties"
        ...
        Public ReadOnly Property Pro_inv_termsDialogEditButton() As System.Web.UI.WebControls.ImageButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "Pro_inv_termsDialogEditButton"), System.Web.UI.WebControls.ImageButton)
            End Get
        End Property
