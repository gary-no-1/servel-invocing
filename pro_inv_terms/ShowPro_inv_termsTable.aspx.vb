...
' This file implements the code-behind class for ShowPro_inv_termsTable.aspx.
' ShowPro_inv_termsTable.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class ShowPro_inv_termsTable
        Inherits BaseApplicationPage
' Code-behind class for the ShowPro_inv_termsTable page.
...
#Region "Ajax Functions"
      ...
      <Services.WebMethod()> _
      Public Shared Function GetAutoCompletionList_Pro_inv_termsSearch(ByVal prefixText As String, ByVal count As Integer) As String()
      ' GetPro_inv_termsSearchCompletionList gets the list of suggestions from the database.
      ' prefixText is the search text typed by the user .
      ' count specifies the number of suggestions to be returned.
      ' Customize by adding code before or after the call to  GetAutoCompletionList_Pro_inv_termsSearch()
      ' or replace the call to GetAutoCompletionList_Pro_inv_termsSearch().
      Return GetAutoCompletionList_Pro_inv_termsSearch_Base(prefixText, count)
      End Function
...
#Region "Section 2: Do not modify this section."
        ...
        Public WithEvents Pro_inv_termsSearch As System.Web.UI.WebControls.TextBox
        Public WithEvents Pro_inv_termsSearchButton As ThemeButton
        Public WithEvents Pro_inv_termsTableControl As ServelInvocing.UI.Controls.ShowPro_inv_termsTable.Pro_inv_termsTableControl
        Public WithEvents Pro_inv_termsTitle As System.Web.UI.WebControls.Literal
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.Pro_inv_termsTableControl.SaveData()
      ...
      End Sub
        ...
        Public Shared Function GetAutoCompletionList_Pro_inv_termsSearch_Base(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim control as ServelInvocing.UI.Controls.ShowPro_inv_termsTable.Pro_inv_termsTableControl 
            control = new ServelInvocing.UI.Controls.ShowPro_inv_termsTable.Pro_inv_termsTableControl()
            
            Return control.GetAutoCompletionList_Pro_inv_termsSearch(prefixText, count)
        ...
        Me.Pro_inv_termsTableControl.LoadData()
