...
' This file implements the code-behind class for AddTerms.aspx.
' AddTerms.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class AddTerms
        Inherits BaseApplicationPage
' Code-behind class for the AddTerms page.
...
#Region "Section 2: Do not modify this section."
        ...
        Public WithEvents TermsRecordControl As ServelInvocing.UI.Controls.AddTerms.TermsRecordControl
        ...
        Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            Page.Title = GetResourceValue("Title:Add") + " Terms"
        End Sub
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.TermsRecordControl.SaveData()
      ...
      End Sub
        ...
        Me.TermsRecordControl.LoadData()
        ...
        Public Sub SaveButton_Click_Base(ByVal sender As Object, ByVal args As EventArgs)
            ...
            If Not TargetKey Is Nothing Then
                ...
                If Not Me.TermsRecordControl Is Nothing AndAlso Not Me.TermsRecordControl.DataSource Is Nothing Then
                      
                      id = Me.TermsRecordControl.DataSource.id0.ToString
                      value = Me.TermsRecordControl.DataSource.GetValue(Me.TermsRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(DFKA)).ToString
                      ...
                      If Not Formula Is Nothing Then
                            value = EvaluateFormula(Formula, Me.TermsRecordControl.DataSource)
                      End If
