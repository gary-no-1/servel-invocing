...
' This file implements the code-behind class for ShowTerms.aspx.
' ShowTerms.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class ShowTerms
        Inherits BaseApplicationPage
' Code-behind class for the ShowTerms page.
...
#Region "Section 2: Do not modify this section."
        ...
        Public WithEvents TermsRecordControl As ServelInvocing.UI.Controls.ShowTerms.TermsRecordControl
