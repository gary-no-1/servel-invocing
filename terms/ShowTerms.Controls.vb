...
' ShowTerms.aspx page.  The Row or RecordControl classes are the 
...
Namespace ServelInvocing.UI.Controls.ShowTerms

#Region "Section 1: Place your customizations here."

    
Public Class TermsRecordControl
        Inherits BaseTermsRecordControl
        ' The BaseTermsRecordControl implements the LoadData, DataBind and other
...
' Base class for the TermsRecordControl control on the ShowTerms page.
' Do not modify this class. Instead override any method in TermsRecordControl.
Public Class BaseTermsRecordControl
        Inherits ServelInvocing.UI.BaseApplicationRecordControl

        '  To customize, override this method in TermsRecordControl.
        ...
        Protected Overridable Sub Control_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
              ...
              AddHandler Me.TermsDialogEditButton.Click, AddressOf TermsDialogEditButton_Click
        ...
        Public Overridable Sub LoadData()        
            ...
            Dim Panel As System.Web.UI.WebControls.Panel = CType(MiscUtils.FindControlRecursively(Me, "TermsRecordControlPanel"), System.Web.UI.WebControls.Panel)
            ...
            Dim recList() As TermsRecord = TermsTable.GetRecords(wc, Nothing, 0, 2)
            ...
            Me.DataSource = TermsTable.GetRecord(recList(0).GetID.ToXmlString(), True)
                  
        End Sub

        ' Populate the UI controls using the DataSource.  To customize, override this method in TermsRecordControl.
        ...
        Public Overridable Function CreateWhereClause() As WhereClause
            ...
            Dim recId As String = Me.Page.Request.QueryString.Item("Terms")
                
            If recId Is Nothing OrElse recId.Trim = "" Then
                ' Get the error message from the application resource file.
                Throw New Exception(Page.GetResourceValue("Err:UrlParamMissing", "ServelInvocing").Replace("{URL}", "Terms"))
            End If
            HttpContext.Current.Session("QueryString in ShowTerms") = recId
            ...
            If KeyValue.IsXmlKey(recId) Then
                ...
                wc.iAND(TermsTable.id0, BaseFilter.ComparisonOperator.EqualsTo, pkValue.GetColumnValue(TermsTable.id0).ToString())
        
            Else
                ' The URL parameter contains the actual value, not an XML structure.
                
                wc.iAND(TermsTable.id0, BaseFilter.ComparisonOperator.EqualsTo, recId)
        ...
        Public Overridable Sub TermsDialogEditButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
        ...
        Public Property RecordUniqueId() As String
            Get
                Return CType(Me.ViewState("BaseTermsRecordControl_Rec"), String)
            End Get
            Set(ByVal value As String)
                Me.ViewState("BaseTermsRecordControl_Rec") = value
            End Set
        End Property
...
#Region "Helper Properties"
        ...
        Public ReadOnly Property TermsDialogEditButton() As System.Web.UI.WebControls.ImageButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "TermsDialogEditButton"), System.Web.UI.WebControls.ImageButton)
            End Get
        End Property
