<%@ Register Tagprefix="ServelInvocing" Namespace="ServelInvocing.UI.Controls.EditTerms" Assembly="ServelInvocing" %>
...
<%@ Page Language="vb" EnableEventValidation="false" AutoEventWireup="false" Codebehind="EditTerms.aspx.vb" Culture="en-IN" MasterPageFile="../Master Pages/VerticalMenu.master" Inherits="ServelInvocing.UI.EditTerms" %>
