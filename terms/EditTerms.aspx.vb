...
' This file implements the code-behind class for EditTerms.aspx.
' EditTerms.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class EditTerms
        Inherits BaseApplicationPage
' Code-behind class for the EditTerms page.
