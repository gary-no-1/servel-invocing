...
<%@ Page Language="vb" EnableEventValidation="false" AutoEventWireup="false" Codebehind="ShowTerms.aspx.vb" Culture="en-IN" MasterPageFile="../Master Pages/VerticalMenu.master" Inherits="ServelInvocing.UI.ShowTerms" %>
<%@ Register Tagprefix="ServelInvocing" TagName="ThemeButton" Src="../Shared/ThemeButton.ascx" %>

<%@ Register Tagprefix="ServelInvocing" Namespace="ServelInvocing.UI.Controls.ShowTerms" Assembly="ServelInvocing" %>
...
<asp:ImageButton id="TermsRecordControlIcon" runat="server" ToolTip="&lt;%# GetResourceValue(&quot;Btn:ExpandCollapse&quot;) %&gt;" causesvalidation="False" imageurl="../images/icon_panelcollapse.gif" /></td><td class="dhb"><table cellpadding="0" cellspacing="0" border="0"><tr><td class="dht" valign="middle"><asp:Literal runat="server" id="TermsTitle" Text="&lt;%#String.Concat(&quot;Terms&quot;) %>">	</asp:Literal></td><td class="dhir"><asp:ImageButton runat="server" id="TermsDialogEditButton" causesvalidation="False" commandname="Redirect" imageurl="../Images/iconEdit.gif" tooltip="&lt;%# GetResourceValue(&quot;Btn:Edit&quot;, &quot;ServelInvocing&quot;) %>">		
	</asp:ImageButton></td></tr></table>
</td><td class="dher"><img src="../Images/space.gif" alt="" /></td></tr></table>
</td></tr><tr><td><asp:panel id="TermsRecordControlCollapsibleRegion" runat="server"><table class="dBody" cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td><asp:panel id="TermsRecordControlPanel" runat="server"><table cellpadding="0" cellspacing="0" border="0"><tr><td class="fls"><asp:Literal runat="server" id="sort_orderLabel" Text="Sort Order">	</asp:Literal></td><td class="dfv"><asp:Literal runat="server" id="sort_order"></asp:Literal> </td></tr><tr><td class="fls"><asp:Literal runat="server" id="narrationLabel" Text="Narration">	</asp:Literal></td><td class="dfv"><asp:Literal runat="server" id="narration"></asp:Literal> </td></tr><tr><td class="fls"><asp:Literal runat="server" id="print_boldLabel" Text="Print Bold">	</asp:Literal></td><td class="dfv"><asp:Literal runat="server" id="print_bold"></asp:Literal></td></tr></table></asp:panel>
</td></tr></table>
