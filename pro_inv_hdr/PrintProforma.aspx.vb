...
' This file implements the code-behind class for PrintProforma.aspx.
' PrintProforma.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class PrintProforma
        Inherits BaseApplicationPage
' Code-behind class for the PrintProforma page.
