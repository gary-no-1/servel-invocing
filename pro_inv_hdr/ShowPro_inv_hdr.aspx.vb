...
' This file implements the code-behind class for ShowPro_inv_hdr.aspx.
' ShowPro_inv_hdr.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class ShowPro_inv_hdr
        Inherits BaseApplicationPage
' Code-behind class for the ShowPro_inv_hdr page.
