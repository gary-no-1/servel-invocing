...
' This file implements the code-behind class for ShowPro_inv_hdrTable.aspx.
' ShowPro_inv_hdrTable.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class ShowPro_inv_hdrTable
        Inherits BaseApplicationPage
' Code-behind class for the ShowPro_inv_hdrTable page.
...
#Region "Ajax Functions"
      ...
      <Services.WebMethod()> _
      Public Shared Function GetAutoCompletionList_Pro_inv_hdrSearch(ByVal prefixText As String, ByVal count As Integer) As String()
      ' GetPro_inv_hdrSearchCompletionList gets the list of suggestions from the database.
      ' prefixText is the search text typed by the user .
      ' count specifies the number of suggestions to be returned.
      ' Customize by adding code before or after the call to  GetAutoCompletionList_Pro_inv_hdrSearch()
      ' or replace the call to GetAutoCompletionList_Pro_inv_hdrSearch().
      Return GetAutoCompletionList_Pro_inv_hdrSearch_Base(prefixText, count)
      End Function
...
#Region "Section 2: Do not modify this section."
        ...
        Public WithEvents inv_cr8_dtLabel As System.Web.UI.WebControls.LinkButton
        Public WithEvents inv_createdLabel As System.Web.UI.WebControls.LinkButton
        ...
        Public WithEvents po_noLabel As System.Web.UI.WebControls.LinkButton
        Public WithEvents pro_inv_dtLabel As System.Web.UI.WebControls.LinkButton
        Public WithEvents Pro_inv_hdrCopyButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents Pro_inv_hdrDeleteButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents Pro_inv_hdrEditButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents Pro_inv_hdrExportCSVButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents Pro_inv_hdrExportExcelButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents Pro_inv_hdrImportButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents Pro_inv_hdrNewButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents Pro_inv_hdrPagination As Pagination
        Public WithEvents Pro_inv_hdrPDFButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents Pro_inv_hdrRefreshButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents Pro_inv_hdrResetButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents Pro_inv_hdrSearch As System.Web.UI.WebControls.TextBox
        Public WithEvents Pro_inv_hdrSearchButton As ThemeButton
        Public WithEvents Pro_inv_hdrTableControl As ServelInvocing.UI.Controls.ShowPro_inv_hdrTable.Pro_inv_hdrTableControl
        Public WithEvents Pro_inv_hdrTitle As System.Web.UI.WebControls.Literal
        Public WithEvents Pro_inv_hdrToggleAll As System.Web.UI.WebControls.CheckBox
        Public WithEvents Pro_inv_hdrWordButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents pro_inv_noLabel As System.Web.UI.WebControls.LinkButton
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.Pro_inv_hdrTableControl.SaveData()
      ...
      End Sub
        ...
        Public Shared Function GetAutoCompletionList_Pro_inv_hdrSearch_Base(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim control as ServelInvocing.UI.Controls.ShowPro_inv_hdrTable.Pro_inv_hdrTableControl 
            control = new ServelInvocing.UI.Controls.ShowPro_inv_hdrTable.Pro_inv_hdrTableControl()
            
            Return control.GetAutoCompletionList_Pro_inv_hdrSearch(prefixText, count)
        ...
        Me.Pro_inv_hdrTableControl.LoadData()
