...
<asp:LinkButton runat="server" id="sale_ord_dtLabel" Text="Sale Order Dt" CausesValidation="False">	</asp:LinkButton></th><th class="thc" scope="col"><asp:LinkButton runat="server" id="id_partyLabel1" Text="Party" CausesValidation="False">	</asp:LinkButton>
                        </th><th class="thc" scope="col"><asp:LinkButton runat="server" id="po_noLabel" Text="P.O. No." CausesValidation="False">	</asp:LinkButton> <br>
<asp:LinkButton runat="server" id="po_dtLabel" Text="P.O. Dt" CausesValidation="False">	</asp:LinkButton></th><th class="thc" scope="col"><asp:LinkButton runat="server" id="id_tax_groupLabel1" Text="Tax Code" CausesValidation="False">	</asp:LinkButton>
