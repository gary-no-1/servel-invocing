...
</td></tr><tr><td class="tre"><table cellpadding="0" cellspacing="0" border="0" width="100%" onkeydown="captureUpDownKey(this, event)"><tr class="tch"><th class="thcnb" colspan="4"><img src="../Images/space.gif" height="1" width="1" alt="" /></th><th class="thcwb" style="padding:0px;vertical-align:middle;"><asp:CheckBox runat="server" id="Pro_inv_hdrToggleAll" onclick="toggleAllCheckboxes(this);">	</asp:CheckBox></th><th class="thc" scope="col"><asp:LinkButton runat="server" id="pro_inv_noLabel" Text="Pro Inv Number" CausesValidation="False">	</asp:LinkButton> <br>
<asp:LinkButton runat="server" id="pro_inv_dtLabel" Text="Pro Inv Date" CausesValidation="False">	</asp:LinkButton></th><th class="thc" scope="col"><asp:LinkButton runat="server" id="sale_ord_noLabel" Text="Sale Order Number" CausesValidation="False">	</asp:LinkButton><br>
<asp:LinkButton runat="server" id="sale_ord_dtLabel" Text="Sale Order Date" CausesValidation="False">	</asp:LinkButton></th><th class="thc" scope="col"><asp:LinkButton runat="server" id="id_partyLabel1" Text="Party" CausesValidation="False">	</asp:LinkButton>
                        ...
                        </th><th class="thc" scope="col"><asp:LinkButton runat="server" id="po_noLabel" Text="P.O. Number" CausesValidation="False">	</asp:LinkButton> <br>
...
<tr><td class="ticnb" scope="row"><asp:ImageButton runat="server" id="Pro_inv_hdrRowViewButton" causesvalidation="False" commandname="Redirect" cssclass="button_link" imageurl="../Images/icon_view.gif" tooltip="&lt;%# GetResourceValue(&quot;Txt:ViewRecord&quot;, &quot;ServelInvocing&quot;) %>">		
	...
	</asp:ImageButton></td><td class="ticwb"><asp:CheckBox runat="server" id="Pro_inv_hdrRecordRowSelection" onclick="moveToThisTableRow(this);">	</asp:CheckBox></td><td class="ttc"><asp:Literal runat="server" id="pro_inv_no"></asp:Literal>  <br>
<asp:Literal runat="server" id="pro_inv_dt"></asp:Literal></td><td class="ttc"><asp:Literal runat="server" id="sale_ord_no"></asp:Literal> <br> 
<asp:Literal runat="server" id="sale_ord_dt"></asp:Literal></td><td class="ttc"><asp:LinkButton runat="server" id="id_party" causesvalidation="False" commandname="Redirect"></asp:LinkButton> </td><td class="ttc"><asp:Literal runat="server" id="bill_name"></asp:Literal> </td><td class="ttc"><asp:Literal runat="server" id="bill_address"></asp:Literal> </td><td class="ttc"><asp:Literal runat="server" id="ship_name"></asp:Literal> </td><td class="ttc"><asp:Literal runat="server" id="ship_address"></asp:Literal> </td><td class="ttc"><asp:Literal runat="server" id="tin_no"></asp:Literal> </td><td class="ttc"><asp:Literal runat="server" id="po_no"></asp:Literal>  <br>
<asp:Literal runat="server" id="po_dt"></asp:Literal></td><td class="ttc"><asp:LinkButton runat="server" id="id_tax_group" causesvalidation="False" commandname="Redirect"></asp:LinkButton> </td></tr></ServelInvocing:Pro_inv_hdrTableControlRow>
</ITEMTEMPLATE>
