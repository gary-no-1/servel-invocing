...
</td><td class="fls"><asp:Literal runat="server" id="id_siteLabel" Text="Site">	</asp:Literal></td><td class="dfv"><asp:DropDownList runat="server" id="id_site" cssclass="field_input" onkeypress="dropDownListTypeAhead(this,false)"></asp:DropDownList>
