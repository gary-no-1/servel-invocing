...
' This file implements the code-behind class for EmailPro_inv_hdr.aspx.
' EmailPro_inv_hdr.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class EmailPro_inv_hdr
        Inherits BaseApplicationPage
' Code-behind class for the EmailPro_inv_hdr page.
' Place your customizations in Section 1. Do not modify Section 2.
        
#Region "Section 1: Place your customizations here."
		Protected Overrides Sub UpdateSessionNavigationHistory()
			'Do nothing
			' this helps in not updating session navigation history. so when OK button is clicked on showPro_Inv_hdr ,
			' it goes back to showPro_Inv_hdrTable
		End Sub
...
#Region "Section 2: Do not modify this section."
        ...
        Public WithEvents Pro_inv_hdrRecordControl As ServelInvocing.UI.Controls.EmailPro_inv_hdr.Pro_inv_hdrRecordControl
        Public WithEvents Pro_inv_hdrTitle As System.Web.UI.WebControls.Literal
        Public WithEvents Pro_inv_itemsTableControl As ServelInvocing.UI.Controls.EmailPro_inv_hdr.Pro_inv_itemsTableControl
        ...
        Public WithEvents Pro_inv_taxesTableControl As ServelInvocing.UI.Controls.EmailPro_inv_hdr.Pro_inv_taxesTableControl
