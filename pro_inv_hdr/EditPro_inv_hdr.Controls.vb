...
' EditPro_inv_hdr.aspx page.  The Row or RecordControl classes are the 
...
Namespace ServelInvocing.UI.Controls.EditPro_inv_hdr
...
' Base class for the Pro_inv_itemsTableControlRow control on the EditPro_inv_hdr page.
...
Public Class BasePro_inv_itemsTableControlRow
        ...
        Public Overridable Sub Setamount()
            ...
            If Me.DataSource IsNot Nothing AndAlso Me.DataSource.IsCreated Then
                ...
                ' The Format method will use the Display Format
                        Dim formattedValue As String = EvaluateFormula("FORMAT(Round(PARSEDECIMAL(Pro_inv_itemsTableControlRow.qty.Text) *PARSEDECIMAL(Pro_inv_itemsTableControlRow.rate.Text) ,0) , ""c"")", Me.DataSource)
...
' Base class for the Pro_inv_itemsTableControl control on the EditPro_inv_hdr page.
...
' Base class for the Pro_inv_taxesTableControlRow control on the EditPro_inv_hdr page.
...
Public Class BasePro_inv_taxesTableControlRow
        ...
        Public Overridable Sub Setsort_order()
            ...
            Else 
                ...
                Me.sort_order.Text = Pro_inv_taxesTable.sort_order.Format(Pro_inv_taxesTable.sort_order.DefaultValue)
        ...
        Public Overridable Sub Getsort_order()
            ...
            'Save the value to data source
            Me.DataSource.Parse(Me.sort_order.Text, Pro_inv_taxesTable.sort_order)			
...
' Base class for the Pro_inv_taxesTableControl control on the EditPro_inv_hdr page.
...
' Base class for the Pro_inv_termsTableControlRow control on the EditPro_inv_hdr page.
...
Public Class BasePro_inv_termsTableControlRow
        ...
        Public Overridable Sub Setsort_order1()
            ...
            Else 
                ...
                Me.sort_order1.Text = Pro_inv_termsTable.sort_order.Format(Pro_inv_termsTable.sort_order.DefaultValue)
        ...
        Public Overridable Sub Getsort_order1()
            ...
            'Save the value to data source
            Me.DataSource.Parse(Me.sort_order1.Text, Pro_inv_termsTable.sort_order)			
...
' Base class for the Pro_inv_termsTableControl control on the EditPro_inv_hdr page.
                ...
                For Each repItem In rep.Items
                    ...
                    If recControl.Visible AndAlso recControl.IsNewRecord() Then
                        ...
                        If recControl.sort_order1.Text <> "" Then
                            rec.Parse(recControl.sort_order1.Text, Pro_inv_termsTable.sort_order)
                        End If
                        newUIDataList.Add(recControl.PreservedUIData())	  
                        newRecordList.Add(rec)
                    End If
...
' Base class for the Pro_inv_hdrRecordControl control on the EditPro_inv_hdr page.
...
Public Class BasePro_inv_hdrRecordControl
        ...
        Public Overridable Sub Setparty_state()
            ...
            If Me.DataSource IsNot Nothing AndAlso Me.DataSource.party_stateSpecified Then
                ...
                ' The Format method will use the Display Format
                                Dim formattedValue As String = Me.DataSource.Format(Pro_inv_hdrTable.party_state)
            ...
            Else 
                ...
                Me.party_state.Text = Pro_inv_hdrTable.party_state.Format(Pro_inv_hdrTable.party_state.DefaultValue)
        ...
        Public Overridable Sub Setsite_state()
            ...
            If Me.DataSource IsNot Nothing AndAlso Me.DataSource.site_stateSpecified Then
                ...
                ' The Format method will use the Display Format
                                Dim formattedValue As String = Me.DataSource.Format(Pro_inv_hdrTable.site_state)
            ...
            Else 
                ...
                Me.site_state.Text = Pro_inv_hdrTable.site_state.Format(Pro_inv_hdrTable.site_state.DefaultValue)
        ...
        Public Overridable Sub Getecc_no()
            ...
            ' save it into the ecc_no field in DataSource pro_inv_hdr record.
            
            ' Custom validation should be performed in Validate, not here.
            
            'Save the value to data source
            Me.DataSource.Parse(Me.ecc_no.Text, Pro_inv_hdrTable.ecc_no)			
        ...
        Public Overridable Sub Getexcise_remark()
            ...
            ' save it into the excise_remark field in DataSource pro_inv_hdr record.
            
            ' Custom validation should be performed in Validate, not here.
            
            'Save the value to data source
            Me.DataSource.Parse(Me.excise_remark.Text, Pro_inv_hdrTable.excise_remark)			
        ...
        Public Overridable Sub Getparty_state()
            ...
            ' save it into the party_state field in DataSource pro_inv_hdr record.
            
            ' Custom validation should be performed in Validate, not here.
            
            'Save the value to data source
            Me.DataSource.Parse(Me.party_state.Text, Pro_inv_hdrTable.party_state)			
        ...
        Public Overridable Sub Getremark()
            ...
            ' save it into the remark field in DataSource pro_inv_hdr record.
            
            ' Custom validation should be performed in Validate, not here.
            
            'Save the value to data source
            Me.DataSource.Parse(Me.remark.Text, Pro_inv_hdrTable.remark)			
        ...
        Public Overridable Sub Getsite_state()
            ...
            ' save it into the site_state field in DataSource pro_inv_hdr record.
        ...
        Public Overridable Function CreateWhereClause() As WhereClause
            ...
            End If
            HttpContext.Current.Session("QueryString in EditPro_inv_hdr") = recId
