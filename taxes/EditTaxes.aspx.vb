...
' This file implements the code-behind class for EditTaxes.aspx.
' EditTaxes.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class EditTaxes
        Inherits BaseApplicationPage
' Code-behind class for the EditTaxes page.
...
#Region "Section 2: Do not modify this section."
        ...
        Public WithEvents TaxesRecordControl As ServelInvocing.UI.Controls.EditTaxes.TaxesRecordControl
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.TaxesRecordControl.SaveData()
      ...
      End Sub
        ...
        Me.TaxesRecordControl.LoadData()
        ...
        Public Sub SaveButton_Click_Base(ByVal sender As Object, ByVal args As EventArgs)
            ...
            If Not TargetKey Is Nothing Then
                ...
                If Not Me.TaxesRecordControl Is Nothing AndAlso Not Me.TaxesRecordControl.DataSource Is Nothing Then
                      
                      id = Me.TaxesRecordControl.DataSource.id0.ToString
                      value = Me.TaxesRecordControl.DataSource.GetValue(Me.TaxesRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(DFKA)).ToString
                      ...
                      If Not Formula Is Nothing Then
                            value = EvaluateFormula(Formula, Me.TaxesRecordControl.DataSource)
                      End If
