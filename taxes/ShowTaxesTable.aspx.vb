...
' This file implements the code-behind class for ShowTaxesTable.aspx.
' ShowTaxesTable.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class ShowTaxesTable
        Inherits BaseApplicationPage
' Code-behind class for the ShowTaxesTable page.
...
#Region "Ajax Functions"
      ...
      <Services.WebMethod()> _
      Public Shared Function GetAutoCompletionList_TaxesSearch(ByVal prefixText As String, ByVal count As Integer) As String()
      ' GetTaxesSearchCompletionList gets the list of suggestions from the database.
      ' prefixText is the search text typed by the user .
      ' count specifies the number of suggestions to be returned.
      ' Customize by adding code before or after the call to  GetAutoCompletionList_TaxesSearch()
      ' or replace the call to GetAutoCompletionList_TaxesSearch().
      Return GetAutoCompletionList_TaxesSearch_Base(prefixText, count)
      End Function
...
#Region "Section 2: Do not modify this section."
        ...
        Public WithEvents TaxesCopyButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents TaxesDeleteButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents TaxesEditButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents TaxesExportCSVButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents TaxesExportExcelButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents TaxesImportButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents TaxesNewButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents TaxesPagination As Pagination
        Public WithEvents TaxesPDFButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents TaxesRefreshButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents TaxesResetButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents TaxesSearch As System.Web.UI.WebControls.TextBox
        Public WithEvents TaxesSearchButton As ThemeButton
        Public WithEvents TaxesTableControl As ServelInvocing.UI.Controls.ShowTaxesTable.TaxesTableControl
        Public WithEvents TaxesTitle As System.Web.UI.WebControls.Literal
        Public WithEvents TaxesToggleAll As System.Web.UI.WebControls.CheckBox
        Public WithEvents TaxesWordButton As System.Web.UI.WebControls.ImageButton
    ...
    End Function
      ...
      End Sub
        ...
        Public Shared Function GetAutoCompletionList_TaxesSearch_Base(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim control as ServelInvocing.UI.Controls.ShowTaxesTable.TaxesTableControl 
            control = new ServelInvocing.UI.Controls.ShowTaxesTable.TaxesTableControl()
            
            Return control.GetAutoCompletionList_TaxesSearch(prefixText, count)
