...
' AddTaxes.aspx page.  The Row or RecordControl classes are the 
...
Namespace ServelInvocing.UI.Controls.AddTaxes
...
' Base class for the TaxesRecordControl control on the AddTaxes page.
...
Public Class BaseTaxesRecordControl
        ...
        Public Overridable Sub LoadData()        
            ...
            Me.DataSource = CType(TaxesRecord.Copy(recList(0), False), TaxesRecord)
        ...
        Public Overridable Sub GetUIData()
            ...
            For Each col In TaxesRecord.TableUtils.TableDefinition.Columns()
        ...
        Public Overridable Function CreateWhereClause() As WhereClause
            ...
            HttpContext.Current.Session("QueryString in AddTaxes") = recId
