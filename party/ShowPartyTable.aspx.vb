...
' This file implements the code-behind class for ShowPartyTable.aspx.
' ShowPartyTable.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class ShowPartyTable
        Inherits BaseApplicationPage
' Code-behind class for the ShowPartyTable page.
...
#Region "Ajax Functions"
      ...
      <Services.WebMethod()> _
      Public Shared Function GetAutoCompletionList_PartySearch(ByVal prefixText As String, ByVal count As Integer) As String()
      ' GetPartySearchCompletionList gets the list of suggestions from the database.
      ' prefixText is the search text typed by the user .
      ' count specifies the number of suggestions to be returned.
      ' Customize by adding code before or after the call to  GetAutoCompletionList_PartySearch()
      ' or replace the call to GetAutoCompletionList_PartySearch().
      Return GetAutoCompletionList_PartySearch_Base(prefixText, count)
      End Function
...
#Region "Section 2: Do not modify this section."
        ...
        Public WithEvents PartyCopyButton As System.Web.UI.WebControls.ImageButton
        ...
        Public WithEvents PartyExportCSVButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents PartyExportExcelButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents PartyImportButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents PartyNewButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents PartyPagination As Pagination
        Public WithEvents PartyPDFButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents PartyRefreshButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents PartyResetButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents PartySearch As System.Web.UI.WebControls.TextBox
        Public WithEvents PartySearchButton As ThemeButton
        Public WithEvents PartyTableControl As ServelInvocing.UI.Controls.ShowPartyTable.PartyTableControl
        ...
        Public WithEvents PartyWordButton As System.Web.UI.WebControls.ImageButton
    ...
    End Function
      ...
      End Sub
        ...
        Public Shared Function GetAutoCompletionList_PartySearch_Base(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim control as ServelInvocing.UI.Controls.ShowPartyTable.PartyTableControl 
            control = new ServelInvocing.UI.Controls.ShowPartyTable.PartyTableControl()
            
            Return control.GetAutoCompletionList_PartySearch(prefixText, count)
        ...
        Me.PartyTableControl.LoadData()
                ...
                If Not pageMaster is Nothing Then
                    ...
                    If Not menuComponent is Nothing Then
                        menuComponent.HiliteSettings = "PartyMenuItem"
                    End If
                End If
