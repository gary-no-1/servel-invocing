...
' This file implements the code-behind class for ShowParty.aspx.
' ShowParty.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class ShowParty
        Inherits BaseApplicationPage
' Code-behind class for the ShowParty page.
...
#Region "Section 2: Do not modify this section."
        ...
        Public WithEvents SitesTableControl As ServelInvocing.UI.Controls.ShowParty.SitesTableControl
