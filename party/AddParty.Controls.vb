...
' AddParty.aspx page.  The Row or RecordControl classes are the 
...
Namespace ServelInvocing.UI.Controls.AddParty
...
' Base class for the SitesTableControlRow control on the AddParty page.
...
' Base class for the SitesTableControl control on the AddParty page.
...
' Base class for the PartyRecordControl control on the AddParty page.
...
Public Class BasePartyRecordControl
        ...
        Public Overridable Sub LoadData()        
            ...
            Me.DataSource = CType(PartyRecord.Copy(recList(0), False), PartyRecord)
        ...
        Public Overridable Sub GetUIData()
            ...
            For Each col In PartyRecord.TableUtils.TableDefinition.Columns()
        ...
        Public Overridable Function CreateWhereClause() As WhereClause
            ...
            HttpContext.Current.Session("QueryString in AddParty") = recId
