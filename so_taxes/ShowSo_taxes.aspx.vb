...
' This file implements the code-behind class for ShowSo_taxes.aspx.
' ShowSo_taxes.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class ShowSo_taxes
        Inherits BaseApplicationPage
' Code-behind class for the ShowSo_taxes page.
...
#Region "Section 2: Do not modify this section."
        ...
        Public WithEvents So_taxesDialogEditButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents So_taxesRecordControl As ServelInvocing.UI.Controls.ShowSo_taxes.So_taxesRecordControl
        Public WithEvents So_taxesTitle As System.Web.UI.WebControls.Literal
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.So_taxesRecordControl.SaveData()
      ...
      End Sub
        ...
        Me.So_taxesRecordControl.LoadData()
