...
' This file implements the code-behind class for ShowRoles.aspx.
' ShowRoles.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class ShowRoles
        Inherits BaseApplicationPage
' Code-behind class for the ShowRoles page.
