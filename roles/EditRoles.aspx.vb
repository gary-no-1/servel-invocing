...
' This file implements the code-behind class for EditRoles.aspx.
' EditRoles.Controls.vb contains the Table, Row and Record control classes
...
' Code-behind class for the EditRoles page.
...
#Region "Section 2: Do not modify this section."
        ...
        Public WithEvents RolesRecordControl As ServelInvocing.UI.Controls.EditRoles.RolesRecordControl
        ...
        Public WithEvents UsersTableControl As ServelInvocing.UI.Controls.EditRoles.UsersTableControl
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.RolesRecordControl.SaveData()
      ...
      End Sub
        ...
        Me.RolesRecordControl.LoadData()
            ...
            If Not TargetKey Is Nothing Then
                ...
                If Not Me.RolesRecordControl Is Nothing AndAlso Not Me.RolesRecordControl.DataSource Is Nothing Then
                      ...
                      If Not Formula Is Nothing Then
                            value = EvaluateFormula(Formula, Me.RolesRecordControl.DataSource)
                      End If
