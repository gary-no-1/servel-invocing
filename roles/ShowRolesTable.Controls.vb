...
' ShowRolesTable.aspx page.  The Row or RecordControl classes are the 
...
Namespace ServelInvocing.UI.Controls.ShowRolesTable
...
' Base class for the RolesTableControlRow control on the ShowRolesTable page.
...
Public Class BaseRolesTableControlRow
        ...
        Protected Overridable Sub Control_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
			...
			Me.Page.LoadFocusScripts(Me)
              ...
              AddHandler Me.RolesRowCopyButton.Click, AddressOf RolesRowCopyButton_Click
        ...
        Public Overridable Sub RolesRowCopyButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
            ...
            Dim url As String = "../roles/AddRoles.aspx?Roles={PK}"
...
#Region "Helper Properties"
        ...
        Public ReadOnly Property RolesRowCopyButton() As System.Web.UI.WebControls.ImageButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "RolesRowCopyButton"), System.Web.UI.WebControls.ImageButton)
            End Get
        End Property
...
' Base class for the RolesTableControl control on the ShowRolesTable page.
...
Public Class BaseRolesTableControl
        ...
        Protected Overridable Sub Control_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            ' Setup the button events.
              ...
              AddHandler Me.RolesCopyButton.Click, AddressOf RolesCopyButton_Click
              ...
              AddHandler Me.RolesExportCSVButton.Click, AddressOf RolesExportCSVButton_Click
              
              AddHandler Me.RolesExportExcelButton.Click, AddressOf RolesExportExcelButton_Click
              
              AddHandler Me.RolesImportButton.Click, AddressOf RolesImportButton_Click
              
              AddHandler Me.RolesNewButton.Click, AddressOf RolesNewButton_Click
              
              AddHandler Me.RolesPDFButton.Click, AddressOf RolesPDFButton_Click
              ...
              AddHandler Me.RolesWordButton.Click, AddressOf RolesWordButton_Click
      ...
      End Sub
        ...
        Public Overridable Sub RegisterPostback()
              ...
              Me.Page.RegisterPostBackTrigger(MiscUtils.FindControlRecursively(Me,"RolesExportCSVButton"))
                        
              Me.Page.RegisterPostBackTrigger(MiscUtils.FindControlRecursively(Me,"RolesExportExcelButton"))
                        
              Me.Page.RegisterPostBackTrigger(MiscUtils.FindControlRecursively(Me,"RolesPDFButton"))
                        
              Me.Page.RegisterPostBackTrigger(MiscUtils.FindControlRecursively(Me,"RolesWordButton"))
      ...
      Me.SaveToSession("RolesSearch_Ajax", Me.RolesSearch.Text)
        ...
        ' event handler for ImageButton
        Public Overridable Sub RolesCopyButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
      ...
      Me.Page.CommitTransaction(sender)
        ...
        ' event handler for ImageButton
        Public Overridable Sub RolesExportCSVButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
        ...
        ' event handler for ImageButton
        Public Overridable Sub RolesExportExcelButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
            ...
            Dim excelReport As ExportDataToExcel = New ExportDataToExcel(RolesTable.Instance, wc, orderBy)
            ' Add each of the columns in order of export.
        ...
        ' event handler for ImageButton
        Public Overridable Sub RolesImportButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
            ...
            ' Any code after the Response.Redirect call will not be executed, since the page is
            ' redirected to the URL.
            Dim url As String = "../Shared/SelectFileToImport.aspx?TableName=Roles"
            Try
                ' Enclose all database retrieval/update code within a Transaction boundary
                DbUtils.StartTransaction
        ...
        ' event handler for ImageButton
        Public Overridable Sub RolesNewButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
            ...
            ' Any code after the Response.Redirect call will not be executed, since the page is
            ' redirected to the URL.
            Dim url As String = "../roles/AddRoles.aspx"
            Dim shouldRedirect As Boolean = True
            Dim TargetKey As String = Nothing
            Dim DFKA As String = Nothing
            Dim id As String = Nothing
        ...
        ' event handler for ImageButton
        Public Overridable Sub RolesPDFButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
            ...
            Try
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowRolesTable.RolesPDFButton.report")
                ' report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "roles"
                ' If ShowRolesTable.RolesPDFButton.report specifies a valid report template,
                ...
                Dim totalRows As Integer = RolesTable.GetRecordCount(whereClause)
                Dim columns As ColumnList = RolesTable.GetColumnList()
                Dim records As RolesRecord() = Nothing
            
                Do 
                    
                    records = RolesTable.GetRecords(whereClause, orderBy, pageNum, rowsPerQuery)
                    If Not (records Is Nothing) AndAlso records.Length > 0 AndAlso whereClause.RunQuery Then 
                        For Each record As RolesRecord In records 
        ...
        ' event handler for ImageButton
        Public Overridable Sub RolesWordButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
            ...
            Try
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowRolesTable.RolesWordButton.word")
                ' report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "roles"
                ' If ShowRolesTable.RolesWordButton.report specifies a valid report template,
                ' AddColumn method will generate a report template.
                ' Each AddColumn method-call specifies a column
                ' The 1st parameter represents the text of the column header
                ' The 2nd parameter represents the horizontal alignment of the column header
...
#Region "Helper Properties"
        ...
        Public ReadOnly Property RolesCopyButton() As System.Web.UI.WebControls.ImageButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "RolesCopyButton"), System.Web.UI.WebControls.ImageButton)
            End Get
        End Property
        ...
        Public ReadOnly Property RolesExportCSVButton() As System.Web.UI.WebControls.ImageButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "RolesExportCSVButton"), System.Web.UI.WebControls.ImageButton)
            End Get
        End Property
        
        Public ReadOnly Property RolesExportExcelButton() As System.Web.UI.WebControls.ImageButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "RolesExportExcelButton"), System.Web.UI.WebControls.ImageButton)
            End Get
        End Property
        
        Public ReadOnly Property RolesImportButton() As System.Web.UI.WebControls.ImageButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "RolesImportButton"), System.Web.UI.WebControls.ImageButton)
            End Get
        End Property
        
        Public ReadOnly Property RolesNewButton() As System.Web.UI.WebControls.ImageButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "RolesNewButton"), System.Web.UI.WebControls.ImageButton)
            End Get
        End Property
        ...
        Public ReadOnly Property RolesPDFButton() As System.Web.UI.WebControls.ImageButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "RolesPDFButton"), System.Web.UI.WebControls.ImageButton)
            End Get
        End Property
        ...
        Public ReadOnly Property RolesWordButton() As System.Web.UI.WebControls.ImageButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "RolesWordButton"), System.Web.UI.WebControls.ImageButton)
            End Get
        End Property
