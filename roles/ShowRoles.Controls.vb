...
Public Class BaseRolesRecordControl
        ...
        Public Overridable Function CreateWhereClause() As WhereClause
            ...
            If KeyValue.IsXmlKey(recId) Then
                ...
                wc.iAND(RolesTable.id0, BaseFilter.ComparisonOperator.EqualsTo, pkValue.GetColumnValue(RolesTable.id0).ToString())
        
            Else
                ' The URL parameter contains the actual value, not an XML structure.
                
                wc.iAND(RolesTable.id0, BaseFilter.ComparisonOperator.EqualsTo, recId)
