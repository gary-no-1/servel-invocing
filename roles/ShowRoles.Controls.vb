...
' ShowRoles.aspx page.  The Row or RecordControl classes are the 
...
Namespace ServelInvocing.UI.Controls.ShowRoles
...
' Base class for the UsersTableControlRow control on the ShowRoles page.
...
' Base class for the UsersTableControl control on the ShowRoles page.
      ...
      Me.Page.CommitTransaction(sender)
        ...
        Public Overridable Sub UsersPDFButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
            ...
            Try
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowRoles.UsersPDFButton.report")
                ' report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "users"
                ' If ShowRoles.UsersPDFButton.report specifies a valid report template,
        ...
        Public Overridable Sub UsersRefreshButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
            ...
            Dim RolesRecordControlObj as RolesRecordControl = DirectCast(Me.Page.FindControlRecursively("RolesRecordControl"), RolesRecordControl)
            RolesRecordControlObj.ResetData = True
        ...
        Public Overridable Sub UsersWordButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
            ...
            Try
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowRoles.UsersWordButton.word")
                ' report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "users"
                ' If ShowRoles.UsersWordButton.report specifies a valid report template,
                ' AddColumn method will generate a report template.
                ' Each AddColumn method-call specifies a column
                ' The 1st parameter represents the text of the column header
                ' The 2nd parameter represents the horizontal alignment of the column header
...
' Base class for the RolesRecordControl control on the ShowRoles page.
...
Public Class BaseRolesRecordControl
        ...
        Protected Overridable Sub Control_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
              ...
              AddHandler Me.RolesDialogEditButton.Click, AddressOf RolesDialogEditButton_Click
        ...
        Public Overridable Sub LoadData()        
            ...
            Dim Panel As System.Web.UI.WebControls.Panel = CType(MiscUtils.FindControlRecursively(Me, "RolesRecordControlPanel"), System.Web.UI.WebControls.Panel)
            ...
            Me.DataSource = RolesTable.GetRecord(recList(0).GetID.ToXmlString(), True)
        ...
        Public Overridable Function CreateWhereClause() As WhereClause
            ...
            If recId Is Nothing OrElse recId.Trim = "" Then
                ' Get the error message from the application resource file.
                Throw New Exception(Page.GetResourceValue("Err:UrlParamMissing", "ServelInvocing").Replace("{URL}", "Roles"))
            End If
            HttpContext.Current.Session("QueryString in ShowRoles") = recId
        ...
        ' event handler for ImageButton
        Public Overridable Sub RolesDialogEditButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
...
#Region "Helper Properties"
        ...
        Public ReadOnly Property RolesDialogEditButton() As System.Web.UI.WebControls.ImageButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "RolesDialogEditButton"), System.Web.UI.WebControls.ImageButton)
            End Get
        End Property
