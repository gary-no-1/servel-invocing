...
' EditRoles.aspx page.  The Row or RecordControl classes are the 
...
Namespace ServelInvocing.UI.Controls.EditRoles
...
' Base class for the RolesRecordControl control on the EditRoles page.
...
Public Class BaseRolesRecordControl
        ...
        Public Overridable Function CreateWhereClause() As WhereClause
            ...
            End If
            HttpContext.Current.Session("QueryString in EditRoles") = recId
