...
' This file implements the code-behind class for ShowUnitsofmeasureTable.aspx.
' ShowUnitsofmeasureTable.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class ShowUnitsofmeasureTable
        Inherits BaseApplicationPage
' Code-behind class for the ShowUnitsofmeasureTable page.
...
#Region "Ajax Functions"
      ...
      <Services.WebMethod()> _
      Public Shared Function GetAutoCompletionList_UnitsofmeasureSearch(ByVal prefixText As String, ByVal count As Integer) As String()
      ' GetUnitsofmeasureSearchCompletionList gets the list of suggestions from the database.
      ' prefixText is the search text typed by the user .
      ' count specifies the number of suggestions to be returned.
      ' Customize by adding code before or after the call to  GetAutoCompletionList_UnitsofmeasureSearch()
      ' or replace the call to GetAutoCompletionList_UnitsofmeasureSearch().
      Return GetAutoCompletionList_UnitsofmeasureSearch_Base(prefixText, count)
      End Function
...
#Region "Section 2: Do not modify this section."
        ...
        Public WithEvents UnitsofmeasureCopyButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents UnitsofmeasureDeleteButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents UnitsofmeasureEditButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents UnitsofmeasureExportCSVButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents UnitsofmeasureExportExcelButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents UnitsofmeasureImportButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents UnitsofmeasureNewButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents UnitsofmeasurePagination As Pagination
        Public WithEvents UnitsofmeasurePDFButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents UnitsofmeasureRefreshButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents UnitsofmeasureResetButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents UnitsofmeasureSearch As System.Web.UI.WebControls.TextBox
        Public WithEvents UnitsofmeasureSearchButton As ThemeButton
        Public WithEvents UnitsofmeasureTableControl As ServelInvocing.UI.Controls.ShowUnitsofmeasureTable.UnitsofmeasureTableControl
        Public WithEvents UnitsofmeasureTitle As System.Web.UI.WebControls.Literal
        Public WithEvents UnitsofmeasureToggleAll As System.Web.UI.WebControls.CheckBox
        Public WithEvents UnitsofmeasureWordButton As System.Web.UI.WebControls.ImageButton
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.UnitsofmeasureTableControl.SaveData()
      ...
      End Sub
        ...
        Public Shared Function GetAutoCompletionList_UnitsofmeasureSearch_Base(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim control as ServelInvocing.UI.Controls.ShowUnitsofmeasureTable.UnitsofmeasureTableControl 
            control = new ServelInvocing.UI.Controls.ShowUnitsofmeasureTable.UnitsofmeasureTableControl()
            
            Return control.GetAutoCompletionList_UnitsofmeasureSearch(prefixText, count)
        ...
        Me.UnitsofmeasureTableControl.LoadData()
                ...
                If Not pageMaster is Nothing Then
                    ...
                    If Not menuComponent is Nothing Then
                        menuComponent.HiliteSettings = "UnitsofmeasureMenuItem"
                    End If
                End If
