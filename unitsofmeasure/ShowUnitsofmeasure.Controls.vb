...
' ShowUnitsofmeasure.aspx page.  The Row or RecordControl classes are the 
...
Namespace ServelInvocing.UI.Controls.ShowUnitsofmeasure
...
Public Class UnitsofmeasureRecordControl
        Inherits BaseUnitsofmeasureRecordControl
        ' The BaseUnitsofmeasureRecordControl implements the LoadData, DataBind and other
...
' Base class for the ItemsTableControlRow control on the ShowUnitsofmeasure page.
...
Public Class BaseItemsTableControlRow
        ...
        Dim parentCtrl As UnitsofmeasureRecordControl
          
          
          parentCtrl = DirectCast(Me.Page.FindControlRecursively("UnitsofmeasureRecordControl"), UnitsofmeasureRecordControl)				  
          ...
          If (Not IsNothing(parentCtrl) AndAlso IsNothing(parentCtrl.DataSource)) 
            ...
            Me.DataSource.uom = parentCtrl.DataSource.uom
...
' Base class for the ItemsTableControl control on the ShowUnitsofmeasure page.
...
Public Class BaseItemsTableControl
      ...
      Dim selectedRecordKeyValue as KeyValue = New KeyValue()
              ...
              Dim unitsofmeasureRecordControlObj As UnitsofmeasureRecordControl = DirectCast(MiscUtils.FindControlRecursively(Me.Page, "UnitsofmeasureRecordControl"), UnitsofmeasureRecordControl)
              
                If (Not IsNothing(unitsofmeasureRecordControlObj) AndAlso Not IsNothing(unitsofmeasureRecordControlObj.GetRecord()) AndAlso Not IsNothing(unitsofmeasureRecordControlObj.GetRecord().uom))
                    wc.iAND(ItemsTable.uom, BaseFilter.ComparisonOperator.EqualsTo, unitsofmeasureRecordControlObj.GetRecord().uom.ToString())
                    selectedRecordKeyValue.AddElement(ItemsTable.uom.InternalName, unitsofmeasureRecordControlObj.GetRecord().uom.ToString())
                Else
                    wc.RunQuery = False
                    Return wc
                End If
      ...
      HttpContext.Current.Session("ItemsTableControlWhereClause") = selectedRecordKeyValue.ToXmlString()
        ...
        Public Overridable Function CreateWhereClause(ByVal searchText as String, ByVal fromSearchControl as String, ByVal AutoTypeAheadSearch as String, ByVal AutoTypeAheadWordSeparators as String) As WhereClause
            ...
            Dim selectedRecordInUnitsofmeasureRecordControl as String = DirectCast(HttpContext.Current.Session("ItemsTableControlWhereClause"), String)
            
            If Not selectedRecordInUnitsofmeasureRecordControl Is Nothing AndAlso KeyValue.IsXmlKey(selectedRecordInUnitsofmeasureRecordControl) Then
                Dim selectedRecordKeyValue as KeyValue = KeyValue.XmlToKey(selectedRecordInUnitsofmeasureRecordControl)
                
       If Not IsNothing(selectedRecordKeyValue) AndAlso selectedRecordKeyValue.ContainsColumn(ItemsTable.uom) Then
            wc.iAND(ItemsTable.uom, BaseFilter.ComparisonOperator.EqualsTo, selectedRecordKeyValue.GetColumnValue(ItemsTable.uom).ToString())
       End If
      ...
      Me.Page.CommitTransaction(sender)
        ...
        Public Overridable Sub ItemsPDFButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
            ...
            Try
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowUnitsofmeasure.ItemsPDFButton.report")
                ' report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "items"
                ' If ShowUnitsofmeasure.ItemsPDFButton.report specifies a valid report template,
        ...
        Public Overridable Sub ItemsRefreshButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
            ...
            Dim UnitsofmeasureRecordControlObj as UnitsofmeasureRecordControl = DirectCast(Me.Page.FindControlRecursively("UnitsofmeasureRecordControl"), UnitsofmeasureRecordControl)
            UnitsofmeasureRecordControlObj.ResetData = True
        ...
        Public Overridable Sub ItemsWordButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
            ...
            Try
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowUnitsofmeasure.ItemsWordButton.word")
                ' report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "items"
                ' If ShowUnitsofmeasure.ItemsWordButton.report specifies a valid report template,
                ' AddColumn method will generate a report template.
                ' Each AddColumn method-call specifies a column
                ' The 1st parameter represents the text of the column header
                ' The 2nd parameter represents the horizontal alignment of the column header
...
' Base class for the UnitsofmeasureRecordControl control on the ShowUnitsofmeasure page.
' Do not modify this class. Instead override any method in UnitsofmeasureRecordControl.
Public Class BaseUnitsofmeasureRecordControl
        Inherits ServelInvocing.UI.BaseApplicationRecordControl

        '  To customize, override this method in UnitsofmeasureRecordControl.
        Protected Overridable Sub Control_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Init
        ...
        Protected Overridable Sub Control_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
              ...
              AddHandler Me.UnitsofmeasureDialogEditButton.Click, AddressOf UnitsofmeasureDialogEditButton_Click
        ...
        Public Overridable Sub LoadData()        
            ...
            Dim Panel As System.Web.UI.WebControls.Panel = CType(MiscUtils.FindControlRecursively(Me, "UnitsofmeasureRecordControlPanel"), System.Web.UI.WebControls.Panel)
            ...
            Dim recList() As UnitsofmeasureRecord = UnitsofmeasureTable.GetRecords(wc, Nothing, 0, 2)
            If recList.Length = 0 Then
            ...
            Me.DataSource = UnitsofmeasureTable.GetRecord(recList(0).GetID.ToXmlString(), True)
                  
        End Sub

        ' Populate the UI controls using the DataSource.  To customize, override this method in UnitsofmeasureRecordControl.
        Public Overrides Sub DataBind()
            ' The DataBind method binds the user interface controls to the values
            ' from the database record.  To do this, it calls the Set methods for 
            ' each of the field displayed on the webpage.  It is better to make 
        ...
        Public Overridable Function CreateWhereClause() As WhereClause
            ...
            Dim recId As String = Me.Page.Request.QueryString.Item("Unitsofmeasure")
                
            If recId Is Nothing OrElse recId.Trim = "" Then
                ' Get the error message from the application resource file.
                Throw New Exception(Page.GetResourceValue("Err:UrlParamMissing", "ServelInvocing").Replace("{URL}", "Unitsofmeasure"))
            End If
            HttpContext.Current.Session("QueryString in ShowUnitsofmeasure") = recId
            ...
            If KeyValue.IsXmlKey(recId) Then
                ...
                wc.iAND(UnitsofmeasureTable.uom, BaseFilter.ComparisonOperator.EqualsTo, pkValue.GetColumnValue(UnitsofmeasureTable.uom).ToString())
        
            Else
                ' The URL parameter contains the actual value, not an XML structure.
                
                wc.iAND(UnitsofmeasureTable.uom, BaseFilter.ComparisonOperator.EqualsTo, recId)
        ...
        ' event handler for ImageButton
        Public Overridable Sub UnitsofmeasureDialogEditButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
        ...
        Public Property RecordUniqueId() As String
            Get
                Return CType(Me.ViewState("BaseUnitsofmeasureRecordControl_Rec"), String)
            End Get
            Set(ByVal value As String)
                Me.ViewState("BaseUnitsofmeasureRecordControl_Rec") = value
            End Set
        End Property
...
#Region "Helper Properties"
        ...
        Public ReadOnly Property UnitsofmeasureDialogEditButton() As System.Web.UI.WebControls.ImageButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "UnitsofmeasureDialogEditButton"), System.Web.UI.WebControls.ImageButton)
            End Get
        End Property
