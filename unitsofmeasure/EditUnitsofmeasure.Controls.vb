...
' EditUnitsofmeasure.aspx page.  The Row or RecordControl classes are the 
...
Namespace ServelInvocing.UI.Controls.EditUnitsofmeasure
...
' Base class for the ItemsTableControlRow control on the EditUnitsofmeasure page.
...
Public Class BaseItemsTableControlRow
        ...
        Protected Overridable Sub Control_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
			...
			Me.Page.LoadFocusScripts(Me)
              ...
              Me.id_item_groupAddRecordLink.PostBackUrl = "../item_groups/AddItem_groups.aspx" & "?Target=" & Me.id_item_group.ClientID & "&DFKA=item_group"
              Me.id_item_groupAddRecordLink.Attributes.Item("onClick") = "window.open('" & Me.id_item_groupAddRecordLink.PostBackUrl & "','_blank', 'width=900, height=700, resizable, scrollbars, modal=yes'); return false;"
        ...
        Public Overridable Sub Setid_item_group()
            ...
            If Me.PreviousUIData.ContainsKey(Me.id_item_group.ID) Then
                If Me.PreviousUIData(Me.id_item_group.ID) Is Nothing
                    Me.Populateid_item_groupDropDownList(Nothing, 100)
                Else
                    Me.Populateid_item_groupDropDownList(Me.PreviousUIData(Me.id_item_group.ID).ToString(), 100)
                End If
                Return
            End If
        ...
        Public Overridable Sub Settariff_no()
            ...
            ' If data was retrieved from UI previously, restore it
            If Me.PreviousUIData.ContainsKey(Me.tariff_no.ID) Then
            
                Me.tariff_no.Text = Me.PreviousUIData(Me.tariff_no.ID).ToString()
...
#Region "Helper Properties"
        ...
        Public ReadOnly Property id_item_groupAddRecordLink() As System.Web.UI.WebControls.ImageButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "id_item_groupAddRecordLink"), System.Web.UI.WebControls.ImageButton)
            End Get
        End Property
...
' Base class for the ItemsTableControl control on the EditUnitsofmeasure page.
            ...
            If Not Me.ResetData Then
                ...
                For Each repItem In rep.Items
                    ...
                    If recControl.Visible AndAlso recControl.IsNewRecord() Then
                        ...
                        End If
                        If MiscUtils.IsValueSelected(recControl.id_item_group) Then
                            rec.Parse(recControl.id_item_group.SelectedItem.Value, ItemsTable.id_item_group)
                        End If
...
' Base class for the UnitsofmeasureRecordControl control on the EditUnitsofmeasure page.
...
Public Class BaseUnitsofmeasureRecordControl
        ...
        Public Overridable Function CreateWhereClause() As WhereClause
            ...
            End If
            HttpContext.Current.Session("QueryString in EditUnitsofmeasure") = recId
