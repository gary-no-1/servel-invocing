...
' AddUnitsofmeasure.aspx page.  The Row or RecordControl classes are the 
...
Namespace ServelInvocing.UI.Controls.AddUnitsofmeasure
...
' Base class for the ItemsTableControlRow control on the AddUnitsofmeasure page.
...
' Base class for the ItemsTableControl control on the AddUnitsofmeasure page.
...
' Base class for the UnitsofmeasureRecordControl control on the AddUnitsofmeasure page.
...
Public Class BaseUnitsofmeasureRecordControl
        ...
        Public Overridable Sub LoadData()        
            ...
            Me.DataSource = CType(UnitsofmeasureRecord.Copy(recList(0), False), UnitsofmeasureRecord)
        ...
        Public Overridable Sub GetUIData()
            ...
            For Each col In UnitsofmeasureRecord.TableUtils.TableDefinition.Columns()
        ...
        Public Overridable Function CreateWhereClause() As WhereClause
            ...
            HttpContext.Current.Session("QueryString in AddUnitsofmeasure") = recId
...
#Region "Helper Functions"
        ...
        Public Overridable Function GetRecord() As UnitsofmeasureRecord
            ...
            Return New UnitsofmeasureRecord()
