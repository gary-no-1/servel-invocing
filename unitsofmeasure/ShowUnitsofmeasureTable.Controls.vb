...
' ShowUnitsofmeasureTable.aspx page.  The Row or RecordControl classes are the 
...
Namespace ServelInvocing.UI.Controls.ShowUnitsofmeasureTable
...
' Base class for the UnitsofmeasureTableControlRow control on the ShowUnitsofmeasureTable page.
...
Public Class BaseUnitsofmeasureTableControlRow
        ...
        Protected Overridable Sub Control_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
			...
			Me.Page.LoadFocusScripts(Me)
              ...
              AddHandler Me.UnitsofmeasureRowCopyButton.Click, AddressOf UnitsofmeasureRowCopyButton_Click
        ...
        Public Overridable Sub UnitsofmeasureRowCopyButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
            ...
            Dim url As String = "../unitsofmeasure/AddUnitsofmeasure.aspx?Unitsofmeasure={PK}"
...
#Region "Helper Properties"
        ...
        Public ReadOnly Property UnitsofmeasureRowCopyButton() As System.Web.UI.WebControls.ImageButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "UnitsofmeasureRowCopyButton"), System.Web.UI.WebControls.ImageButton)
            End Get
        End Property
...
' Base class for the UnitsofmeasureTableControl control on the ShowUnitsofmeasureTable page.
...
Public Class BaseUnitsofmeasureTableControl
        ...
        Protected Overridable Sub Control_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            ' Setup the button events.
              ...
              AddHandler Me.UnitsofmeasureCopyButton.Click, AddressOf UnitsofmeasureCopyButton_Click
              ...
              AddHandler Me.UnitsofmeasureExportCSVButton.Click, AddressOf UnitsofmeasureExportCSVButton_Click
              
              AddHandler Me.UnitsofmeasureExportExcelButton.Click, AddressOf UnitsofmeasureExportExcelButton_Click
              
              AddHandler Me.UnitsofmeasureImportButton.Click, AddressOf UnitsofmeasureImportButton_Click
              
              AddHandler Me.UnitsofmeasureNewButton.Click, AddressOf UnitsofmeasureNewButton_Click
              
              AddHandler Me.UnitsofmeasurePDFButton.Click, AddressOf UnitsofmeasurePDFButton_Click
              ...
              AddHandler Me.UnitsofmeasureWordButton.Click, AddressOf UnitsofmeasureWordButton_Click
      ...
      End Sub
        ...
        Public Overridable Sub RegisterPostback()
              ...
              Me.Page.RegisterPostBackTrigger(MiscUtils.FindControlRecursively(Me,"UnitsofmeasureExportCSVButton"))
                        
              Me.Page.RegisterPostBackTrigger(MiscUtils.FindControlRecursively(Me,"UnitsofmeasureExportExcelButton"))
                        
              Me.Page.RegisterPostBackTrigger(MiscUtils.FindControlRecursively(Me,"UnitsofmeasurePDFButton"))
                        
              Me.Page.RegisterPostBackTrigger(MiscUtils.FindControlRecursively(Me,"UnitsofmeasureWordButton"))
      ...
      Me.SaveToSession("uomFilter_Ajax", Me.uomFilter.SelectedValue)
        ...
        ' event handler for ImageButton
        Public Overridable Sub UnitsofmeasureCopyButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
      ...
      Me.Page.CommitTransaction(sender)
        ...
        ' event handler for ImageButton
        Public Overridable Sub UnitsofmeasureExportCSVButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
          ...
          ' Create the Order By clause based on the user's current sorting preference.
            ...
            Dim columns() as BaseColumn = New BaseColumn() { _
                       UnitsofmeasureTable.uom, _ 
             Nothing}
            Dim  exportData as ExportDataToCSV = New ExportDataToCSV(UnitsofmeasureTable.Instance, wc, orderBy, columns)
        ...
        ' event handler for ImageButton
        Public Overridable Sub UnitsofmeasureExportExcelButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
            ...
            Dim excelReport As ExportDataToExcel = New ExportDataToExcel(UnitsofmeasureTable.Instance, wc, orderBy)
            ' Add each of the columns in order of export.
            ' To customize the data type, change the second parameter of the new ExcelColumn to be
            ' a format string from Excel's Format Cell menu. For example "dddd, mmmm dd, yyyy h:mm AM/PM;@", "#,##0.00"
             excelReport.AddColumn(New ExcelColumn(UnitsofmeasureTable.uom, "Default"))
        ...
        ' event handler for ImageButton
        Public Overridable Sub UnitsofmeasureImportButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
            ...
            ' Any code after the Response.Redirect call will not be executed, since the page is
            ' redirected to the URL.
            Dim url As String = "../Shared/SelectFileToImport.aspx?TableName=Unitsofmeasure"
            Try
                ' Enclose all database retrieval/update code within a Transaction boundary
                DbUtils.StartTransaction
        ...
        ' event handler for ImageButton
        Public Overridable Sub UnitsofmeasureNewButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
            ...
            ' Any code after the Response.Redirect call will not be executed, since the page is
            ' redirected to the URL.
            Dim url As String = "../unitsofmeasure/AddUnitsofmeasure.aspx"
            Dim shouldRedirect As Boolean = True
            Dim TargetKey As String = Nothing
            Dim DFKA As String = Nothing
            Dim id As String = Nothing
        ...
        ' event handler for ImageButton
        Public Overridable Sub UnitsofmeasurePDFButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
            ...
            Try
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowUnitsofmeasureTable.UnitsofmeasurePDFButton.report")
                ' report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "unitsofmeasure"
                ' If ShowUnitsofmeasureTable.UnitsofmeasurePDFButton.report specifies a valid report template,
                ...
                ' The 5th parameter represents the relative width of the column   			
                 report.AddColumn(UnitsofmeasureTable.uom.Name, ReportEnum.Align.Left, "${uom}", ReportEnum.Align.Left, 15)
                ...
                Dim totalRows As Integer = UnitsofmeasureTable.GetRecordCount(whereClause)
                Dim columns As ColumnList = UnitsofmeasureTable.GetColumnList()
                Dim records As UnitsofmeasureRecord() = Nothing
            
                Do 
                    
                    records = UnitsofmeasureTable.GetRecords(whereClause, orderBy, pageNum, rowsPerQuery)
                    If Not (records Is Nothing) AndAlso records.Length > 0 AndAlso whereClause.RunQuery Then 
                        For Each record As UnitsofmeasureRecord In records 
                            ...
                            ' The 4th parameters represent the maximum length of the data value being shown
                                                         report.AddData("${uom}", record.Format(UnitsofmeasureTable.uom), ReportEnum.Align.Left, 100)
        ...
        ' event handler for ImageButton
        Public Overridable Sub UnitsofmeasureWordButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
            ...
            Try
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowUnitsofmeasureTable.UnitsofmeasureWordButton.word")
                ' report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "unitsofmeasure"
                ' If ShowUnitsofmeasureTable.UnitsofmeasureWordButton.report specifies a valid report template,
                ' AddColumn method will generate a report template.
                ' Each AddColumn method-call specifies a column
                ' The 1st parameter represents the text of the column header
                ' The 2nd parameter represents the horizontal alignment of the column header
...
#Region "Helper Properties"
        ...
        Public ReadOnly Property UnitsofmeasureCopyButton() As System.Web.UI.WebControls.ImageButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "UnitsofmeasureCopyButton"), System.Web.UI.WebControls.ImageButton)
            End Get
        End Property
        ...
        Public ReadOnly Property UnitsofmeasureExportCSVButton() As System.Web.UI.WebControls.ImageButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "UnitsofmeasureExportCSVButton"), System.Web.UI.WebControls.ImageButton)
            End Get
        End Property
        
        Public ReadOnly Property UnitsofmeasureExportExcelButton() As System.Web.UI.WebControls.ImageButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "UnitsofmeasureExportExcelButton"), System.Web.UI.WebControls.ImageButton)
            End Get
        End Property
        
        Public ReadOnly Property UnitsofmeasureImportButton() As System.Web.UI.WebControls.ImageButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "UnitsofmeasureImportButton"), System.Web.UI.WebControls.ImageButton)
            End Get
        End Property
        
        Public ReadOnly Property UnitsofmeasureNewButton() As System.Web.UI.WebControls.ImageButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "UnitsofmeasureNewButton"), System.Web.UI.WebControls.ImageButton)
            End Get
        End Property
        ...
        Public ReadOnly Property UnitsofmeasurePDFButton() As System.Web.UI.WebControls.ImageButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "UnitsofmeasurePDFButton"), System.Web.UI.WebControls.ImageButton)
            End Get
        End Property
        ...
        Public ReadOnly Property UnitsofmeasureWordButton() As System.Web.UI.WebControls.ImageButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "UnitsofmeasureWordButton"), System.Web.UI.WebControls.ImageButton)
            End Get
        End Property
