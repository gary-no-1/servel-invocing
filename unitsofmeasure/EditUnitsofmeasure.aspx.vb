...
' This file implements the code-behind class for EditUnitsofmeasure.aspx.
' EditUnitsofmeasure.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class EditUnitsofmeasure
        Inherits BaseApplicationPage
' Code-behind class for the EditUnitsofmeasure page.
...
#Region "Section 2: Do not modify this section."
        ...
        Public WithEvents ItemsTableControl As ServelInvocing.UI.Controls.EditUnitsofmeasure.ItemsTableControl
        ...
        Public WithEvents UnitsofmeasureRecordControl As ServelInvocing.UI.Controls.EditUnitsofmeasure.UnitsofmeasureRecordControl
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.UnitsofmeasureRecordControl.SaveData()
      ...
      End Sub
        ...
        Me.UnitsofmeasureRecordControl.LoadData()
        ...
        Public Sub SaveButton_Click_Base(ByVal sender As Object, ByVal args As EventArgs)
            ...
            If Not TargetKey Is Nothing Then
                ...
                If Not Me.UnitsofmeasureRecordControl Is Nothing AndAlso Not Me.UnitsofmeasureRecordControl.DataSource Is Nothing Then
                      
                      id = Me.UnitsofmeasureRecordControl.DataSource.uom.ToString
                      value = Me.UnitsofmeasureRecordControl.DataSource.GetValue(Me.UnitsofmeasureRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(DFKA)).ToString
                      ...
                      If Not Formula Is Nothing Then
                            value = EvaluateFormula(Formula, Me.UnitsofmeasureRecordControl.DataSource)
                      End If
