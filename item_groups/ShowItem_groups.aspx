...
<tr><td class="ticnb" scope="row"><asp:ImageButton runat="server" id="ItemsRowViewButton" causesvalidation="False" commandname="Redirect" cssclass="button_link" imageurl="../Images/icon_view.gif" tooltip="&lt;%# GetResourceValue(&quot;Txt:ViewRecord&quot;, &quot;ServelInvocing&quot;) %>">		
	...
	</asp:ImageButton></td><td class="ticwb"><asp:CheckBox runat="server" id="ItemsRecordRowSelection" onclick="moveToThisTableRow(this);">	</asp:CheckBox></td><td class="ttc"><asp:Literal runat="server" id="item_code"></asp:Literal> </td><td class="ttc"><asp:Literal runat="server" id="item_description"></asp:Literal> </td><td class="ttc"><asp:LinkButton runat="server" id="uom" causesvalidation="False" commandname="Redirect"></asp:LinkButton> </td><td class="ttc"><asp:Literal runat="server" id="material_category"></asp:Literal> </td><td class="ttc"><asp:Literal runat="server" id="tariff_no1"></asp:Literal> </td><td class="ttc"><asp:Literal runat="server" id="specification"></asp:Literal> </td><td class="ttc" style="text-align: right;"><asp:Literal runat="server" id="closing_stock"></asp:Literal> </td></tr></ServelInvocing:ItemsTableControlRow>
</ITEMTEMPLATE>
