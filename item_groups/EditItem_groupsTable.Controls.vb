...
' EditItem_groupsTable.aspx page.  The Row or RecordControl classes are the 
...
Namespace ServelInvocing.UI.Controls.EditItem_groupsTable
...
' Base class for the Item_groupsTableControlRow control on the EditItem_groupsTable page.
...
Public Class BaseItem_groupsTableControlRow
        ...
        Public Overridable Sub Setitem_group()
            ...
            If Me.PreviousUIData.ContainsKey(Me.item_group.ID) Then
            
                Me.item_group.Text = Me.PreviousUIData(Me.item_group.ID).ToString()
        ...
        Public Overridable Sub Item_groupsRowDeleteButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
            ...
            If(Not Me.Page.IsPageRefresh) Then
                ...
                Dim tc As Item_groupsTableControl = DirectCast(GetParentControlObject(Me, "Item_groupsTableControl"), Item_groupsTableControl)
...
' Base class for the Item_groupsTableControl control on the EditItem_groupsTable page.
...
Public Class BaseItem_groupsTableControl
        ...
        Protected Overridable Sub Control_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            ' Setup the button events.
              ...
              AddHandler Me.Item_groupsAddButton.Click, AddressOf Item_groupsAddButton_Click
              ...
              AddHandler Me.Item_groupsSaveButton.Click, AddressOf Item_groupsSaveButton_Click
              
            Me.Item_groupsSaveButton.Attributes.Add("onclick", "SubmitHRefOnce(this, """ & Me.Page.GetResourceValue("Txt:SaveRecord", "ServelInvocing") & """);")
      ...
      End Sub
        ...
        Public Overridable Sub RegisterPostback()
              ...
              Me.Page.RegisterPostBackTrigger(MiscUtils.FindControlRecursively(Me,"Item_groupsSaveButton"))
      ...
      Me.SaveToSession("tariff_noFilter_Ajax", Me.tariff_noFilter.SelectedValue)
        ...
        ' event handler for ImageButton
        Public Overridable Sub Item_groupsAddButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
      ...
      Me.Page.CommitTransaction(sender)
        ...
        ' event handler for ImageButton
        Public Overridable Sub Item_groupsSaveButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
...
#Region "Helper Properties"
        ...
        Public ReadOnly Property Item_groupsAddButton() As System.Web.UI.WebControls.ImageButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "Item_groupsAddButton"), System.Web.UI.WebControls.ImageButton)
            End Get
        End Property
        ...
        Public ReadOnly Property Item_groupsSaveButton() As System.Web.UI.WebControls.ImageButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "Item_groupsSaveButton"), System.Web.UI.WebControls.ImageButton)
            End Get
        End Property
