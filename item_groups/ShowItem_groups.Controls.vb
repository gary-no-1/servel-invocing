...
' ShowItem_groups.aspx page.  The Row or RecordControl classes are the 
...
Namespace ServelInvocing.UI.Controls.ShowItem_groups
...
' Base class for the ItemsTableControlRow control on the ShowItem_groups page.
...
Public Class BaseItemsTableControlRow
        ...
        Public Overridable Sub Settariff_no1()
            ...
            ' Me.DataSource is the items record retrieved from the database.
            ' Me.tariff_no1 is the ASP:Literal on the webpage.
            ...
            ' on Properties.
            If Me.tariff_no1.Text Is Nothing _
                OrElse Me.tariff_no1.Text.Trim() = "" Then
                ' Set the value specified on the Properties.
                Me.tariff_no1.Text = "&nbsp;"
            End If
...
#Region "Helper Properties"
        ...
        Public ReadOnly Property tariff_no1() As System.Web.UI.WebControls.Literal
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "tariff_no1"), System.Web.UI.WebControls.Literal)
            End Get
        End Property
...
' Base class for the ItemsTableControl control on the ShowItem_groups page.
      ...
      Me.Page.CommitTransaction(sender)
        ...
        Public Overridable Sub ItemsPDFButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
            ...
            Try
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowItem_groups.ItemsPDFButton.report")
                ' report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "items"
                ' If ShowItem_groups.ItemsPDFButton.report specifies a valid report template,
        ...
        Public Overridable Sub ItemsRefreshButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
            ...
            Dim Item_groupsRecordControlObj as Item_groupsRecordControl = DirectCast(Me.Page.FindControlRecursively("Item_groupsRecordControl"), Item_groupsRecordControl)
            Item_groupsRecordControlObj.ResetData = True
        ...
        Public Overridable Sub ItemsWordButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
            ...
            Try
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowItem_groups.ItemsWordButton.word")
                ' report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "items"
                ' If ShowItem_groups.ItemsWordButton.report specifies a valid report template,
                ' AddColumn method will generate a report template.
                ' Each AddColumn method-call specifies a column
                ' The 1st parameter represents the text of the column header
                ' The 2nd parameter represents the horizontal alignment of the column header
...
' Base class for the Item_groupsRecordControl control on the ShowItem_groups page.
...
Public Class BaseItem_groupsRecordControl
        ...
        Protected Overridable Sub Control_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
              ...
              AddHandler Me.Item_groupsDialogEditButton.Click, AddressOf Item_groupsDialogEditButton_Click
        ...
        Public Overridable Sub LoadData()        
            ...
            Dim Panel As System.Web.UI.WebControls.Panel = CType(MiscUtils.FindControlRecursively(Me, "Item_groupsRecordControlPanel"), System.Web.UI.WebControls.Panel)
            ...
            Me.DataSource = Item_groupsTable.GetRecord(recList(0).GetID.ToXmlString(), True)
        ...
        Public Overridable Function CreateWhereClause() As WhereClause
            ...
            If recId Is Nothing OrElse recId.Trim = "" Then
                ' Get the error message from the application resource file.
                Throw New Exception(Page.GetResourceValue("Err:UrlParamMissing", "ServelInvocing").Replace("{URL}", "Item_groups"))
            End If
            HttpContext.Current.Session("QueryString in ShowItem_groups") = recId
        ...
        ' event handler for ImageButton
        Public Overridable Sub Item_groupsDialogEditButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
...
#Region "Helper Properties"
        ...
        Public ReadOnly Property Item_groupsDialogEditButton() As System.Web.UI.WebControls.ImageButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "Item_groupsDialogEditButton"), System.Web.UI.WebControls.ImageButton)
            End Get
        End Property
