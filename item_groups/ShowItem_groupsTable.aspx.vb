...
' This file implements the code-behind class for ShowItem_groupsTable.aspx.
' ShowItem_groupsTable.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class ShowItem_groupsTable
        Inherits BaseApplicationPage
' Code-behind class for the ShowItem_groupsTable page.
...
#Region "Ajax Functions"
      ...
      <Services.WebMethod()> _
      Public Shared Function GetAutoCompletionList_Item_groupsSearch(ByVal prefixText As String, ByVal count As Integer) As String()
      ' GetItem_groupsSearchCompletionList gets the list of suggestions from the database.
      ' prefixText is the search text typed by the user .
      ' count specifies the number of suggestions to be returned.
      ' Customize by adding code before or after the call to  GetAutoCompletionList_Item_groupsSearch()
      ' or replace the call to GetAutoCompletionList_Item_groupsSearch().
      Return GetAutoCompletionList_Item_groupsSearch_Base(prefixText, count)
      End Function
...
#Region "Section 2: Do not modify this section."
        ...
        Public WithEvents item_groupLabel1 As System.Web.UI.WebControls.LinkButton
        Public WithEvents Item_groupsCopyButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents Item_groupsDeleteButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents Item_groupsEditButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents Item_groupsExportCSVButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents Item_groupsExportExcelButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents Item_groupsImportButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents Item_groupsNewButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents Item_groupsPagination As Pagination
        Public WithEvents Item_groupsPDFButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents Item_groupsRefreshButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents Item_groupsResetButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents Item_groupsSearch As System.Web.UI.WebControls.TextBox
        Public WithEvents Item_groupsSearchButton As ThemeButton
        Public WithEvents Item_groupsTableControl As ServelInvocing.UI.Controls.ShowItem_groupsTable.Item_groupsTableControl
        Public WithEvents Item_groupsTitle As System.Web.UI.WebControls.Literal
        Public WithEvents Item_groupsToggleAll As System.Web.UI.WebControls.CheckBox
        Public WithEvents Item_groupsWordButton As System.Web.UI.WebControls.ImageButton
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.Item_groupsTableControl.SaveData()
      ...
      End Sub
        ...
        Public Shared Function GetAutoCompletionList_Item_groupsSearch_Base(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim control as ServelInvocing.UI.Controls.ShowItem_groupsTable.Item_groupsTableControl 
            control = new ServelInvocing.UI.Controls.ShowItem_groupsTable.Item_groupsTableControl()
            
            Return control.GetAutoCompletionList_Item_groupsSearch(prefixText, count)
        ...
        Me.Item_groupsTableControl.LoadData()
                ...
                If Not pageMaster is Nothing Then
                    ...
                    If Not menuComponent is Nothing Then
                        menuComponent.HiliteSettings = "Item_groupsMenuItem"
                    End If
                End If
