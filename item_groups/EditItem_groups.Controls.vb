...
' EditItem_groups.aspx page.  The Row or RecordControl classes are the 
...
Namespace ServelInvocing.UI.Controls.EditItem_groups
...
' Base class for the ItemsTableControlRow control on the EditItem_groups page.
...
' Base class for the ItemsTableControl control on the EditItem_groups page.
...
' Base class for the Item_groupsRecordControl control on the EditItem_groups page.
...
Public Class BaseItem_groupsRecordControl
        ...
        Public Overridable Function CreateWhereClause() As WhereClause
            ...
            End If
            HttpContext.Current.Session("QueryString in EditItem_groups") = recId
