...
' This file implements the code-behind class for EditItem_groups.aspx.
' EditItem_groups.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class EditItem_groups
        Inherits BaseApplicationPage
' Code-behind class for the EditItem_groups page.
...
#Region "Section 2: Do not modify this section."
        ...
        Public WithEvents Item_groupsRecordControl As ServelInvocing.UI.Controls.EditItem_groups.Item_groupsRecordControl
        ...
        Public WithEvents ItemsTableControl As ServelInvocing.UI.Controls.EditItem_groups.ItemsTableControl
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.Item_groupsRecordControl.SaveData()
      ...
      End Sub
        ...
        Me.Item_groupsRecordControl.LoadData()
        ...
        Public Sub SaveButton_Click_Base(ByVal sender As Object, ByVal args As EventArgs)
            ...
            If Not TargetKey Is Nothing Then
                ...
                If Not Me.Item_groupsRecordControl Is Nothing AndAlso Not Me.Item_groupsRecordControl.DataSource Is Nothing Then
                      
                      id = Me.Item_groupsRecordControl.DataSource.id0.ToString
                      value = Me.Item_groupsRecordControl.DataSource.GetValue(Me.Item_groupsRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(DFKA)).ToString
                      ...
                      If Not Formula Is Nothing Then
                            value = EvaluateFormula(Formula, Me.Item_groupsRecordControl.DataSource)
                      End If
