...
' This file implements the code-behind class for EditPro_inv_items.aspx.
' EditPro_inv_items.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class EditPro_inv_items
        Inherits BaseApplicationPage
' Code-behind class for the EditPro_inv_items page.
...
#Region "Section 2: Do not modify this section."
        ...
        Public WithEvents id_item As System.Web.UI.WebControls.DropDownList
        Public WithEvents id_itemAddRecordLink As System.Web.UI.WebControls.ImageButton
        ...
        Public WithEvents Pro_inv_itemsRecordControl As ServelInvocing.UI.Controls.EditPro_inv_items.Pro_inv_itemsRecordControl
        ...
        Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            Page.Title = GetResourceValue("Title:Edit") + " Pro Inv Items"
        End Sub
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.Pro_inv_itemsRecordControl.SaveData()
      ...
      End Sub
        ...
        Me.Pro_inv_itemsRecordControl.LoadData()
        ...
        Public Sub SaveButton_Click_Base(ByVal sender As Object, ByVal args As EventArgs)
            ...
            If Not TargetKey Is Nothing Then
                ...
                If Not Me.Pro_inv_itemsRecordControl Is Nothing AndAlso Not Me.Pro_inv_itemsRecordControl.DataSource Is Nothing Then
                      
                      id = Me.Pro_inv_itemsRecordControl.DataSource.id0.ToString
                      value = Me.Pro_inv_itemsRecordControl.DataSource.GetValue(Me.Pro_inv_itemsRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(DFKA)).ToString
                      ...
                      If Not Formula Is Nothing Then
                            value = EvaluateFormula(Formula, Me.Pro_inv_itemsRecordControl.DataSource)
                      End If
