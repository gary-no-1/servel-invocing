...
' AddPro_inv_items.aspx page.  The Row or RecordControl classes are the 
...
Namespace ServelInvocing.UI.Controls.AddPro_inv_items
...
' Base class for the Pro_inv_itemsRecordControl control on the AddPro_inv_items page.
...
Public Class BasePro_inv_itemsRecordControl
        ...
        Public Overridable Sub LoadData()        
            ...
            Me.DataSource = CType(Pro_inv_itemsRecord.Copy(recList(0), False), Pro_inv_itemsRecord)
        ...
        Public Overridable Sub GetUIData()
            ...
            For Each col In Pro_inv_itemsRecord.TableUtils.TableDefinition.Columns()
        ...
        Public Overridable Function CreateWhereClause() As WhereClause
            ...
            HttpContext.Current.Session("QueryString in AddPro_inv_items") = recId
...
#Region "Helper Functions"
        ...
        Public Overridable Function GetRecord() As Pro_inv_itemsRecord
            ...
            Return New Pro_inv_itemsRecord()
