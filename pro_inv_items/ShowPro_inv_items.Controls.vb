...
' ShowPro_inv_items.aspx page.  The Row or RecordControl classes are the 
...
Namespace ServelInvocing.UI.Controls.ShowPro_inv_items

#Region "Section 1: Place your customizations here."

    
Public Class Pro_inv_itemsRecordControl
        Inherits BasePro_inv_itemsRecordControl
        ' The BasePro_inv_itemsRecordControl implements the LoadData, DataBind and other
...
' Base class for the Pro_inv_itemsRecordControl control on the ShowPro_inv_items page.
' Do not modify this class. Instead override any method in Pro_inv_itemsRecordControl.
Public Class BasePro_inv_itemsRecordControl
        Inherits ServelInvocing.UI.BaseApplicationRecordControl

        '  To customize, override this method in Pro_inv_itemsRecordControl.
        ...
        Protected Overridable Sub Control_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
              ...
              AddHandler Me.Pro_inv_itemsDialogEditButton.Click, AddressOf Pro_inv_itemsDialogEditButton_Click
        ...
        Public Overridable Sub LoadData()        
            ...
            Dim Panel As System.Web.UI.WebControls.Panel = CType(MiscUtils.FindControlRecursively(Me, "Pro_inv_itemsRecordControlPanel"), System.Web.UI.WebControls.Panel)
            ...
            Dim recList() As Pro_inv_itemsRecord = Pro_inv_itemsTable.GetRecords(wc, Nothing, 0, 2)
            ...
            Me.DataSource = Pro_inv_itemsTable.GetRecord(recList(0).GetID.ToXmlString(), True)
                  
        End Sub

        ' Populate the UI controls using the DataSource.  To customize, override this method in Pro_inv_itemsRecordControl.
        ...
        Public Overridable Function CreateWhereClause() As WhereClause
            ...
            Dim recId As String = Me.Page.Request.QueryString.Item("Pro_inv_items")
                
            If recId Is Nothing OrElse recId.Trim = "" Then
                ' Get the error message from the application resource file.
                Throw New Exception(Page.GetResourceValue("Err:UrlParamMissing", "ServelInvocing").Replace("{URL}", "Pro_inv_items"))
            End If
            HttpContext.Current.Session("QueryString in ShowPro_inv_items") = recId
            ...
            If KeyValue.IsXmlKey(recId) Then
                ...
                wc.iAND(Pro_inv_itemsTable.id0, BaseFilter.ComparisonOperator.EqualsTo, pkValue.GetColumnValue(Pro_inv_itemsTable.id0).ToString())
        
            Else
                ' The URL parameter contains the actual value, not an XML structure.
                
                wc.iAND(Pro_inv_itemsTable.id0, BaseFilter.ComparisonOperator.EqualsTo, recId)
        ...
        Public Overridable Sub Pro_inv_itemsDialogEditButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
        ...
        Public Overridable Sub id_item_Click(ByVal sender As Object, ByVal args As EventArgs)
            ...
            ' Any code after the Response.Redirect call will not be executed, since the page is
            ' redirected to the URL.
            Dim url As String = "../items/ShowItems.aspx?Items={Pro_inv_itemsRecordControl:FK:pro_inv_items_items_id_item_FK}"
            Dim shouldRedirect As Boolean = True
            Dim TargetKey As String = Nothing
            Dim DFKA As String = Nothing
            Dim id As String = Nothing
        ...
        Public Overridable Sub id_pro_inv_hdr_Click(ByVal sender As Object, ByVal args As EventArgs)
            ...
            ' Any code after the Response.Redirect call will not be executed, since the page is
            ' redirected to the URL.
            Dim url As String = "../pro_inv_hdr/ShowPro_inv_hdr.aspx?Pro_inv_hdr={Pro_inv_itemsRecordControl:FK:pro_inv_items_pro_inv_hdr_id_pro_inv_hdr_FK}"
            Dim shouldRedirect As Boolean = True
            Dim TargetKey As String = Nothing
            Dim DFKA As String = Nothing
            Dim id As String = Nothing
        ...
        Public Property RecordUniqueId() As String
            Get
                Return CType(Me.ViewState("BasePro_inv_itemsRecordControl_Rec"), String)
            End Get
            Set(ByVal value As String)
                Me.ViewState("BasePro_inv_itemsRecordControl_Rec") = value
            End Set
        End Property
...
#Region "Helper Properties"
        ...
        Public ReadOnly Property Pro_inv_itemsDialogEditButton() As System.Web.UI.WebControls.ImageButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "Pro_inv_itemsDialogEditButton"), System.Web.UI.WebControls.ImageButton)
            End Get
        End Property
