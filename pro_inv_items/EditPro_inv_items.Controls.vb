...
' EditPro_inv_items.aspx page.  The Row or RecordControl classes are the 
...
Namespace ServelInvocing.UI.Controls.EditPro_inv_items
...
' Base class for the Pro_inv_itemsRecordControl control on the EditPro_inv_items page.
...
Public Class BasePro_inv_itemsRecordControl
        ...
        Public Overridable Sub Setid_pro_inv_hdr()
            ...
            Else
                ...
                Else
                    Me.Populateid_pro_inv_hdrDropDownList(Pro_inv_itemsTable.id_pro_inv_hdr.DefaultValue, 100)
                End If
        ...
        Public Overridable Sub Getid_pro_inv_hdr()
            ...
            ' save it into the id_pro_inv_hdr field in DataSource pro_inv_items record.
                        
            ' Custom validation should be performed in Validate, not here.
            
            Me.DataSource.Parse(GetValueSelectedPageRequest(Me.id_pro_inv_hdr), Pro_inv_itemsTable.id_pro_inv_hdr)				
        ...
        Public Overridable Function CreateWhereClause() As WhereClause
            ...
            End If
            HttpContext.Current.Session("QueryString in EditPro_inv_items") = recId
            ...
            If Not selectedValue Is Nothing AndAlso _
                ...
                Try
                    ...
                    If rc IsNot Nothing AndAlso rc.Length = 1 Then
                        ...
                        Dim fvalue As String = Pro_inv_itemsTable.id_pro_inv_hdr.Format(selectedValue)																			
