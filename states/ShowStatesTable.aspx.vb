...
' This file implements the code-behind class for ShowStatesTable.aspx.
' ShowStatesTable.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class ShowStatesTable
        Inherits BaseApplicationPage
' Code-behind class for the ShowStatesTable page.
...
#Region "Ajax Functions"
      ...
      <Services.WebMethod()> _
      Public Shared Function GetAutoCompletionList_StatesSearch(ByVal prefixText As String, ByVal count As Integer) As String()
      ' GetStatesSearchCompletionList gets the list of suggestions from the database.
      ' prefixText is the search text typed by the user .
      ' count specifies the number of suggestions to be returned.
      ' Customize by adding code before or after the call to  GetAutoCompletionList_StatesSearch()
      ' or replace the call to GetAutoCompletionList_StatesSearch().
      Return GetAutoCompletionList_StatesSearch_Base(prefixText, count)
      End Function
...
#Region "Section 2: Do not modify this section."
        ...
        Public WithEvents StatesCopyButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents StatesDeleteButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents StatesEditButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents StatesExportCSVButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents StatesExportExcelButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents StatesImportButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents StatesNewButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents StatesPagination As Pagination
        Public WithEvents StatesPDFButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents StatesRefreshButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents StatesResetButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents StatesSearch As System.Web.UI.WebControls.TextBox
        Public WithEvents StatesSearchButton As ThemeButton
        Public WithEvents StatesTableControl As ServelInvocing.UI.Controls.ShowStatesTable.StatesTableControl
        Public WithEvents StatesTitle As System.Web.UI.WebControls.Literal
        Public WithEvents StatesToggleAll As System.Web.UI.WebControls.CheckBox
        Public WithEvents StatesWordButton As System.Web.UI.WebControls.ImageButton
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.StatesTableControl.SaveData()
      ...
      End Sub
        ...
        Public Shared Function GetAutoCompletionList_StatesSearch_Base(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim control as ServelInvocing.UI.Controls.ShowStatesTable.StatesTableControl 
            control = new ServelInvocing.UI.Controls.ShowStatesTable.StatesTableControl()
            
            Return control.GetAutoCompletionList_StatesSearch(prefixText, count)
        ...
        Me.StatesTableControl.LoadData()
