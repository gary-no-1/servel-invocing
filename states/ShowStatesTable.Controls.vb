...
' ShowStatesTable.aspx page.  The Row or RecordControl classes are the 
...
Namespace ServelInvocing.UI.Controls.ShowStatesTable
...
' Base class for the StatesTableControlRow control on the ShowStatesTable page.
...
Public Class BaseStatesTableControlRow
        ...
        Protected Overridable Sub Control_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
			...
			Me.Page.LoadFocusScripts(Me)
              ...
              AddHandler Me.StatesRowCopyButton.Click, AddressOf StatesRowCopyButton_Click
        ...
        Public Overridable Sub StatesRowCopyButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
            ...
            Dim url As String = "../states/AddStates.aspx?States={PK}"
...
#Region "Helper Properties"
        ...
        Public ReadOnly Property StatesRowCopyButton() As System.Web.UI.WebControls.ImageButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "StatesRowCopyButton"), System.Web.UI.WebControls.ImageButton)
            End Get
        End Property
...
' Base class for the StatesTableControl control on the ShowStatesTable page.
...
Public Class BaseStatesTableControl
        ...
        Protected Overridable Sub Control_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            ' Setup the button events.
              ...
              AddHandler Me.StatesCopyButton.Click, AddressOf StatesCopyButton_Click
              ...
              AddHandler Me.StatesExportCSVButton.Click, AddressOf StatesExportCSVButton_Click
              
              AddHandler Me.StatesExportExcelButton.Click, AddressOf StatesExportExcelButton_Click
              
              AddHandler Me.StatesImportButton.Click, AddressOf StatesImportButton_Click
              
              AddHandler Me.StatesNewButton.Click, AddressOf StatesNewButton_Click
              
              AddHandler Me.StatesPDFButton.Click, AddressOf StatesPDFButton_Click
              ...
              AddHandler Me.StatesWordButton.Click, AddressOf StatesWordButton_Click
      ...
      End Sub
        ...
        Public Overridable Sub RegisterPostback()
              ...
              Me.Page.RegisterPostBackTrigger(MiscUtils.FindControlRecursively(Me,"StatesExportCSVButton"))
                        
              Me.Page.RegisterPostBackTrigger(MiscUtils.FindControlRecursively(Me,"StatesExportExcelButton"))
                        
              Me.Page.RegisterPostBackTrigger(MiscUtils.FindControlRecursively(Me,"StatesPDFButton"))
                        
              Me.Page.RegisterPostBackTrigger(MiscUtils.FindControlRecursively(Me,"StatesWordButton"))
      ...
      Me.SaveToSession("StatesSearch_Ajax", Me.StatesSearch.Text)
        ...
        ' event handler for ImageButton
        Public Overridable Sub StatesCopyButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
      ...
      Me.Page.CommitTransaction(sender)
        ...
        ' event handler for ImageButton
        Public Overridable Sub StatesExportCSVButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
          ...
          ' Create the Order By clause based on the user's current sorting preference.
            ...
            Dim columns() as BaseColumn = New BaseColumn() { _
                       StatesTable.state_code, _ 
             StatesTable.state_name, _ 
             Nothing}
            Dim  exportData as ExportDataToCSV = New ExportDataToCSV(StatesTable.Instance, wc, orderBy, columns)
        ...
        ' event handler for ImageButton
        Public Overridable Sub StatesExportExcelButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
            ...
            Dim excelReport As ExportDataToExcel = New ExportDataToExcel(StatesTable.Instance, wc, orderBy)
            ' Add each of the columns in order of export.
            ' To customize the data type, change the second parameter of the new ExcelColumn to be
            ' a format string from Excel's Format Cell menu. For example "dddd, mmmm dd, yyyy h:mm AM/PM;@", "#,##0.00"
             excelReport.AddColumn(New ExcelColumn(StatesTable.state_code, "Default"))
             excelReport.AddColumn(New ExcelColumn(StatesTable.state_name, "Default"))
        ...
        ' event handler for ImageButton
        Public Overridable Sub StatesImportButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
            ...
            ' Any code after the Response.Redirect call will not be executed, since the page is
            ' redirected to the URL.
            Dim url As String = "../Shared/SelectFileToImport.aspx?TableName=States"
            Try
                ' Enclose all database retrieval/update code within a Transaction boundary
                DbUtils.StartTransaction
        ...
        ' event handler for ImageButton
        Public Overridable Sub StatesNewButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
            ...
            ' Any code after the Response.Redirect call will not be executed, since the page is
            ' redirected to the URL.
            Dim url As String = "../states/AddStates.aspx"
            Dim shouldRedirect As Boolean = True
            Dim TargetKey As String = Nothing
            Dim DFKA As String = Nothing
            Dim id As String = Nothing
        ...
        ' event handler for ImageButton
        Public Overridable Sub StatesPDFButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
            ...
            Try
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowStatesTable.StatesPDFButton.report")
                ' report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "states"
                ' If ShowStatesTable.StatesPDFButton.report specifies a valid report template,
                ...
                ' The 5th parameter represents the relative width of the column   			
                 report.AddColumn(StatesTable.state_code.Name, ReportEnum.Align.Left, "${state_code}", ReportEnum.Align.Left, 15)
                 report.AddColumn(StatesTable.state_name.Name, ReportEnum.Align.Left, "${state_name}", ReportEnum.Align.Left, 24)
                ...
                Dim totalRows As Integer = StatesTable.GetRecordCount(whereClause)
                Dim columns As ColumnList = StatesTable.GetColumnList()
                Dim records As StatesRecord() = Nothing
            
                Do 
                    
                    records = StatesTable.GetRecords(whereClause, orderBy, pageNum, rowsPerQuery)
                    If Not (records Is Nothing) AndAlso records.Length > 0 AndAlso whereClause.RunQuery Then 
                        For Each record As StatesRecord In records 
                            ...
                            ' The 4th parameters represent the maximum length of the data value being shown
                                                         report.AddData("${state_code}", record.Format(StatesTable.state_code), ReportEnum.Align.Left, 100)
                             report.AddData("${state_name}", record.Format(StatesTable.state_name), ReportEnum.Align.Left, 100)
        ...
        ' event handler for ImageButton
        Public Overridable Sub StatesWordButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
            ...
            Try
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowStatesTable.StatesWordButton.word")
                ' report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "states"
                ' If ShowStatesTable.StatesWordButton.report specifies a valid report template,
                ' AddColumn method will generate a report template.
                ' Each AddColumn method-call specifies a column
                ' The 1st parameter represents the text of the column header
                ' The 2nd parameter represents the horizontal alignment of the column header
...
#Region "Helper Properties"
        ...
        Public ReadOnly Property StatesCopyButton() As System.Web.UI.WebControls.ImageButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "StatesCopyButton"), System.Web.UI.WebControls.ImageButton)
            End Get
        End Property
        ...
        Public ReadOnly Property StatesExportCSVButton() As System.Web.UI.WebControls.ImageButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "StatesExportCSVButton"), System.Web.UI.WebControls.ImageButton)
            End Get
        End Property
        
        Public ReadOnly Property StatesExportExcelButton() As System.Web.UI.WebControls.ImageButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "StatesExportExcelButton"), System.Web.UI.WebControls.ImageButton)
            End Get
        End Property
        
        Public ReadOnly Property StatesImportButton() As System.Web.UI.WebControls.ImageButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "StatesImportButton"), System.Web.UI.WebControls.ImageButton)
            End Get
        End Property
        
        Public ReadOnly Property StatesNewButton() As System.Web.UI.WebControls.ImageButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "StatesNewButton"), System.Web.UI.WebControls.ImageButton)
            End Get
        End Property
        ...
        Public ReadOnly Property StatesPDFButton() As System.Web.UI.WebControls.ImageButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "StatesPDFButton"), System.Web.UI.WebControls.ImageButton)
            End Get
        End Property
        ...
        Public ReadOnly Property StatesWordButton() As System.Web.UI.WebControls.ImageButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "StatesWordButton"), System.Web.UI.WebControls.ImageButton)
            End Get
        End Property
