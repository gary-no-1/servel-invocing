...
' This file implements the code-behind class for ShowSalepersonTable.aspx.
' ShowSalepersonTable.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class ShowSalepersonTable
        Inherits BaseApplicationPage
' Code-behind class for the ShowSalepersonTable page.
...
#Region "Ajax Functions"
      ...
      <Services.WebMethod()> _
      Public Shared Function GetAutoCompletionList_SalepersonSearch(ByVal prefixText As String, ByVal count As Integer) As String()
      ' GetSalepersonSearchCompletionList gets the list of suggestions from the database.
      ' prefixText is the search text typed by the user .
      ' count specifies the number of suggestions to be returned.
      ' Customize by adding code before or after the call to  GetAutoCompletionList_SalepersonSearch()
      ' or replace the call to GetAutoCompletionList_SalepersonSearch().
      Return GetAutoCompletionList_SalepersonSearch_Base(prefixText, count)
      End Function
...
#Region "Section 2: Do not modify this section."
        ...
        Public WithEvents SalepersonCopyButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents SalepersonDeleteButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents SalepersonEditButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents SalepersonExportCSVButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents SalepersonExportExcelButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents SalepersonImportButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents SalepersonNewButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents SalepersonPagination As Pagination
        Public WithEvents SalepersonPDFButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents SalepersonRefreshButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents SalepersonResetButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents SalepersonSearch As System.Web.UI.WebControls.TextBox
        Public WithEvents SalepersonSearchButton As ThemeButton
        Public WithEvents SalepersonTableControl As ServelInvocing.UI.Controls.ShowSalepersonTable.SalepersonTableControl
        Public WithEvents SalepersonTitle As System.Web.UI.WebControls.Literal
        Public WithEvents SalepersonToggleAll As System.Web.UI.WebControls.CheckBox
        Public WithEvents SalepersonWordButton As System.Web.UI.WebControls.ImageButton
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.SalepersonTableControl.SaveData()
      ...
      End Sub
        ...
        Public Shared Function GetAutoCompletionList_SalepersonSearch_Base(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim control as ServelInvocing.UI.Controls.ShowSalepersonTable.SalepersonTableControl 
            control = new ServelInvocing.UI.Controls.ShowSalepersonTable.SalepersonTableControl()
            
            Return control.GetAutoCompletionList_SalepersonSearch(prefixText, count)
        ...
        Me.SalepersonTableControl.LoadData()
                ...
                If Not pageMaster is Nothing Then
                    ...
                    If Not menuComponent is Nothing Then
                        menuComponent.HiliteSettings = "SalepersonMenuItem"
                    End If
                End If
