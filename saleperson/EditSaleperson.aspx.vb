...
' This file implements the code-behind class for EditSaleperson.aspx.
' EditSaleperson.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class EditSaleperson
        Inherits BaseApplicationPage
' Code-behind class for the EditSaleperson page.
...
#Region "Section 2: Do not modify this section."
        ...
        Public WithEvents SalepersonRecordControl As ServelInvocing.UI.Controls.EditSaleperson.SalepersonRecordControl
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.SalepersonRecordControl.SaveData()
      ...
      End Sub
        ...
        Me.SalepersonRecordControl.LoadData()
        ...
        Public Sub SaveButton_Click_Base(ByVal sender As Object, ByVal args As EventArgs)
            ...
            If Not TargetKey Is Nothing Then
                ...
                If Not Me.SalepersonRecordControl Is Nothing AndAlso Not Me.SalepersonRecordControl.DataSource Is Nothing Then
                      
                      id = Me.SalepersonRecordControl.DataSource.id0.ToString
                      value = Me.SalepersonRecordControl.DataSource.GetValue(Me.SalepersonRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(DFKA)).ToString
                      ...
                      If Not Formula Is Nothing Then
                            value = EvaluateFormula(Formula, Me.SalepersonRecordControl.DataSource)
                      End If
