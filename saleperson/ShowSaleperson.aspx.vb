...
' This file implements the code-behind class for ShowSaleperson.aspx.
' ShowSaleperson.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class ShowSaleperson
        Inherits BaseApplicationPage
' Code-behind class for the ShowSaleperson page.
...
#Region "Section 2: Do not modify this section."
        ...
        Public WithEvents SalepersonDialogEditButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents SalepersonRecordControl As ServelInvocing.UI.Controls.ShowSaleperson.SalepersonRecordControl
