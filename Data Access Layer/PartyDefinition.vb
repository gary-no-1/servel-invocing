...
''' <see cref="PartyTable">ServelInvocing.PartyTable</see> class
...
#Region "Definition (XML) for PartyDefinition table"
	'Next 542 lines contain Table Definition (XML) for table "PartyDefinition"
...
"<XMLDefinition Generator=""Iron Speed Designer"" Version=""7.0"" Type=""GENERIC"">"& _
  "<ColumnDefinition>"& _
    ...
    "<Column InternalName=""8"" Priority=""9"" ColumnNum=""8"">"& _
      "<columnName>lst_no</columnName>"& _
      "<columnUIName Source=""User"">LST No.</columnUIName>"& _
      "<columnType>String</columnType>"& _
      "<columnDBType>nchar</columnDBType>"& _
    ...
    "<Column InternalName=""9"" Priority=""10"" ColumnNum=""9"">"& _
      "<columnName>cst_no</columnName>"& _
      "<columnUIName Source=""User"">CST No.</columnUIName>"& _
      "<columnType>String</columnType>"& _
      "<columnDBType>nchar</columnDBType>"& _
      "<columnLengthSet>20</columnLengthSet>"& _
      "<columnDefault></columnDefault>"& _
    ...
    "<Column InternalName=""10"" Priority=""11"" ColumnNum=""10"">"& _
      "<columnName>lst_date</columnName>"& _
      "<columnUIName Source=""User"">LST Date</columnUIName>"& _
    ...
    "<Column InternalName=""11"" Priority=""12"" ColumnNum=""11"">"& _
      "<columnName>cst_date</columnName>"& _
      "<columnUIName Source=""User"">CST Date</columnUIName>"& _
      "<columnType>Date</columnType>"& _
      "<columnDBType>date</columnDBType>"& _
      "<columnLengthSet></columnLengthSet>"& _
      "<columnDefault></columnDefault>"& _
    ...
    "<Column InternalName=""12"" Priority=""13"" ColumnNum=""12"">"& _
      ...
      "<columnUIName Source=""User"">VAT</columnUIName>"& _
      "<columnType>String</columnType>"& _
      "<columnDBType>nchar</columnDBType>"& _
      "<columnLengthSet>20</columnLengthSet>"& _
      "<columnDefault></columnDefault>"& _
    ...
    "<Column InternalName=""18"" Priority=""19"" ColumnNum=""18"">"& _
      ...
      "<columnTableAliasName></columnTableAliasName>"& _
      "<foreignKey>"& _
        "<columnFKName>party_states_FK</columnFKName>"& _
    ...
    "</Column>"& _
  "</ColumnDefinition>"& _
  "<TableName>party</TableName>"& _
  "<Version>4</Version>"& _
  "<Owner>dbo</Owner>"& _
  "<TableCodeName>Party</TableCodeName>"& _
  "<TableAliasName>Party_</TableAliasName>"& _
