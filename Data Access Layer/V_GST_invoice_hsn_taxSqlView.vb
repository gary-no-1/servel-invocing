...
''' <summary>
''' Used by the <see cref="V_GST_invoice_hsn_taxView"></see> class to access and/or modify the database.
''' </summary>
''' <remarks>
...
Public Class V_GST_invoice_hsn_taxSqlView
	Inherits BaseV_GST_invoice_hsn_taxSqlView
