...
''' <see cref="SalepersonTable">ServelInvocing.SalepersonTable</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="SalepersonTable"></seealso>

Public Class SalepersonDefinition

#Region "Definition (XML) for SalepersonDefinition table"
	'Next 62 lines contain Table Definition (XML) for table "SalepersonDefinition"
...
"<XMLDefinition Generator=""Iron Speed Designer"" Version=""7.0"" Type=""GENERIC"">"& _
  "<ColumnDefinition>"& _
    ...
    "</Column>"& _
  "</ColumnDefinition>"& _
  "<TableName>saleperson</TableName>"& _
  "<Version></Version>"& _
  "<Owner>dbo</Owner>"& _
  "<TableCodeName>Saleperson</TableCodeName>"& _
  "<TableAliasName>Saleperson_</TableAliasName>"& _
