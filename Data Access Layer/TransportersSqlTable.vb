...
Namespace ServelInvocing.Data
	...
	''' <summary>
	''' Used by the <see cref="TransportersTable"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class TransportersSqlTable
		Inherits BaseTransportersSqlTable
