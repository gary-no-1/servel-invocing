...
''' <summary>
''' Used by the <see cref="V_Invoice_ItemsView"></see> class to access and/or modify the database.
''' </summary>
''' <remarks>
...
Public Class V_Invoice_ItemsSqlView
	Inherits BaseV_Invoice_ItemsSqlView
