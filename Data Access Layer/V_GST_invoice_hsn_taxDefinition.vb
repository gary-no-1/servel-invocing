...
''' <see cref="V_GST_invoice_hsn_taxView">ServelInvocing.V_GST_invoice_hsn_taxView</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="V_GST_invoice_hsn_taxView"></seealso>

Public Class V_GST_invoice_hsn_taxDefinition

#Region "Definition (XML) for V_GST_invoice_hsn_taxDefinition table"
	'Next 246 lines contain Table Definition (XML) for table "V_GST_invoice_hsn_taxDefinition"
...
"<XMLDefinition Generator=""Iron Speed Designer"" Version=""7.0"" Type=""VIEW"">"& _
  "<ColumnDefinition>"& _
    ...
    "<Column InternalName=""1"" Priority=""2"" ColumnNum=""1"">"& _
      ...
      "<columnUIName>Inv dt</columnUIName>"& _
    ...
    "<Column InternalName=""7"" Priority=""8"" ColumnNum=""7"">"& _
      ...
      "<columnUIName>Igst</columnUIName>"& _
      "<columnType>Number</columnType>"& _
      "<columnDBType>decimal</columnDBType>"& _
      "<columnLengthSet>38.9</columnLengthSet>"& _
      "<columnDefault></columnDefault>"& _
      "<columnDBDefault></columnDBDefault>"& _
      "<columnIndex>N</columnIndex>"& _
      "<columnUnique>N</columnUnique>"& _
    ...
    "</Column>"& _
  "</ColumnDefinition>"& _
  "<TableName>V_GST_invoice_hsn_tax</TableName>"& _
  "<Version></Version>"& _
  "<Owner>dbo</Owner>"& _
  "<TableCodeName>V_GST_invoice_hsn_tax</TableCodeName>"& _
  "<TableAliasName>V_GST_invoice_hsn_tax_</TableAliasName>"& _
...
#End Region
	...
	''' <see cref="V_GST_invoice_hsn_taxView"></see>
