...
Namespace ServelInvocing.Data
	...
	''' <summary>
	''' Used by the <see cref="Pro_inv_termsTable"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class Pro_inv_termsSqlTable
		Inherits BasePro_inv_termsSqlTable
