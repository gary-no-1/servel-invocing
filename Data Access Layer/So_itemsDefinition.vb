...
''' <see cref="So_itemsTable">ServelInvocing.So_itemsTable</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="So_itemsTable"></seealso>

Public Class So_itemsDefinition

#Region "Definition (XML) for So_itemsDefinition table"
	'Next 262 lines contain Table Definition (XML) for table "So_itemsDefinition"
...
"<XMLDefinition Generator=""Iron Speed Designer"" Version=""7.0"" Type=""GENERIC"">"& _
  "<ColumnDefinition>"& _
    ...
    "<Column InternalName=""1"" Priority=""2"" ColumnNum=""1"">"& _
      ...
      "<columnTableAliasName></columnTableAliasName>"& _
      "<foreignKey>"& _
        "<columnFKName>so_items_so_hdr_id_so_hdr_FK</columnFKName>"& _
    ...
    "<Column InternalName=""2"" Priority=""3"" ColumnNum=""2"">"& _
      ...
      "<columnTableAliasName></columnTableAliasName>"& _
      "<foreignKey>"& _
        "<columnFKName>so_items_items_id_item_FK</columnFKName>"& _
    ...
    "<Column InternalName=""8"" Priority=""9"" ColumnNum=""8"">"& _
      "<columnName>ass_value</columnName>"& _
      "<columnUIName>Value</columnUIName>"& _
      "<columnType>Number</columnType>"& _
      "<columnDBType>decimal</columnDBType>"& _
    ...
    "</Column>"& _
  "</ColumnDefinition>"& _
  "<TableName>so_items</TableName>"& _
  "<Version></Version>"& _
  "<Owner>dbo</Owner>"& _
  "<TableCodeName>So_items</TableCodeName>"& _
  "<TableAliasName>So_items_</TableAliasName>"& _
