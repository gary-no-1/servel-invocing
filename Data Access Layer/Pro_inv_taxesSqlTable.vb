...
''' <summary>
''' Used by the <see cref="Pro_inv_taxesTable"></see> class to access and/or modify the database.
''' </summary>
''' <remarks>
...
Public Class Pro_inv_taxesSqlTable
	Inherits BasePro_inv_taxesSqlTable
