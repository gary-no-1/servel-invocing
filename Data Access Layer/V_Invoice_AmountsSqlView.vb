...
''' <summary>
''' Used by the <see cref="V_Invoice_AmountsView"></see> class to access and/or modify the database.
''' </summary>
''' <remarks>
...
Public Class V_Invoice_AmountsSqlView
	Inherits BaseV_Invoice_AmountsSqlView
