...
''' <summary>
''' Used by the <see cref="V_GST_InvoicesView"></see> class to access and/or modify the database.
''' </summary>
''' <remarks>
...
Public Class V_GST_InvoicesSqlView
	Inherits BaseV_GST_InvoicesSqlView
