...
''' <summary>
''' Used by the <see cref="V_GST_Sale_b2bView"></see> class to access and/or modify the database.
''' </summary>
''' <remarks>
...
Public Class V_GST_Sale_b2bSqlView
	Inherits BaseV_GST_Sale_b2bSqlView
