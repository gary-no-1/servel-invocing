...
''' <see cref="RolesTable">ServelInvocing.RolesTable</see> class
...
#Region "Definition (XML) for RolesDefinition table"
	'Next 65 lines contain Table Definition (XML) for table "RolesDefinition"
...
"<XMLDefinition Generator=""Iron Speed Designer"" Version=""7.0"" Type=""GENERIC"">"& _
  "<ColumnDefinition>"& _
    ...
    "<Column InternalName=""1"" Priority=""2"" ColumnNum=""1"">"& _
      "<columnName>role</columnName>"& _
      "<columnUIName Source=""User"">Role</columnUIName>"& _
    ...
    "</Column>"& _
  "</ColumnDefinition>"& _
  "<TableName>roles</TableName>"& _
  "<Version>1</Version>"& _
  "<Owner>dbo</Owner>"& _
  "<TableCodeName>Roles</TableCodeName>"& _
  "<TableAliasName>Roles_</TableAliasName>"& _
