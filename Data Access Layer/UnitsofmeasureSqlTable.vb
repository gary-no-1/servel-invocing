...
Namespace ServelInvocing.Data
	...
	''' <summary>
	''' Used by the <see cref="UnitsofmeasureTable"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class UnitsofmeasureSqlTable
		Inherits BaseUnitsofmeasureSqlTable
