...
Namespace ServelInvocing.Data
	...
	''' <summary>
	''' Used by the <see cref="Pro_inv_itemsTable"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class Pro_inv_itemsSqlTable
		Inherits BasePro_inv_itemsSqlTable
