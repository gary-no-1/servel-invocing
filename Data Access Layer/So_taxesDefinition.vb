...
''' <see cref="So_taxesTable">ServelInvocing.So_taxesTable</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="So_taxesTable"></seealso>

Public Class So_taxesDefinition

#Region "Definition (XML) for So_taxesDefinition table"
	'Next 400 lines contain Table Definition (XML) for table "So_taxesDefinition"
...
"<XMLDefinition Generator=""Iron Speed Designer"" Version=""7.0"" Type=""GENERIC"">"& _
  "<ColumnDefinition>"& _
    ...
    "<Column InternalName=""1"" Priority=""2"" ColumnNum=""1"">"& _
      ...
      "<columnTableAliasName></columnTableAliasName>"& _
      "<foreignKey>"& _
        "<columnFKName>so_taxes_so_hdr_id_so_hdr_FK</columnFKName>"& _
    ...
    "<Column InternalName=""2"" Priority=""3"" ColumnNum=""2"">"& _
      ...
      "<columnTableAliasName></columnTableAliasName>"& _
      "<foreignKey>"& _
        "<columnFKName>so_taxes_taxes_id_taxes_FK</columnFKName>"& _
    ...
    "</Column>"& _
  "</ColumnDefinition>"& _
  "<TableName>so_taxes</TableName>"& _
  "<Version></Version>"& _
  "<Owner>dbo</Owner>"& _
  "<TableCodeName>So_taxes</TableCodeName>"& _
  "<TableAliasName>So_taxes_</TableAliasName>"& _
