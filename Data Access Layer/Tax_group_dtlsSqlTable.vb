...
Namespace ServelInvocing.Data
	...
	''' <summary>
	''' Used by the <see cref="Tax_group_dtlsTable"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class Tax_group_dtlsSqlTable
		Inherits BaseTax_group_dtlsSqlTable
