...
''' <see cref="Inv_taxesTable">ServelInvocing.Inv_taxesTable</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="Inv_taxesTable"></seealso>

Public Class Inv_taxesDefinition

#Region "Definition (XML) for Inv_taxesDefinition table"
	'Next 403 lines contain Table Definition (XML) for table "Inv_taxesDefinition"
...
"<XMLDefinition Generator=""Iron Speed Designer"" Version=""7.0"" Type=""GENERIC"">"& _
  "<ColumnDefinition>"& _
    ...
    "<Column InternalName=""1"" Priority=""2"" ColumnNum=""1"">"& _
      "<columnName>id_inv_hdr</columnName>"& _
      "<columnUIName>ID Inv HDR</columnUIName>"& _
      "<columnType>Number</columnType>"& _
      "<columnDBType>int</columnDBType>"& _
      "<columnLengthSet>10.0</columnLengthSet>"& _
      "<columnDefault></columnDefault>"& _
      ...
      "<columnTableAliasName></columnTableAliasName>"& _
      "<foreignKey>"& _
        "<columnFKName>inv_taxes_inv_hdr_id_inv_hdr_FK</columnFKName>"& _
        "<columnFKTable>ServelInvocing.Business.Inv_hdrTable, ServelInvocing.Business</columnFKTable>"& _
    ...
    "<Column InternalName=""2"" Priority=""3"" ColumnNum=""2"">"& _
      ...
      "<columnTableAliasName></columnTableAliasName>"& _
      "<foreignKey>"& _
        "<columnFKName>inv_taxes_taxes_id_taxes_FK</columnFKName>"& _
    ...
    "<Column InternalName=""9"" Priority=""10"" ColumnNum=""9"">"& _
      "<columnName>tax_lock</columnName>"& _
      "<columnUIName>Tax Lock</columnUIName>"& _
    ...
    "<Column InternalName=""10"" Priority=""11"" ColumnNum=""10"">"& _
      ...
      "<columnUIName>Calc Type</columnUIName>"& _
      "<columnType>String</columnType>"& _
      "<columnDBType>nchar</columnDBType>"& _
    ...
    "<Column InternalName=""14"" Priority=""15"" ColumnNum=""14"">"& _
      "<columnName>excise_total</columnName>"& _
      "<columnUIName>Excise Total</columnUIName>"& _
      "<columnType>Number</columnType>"& _
      "<columnDBType>decimal</columnDBType>"& _
      "<columnLengthSet>18.2</columnLengthSet>"& _
      "<columnDefault></columnDefault>"& _
    ...
    "</Column>"& _
  "</ColumnDefinition>"& _
  "<TableName>inv_taxes</TableName>"& _
  "<Version></Version>"& _
  "<Owner>dbo</Owner>"& _
  "<TableCodeName>Inv_taxes</TableCodeName>"& _
  "<TableAliasName>Inv_taxes_</TableAliasName>"& _
