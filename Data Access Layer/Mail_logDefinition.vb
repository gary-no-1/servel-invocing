...
''' <see cref="Mail_logTable">ServelInvocing.Mail_logTable</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="Mail_logTable"></seealso>

Public Class Mail_logDefinition

#Region "Definition (XML) for Mail_logDefinition table"
	'Next 285 lines contain Table Definition (XML) for table "Mail_logDefinition"
...
"<XMLDefinition Generator=""Iron Speed Designer"" Version=""7.0"" Type=""GENERIC"">"& _
  "<ColumnDefinition>"& _
    ...
    "<Column InternalName=""1"" Priority=""2"" ColumnNum=""1"">"& _
      "<columnName>doc_type</columnName>"& _
      "<columnUIName>Document Type</columnUIName>"& _
    ...
    "<Column InternalName=""3"" Priority=""4"" ColumnNum=""3"">"& _
      "<columnName>sent_by</columnName>"& _
      "<columnUIName>Sent By</columnUIName>"& _
      "<columnType>String</columnType>"& _
      "<columnDBType>nchar</columnDBType>"& _
    ...
    "<Column InternalName=""4"" Priority=""5"" ColumnNum=""4"">"& _
      "<columnName>sent_date</columnName>"& _
      "<columnUIName>Sent Date</columnUIName>"& _
    ...
    "<Column InternalName=""5"" Priority=""6"" ColumnNum=""5"">"& _
      "<columnName>sent_to</columnName>"& _
      "<columnUIName>Sent To</columnUIName>"& _
      "<columnType>String</columnType>"& _
    ...
    "<Column InternalName=""6"" Priority=""7"" ColumnNum=""6"">"& _
      "<columnName>sent_cc</columnName>"& _
      "<columnUIName Source=""User"">Copy To</columnUIName>"& _
      "<columnType>String</columnType>"& _
      "<columnDBType>nvarchar</columnDBType>"& _
      "<columnLengthSet>100</columnLengthSet>"& _
      "<columnDefault></columnDefault>"& _
    ...
    "<Column InternalName=""7"" Priority=""8"" ColumnNum=""7"">"& _
      "<columnName>sent_bcc</columnName>"& _
      "<columnUIName Source=""User"">Bcc</columnUIName>"& _
      "<columnType>String</columnType>"& _
      "<columnDBType>nvarchar</columnDBType>"& _
      "<columnLengthSet>100</columnLengthSet>"& _
      "<columnDefault></columnDefault>"& _
    ...
    "<Column InternalName=""8"" Priority=""9"" ColumnNum=""8"">"& _
      "<columnName>sent_subject</columnName>"& _
      "<columnUIName Source=""User"">Subject</columnUIName>"& _
      "<columnType>String</columnType>"& _
      "<columnDBType>nvarchar</columnDBType>"& _
      "<columnLengthSet>100</columnLengthSet>"& _
      "<columnDefault></columnDefault>"& _
    ...
    "<Column InternalName=""9"" Priority=""10"" ColumnNum=""9"">"& _
      "<columnName>sent_body</columnName>"& _
      "<columnUIName Source=""User"">Body</columnUIName>"& _
      "<columnType>String</columnType>"& _
      "<columnDBType>nvarchar</columnDBType>"& _
      "<columnLengthSet>1500</columnLengthSet>"& _
      "<columnDefault></columnDefault>"& _
      "<columnDBDefault Source=""User""></columnDBDefault>"& _
      "<columnIndex>N</columnIndex>"& _
      "<columnUnique>N</columnUnique>"& _
    ...
    "<Column InternalName=""10"" Priority=""11"" ColumnNum=""10"">"& _
      "<columnName>sent_attach</columnName>"& _
      "<columnUIName Source=""User"">Attachment</columnUIName>"& _
      "<columnType>String</columnType>"& _
      "<columnDBType>nvarchar</columnDBType>"& _
      "<columnLengthSet>100</columnLengthSet>"& _
      "<columnDefault></columnDefault>"& _
    ...
    "</Column>"& _
  "</ColumnDefinition>"& _
  "<TableName>mail_log</TableName>"& _
  "<Version></Version>"& _
  "<Owner>dbo</Owner>"& _
  "<TableCodeName>Mail_log</TableCodeName>"& _
  "<TableAliasName>Mail_log_</TableAliasName>"& _
