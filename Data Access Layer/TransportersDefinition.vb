...
''' <see cref="TransportersTable">ServelInvocing.TransportersTable</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="TransportersTable"></seealso>

Public Class TransportersDefinition

#Region "Definition (XML) for TransportersDefinition table"
	'Next 258 lines contain Table Definition (XML) for table "TransportersDefinition"
...
"<XMLDefinition Generator=""Iron Speed Designer"" Version=""7.0"" Type=""GENERIC"">"& _
  "<ColumnDefinition>"& _
    ...
    "<Column InternalName=""4"" Priority=""5"" ColumnNum=""4"">"& _
      ...
      "<columnUIName Source=""User"">City</columnUIName>"& _
      "<columnType>String</columnType>"& _
      "<columnDBType>nchar</columnDBType>"& _
    ...
    "<Column InternalName=""8"" Priority=""9"" ColumnNum=""8"">"& _
      ...
      "<columnUIName Source=""User"">Pan Number</columnUIName>"& _
      "<columnType>String</columnType>"& _
      "<columnDBType>nchar</columnDBType>"& _
    ...
    "<Column InternalName=""9"" Priority=""10"" ColumnNum=""9"">"& _
      ...
      "<columnUIName Source=""User"">Tin Number</columnUIName>"& _
      "<columnType>String</columnType>"& _
      "<columnDBType>nchar</columnDBType>"& _
    ...
    "</Column>"& _
  "</ColumnDefinition>"& _
  "<TableName>transporters</TableName>"& _
  "<Version></Version>"& _
  "<Owner>dbo</Owner>"& _
  "<TableCodeName>Transporters</TableCodeName>"& _
  "<TableAliasName>Transporters_</TableAliasName>"& _
...
#End Region
	...
	''' <see cref="TransportersTable"></see>
