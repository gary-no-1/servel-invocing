...
' This file implements the code-behind class for ShowV_Invoice_ItemsTable.aspx.
' ShowV_Invoice_ItemsTable.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class ShowV_Invoice_ItemsTable
        Inherits BaseApplicationPage
' Code-behind class for the ShowV_Invoice_ItemsTable page.
...
#Region "Ajax Functions"
      ...
      <Services.WebMethod()> _
      Public Shared Function GetAutoCompletionList_V_Invoice_ItemsSearch(ByVal prefixText As String, ByVal count As Integer) As String()
      ' GetV_Invoice_ItemsSearchCompletionList gets the list of suggestions from the database.
      ' prefixText is the search text typed by the user .
      ' count specifies the number of suggestions to be returned.
      ' Customize by adding code before or after the call to  GetAutoCompletionList_V_Invoice_ItemsSearch()
      ' or replace the call to GetAutoCompletionList_V_Invoice_ItemsSearch().
      Return GetAutoCompletionList_V_Invoice_ItemsSearch_Base(prefixText, count)
      End Function
...
#Region "Section 2: Do not modify this section."
        ...
        Public WithEvents inv_dtLabel1 As System.Web.UI.WebControls.LinkButton
        ...
        Public WithEvents item_codeLabel1 As System.Web.UI.WebControls.Literal
        ...
        Public WithEvents V_Invoice_ItemsExportCSVButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents V_Invoice_ItemsExportExcelButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents V_Invoice_ItemsFilterButton As ThemeButton
        Public WithEvents V_Invoice_ItemsPagination As Pagination
        Public WithEvents V_Invoice_ItemsPDFButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents V_Invoice_ItemsRefreshButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents V_Invoice_ItemsResetButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents V_Invoice_ItemsSearch As System.Web.UI.WebControls.TextBox
        Public WithEvents V_Invoice_ItemsSearchButton As ThemeButton
        Public WithEvents V_Invoice_ItemsTableControl As ServelInvocing.UI.Controls.ShowV_Invoice_ItemsTable.V_Invoice_ItemsTableControl
        Public WithEvents V_Invoice_ItemsTitle As System.Web.UI.WebControls.Literal
        Public WithEvents V_Invoice_ItemsWordButton As System.Web.UI.WebControls.ImageButton
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.V_Invoice_ItemsTableControl.SaveData()
      ...
      End Sub
        ...
        Public Shared Function GetAutoCompletionList_V_Invoice_ItemsSearch_Base(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim control as ServelInvocing.UI.Controls.ShowV_Invoice_ItemsTable.V_Invoice_ItemsTableControl 
            control = new ServelInvocing.UI.Controls.ShowV_Invoice_ItemsTable.V_Invoice_ItemsTableControl()
            
            Return control.GetAutoCompletionList_V_Invoice_ItemsSearch(prefixText, count)
        ...
        Me.V_Invoice_ItemsTableControl.LoadData()
