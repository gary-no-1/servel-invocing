...
' This file implements the code-behind class for V_Invoice_ItemsWebReport.aspx.
' V_Invoice_ItemsWebReport.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class V_Invoice_ItemsWebReport
        Inherits BaseApplicationPage
' Code-behind class for the V_Invoice_ItemsWebReport page.
...
#Region "Section 2: Do not modify this section."
        ...
        Public WithEvents V_Invoice_ItemsTableControl As ServelInvocing.UI.Controls.V_Invoice_ItemsWebReport.V_Invoice_ItemsTableControl
