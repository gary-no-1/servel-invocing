...
' This file implements the code-behind class for ShowItemsTable.aspx.
' ShowItemsTable.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class ShowItemsTable
        Inherits BaseApplicationPage
' Code-behind class for the ShowItemsTable page.
...
#Region "Ajax Functions"
      ...
      <Services.WebMethod()> _
      Public Shared Function GetAutoCompletionList_ItemsSearch(ByVal prefixText As String, ByVal count As Integer) As String()
      ' GetItemsSearchCompletionList gets the list of suggestions from the database.
      ' prefixText is the search text typed by the user .
      ' count specifies the number of suggestions to be returned.
      ' Customize by adding code before or after the call to  GetAutoCompletionList_ItemsSearch()
      ' or replace the call to GetAutoCompletionList_ItemsSearch().
      Return GetAutoCompletionList_ItemsSearch_Base(prefixText, count)
      End Function
...
#Region "Section 2: Do not modify this section."
        ...
        Public WithEvents ItemsSearch As System.Web.UI.WebControls.TextBox
        Public WithEvents ItemsSearchButton As ThemeButton
        Public WithEvents ItemsTableControl As ServelInvocing.UI.Controls.ShowItemsTable.ItemsTableControl
    ...
    End Function
      ...
      End Sub
        ...
        Public Shared Function GetAutoCompletionList_ItemsSearch_Base(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim control as ServelInvocing.UI.Controls.ShowItemsTable.ItemsTableControl 
            control = new ServelInvocing.UI.Controls.ShowItemsTable.ItemsTableControl()
            
            Return control.GetAutoCompletionList_ItemsSearch(prefixText, count)
