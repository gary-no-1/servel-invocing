...
' This file implements the code-behind class for EditItems.aspx.
' EditItems.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class EditItems
        Inherits BaseApplicationPage
' Code-behind class for the EditItems page.
...
#Region "Section 2: Do not modify this section."
        ...
        Public WithEvents ItemsRecordControl As ServelInvocing.UI.Controls.EditItems.ItemsRecordControl
        ...
        Public WithEvents uomAddRecordLink As System.Web.UI.WebControls.ImageButton
