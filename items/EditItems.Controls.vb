...
' EditItems.aspx page.  The Row or RecordControl classes are the 
...
Namespace ServelInvocing.UI.Controls.EditItems
...
' Base class for the ItemsRecordControl control on the EditItems page.
...
Public Class BaseItemsRecordControl
        ...
        Public Overridable Function CreateWhereClause() As WhereClause
            ...
            End If
            HttpContext.Current.Session("QueryString in EditItems") = recId
