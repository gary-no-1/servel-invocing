...
</td></tr><tr><td><asp:panel id="ItemsRecordControlCollapsibleRegion" runat="server"><table class="dBody" cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td><asp:panel id="ItemsRecordControlPanel" runat="server"><table cellpadding="0" cellspacing="0" border="0"><tr><td class="fls"><asp:Literal runat="server" id="item_codeLabel" Text="Item Code">	</asp:Literal></td><td class="dfv"><asp:Literal runat="server" id="item_code"></asp:Literal> </td><td class="fls"><asp:Literal runat="server" id="item_descriptionLabel" Text="Item Description">	</asp:Literal></td><td class="dfv"><asp:Literal runat="server" id="item_description"></asp:Literal> </td></tr><tr><td class="fls"><asp:Literal runat="server" id="id_item_groupLabel" Text="Item Group">	</asp:Literal></td><td class="dfv"><asp:LinkButton runat="server" id="id_item_group" causesvalidation="False" commandname="Redirect"></asp:LinkButton> </td><td class="fls"><asp:Literal runat="server" id="item_typeLabel" Text="Item Type">	</asp:Literal></td><td class="dfv"><asp:Literal runat="server" id="item_type"></asp:Literal> </td></tr><tr><td class="fls"><asp:Literal runat="server" id="uomLabel" Text="Uom">	</asp:Literal></td><td class="dfv"><asp:LinkButton runat="server" id="uom" causesvalidation="False" commandname="Redirect"></asp:LinkButton> </td><td class="fls"><asp:Literal runat="server" id="material_categoryLabel" Text="Material Category">	</asp:Literal></td><td class="dfv"><asp:Literal runat="server" id="material_category"></asp:Literal> </td></tr><tr><td class="fls"><asp:Literal runat="server" id="tariff_noLabel" Text="Tariff Number">	</asp:Literal></td><td class="dfv"><asp:Literal runat="server" id="tariff_no"></asp:Literal> </td><td class="fls"><asp:Literal runat="server" id="closing_stockLabel" Text="Closing Stock">	</asp:Literal></td><td class="dfv"><asp:Literal runat="server" id="closing_stock"></asp:Literal> </td></tr><tr><td class="fls"><asp:Literal runat="server" id="hsnLabel" Text="HSN">	</asp:Literal></td><td class="dfv"><asp:Literal runat="server" id="hsn"></asp:Literal></td><td class="dfv"></td><td class="dfv"></td></tr><tr><td class="fls"><asp:Literal runat="server" id="specificationLabel" Text="Specification">	</asp:Literal></td><td class="dfv" colspan="3"><asp:Literal runat="server" id="specification"></asp:Literal> </td></tr></table></asp:panel>
</td></tr></table>
