...
' AddItems.aspx page.  The Row or RecordControl classes are the 
...
Namespace ServelInvocing.UI.Controls.AddItems
...
' Base class for the ItemsRecordControl control on the AddItems page.
...
Public Class BaseItemsRecordControl
        ...
        Public Overridable Function CreateWhereClause() As WhereClause
            ...
            HttpContext.Current.Session("QueryString in AddItems") = recId
