...
<%@ Register Tagprefix="ServelInvocing" Namespace="ServelInvocing.UI.Controls.EditItems" Assembly="ServelInvocing" %>

<%@ Page Language="vb" EnableEventValidation="false" AutoEventWireup="false" Codebehind="EditItems.aspx.vb" Culture="en-IN" MasterPageFile="../Master Pages/VerticalMenu.master" Inherits="ServelInvocing.UI.EditItems" %>
...
<asp:ImageButton runat="server" id="id_item_groupAddRecordLink" causesvalidation="False" commandname="Redirect" imageurl="../Images/iconNewFlat.gif" tooltip="&lt;%# GetResourceValue(&quot;Btn:Add&quot;, &quot;ServelInvocing&quot;) %>">		
	</asp:ImageButton> </td><td class="fls"><asp:Literal runat="server" id="item_typeLabel" Text="Item Type">	</asp:Literal></td><td class="dfv"><asp:DropDownList runat="server" id="item_type" cssclass="field_input" onkeypress="dropDownListTypeAhead(this,false)"></asp:DropDownList>
...
<asp:ImageButton runat="server" id="uomAddRecordLink" causesvalidation="False" commandname="Redirect" imageurl="../Images/iconNewFlat.gif" tooltip="&lt;%# GetResourceValue(&quot;Btn:Add&quot;, &quot;ServelInvocing&quot;) %>">		
	</asp:ImageButton> </td><td class="fls"><asp:Literal runat="server" id="material_categoryLabel" Text="Material Category">	</asp:Literal></td><td class="dfv"><asp:TextBox runat="server" id="material_category" Columns="1" MaxLength="1" cssclass="field_input"></asp:TextBox>&nbsp;
...
<BaseClasses:TextBoxMaxLengthValidator runat="server" id="tariff_noTextBoxMaxLengthValidator" ControlToValidate="tariff_no" ErrorMessage="&lt;%# GetResourceValue(&quot;Val:ValueTooLong&quot;, &quot;ServelInvocing&quot;).Replace(&quot;{FieldName}&quot;, &quot;Tariff Number&quot;) %>"></BaseClasses:TextBoxMaxLengthValidator> </td><td class="fls"><asp:Literal runat="server" id="closing_stockLabel" Text="Closing Stock">	</asp:Literal></td><td class="dfv"><table border="0" cellpadding="0" cellspacing="0">
<tr>
...
<%# SystemUtils.GenerateIncrementDecrementButtons(true, FindControlRecursively("closing_stock"),"NumberTextBox","","","") %>
</td>
<td>
&nbsp;
