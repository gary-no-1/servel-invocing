...
' This file implements the code-behind class for ShowV_GST_InvoicesTable.aspx.
' ShowV_GST_InvoicesTable.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class ShowV_GST_InvoicesTable
        Inherits BaseApplicationPage
' Code-behind class for the ShowV_GST_InvoicesTable page.
...
#Region "Ajax Functions"
      ...
      <Services.WebMethod()> _
      Public Shared Function GetAutoCompletionList_V_GST_InvoicesSearch(ByVal prefixText As String, ByVal count As Integer) As String()
      ' GetV_GST_InvoicesSearchCompletionList gets the list of suggestions from the database.
      ' prefixText is the search text typed by the user .
      ' count specifies the number of suggestions to be returned.
      ' Customize by adding code before or after the call to  GetAutoCompletionList_V_GST_InvoicesSearch()
      ' or replace the call to GetAutoCompletionList_V_GST_InvoicesSearch().
      Return GetAutoCompletionList_V_GST_InvoicesSearch_Base(prefixText, count)
      End Function
...
#Region "Section 2: Do not modify this section."
        ...
        Public WithEvents e_commLabel As System.Web.UI.WebControls.LinkButton
        Public WithEvents grand_totalLabel As System.Web.UI.WebControls.LinkButton
        Public WithEvents gst_inv_dtLabel As System.Web.UI.WebControls.LinkButton
        Public WithEvents gst_stateLabel As System.Web.UI.WebControls.LinkButton
        ...
        Public WithEvents invoice_typeLabel As System.Web.UI.WebControls.LinkButton
        Public WithEvents item_totalLabel As System.Web.UI.WebControls.LinkButton
        Public WithEvents PageTitle As System.Web.UI.WebControls.Literal
        Public WithEvents reverse_chargeLabel As System.Web.UI.WebControls.LinkButton
        Public WithEvents sgstLabel As System.Web.UI.WebControls.LinkButton
        Public WithEvents site_gst_noLabel1 As System.Web.UI.WebControls.LinkButton
        Public WithEvents tax_rateLabel As System.Web.UI.WebControls.LinkButton
        Public WithEvents V_GST_InvoicesExportCSVButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents V_GST_InvoicesExportExcelButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents V_GST_InvoicesFilterButton As ThemeButton
        Public WithEvents V_GST_InvoicesPagination As Pagination
        Public WithEvents V_GST_InvoicesPDFButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents V_GST_InvoicesRefreshButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents V_GST_InvoicesResetButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents V_GST_InvoicesSearch As System.Web.UI.WebControls.TextBox
        Public WithEvents V_GST_InvoicesSearchButton As ThemeButton
        Public WithEvents V_GST_InvoicesTableControl As ServelInvocing.UI.Controls.ShowV_GST_InvoicesTable.V_GST_InvoicesTableControl
        Public WithEvents V_GST_InvoicesTitle As System.Web.UI.WebControls.Literal
        Public WithEvents V_GST_InvoicesWordButton As System.Web.UI.WebControls.ImageButton
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.V_GST_InvoicesTableControl.SaveData()
      ...
      End Sub
        ...
        Public Shared Function GetAutoCompletionList_V_GST_InvoicesSearch_Base(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim control as ServelInvocing.UI.Controls.ShowV_GST_InvoicesTable.V_GST_InvoicesTableControl 
            control = new ServelInvocing.UI.Controls.ShowV_GST_InvoicesTable.V_GST_InvoicesTableControl()
            
            Return control.GetAutoCompletionList_V_GST_InvoicesSearch(prefixText, count)
        ...
        Me.V_GST_InvoicesTableControl.LoadData()
