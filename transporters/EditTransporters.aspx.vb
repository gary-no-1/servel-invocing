...
' This file implements the code-behind class for EditTransporters.aspx.
' EditTransporters.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class EditTransporters
        Inherits BaseApplicationPage
' Code-behind class for the EditTransporters page.
...
#Region "Section 2: Do not modify this section."
        ...
        Public WithEvents TransportersRecordControl As ServelInvocing.UI.Controls.EditTransporters.TransportersRecordControl
        ...
        Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            Page.Title = GetResourceValue("Title:Edit") + " Transporters"
        End Sub
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.TransportersRecordControl.SaveData()
      ...
      End Sub
        ...
        Me.TransportersRecordControl.LoadData()
        ...
        Public Sub SaveButton_Click_Base(ByVal sender As Object, ByVal args As EventArgs)
            ...
            If Not TargetKey Is Nothing Then
                ...
                If Not Me.TransportersRecordControl Is Nothing AndAlso Not Me.TransportersRecordControl.DataSource Is Nothing Then
                      
                      id = Me.TransportersRecordControl.DataSource.id0.ToString
                      value = Me.TransportersRecordControl.DataSource.GetValue(Me.TransportersRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(DFKA)).ToString
                      ...
                      If Not Formula Is Nothing Then
                            value = EvaluateFormula(Formula, Me.TransportersRecordControl.DataSource)
                      End If
