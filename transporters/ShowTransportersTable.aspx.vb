...
' This file implements the code-behind class for ShowTransportersTable.aspx.
' ShowTransportersTable.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class ShowTransportersTable
        Inherits BaseApplicationPage
' Code-behind class for the ShowTransportersTable page.
...
#Region "Ajax Functions"
      ...
      <Services.WebMethod()> _
      Public Shared Function GetAutoCompletionList_TransportersSearch(ByVal prefixText As String, ByVal count As Integer) As String()
      ' GetTransportersSearchCompletionList gets the list of suggestions from the database.
      ' prefixText is the search text typed by the user .
      ' count specifies the number of suggestions to be returned.
      ' Customize by adding code before or after the call to  GetAutoCompletionList_TransportersSearch()
      ' or replace the call to GetAutoCompletionList_TransportersSearch().
      Return GetAutoCompletionList_TransportersSearch_Base(prefixText, count)
      End Function
...
#Region "Section 2: Do not modify this section."
        ...
        Public WithEvents TransportersCopyButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents TransportersDeleteButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents TransportersEditButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents TransportersExportCSVButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents TransportersExportExcelButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents TransportersImportButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents TransportersNewButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents TransportersPagination As Pagination
        Public WithEvents TransportersPDFButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents TransportersRefreshButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents TransportersResetButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents TransportersSearch As System.Web.UI.WebControls.TextBox
        Public WithEvents TransportersSearchButton As ThemeButton
        Public WithEvents TransportersTableControl As ServelInvocing.UI.Controls.ShowTransportersTable.TransportersTableControl
        Public WithEvents TransportersTitle As System.Web.UI.WebControls.Literal
        Public WithEvents TransportersToggleAll As System.Web.UI.WebControls.CheckBox
        Public WithEvents TransportersWordButton As System.Web.UI.WebControls.ImageButton
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.TransportersTableControl.SaveData()
      ...
      End Sub
        ...
        Public Shared Function GetAutoCompletionList_TransportersSearch_Base(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim control as ServelInvocing.UI.Controls.ShowTransportersTable.TransportersTableControl 
            control = new ServelInvocing.UI.Controls.ShowTransportersTable.TransportersTableControl()
            
            Return control.GetAutoCompletionList_TransportersSearch(prefixText, count)
        ...
        Me.TransportersTableControl.LoadData()
