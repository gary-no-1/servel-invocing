...
' ShowTransporters.aspx page.  The Row or RecordControl classes are the 
...
Namespace ServelInvocing.UI.Controls.ShowTransporters
...
' Base class for the TransportersRecordControl control on the ShowTransporters page.
...
Public Class BaseTransportersRecordControl
        ...
        Protected Overridable Sub Control_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
              ...
              AddHandler Me.TransportersDialogEditButton.Click, AddressOf TransportersDialogEditButton_Click
        ...
        Public Overridable Sub LoadData()        
            ...
            Dim Panel As System.Web.UI.WebControls.Panel = CType(MiscUtils.FindControlRecursively(Me, "TransportersRecordControlPanel"), System.Web.UI.WebControls.Panel)
            ...
            Me.DataSource = TransportersTable.GetRecord(recList(0).GetID.ToXmlString(), True)
        ...
        Public Overridable Function CreateWhereClause() As WhereClause
            ...
            If recId Is Nothing OrElse recId.Trim = "" Then
                ...
                Throw New Exception(Page.GetResourceValue("Err:UrlParamMissing", "ServelInvocing").Replace("{URL}", "Transporters"))
            End If
            HttpContext.Current.Session("QueryString in ShowTransporters") = recId
        ...
        Public Overridable Sub TransportersDialogEditButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
...
#Region "Helper Properties"
        ...
        Public ReadOnly Property TransportersDialogEditButton() As System.Web.UI.WebControls.ImageButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "TransportersDialogEditButton"), System.Web.UI.WebControls.ImageButton)
            End Get
        End Property
