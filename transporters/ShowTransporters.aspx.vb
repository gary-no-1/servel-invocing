...
' This file implements the code-behind class for ShowTransporters.aspx.
' ShowTransporters.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class ShowTransporters
        Inherits BaseApplicationPage
' Code-behind class for the ShowTransporters page.
...
#Region "Section 2: Do not modify this section."
        ...
        Public WithEvents TransportersDialogEditButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents TransportersRecordControl As ServelInvocing.UI.Controls.ShowTransporters.TransportersRecordControl
