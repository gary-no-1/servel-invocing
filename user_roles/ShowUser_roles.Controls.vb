...
' ShowUser_roles.aspx page.  The Row or RecordControl classes are the 
...
Namespace ServelInvocing.UI.Controls.ShowUser_roles
...
' Base class for the User_rolesRecordControl control on the ShowUser_roles page.
...
Public Class BaseUser_rolesRecordControl
        ...
        Protected Overridable Sub Control_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
              ...
              AddHandler Me.User_rolesDialogEditButton.Click, AddressOf User_rolesDialogEditButton_Click
        ...
        Public Overridable Function CreateWhereClause() As WhereClause
            ...
            End If
            HttpContext.Current.Session("QueryString in ShowUser_roles") = recId
        ...
        Public Overridable Sub User_rolesDialogEditButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
        ...
        Public Overridable Sub role_id_Click(ByVal sender As Object, ByVal args As EventArgs)
            ...
            ' Any code after the Response.Redirect call will not be executed, since the page is
            ' redirected to the URL.
            Dim url As String = "../roles/ShowRoles.aspx?Roles={User_rolesRecordControl:FK:FK_user_roles_roles}"
            Dim shouldRedirect As Boolean = True
            Dim TargetKey As String = Nothing
            Dim DFKA As String = Nothing
            Dim id As String = Nothing
        ...
        Public Overridable Sub user_id_Click(ByVal sender As Object, ByVal args As EventArgs)
            ...
            ' Any code after the Response.Redirect call will not be executed, since the page is
            ' redirected to the URL.
            Dim url As String = "../users/ShowUsers.aspx?Users={User_rolesRecordControl:FK:FK_user_roles_users}"
            Dim shouldRedirect As Boolean = True
            Dim TargetKey As String = Nothing
            Dim DFKA As String = Nothing
            Dim id As String = Nothing
...
#Region "Helper Properties"
        ...
        Public ReadOnly Property User_rolesDialogEditButton() As System.Web.UI.WebControls.ImageButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "User_rolesDialogEditButton"), System.Web.UI.WebControls.ImageButton)
            End Get
        End Property
