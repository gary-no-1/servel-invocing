...
' AddUser_roles.aspx page.  The Row or RecordControl classes are the 
...
Namespace ServelInvocing.UI.Controls.AddUser_roles
...
' Base class for the User_rolesRecordControl control on the AddUser_roles page.
...
Public Class BaseUser_rolesRecordControl
        ...
        Public Overridable Sub LoadData()        
            ...
            Me.DataSource = CType(User_rolesRecord.Copy(recList(0), False), User_rolesRecord)
        ...
        Public Overridable Sub GetUIData()
            ...
            For Each col In User_rolesRecord.TableUtils.TableDefinition.Columns()
        ...
        Public Overridable Function CreateWhereClause() As WhereClause
            ...
            HttpContext.Current.Session("QueryString in AddUser_roles") = recId
