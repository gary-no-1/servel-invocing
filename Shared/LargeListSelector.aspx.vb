...
Imports ServelInvocing.UI.Controls.LargeListSelector
...
#Region "Section 2: Do not modify this section."
        ...
        Public Shared Function GetAutoCompletionList_Base(ByVal startsWithText As String, ByVal containsText As String, ByVal count As Integer) As String()
            ...
            Dim control As ServelInvocing.UI.Controls.LargeListSelector.ItemsTable
            control = New ServelInvocing.UI.Controls.LargeListSelector.ItemsTable
