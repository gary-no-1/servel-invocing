...
Namespace ServelInvocing.UI
    ...
    Public Class BaseApplicationRecordControl
        ...
        ''' Allow for migration from earlier versions which did not have url encryption.
        Public Overridable Function ModifyRedirectUrl(ByVal redirectUrl As String, ByVal redirectArgument As String, ByVal rec As Object) As String
            Return EvaluateExpressions(redirectUrl, redirectArgument, rec, False)
        End Function

        Public Overridable Function ModifyRedirectUrl(ByVal redirectUrl As String, ByVal redirectArgument As String, ByVal rec As Object, ByVal bEncrypt As Boolean) As String
            Return EvaluateExpressions(redirectUrl, redirectArgument, rec, bEncrypt)
        End Function

        Public Overridable Function EvaluateExpressions(ByVal redirectUrl As String, ByVal redirectArgument As String, ByVal rec As Object, ByVal bEncrypt As Boolean) As String
...
#End Region
        ...
        ''' This function is called as <Products>TableControlRow.ROWNUM().
        ...
        ''' This function is called as <Products>TableControlRow.RANK().
        ...
        ''' This function is called as <Products>TableControlRow.RUNNINGTOTAL().
        ''' Say there are 5 rows and they contain 57, 32, 12, 19, 98.
