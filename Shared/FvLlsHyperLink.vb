    ...
    Public Class FvLlsHyperLink
     ...
     Public Property MinListItems() As Integer
        ...
        Protected Function DeriveNavigateUrl() As String
            ...
            tableName = CType(Me.Page, ServelInvocing.UI.BaseApplicationPage).Encrypt(tableName)
            fieldName = CType(Me.Page, ServelInvocing.UI.BaseApplicationPage).Encrypt(fieldName)
            displayFieldName = CType(Me.Page, ServelInvocing.UI.BaseApplicationPage).Encrypt(displayFieldName)
            formula = CType(Me.Page, ServelInvocing.UI.BaseApplicationPage).Encrypt(formula)
