...
#Region "Methods"
        ...
        ''' </summary>
        Public Function ImportRecords(ByVal isImportFirstRowChecked As Boolean) As BaseClasses.Utils.ImportedResults
        ...
        ''' </summary>
        Private Sub DoImport(ByVal rowValues() As String)
            Dim r As IRecord
            r = Me.DBTable.CreateRecord
            If (UpdateColumnValuesInRecord(rowValues, r)) Then
                r.Save()
        ...
        Private Function UpdateColumnValuesInRecord(ByVal rowValues() As String, ByVal record As IRecord) As Boolean
            Dim j As Integer = 0
            ...
            For Each data As String In rowValues
                ...
                Try
                    ...
                    If ((Me.ColumnNameList(j).ToString <> "") _
                        ...
                        Dim fkColumn As ForeignKey = Me.DBTable.TableDefinition.GetForeignKeyByColumnName(currentColumn.InternalName)
                        ...
                        If (Not (fkColumn) Is Nothing) Then
                            ...
                            If ((Not (fkColumn.PrimaryKeyDisplayColumns) Is Nothing) _
                                        AndAlso (fkColumn.PrimaryKeyDisplayColumns <> "")) Then
                            ...
                            End If
                            records = originalBaseTable.GetRecordList(wc.GetFilter, Nothing, 0, 100)
