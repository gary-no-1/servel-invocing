...
' This file implements the code-behind class for EditTax_types.aspx.
' EditTax_types.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class EditTax_types
        Inherits BaseApplicationPage
' Code-behind class for the EditTax_types page.
...
#Region "Section 2: Do not modify this section."
        ...
        Public WithEvents Tax_typesRecordControl As ServelInvocing.UI.Controls.EditTax_types.Tax_typesRecordControl
        ...
        Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            Page.Title = GetResourceValue("Title:Edit") + " Tax Types"
        End Sub
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.Tax_typesRecordControl.SaveData()
      ...
      End Sub
        ...
        Me.Tax_typesRecordControl.LoadData()
        ...
        Public Sub SaveButton_Click_Base(ByVal sender As Object, ByVal args As EventArgs)
            ...
            If Not TargetKey Is Nothing Then
                ...
                If Not Me.Tax_typesRecordControl Is Nothing AndAlso Not Me.Tax_typesRecordControl.DataSource Is Nothing Then
                      
                      id = Me.Tax_typesRecordControl.DataSource.tax_type.ToString
                      value = Me.Tax_typesRecordControl.DataSource.GetValue(Me.Tax_typesRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(DFKA)).ToString
                      ...
                      If Not Formula Is Nothing Then
                            value = EvaluateFormula(Formula, Me.Tax_typesRecordControl.DataSource)
                      End If
