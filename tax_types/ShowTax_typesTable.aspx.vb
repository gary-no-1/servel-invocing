...
' This file implements the code-behind class for ShowTax_typesTable.aspx.
' ShowTax_typesTable.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class ShowTax_typesTable
        Inherits BaseApplicationPage
' Code-behind class for the ShowTax_typesTable page.
...
#Region "Ajax Functions"
      ...
      <Services.WebMethod()> _
      Public Shared Function GetAutoCompletionList_Tax_typesSearch(ByVal prefixText As String, ByVal count As Integer) As String()
      ' GetTax_typesSearchCompletionList gets the list of suggestions from the database.
      ' prefixText is the search text typed by the user .
      ' count specifies the number of suggestions to be returned.
      ' Customize by adding code before or after the call to  GetAutoCompletionList_Tax_typesSearch()
      ' or replace the call to GetAutoCompletionList_Tax_typesSearch().
      Return GetAutoCompletionList_Tax_typesSearch_Base(prefixText, count)
      End Function
...
#Region "Section 2: Do not modify this section."
        ...
        Public WithEvents tax_typeLabel1 As System.Web.UI.WebControls.LinkButton
        Public WithEvents Tax_typesCopyButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents Tax_typesDeleteButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents Tax_typesEditButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents Tax_typesExportCSVButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents Tax_typesExportExcelButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents Tax_typesImportButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents Tax_typesNewButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents Tax_typesPagination As Pagination
        Public WithEvents Tax_typesPDFButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents Tax_typesRefreshButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents Tax_typesResetButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents Tax_typesSearch As System.Web.UI.WebControls.TextBox
        Public WithEvents Tax_typesSearchButton As ThemeButton
        Public WithEvents Tax_typesTableControl As ServelInvocing.UI.Controls.ShowTax_typesTable.Tax_typesTableControl
        Public WithEvents Tax_typesTitle As System.Web.UI.WebControls.Literal
        Public WithEvents Tax_typesToggleAll As System.Web.UI.WebControls.CheckBox
        Public WithEvents Tax_typesWordButton As System.Web.UI.WebControls.ImageButton
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.Tax_typesTableControl.SaveData()
      ...
      End Sub
        ...
        Public Shared Function GetAutoCompletionList_Tax_typesSearch_Base(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim control as ServelInvocing.UI.Controls.ShowTax_typesTable.Tax_typesTableControl 
            control = new ServelInvocing.UI.Controls.ShowTax_typesTable.Tax_typesTableControl()
            
            Return control.GetAutoCompletionList_Tax_typesSearch(prefixText, count)
        ...
        Me.Tax_typesTableControl.LoadData()
