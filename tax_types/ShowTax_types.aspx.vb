...
' This file implements the code-behind class for ShowTax_types.aspx.
' ShowTax_types.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class ShowTax_types
        Inherits BaseApplicationPage
' Code-behind class for the ShowTax_types page.
...
#Region "Section 2: Do not modify this section."
        ...
        Public WithEvents Tax_typesDialogEditButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents Tax_typesRecordControl As ServelInvocing.UI.Controls.ShowTax_types.Tax_typesRecordControl
