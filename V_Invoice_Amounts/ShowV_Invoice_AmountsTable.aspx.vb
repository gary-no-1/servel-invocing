...
' This file implements the code-behind class for ShowV_Invoice_AmountsTable.aspx.
' ShowV_Invoice_AmountsTable.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class ShowV_Invoice_AmountsTable
        Inherits BaseApplicationPage
' Code-behind class for the ShowV_Invoice_AmountsTable page.
...
#Region "Ajax Functions"
      ...
      <Services.WebMethod()> _
      Public Shared Function GetAutoCompletionList_V_Invoice_AmountsSearch(ByVal prefixText As String, ByVal count As Integer) As String()
      ' GetV_Invoice_AmountsSearchCompletionList gets the list of suggestions from the database.
      ' prefixText is the search text typed by the user .
      ' count specifies the number of suggestions to be returned.
      ' Customize by adding code before or after the call to  GetAutoCompletionList_V_Invoice_AmountsSearch()
      ' or replace the call to GetAutoCompletionList_V_Invoice_AmountsSearch().
      Return GetAutoCompletionList_V_Invoice_AmountsSearch_Base(prefixText, count)
      End Function
...
#Region "Section 2: Do not modify this section."
        ...
        Public WithEvents inv_dtLabel As System.Web.UI.WebControls.LinkButton
        Public WithEvents inv_dtLabel1 As System.Web.UI.WebControls.Literal
        Public WithEvents inv_noLabel1 As System.Web.UI.WebControls.LinkButton
        Public WithEvents item_totalLabel As System.Web.UI.WebControls.LinkButton
        Public WithEvents nameLabel As System.Web.UI.WebControls.LinkButton
        Public WithEvents nameLabel1 As System.Web.UI.WebControls.Literal
        Public WithEvents oth_amtLabel As System.Web.UI.WebControls.LinkButton
        Public WithEvents PageTitle As System.Web.UI.WebControls.Literal
        Public WithEvents srv_taxLabel As System.Web.UI.WebControls.LinkButton
        Public WithEvents V_Invoice_AmountsExportCSVButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents V_Invoice_AmountsExportExcelButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents V_Invoice_AmountsFilterButton As ThemeButton
        Public WithEvents V_Invoice_AmountsPagination As Pagination
        Public WithEvents V_Invoice_AmountsPDFButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents V_Invoice_AmountsRefreshButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents V_Invoice_AmountsResetButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents V_Invoice_AmountsSearch As System.Web.UI.WebControls.TextBox
        Public WithEvents V_Invoice_AmountsSearchButton As ThemeButton
        Public WithEvents V_Invoice_AmountsTableControl As ServelInvocing.UI.Controls.ShowV_Invoice_AmountsTable.V_Invoice_AmountsTableControl
        Public WithEvents V_Invoice_AmountsTitle As System.Web.UI.WebControls.Literal
        Public WithEvents V_Invoice_AmountsWordButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents vat_amtLabel As System.Web.UI.WebControls.LinkButton
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.V_Invoice_AmountsTableControl.SaveData()
      ...
      End Sub
        ...
        Public Shared Function GetAutoCompletionList_V_Invoice_AmountsSearch_Base(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim control as ServelInvocing.UI.Controls.ShowV_Invoice_AmountsTable.V_Invoice_AmountsTableControl 
            control = new ServelInvocing.UI.Controls.ShowV_Invoice_AmountsTable.V_Invoice_AmountsTableControl()
            
            Return control.GetAutoCompletionList_V_Invoice_AmountsSearch(prefixText, count)
        ...
        Me.V_Invoice_AmountsTableControl.LoadData()
