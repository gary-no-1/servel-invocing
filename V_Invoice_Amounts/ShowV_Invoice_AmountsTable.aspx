...
<asp:TextBox runat="server" id="inv_dtFromFilter" columns="30" cssclass="Filter_Input" onkeyup="DateFormat(this, this.value, event.keyCode, 'dd-mm-yyyy')" timestring="&quot;00:00:00&quot;" AutoPostback="False" style="vertical-align:middle">	</asp:TextBox>
	...
	<Selectors:CalendarExtendarClass runat="server" ID="inv_dtToFilterCalenderExtender" TargetControlID="inv_dtToFilter" CssClass="MyCalendar">
...
</td><td class="filbc"><ServelInvocing:ThemeButton runat="server" id="V_Invoice_AmountsFilterButton" button-causesvalidation="False" button-commandname="Search" button-text="&lt;%# GetResourceValue(&quot;Btn:SearchGoButtonText&quot;, &quot;ServelInvocing&quot;) %>" postback="False"></ServelInvocing:ThemeButton></td></tr><tr><td class="fila"><asp:Literal runat="server" id="nameLabel1" Text="Name">	</asp:Literal></td><td><asp:DropDownList runat="server" id="nameFilter" autopostback="True" cssclass="Filter_Input" onkeypress="dropDownListTypeAhead(this,false)">	</asp:DropDownList> </td><td class="filbc"></td></tr></table>
                        ...
                        </th><th class="thc" scope="col"><asp:LinkButton runat="server" id="nameLabel" Text="Name" CausesValidation="False">	</asp:LinkButton></th><th class="thc" scope="col"><asp:LinkButton runat="server" id="item_totalLabel" Text="Item Total" CausesValidation="False">	</asp:LinkButton>
...
<tr><td class="ttc"><asp:Literal runat="server" id="inv_no"></asp:Literal> </td><td class="ttc"><asp:Literal runat="server" id="inv_dt"></asp:Literal> </td><td class="ttc" style="text-align:left;"><asp:Literal runat="server" id="name"></asp:Literal></td><td class="ttc" style="text-align: right;"><asp:Literal runat="server" id="item_total"></asp:Literal> </td><td class="ttc" style="text-align: right;"><asp:Literal runat="server" id="excise_amt"></asp:Literal> </td><td class="ttc" style="text-align: right;"><asp:Literal runat="server" id="vat_amt"></asp:Literal> </td><td class="ttc" style="text-align: right;"><asp:Literal runat="server" id="cst_amt"></asp:Literal> </td><td class="ttc" style="text-align: right;"><asp:Literal runat="server" id="srv_tax"></asp:Literal> </td><td class="ttc" style="text-align: right;"><asp:Literal runat="server" id="oth_amt"></asp:Literal> </td><td class="ttc" style="text-align: right;"><asp:Literal runat="server" id="grand_total"></asp:Literal> </td></tr></ServelInvocing:V_Invoice_AmountsTableControlRow>
</ITEMTEMPLATE>
