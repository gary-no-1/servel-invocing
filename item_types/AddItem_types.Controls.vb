...
' AddItem_types.aspx page.  The Row or RecordControl classes are the 
...
Namespace ServelInvocing.UI.Controls.AddItem_types
...
' Base class for the Item_typesRecordControl control on the AddItem_types page.
...
Public Class BaseItem_typesRecordControl
        ...
        Public Overridable Sub LoadData()        
            ...
            Me.DataSource = CType(Item_typesRecord.Copy(recList(0), False), Item_typesRecord)
        ...
        Public Overridable Sub GetUIData()
            ...
            For Each col In Item_typesRecord.TableUtils.TableDefinition.Columns()
        ...
        Public Overridable Function CreateWhereClause() As WhereClause
            ...
            HttpContext.Current.Session("QueryString in AddItem_types") = recId
