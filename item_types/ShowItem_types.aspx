...
</td></tr><tr><td><asp:panel id="Item_typesRecordControlCollapsibleRegion" runat="server"><table class="dBody" cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td><asp:panel id="Item_typesRecordControlPanel" runat="server"><table cellpadding="0" cellspacing="0" border="0"><tr><td class="fls"><asp:Literal runat="server" id="item_typeLabel" Text="Item Type">	</asp:Literal></td><td class="dfv"><asp:Literal runat="server" id="item_type"></asp:Literal> </td></tr><tr><td class="fls"><asp:Literal runat="server" id="gst_serviceLabel" Text="Service Type">	</asp:Literal></td><td class="dfv"><asp:Literal runat="server" id="gst_service"></asp:Literal></td></tr></table></asp:panel>
</td></tr></table>
