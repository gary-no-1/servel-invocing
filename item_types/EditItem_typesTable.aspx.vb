...
' This file implements the code-behind class for EditItem_typesTable.aspx.
' EditItem_typesTable.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class EditItem_typesTable
        Inherits BaseApplicationPage
' Code-behind class for the EditItem_typesTable page.
...
#Region "Section 2: Do not modify this section."
        ...
        Public WithEvents Item_typesTableControl As ServelInvocing.UI.Controls.EditItem_typesTable.Item_typesTableControl
    ...
    End Function
      ...
      End Sub
        ...
        Public Shared Function GetAutoCompletionList_Item_typesSearch_Base(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim control as ServelInvocing.UI.Controls.EditItem_typesTable.Item_typesTableControl 
            control = new ServelInvocing.UI.Controls.EditItem_typesTable.Item_typesTableControl()
