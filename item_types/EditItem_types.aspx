<%@ Page Language="vb" EnableEventValidation="false" AutoEventWireup="false" Codebehind="EditItem_types.aspx.vb" Culture="en-IN" MasterPageFile="../Master Pages/VerticalMenu.master" Inherits="ServelInvocing.UI.EditItem_types" %>
<%@ Register Tagprefix="Selectors" Namespace="ServelInvocing" Assembly="ServelInvocing" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<%@ Register Tagprefix="ServelInvocing" Namespace="ServelInvocing.UI.Controls.EditItem_types" Assembly="ServelInvocing" %>
...
<BaseClasses:TextBoxMaxLengthValidator runat="server" id="item_typeTextBoxMaxLengthValidator" ControlToValidate="item_type" ErrorMessage="&lt;%# GetResourceValue(&quot;Val:ValueTooLong&quot;, &quot;ServelInvocing&quot;).Replace(&quot;{FieldName}&quot;, &quot;Item Type&quot;) %>"></BaseClasses:TextBoxMaxLengthValidator> </td></tr><tr><td class="fls"><asp:Literal runat="server" id="gst_serviceLabel" Text="Service Type">	</asp:Literal></td><td class="dfv"><asp:CheckBox runat="server" id="gst_service"></asp:CheckBox></td></tr></table></asp:panel>
</td></tr></table>
