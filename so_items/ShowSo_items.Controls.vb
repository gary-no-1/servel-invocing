...
' ShowSo_items.aspx page.  The Row or RecordControl classes are the 
...
Namespace ServelInvocing.UI.Controls.ShowSo_items

#Region "Section 1: Place your customizations here."

    
Public Class So_itemsRecordControl
        Inherits BaseSo_itemsRecordControl
        ' The BaseSo_itemsRecordControl implements the LoadData, DataBind and other
...
' Base class for the So_itemsRecordControl control on the ShowSo_items page.
' Do not modify this class. Instead override any method in So_itemsRecordControl.
Public Class BaseSo_itemsRecordControl
        Inherits ServelInvocing.UI.BaseApplicationRecordControl

        '  To customize, override this method in So_itemsRecordControl.
        ...
        Protected Overridable Sub Control_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
              ...
              AddHandler Me.So_itemsDialogEditButton.Click, AddressOf So_itemsDialogEditButton_Click
        ...
        Public Overridable Sub LoadData()        
            ...
            Dim Panel As System.Web.UI.WebControls.Panel = CType(MiscUtils.FindControlRecursively(Me, "So_itemsRecordControlPanel"), System.Web.UI.WebControls.Panel)
            ...
            Dim recList() As So_itemsRecord = So_itemsTable.GetRecords(wc, Nothing, 0, 2)
            ...
            Me.DataSource = So_itemsTable.GetRecord(recList(0).GetID.ToXmlString(), True)
                  
        End Sub

        ' Populate the UI controls using the DataSource.  To customize, override this method in So_itemsRecordControl.
        ...
        Public Overridable Sub Setid_so_hdr()
            ...
            If Me.DataSource IsNot Nothing AndAlso Me.DataSource.id_so_hdrSpecified Then
                ...
                ' The Format method will return the Display Foreign Key As (DFKA) value
                                Dim formattedValue As String = Me.DataSource.Format(So_itemsTable.id_so_hdr)
            ...
            Else 
                ...
                Me.id_so_hdr.Text = So_itemsTable.id_so_hdr.Format(So_itemsTable.id_so_hdr.DefaultValue)
        ...
        Public Overridable Function CreateWhereClause() As WhereClause
            ...
            Dim recId As String = Me.Page.Request.QueryString.Item("So_items")
                
            If recId Is Nothing OrElse recId.Trim = "" Then
                ' Get the error message from the application resource file.
                Throw New Exception(Page.GetResourceValue("Err:UrlParamMissing", "ServelInvocing").Replace("{URL}", "So_items"))
            End If
            HttpContext.Current.Session("QueryString in ShowSo_items") = recId
            ...
            If KeyValue.IsXmlKey(recId) Then
                ...
                wc.iAND(So_itemsTable.id0, BaseFilter.ComparisonOperator.EqualsTo, pkValue.GetColumnValue(So_itemsTable.id0).ToString())
        
            Else
                ' The URL parameter contains the actual value, not an XML structure.
                
                wc.iAND(So_itemsTable.id0, BaseFilter.ComparisonOperator.EqualsTo, recId)
        ...
        Public Overridable Sub So_itemsDialogEditButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
        ...
        Public Overridable Sub id_item_Click(ByVal sender As Object, ByVal args As EventArgs)
            ...
            ' Any code after the Response.Redirect call will not be executed, since the page is
            ' redirected to the URL.
            Dim url As String = "../items/ShowItems.aspx?Items={So_itemsRecordControl:FK:so_items_items_id_item_FK}"
            Dim shouldRedirect As Boolean = True
            Dim TargetKey As String = Nothing
            Dim DFKA As String = Nothing
            Dim id As String = Nothing
        ...
        Public Overridable Sub id_so_hdr_Click(ByVal sender As Object, ByVal args As EventArgs)
            ...
            ' Any code after the Response.Redirect call will not be executed, since the page is
            ' redirected to the URL.
            Dim url As String = "../so_hdr/ShowSo_hdr.aspx?So_hdr={So_itemsRecordControl:FK:so_items_so_hdr_id_so_hdr_FK}"
            Dim shouldRedirect As Boolean = True
            Dim TargetKey As String = Nothing
            Dim DFKA As String = Nothing
            Dim id As String = Nothing
        ...
        Public Property RecordUniqueId() As String
            Get
                Return CType(Me.ViewState("BaseSo_itemsRecordControl_Rec"), String)
            End Get
            Set(ByVal value As String)
                Me.ViewState("BaseSo_itemsRecordControl_Rec") = value
            End Set
        End Property
...
#Region "Helper Properties"
        ...
        Public ReadOnly Property So_itemsDialogEditButton() As System.Web.UI.WebControls.ImageButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "So_itemsDialogEditButton"), System.Web.UI.WebControls.ImageButton)
            End Get
        End Property
        
        Public ReadOnly Property So_itemsTitle() As System.Web.UI.WebControls.Literal
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "So_itemsTitle"), System.Web.UI.WebControls.Literal)
            End Get
        End Property
