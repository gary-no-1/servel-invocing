...
' ShowInv_itemsTable.aspx page.  The Row or RecordControl classes are the 
...
Namespace ServelInvocing.UI.Controls.ShowInv_itemsTable
...
' Base class for the Inv_itemsTableControlRow control on the ShowInv_itemsTable page.
...
Public Class BaseInv_itemsTableControlRow
        ...
        Protected Overridable Sub Control_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
			...
			Me.Page.LoadFocusScripts(Me)
              ...
              Me.Inv_itemsRowDeleteButton.Attributes.Add("onClick", "return (confirm('" & (CType(Me.Page,BaseApplicationPage)).GetResourceValue("DeleteRecordConfirm", "ServelInvocing") & "'));")
              ' Register the event handlers.
          
              AddHandler Me.Inv_itemsRowCopyButton.Click, AddressOf Inv_itemsRowCopyButton_Click
              
              AddHandler Me.Inv_itemsRowDeleteButton.Click, AddressOf Inv_itemsRowDeleteButton_Click
              
              AddHandler Me.Inv_itemsRowEditButton.Click, AddressOf Inv_itemsRowEditButton_Click
              
              AddHandler Me.Inv_itemsRowViewButton.Click, AddressOf Inv_itemsRowViewButton_Click
        ...
        Public Overridable Sub Inv_itemsRowCopyButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
        ...
        ' event handler for ImageButton
        Public Overridable Sub Inv_itemsRowDeleteButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
      ...
      Me.Page.CommitTransaction(sender)
        ...
        ' event handler for ImageButton
        Public Overridable Sub Inv_itemsRowEditButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
            ...
            ' Any code after the Response.Redirect call will not be executed, since the page is
            ' redirected to the URL.
            Dim url As String = "../inv_items/EditInv_items.aspx?Inv_items={PK}"
            Dim shouldRedirect As Boolean = True
            Dim TargetKey As String = Nothing
            Dim DFKA As String = Nothing
            Dim id As String = Nothing
        ...
        ' event handler for ImageButton
        Public Overridable Sub Inv_itemsRowViewButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
            ...
            ' Any code after the Response.Redirect call will not be executed, since the page is
            ' redirected to the URL.
            Dim url As String = "../inv_items/ShowInv_items.aspx?Inv_items={PK}"
            Dim shouldRedirect As Boolean = True
            Dim TargetKey As String = Nothing
            Dim DFKA As String = Nothing
            Dim id As String = Nothing
        ...
        Public Overridable Sub id_inv_hdr_Click(ByVal sender As Object, ByVal args As EventArgs)
            ...
            ' Any code after the Response.Redirect call will not be executed, since the page is
            ' redirected to the URL.
            Dim url As String = "../inv_hdr/ShowInv_hdr.aspx?Inv_hdr={Inv_itemsTableControlRow:FK:inv_items_inv_hdr_id_inv_hdr_FK}"
            Dim shouldRedirect As Boolean = True
            Dim TargetKey As String = Nothing
            Dim DFKA As String = Nothing
            Dim id As String = Nothing
...
#Region "Helper Properties"
        ...
        Public ReadOnly Property Inv_itemsRowCopyButton() As System.Web.UI.WebControls.ImageButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "Inv_itemsRowCopyButton"), System.Web.UI.WebControls.ImageButton)
            End Get
        End Property
        
        Public ReadOnly Property Inv_itemsRowDeleteButton() As System.Web.UI.WebControls.ImageButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "Inv_itemsRowDeleteButton"), System.Web.UI.WebControls.ImageButton)
            End Get
        End Property
        
        Public ReadOnly Property Inv_itemsRowEditButton() As System.Web.UI.WebControls.ImageButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "Inv_itemsRowEditButton"), System.Web.UI.WebControls.ImageButton)
            End Get
        End Property
        
        Public ReadOnly Property Inv_itemsRowViewButton() As System.Web.UI.WebControls.ImageButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "Inv_itemsRowViewButton"), System.Web.UI.WebControls.ImageButton)
            End Get
        End Property
...
' Base class for the Inv_itemsTableControl control on the ShowInv_itemsTable page.
...
Public Class BaseInv_itemsTableControl
        ...
        Protected Overridable Sub Control_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Init
           ...
           ' Setup the filter and search events.
            ...
            If Not Me.Page.IsPostBack Then
                Dim initialVal As String = ""
                If  Me.InSession(Me.Inv_itemsSearch) 				
                    initialVal = Me.GetFromSession(Me.Inv_itemsSearch)
                
                End If
                If initialVal <> ""				
                        
                        Me.Inv_itemsSearch.Text = initialVal
        ...
        Protected Overridable Sub Control_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            SaveControlsToSession_Ajax()
              ...
              ' Show confirmation message on Click
              Me.Inv_itemsDeleteButton.Attributes.Add("onClick", "return (confirm('" & (CType(Me.Page,BaseApplicationPage)).GetResourceValue("DeleteConfirm", "ServelInvocing") & "'));")
            ...
            ' Setup the button events.
              ...
              AddHandler Me.Inv_itemsCopyButton.Click, AddressOf Inv_itemsCopyButton_Click
              
              AddHandler Me.Inv_itemsDeleteButton.Click, AddressOf Inv_itemsDeleteButton_Click
              
              AddHandler Me.Inv_itemsEditButton.Click, AddressOf Inv_itemsEditButton_Click
              ...
              AddHandler Me.Inv_itemsImportButton.Click, AddressOf Inv_itemsImportButton_Click
              
              AddHandler Me.Inv_itemsNewButton.Click, AddressOf Inv_itemsNewButton_Click
            ...
            AddHandler Me.Inv_itemsSearchButton.Button.Click, AddressOf Inv_itemsSearchButton_Click
      ...
      End Sub
          ...
          End If
            ...
            Me.Page.PregetDfkaRecords(Inv_itemsTable.id_inv_hdr, Me.DataSource)
        ...
        Public Overridable Function CreateWhereClause() As WhereClause
            ...
            If IsValueSelected(Me.id_inv_hdrFilter) Then
                ...
                wc.iAND(Inv_itemsTable.id_inv_hdr, BaseFilter.ComparisonOperator.EqualsTo, MiscUtils.GetSelectedValue(Me.id_inv_hdrFilter, Me.GetFromSession(Me.id_inv_hdrFilter)), False, False)
            ...
            If IsValueSelected(Me.id_itemFilter) Then
                ...
                wc.iAND(Inv_itemsTable.id_item, BaseFilter.ComparisonOperator.EqualsTo, MiscUtils.GetSelectedValue(Me.id_itemFilter, Me.GetFromSession(Me.id_itemFilter)), False, False)
            
                
            End If
                       
            If IsValueSelected(Me.Inv_itemsSearch) Then
                ' Strip "..." from begin and ending of the search text, otherwise the search will return 0 values as in database "..." is not stored.
                If Me.Inv_itemsSearch.Text.StartsWith("...") Then
                    Me.Inv_itemsSearch.Text = Me.Inv_itemsSearch.Text.SubString(3,Me.Inv_itemsSearch.Text.Length-3)
                End If
                If Me.Inv_itemsSearch.Text.EndsWith("...") then
                    Me.Inv_itemsSearch.Text = Me.Inv_itemsSearch.Text.SubString(0,Me.Inv_itemsSearch.Text.Length-3)
                End If
                
                Dim formatedSearchText As String = MiscUtils.GetSelectedValue(Me.Inv_itemsSearch, Me.GetFromSession(Me.Inv_itemsSearch))
        ...
        ' These clauses are added depending on operator and fields selected in Control's property page, bindings tab.
                    ...
                    search.iOR(Inv_itemsTable.item_code, BaseFilter.ComparisonOperator.Contains, MiscUtils.GetSelectedValue(Me.Inv_itemsSearch, Me.GetFromSession(Me.Inv_itemsSearch)), True, False)
        
                    search.iOR(Inv_itemsTable.item_description, BaseFilter.ComparisonOperator.Contains, MiscUtils.GetSelectedValue(Me.Inv_itemsSearch, Me.GetFromSession(Me.Inv_itemsSearch)), True, False)
        ...
        Public Overridable Function CreateWhereClause(ByVal searchText as String, ByVal fromSearchControl as String, ByVal AutoTypeAheadSearch as String, ByVal AutoTypeAheadWordSeparators as String) As WhereClause
            ...
            If IsValueSelected(id_inv_hdrFilterSelectedValue) Then
                 ...
                 wc.iAND(Inv_itemsTable.id_inv_hdr, BaseFilter.ComparisonOperator.EqualsTo, id_inv_hdrFilterSelectedValue, false, False)
            ...
            If IsValueSelected(id_itemFilterSelectedValue) Then
                 ...
                 wc.iAND(Inv_itemsTable.id_item, BaseFilter.ComparisonOperator.EqualsTo, id_itemFilterSelectedValue, false, False)
             
             End If
                      
            If IsValueSelected(searchText) and fromSearchControl = "Inv_itemsSearch" Then
                ...
                If IsValueSelected(formatedSearchText) Then
                    ...
                    If InvariantLCase(AutoTypeAheadSearch).equals("wordsstartingwithsearchstring") Then
                        ...
                        search.iOR(Inv_itemsTable.item_code, BaseFilter.ComparisonOperator.Starts_With, formatedSearchText, True, False)
                        search.iOR(Inv_itemsTable.item_code, BaseFilter.ComparisonOperator.Contains, AutoTypeAheadWordSeparators & formatedSearchText, True, False)
                
                        search.iOR(Inv_itemsTable.item_description, BaseFilter.ComparisonOperator.Starts_With, formatedSearchText, True, False)
                        search.iOR(Inv_itemsTable.item_description, BaseFilter.ComparisonOperator.Contains, AutoTypeAheadWordSeparators & formatedSearchText, True, False)
                
                    Else
                        
                        search.iOR(Inv_itemsTable.item_code, BaseFilter.ComparisonOperator.Contains, formatedSearchText, True, False)
                        search.iOR(Inv_itemsTable.item_description, BaseFilter.ComparisonOperator.Contains, formatedSearchText, True, False)
                    End If
                    wc.iAND(search)
        ...
        Public Overridable Function GetAutoCompletionList_Inv_itemsSearch(ByVal prefixText As String, ByVal count As Integer) As String()
            Dim resultList As ArrayList = New ArrayList
            Dim wordList As ArrayList = New ArrayList
            Dim iteration As Integer = 0
            
            Dim wc As WhereClause = CreateWhereClause(prefixText,"Inv_itemsSearch", "WordsStartingWithSearchString", "[^a-zA-Z0-9]")
            While (resultList.Count < count AndAlso iteration < 5)
                ' Fetch 100 records in each iteration
                Dim recordList () As ServelInvocing.Business.Inv_itemsRecord = Inv_itemsTable.GetRecords(wc, Nothing, iteration, 100)
                Dim rec As Inv_itemsRecord = Nothing
                ...
                For Each rec In recordList 
                    ...
                    resultItem = rec.Format(Inv_itemsTable.item_code)
                    ...
                    resultItem = rec.Format(Inv_itemsTable.item_description)
                    If resultItem IsNot Nothing AndAlso resultItem.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture).Contains(prefixText.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture))  Then
                ...
                For Each repItem In rep.Items
                    ...
                    If recControl.Visible AndAlso recControl.IsNewRecord() Then
                        ...
                        If recControl.id_inv_hdr.Text <> "" Then
                            rec.Parse(recControl.id_inv_hdr.Text, Inv_itemsTable.id_inv_hdr)
                        End If
        ...
        Public Overridable Sub SetInv_itemsSearch()
        ...
        Protected Overrides Sub SaveControlsToSession()
            ...
            Me.SaveToSession(Me.Inv_itemsSearch, Me.Inv_itemsSearch.Text)
      ...
      Me.SaveToSession("Inv_itemsSearch_Ajax", Me.Inv_itemsSearch.Text)
        ...
        Protected Overrides Sub ClearControlsFromSession()
            ...
            Me.RemoveFromSession(Me.Inv_itemsSearch)
        ...
        Public Overridable Sub ass_valueLabel_Click(ByVal sender As Object, ByVal args As EventArgs)
            ...
            Dim sd As OrderByItem = Me.CurrentSortOrder.Find(Inv_itemsTable.ass_value)
            If sd Is Nothing Then
                ' First time sort, so add sort order for ass_value.
                Me.CurrentSortOrder.Reset()
                Me.CurrentSortOrder.Add(Inv_itemsTable.ass_value, OrderByItem.OrderDir.Asc)
            Else
        ...
        Public Overridable Sub id_inv_hdrLabel1_Click(ByVal sender As Object, ByVal args As EventArgs)
            ...
            Dim sd As OrderByItem = Me.CurrentSortOrder.Find(Inv_itemsTable.id_inv_hdr)
            If sd Is Nothing Then
                ' First time sort, so add sort order for id_inv_hdr.
                Me.CurrentSortOrder.Reset()
                Me.CurrentSortOrder.Add(Inv_itemsTable.id_inv_hdr, OrderByItem.OrderDir.Asc)
            Else
        ...
        Public Overridable Sub item_codeLabel_Click(ByVal sender As Object, ByVal args As EventArgs)
            ...
            Dim sd As OrderByItem = Me.CurrentSortOrder.Find(Inv_itemsTable.item_code)
            If sd Is Nothing Then
                ' First time sort, so add sort order for item_code.
                Me.CurrentSortOrder.Reset()
                Me.CurrentSortOrder.Add(Inv_itemsTable.item_code, OrderByItem.OrderDir.Asc)
            Else
        ...
        ' event handler for ImageButton
        Public Overridable Sub Inv_itemsCopyButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
        ...
        ' event handler for ImageButton
        Public Overridable Sub Inv_itemsDeleteButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
      ...
      Me.Page.CommitTransaction(sender)
        ...
        ' event handler for ImageButton
        Public Overridable Sub Inv_itemsEditButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
        ...
        Public Overridable Sub Inv_itemsExportExcelButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
            ...
            ' a format string from Excel's Format Cell menu. For example "dddd, mmmm dd, yyyy h:mm AM/PM;@", "#,##0.00"
             excelReport.AddColumn(New ExcelColumn(Inv_itemsTable.id_inv_hdr, "Default"))
             excelReport.AddColumn(New ExcelColumn(Inv_itemsTable.id_item, "Default"))
             excelReport.AddColumn(New ExcelColumn(Inv_itemsTable.item_code, "Default"))
             ...
             excelReport.AddColumn(New ExcelColumn(Inv_itemsTable.ass_value, "Standard"))
        ...
        ' event handler for ImageButton
        Public Overridable Sub Inv_itemsImportButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
            ...
            ' Any code after the Response.Redirect call will not be executed, since the page is
            ' redirected to the URL.
            Dim url As String = "../Shared/SelectFileToImport.aspx?TableName=Inv_items"
            Try
                ' Enclose all database retrieval/update code within a Transaction boundary
                DbUtils.StartTransaction
        ...
        ' event handler for ImageButton
        Public Overridable Sub Inv_itemsNewButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
        ...
        Public Overridable Sub Inv_itemsPDFButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
            ...
            Try
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowInv_itemsTable.Inv_itemsPDFButton.report")
                ' report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "inv_items"
                ' If ShowInv_itemsTable.Inv_itemsPDFButton.report specifies a valid report template,
                ...
                ' The 5th parameter represents the relative width of the column   			
                 report.AddColumn(Inv_itemsTable.id_inv_hdr.Name, ReportEnum.Align.Left, "${id_inv_hdr}", ReportEnum.Align.Left, 30)
                 report.AddColumn(Inv_itemsTable.id_item.Name, ReportEnum.Align.Left, "${id_item}", ReportEnum.Align.Left, 24)
                 report.AddColumn(Inv_itemsTable.item_code.Name, ReportEnum.Align.Left, "${item_code}", ReportEnum.Align.Left, 24)
                 ...
                 report.AddColumn(Inv_itemsTable.ass_value.Name, ReportEnum.Align.Right, "${ass_value}", ReportEnum.Align.Right, 20)
                    ...
                    If Not (records Is Nothing) AndAlso records.Length > 0 AndAlso whereClause.RunQuery Then 
                        For Each record As Inv_itemsRecord In records 
                            ...
                            ' The 4th parameters represent the maximum length of the data value being shown
                                                         report.AddData("${id_inv_hdr}", record.Format(Inv_itemsTable.id_inv_hdr), ReportEnum.Align.Left)
                             report.AddData("${id_item}", record.Format(Inv_itemsTable.id_item), ReportEnum.Align.Left)
                             report.AddData("${item_code}", record.Format(Inv_itemsTable.item_code), ReportEnum.Align.Left, 100)
                             ...
                             report.AddData("${ass_value}", record.Format(Inv_itemsTable.ass_value), ReportEnum.Align.Right, 100)
        ...
        Public Overridable Sub Inv_itemsWordButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
            ...
            Try
                ...
                report.SpecificReportFileName = Page.Server.MapPath("ShowInv_itemsTable.Inv_itemsWordButton.word")
                ' report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "inv_items"
                ' If ShowInv_itemsTable.Inv_itemsWordButton.report specifies a valid report template,
                ' AddColumn method will generate a report template.
                ' Each AddColumn method-call specifies a column
                ' The 1st parameter represents the text of the column header
                ' The 2nd parameter represents the horizontal alignment of the column header
        ...
        Public Overridable Sub Inv_itemsSearchButton_Click(ByVal sender As Object, ByVal args As EventArgs)
...
#Region "Helper Properties"
        ...
        Public ReadOnly Property Inv_itemsCopyButton() As System.Web.UI.WebControls.ImageButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "Inv_itemsCopyButton"), System.Web.UI.WebControls.ImageButton)
            End Get
        End Property
        
        Public ReadOnly Property Inv_itemsDeleteButton() As System.Web.UI.WebControls.ImageButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "Inv_itemsDeleteButton"), System.Web.UI.WebControls.ImageButton)
            End Get
        End Property
        
        Public ReadOnly Property Inv_itemsEditButton() As System.Web.UI.WebControls.ImageButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "Inv_itemsEditButton"), System.Web.UI.WebControls.ImageButton)
            End Get
        End Property
        ...
        Public ReadOnly Property Inv_itemsImportButton() As System.Web.UI.WebControls.ImageButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "Inv_itemsImportButton"), System.Web.UI.WebControls.ImageButton)
            End Get
        End Property
        
        Public ReadOnly Property Inv_itemsNewButton() As System.Web.UI.WebControls.ImageButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "Inv_itemsNewButton"), System.Web.UI.WebControls.ImageButton)
            End Get
        End Property
        ...
        Public ReadOnly Property Inv_itemsSearch() As System.Web.UI.WebControls.TextBox
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "Inv_itemsSearch"), System.Web.UI.WebControls.TextBox)
            End Get
        End Property
        
        Public ReadOnly Property Inv_itemsSearchButton() As ServelInvocing.UI.IThemeButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "Inv_itemsSearchButton"), ServelInvocing.UI.IThemeButton)
          End Get
          End Property
