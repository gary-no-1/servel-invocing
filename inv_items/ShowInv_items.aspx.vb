...
' This file implements the code-behind class for ShowInv_items.aspx.
' ShowInv_items.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class ShowInv_items
        Inherits BaseApplicationPage
' Code-behind class for the ShowInv_items page.
...
#Region "Section 2: Do not modify this section."
        ...
        Public WithEvents Inv_itemsDialogEditButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents Inv_itemsRecordControl As ServelInvocing.UI.Controls.ShowInv_items.Inv_itemsRecordControl
