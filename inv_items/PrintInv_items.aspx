<%@ Page Language="vb" EnableEventValidation="false" AutoEventWireup="false" Codebehind="PrintInv_items.aspx.vb" Culture="en-IN" MasterPageFile="~/Master Pages/Print.master" Inherits="ServelInvocing.UI.PrintInv_items" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<%@ Register Tagprefix="Selectors" Namespace="ServelInvocing" Assembly="ServelInvocing" %>

<%@ Register Tagprefix="ServelInvocing" Namespace="ServelInvocing.UI.Controls.PrintInv_items" Assembly="ServelInvocing" %>
