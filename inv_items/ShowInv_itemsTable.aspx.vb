...
' This file implements the code-behind class for ShowInv_itemsTable.aspx.
' ShowInv_itemsTable.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class ShowInv_itemsTable
        Inherits BaseApplicationPage
' Code-behind class for the ShowInv_itemsTable page.
...
#Region "Ajax Functions"
      ...
      <Services.WebMethod()> _
      Public Shared Function GetAutoCompletionList_Inv_itemsSearch(ByVal prefixText As String, ByVal count As Integer) As String()
      ' GetInv_itemsSearchCompletionList gets the list of suggestions from the database.
      ' prefixText is the search text typed by the user .
      ' count specifies the number of suggestions to be returned.
      ' Customize by adding code before or after the call to  GetAutoCompletionList_Inv_itemsSearch()
      ' or replace the call to GetAutoCompletionList_Inv_itemsSearch().
      Return GetAutoCompletionList_Inv_itemsSearch_Base(prefixText, count)
      End Function
...
#Region "Section 2: Do not modify this section."
        ...
        Public WithEvents Inv_itemsCopyButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents Inv_itemsDeleteButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents Inv_itemsEditButton As System.Web.UI.WebControls.ImageButton
        ...
        Public WithEvents Inv_itemsImportButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents Inv_itemsNewButton As System.Web.UI.WebControls.ImageButton
        ...
        Public WithEvents Inv_itemsSearch As System.Web.UI.WebControls.TextBox
        Public WithEvents Inv_itemsSearchButton As ThemeButton
        Public WithEvents Inv_itemsTableControl As ServelInvocing.UI.Controls.ShowInv_itemsTable.Inv_itemsTableControl
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.Inv_itemsTableControl.SaveData()
      ...
      End Sub
        ...
        Public Shared Function GetAutoCompletionList_Inv_itemsSearch_Base(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim control as ServelInvocing.UI.Controls.ShowInv_itemsTable.Inv_itemsTableControl 
            control = new ServelInvocing.UI.Controls.ShowInv_itemsTable.Inv_itemsTableControl()
            
            Return control.GetAutoCompletionList_Inv_itemsSearch(prefixText, count)
        ...
        Me.Inv_itemsTableControl.LoadData()
