...
' This file implements the code-behind class for Inv_itemsWebReport.aspx.
' Inv_itemsWebReport.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class Inv_itemsWebReport
        Inherits BaseApplicationPage
' Code-behind class for the Inv_itemsWebReport page.
...
#Region "Section 2: Do not modify this section."
        ...
        Public WithEvents id_itemLabel1 As System.Web.UI.WebControls.Literal
        Public WithEvents Inv_itemsTableControl As ServelInvocing.UI.Controls.Inv_itemsWebReport.Inv_itemsTableControl
