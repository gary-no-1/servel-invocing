...
' This file implements the code-behind class for PrintInv_items.aspx.
' PrintInv_items.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class PrintInv_items
        Inherits BaseApplicationPage
' Code-behind class for the PrintInv_items page.
...
#Region "Section 2: Do not modify this section."
        ...
        Public WithEvents Inv_itemsRecordControl As ServelInvocing.UI.Controls.PrintInv_items.Inv_itemsRecordControl
