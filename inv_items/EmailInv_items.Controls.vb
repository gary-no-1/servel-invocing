...
' EmailInv_items.aspx page.  The Row or RecordControl classes are the 
...
Namespace ServelInvocing.UI.Controls.EmailInv_items
...
' Base class for the Inv_itemsRecordControl control on the EmailInv_items page.
...
Public Class BaseInv_itemsRecordControl
        ...
        Public Overridable Function CreateWhereClause() As WhereClause
            ...
            End If
            HttpContext.Current.Session("QueryString in EmailInv_items") = recId
