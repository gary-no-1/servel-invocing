...
' This file implements the code-behind class for EditInv_items.aspx.
' EditInv_items.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class EditInv_items
        Inherits BaseApplicationPage
' Code-behind class for the EditInv_items page.
...
#Region "Section 2: Do not modify this section."
        ...
        Public WithEvents id_inv_hdr As System.Web.UI.WebControls.DropDownList
        ...
        Public WithEvents Inv_itemsRecordControl As ServelInvocing.UI.Controls.EditInv_items.Inv_itemsRecordControl
        ...
        Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            Page.Title = GetResourceValue("Title:Edit") + " Items"
        End Sub
    ...
    End Function
      ...
      Public Sub SaveData_Base()
        ...
        Me.Inv_itemsRecordControl.SaveData()
      ...
      End Sub
        ...
        Me.Inv_itemsRecordControl.LoadData()
        ...
        Public Sub SaveButton_Click_Base(ByVal sender As Object, ByVal args As EventArgs)
            ...
            If Not TargetKey Is Nothing Then
                ...
                If Not Me.Inv_itemsRecordControl Is Nothing AndAlso Not Me.Inv_itemsRecordControl.DataSource Is Nothing Then
                      
                      id = Me.Inv_itemsRecordControl.DataSource.id0.ToString
                      value = Me.Inv_itemsRecordControl.DataSource.GetValue(Me.Inv_itemsRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(DFKA)).ToString
                      ...
                      If Not Formula Is Nothing Then
                            value = EvaluateFormula(Formula, Me.Inv_itemsRecordControl.DataSource)
                      End If
