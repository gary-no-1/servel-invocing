...
#Region "Section 2: Do not modify this section."
    ...
    End Function
        ...
        Private Function ReplaceTextWithResourceValue(ByVal value As String) As String
            ...
            While regex.IsMatch(value)
                ...
                If System.Text.RegularExpressions.Regex.IsMatch(value, "}") Then
                    ...
                    value = value.Replace(value.Substring((startIndex - 1), ((endIndex - startIndex) + 2)), GetResourceValue(textToLookUp, "ServelInvocing"))
                End If
        ...
        Public ReadOnly Property MultiLevelMenu() As System.Web.UI.WebControls.Menu Implements IMenu.MultiLevelMenu
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "MultiLevelMenu"), System.Web.UI.WebControls.Menu)
            End Get
        End Property
